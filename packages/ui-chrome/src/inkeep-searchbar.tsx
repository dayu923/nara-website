    ...
    <>
      <div className={className + " relative xl:w-[21.75rem]"}>
        <button
          ...
          className="w-full flex items-center gap-2 m-0 py-1.5 max-xl:px-2 xl:pr-6 xl:pl-5 rounded-[8px] !bg-gray-50/5 max-xl:text-white xl:text-gray-50 hover:text-gray-300 hover:bg-gray-50/9 focus:ring-gray-700  shadow-sm light:!bg-white light:!border-gray-300 light:text-[#7f8391] light:hover:!bg-white light:hover:text-gray-900 focus:outline-none focus:ring-2 text-sm md:text-[14px] leading-6 tracking-normal cursor-text transition-all duration-200 ease-in-out"
        >
          ...
          <kbd className="hidden xl:inline-flex items-center gap-1 px-2 py-0.5 text-xs font-medium text-gray-500 !bg-transparent rounded light:text-gray-700 ">
            ⌘K
          </kbd>
        </button>
      </div>
