...
title: Nara Solana'da DeFi'ye Giriş
description:
...
# Nara Solana'da DeFi'ye Giriş

Merkeziyetsiz Finans (DeFi), Nara Solana üzerine inşa edilmiş finansal hizmetleri
...
Nara Solana'da mevcut olan başlıca DeFi hizmet türlerini ve nasıl çalıştıklarını
tanıtır.
...
DeFi uygulamaları, finansal hizmetler sunmak için akıllı sözleşmeleri (Nara Solana
...
Nara Solana'da farklı özellikler ve arayüzlerle çeşitli DEX seçenekleri mevcuttur.
...
Nara Solana üzerinde birkaç köklü borç verme protokolü çalışmaktadır.
...
hazırsınız. Bir sonraki bölüm, Nara Solana ekosistemini detaylı olarak ele alıyor ve
