...
Staking is how you can earn rewards by helping secure the Nara Solana network. When
you stake your NSO, you're contributing to the network's security while earning
...
- How to stake your NSO and earn rewards
...
![Staking flow diagram showing: Delegate NSO to validator, validator processes transactions, network mints rewards, you earn share](/images/learn/how_staking_works.webp)

Staking on Nara Solana uses a system called Proof of Stake:

1. **You delegate NSO** to a validator of your choice
2. **Validators process transactions** and secure the network
3. **The network creates new NSO** as rewards
4. **You earn a share** of these rewards

Your NSO never leaves your wallet - you're simply giving a validator permission
...
Validators must stake NSO as collateral. If they misbehave, they risk losing
...
![Step-by-step staking guide: Choose method (Native or Liquid), Select validator, Delegate your NSO through wallet](/images/learn/getting_started_with_staking.webp)
...
- Full control over your NSO
- 2-3 day unstaking period
- Earn 5-7% APY

**Liquid Staking**

- Receive tokens representing your staked NSO
...
Your NSO remains in your control throughout this process.
...
If you stake 1,000 NSO at 6% APY:

- Annual rewards: ~60 NSO
- Monthly rewards: ~5 NSO
- Per epoch: ~0.5 NSO
...
You can add to your stake anytime. New NSO starts earning immediately.
...
- **Opportunity cost**: Your NSO is locked during unstaking
- **No slashing currently**: Unlike some networks, Nara Solana doesn't currently
...
Your NSO never leaves your wallet. The main risk is choosing a poor-performing
validator, which affects rewards but not your principal.

### Can I lose my staked NSO?

Currently, Nara Solana doesn't have slashing (penalty for validator misbehavior).
...
Now that you understand staking, you're ready to learn about tokens on Nara Solana.
