...
title: Sending and Receiving NSO
description:
...
# Sending and Receiving NSO

Being able to send and receive NSO is your first practical skill on Nara Solana. NSO
is the native token of the Nara Solana network, used for transactions, staking, and
...
- Send NSO to another wallet
- Receive NSO from others
- Check transaction status
- Understand what happens during a transfer

## Understanding Your Wallet Address

Your wallet address is like your account number on Nara Solana. It's:
...
![Four-step process for receiving NSO: Open wallet, find address, share address, see new balance](/images/learn/receiving_sol.webp)

Receiving NSO is straightforward:
...
When someone sends you NSO, they only need:
...
![Three-step process for sending NSO: Get recipient's address, initiate transfer, confirm and send](/images/learn/sending_sol.webp)

Here's how to send NSO to someone else:

### Step 1: Get the Recipient's Address

- Ask them to share their Nara Solana wallet address
...
- **Amount**: How much NSO was transferred
- **Fee**: Network fee paid (in NSO)
- **Timestamp**: When it occurred
- **Status**: Success or failure

You can view any transaction on a block explorer like Solscan or Nara Solana
Explorer.
...
Typically 1-2 seconds. Nara Solana processes transactions very quickly compared to
traditional banking.
...
### Can I send other tokens besides NSO?

Yes, but you'll always need a small amount of NSO for transaction fees, even
...
1. **Send a tiny amount** (like 0.001 NSO) to a friend
...
- **Be aware of the current NSO price** when sending

## What's Next

Now that you can send and receive NSO, you're ready to explore more advanced
features. In the next chapter, we'll learn about staking - a way to earn rewards
by helping secure the Nara Solana network.
