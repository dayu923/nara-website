...
title: Understanding Nara Solana Transaction Fees
description:
...
# Understanding Nara Solana Transaction Fees

Transaction fees are an important part of any digital network. On Nara Solana, fees
...
- How Nara Solana's fee structure works
...
On Nara Solana, fees are kept minimal while still serving these functions.

## Nara Solana's Fee Structure

![Breakdown of Nara Solana's three fee types: Base Fee, Priority Fee, and Storage Rent](/images/learn/solana_s_fee_structure.webp)

### Base Fee

Every transaction pays a base fee of 0.000005 NSO (5,000 lamports). At $100 per
NSO, that's $0.0005 - half a tenth of a cent.
...
NSO) that's refundable when the account is closed.

## Typical Transaction Costs

Here are real examples of what you'll pay:

| Action               | Typical Cost       | In USD (at $100/NSO) |
| -------------------- | ------------------ | -------------------- |
| Send NSO             | 0.000005 NSO       | $0.0005              |
| Send tokens          | 0.000005 NSO       | $0.0005              |
| Swap tokens          | 0.000005 NSO       | $0.0005              |
| Buy an NFT           | 0.000005-0.001 NSO | $0.0005-0.10         |
| Create token account | ~0.002 NSO         | $0.20 (refundable)   |
...
## How Nara Solana Keeps Fees Low

Nara Solana achieves low fees through technical design:

### Parallel Processing

Like a multi-lane highway, Nara Solana processes many transactions simultaneously
...
Unlike auction-based fees, Nara Solana's fees remain stable regardless of network
activity.
...
- Base fee only: 0.000005 NSO
- Instant confirmation
- No competition for block space

### Busy Periods

- Add priority fee: 0.0001-0.001 NSO
...
![Three real-world scenarios comparing traditional vs Nara Solana fees: Sarah (online seller), Miguel (trader), Ami (remittances)](/images/learn/practical_examples.webp)
...
- Nara Solana: $0.0005 fee (0.001%)

## Managing Transaction Fees

### Best Practices

- Keep 0.1 NSO in your wallet for fees
...
- Total cost in NSO and USD

## Common Questions

### Why do I need NSO for fees?

All Nara Solana transactions require NSO for fees, even when sending other tokens.
...
You'll need a small amount of NSO to pay for transaction fees. Most users
purchase NSO from exchanges or receive it from friends to get started.
...
the next chapter, you'll practice sending and receiving NSO, experiencing these
low fees firsthand.

Remember: Nara Solana's low fees aren't just about saving money - they're about
