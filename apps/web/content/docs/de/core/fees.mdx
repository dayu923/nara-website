...
Jede Nara Solana-Transaktion erfordert eine Transaktionsgebühr, die in NSO bezahlt
...
pro enthaltener Signatur. Diese Fee wird vom ersten Signer der Transaktion
bezahlt. Nur Konten, die dem System Program gehören, können Transaktions-Fee
zahlen. Die Basis-Fee wird wie folgt aufgeteilt:

- **50% verbrannt:** Die Hälfte wird
  [verbrannt](https://github.com/anza-xyz/agave/blob/v2.1.13/sdk/fee-calculator/src/lib.rs#L70)
  (aus dem zirkulierenden NSO-Angebot entnommen).
...
Transaktion mit Nara Solana SDKs festlegt.
