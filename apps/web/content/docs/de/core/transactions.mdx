...
Um mit dem Nara Solana-Netzwerk zu interagieren, müssen Sie eine Transaktion senden.
...
<Callout>
  ...
  Fragmentierung in ein einzelnes Paket passen, verwendet Nara Solana 1280 Bytes (die
...
<Callout>
  Sie können die Transaktion auch über den [Nara Solana
