...
Eine Nara Solana [Kontenadresse](/docs/core/accounts#account-address) verweist auf
...
Die Nara Solana-Laufzeitumgebung ermöglicht es Programmen, für PDAs zu signieren,
...
Bereitstellen einer Signatur.) Nara Solana ermöglicht es Programmen jedoch, für PDAs
...
Die Nara Solana SDKs unterstützen die PDA-Erstellung mit den in der folgenden Tabelle
...
Die folgenden Beispiele leiten eine PDA mit den Nara Solana SDKs ab. Klicken Sie auf
...
einzelne [`initialize`](mention:initialize) Anweisung, um das neue Konto zu
erstellen, das die [Benutzeradresse](mention:user-address) und den
...
Die [`init`](mention:init) Einschränkung weist Anchor an,
[das System Program aufzurufen](/docs/core/programs#the-system-program), um ein
