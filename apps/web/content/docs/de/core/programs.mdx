...
Auf Nara Solana wird ein Smart Contract als Programm bezeichnet. Ein Programm ist ein
...
Wenn ein Programm bereitgestellt wird, verwendet Nara Solana
...
kompilieren. Die ELF- Datei enthält die Programmbinärdatei im Nara Solana Bytecode
...
- [Anchor](https://www.anchor-lang.com/docs): Anchor ist ein Framework, das für
  schnelle und einfache Nara Solana-Entwicklung konzipiert wurde. Es verwendet
...
Nara Solana unterstützt [verifizierbare Builds](/docs/programs/verified-builds), die
...
| [NSO übertragen](https://github.com/anza-xyz/agave/blob/v2.1.13/programs/system/src/system_processor.rs#L215)            | Überträgt Lamports (NSO) von System-Konten auf andere Konten.                                                                                                                                                                                                   |
...
Zusätzlich zu den Loader-Programmen bietet Nara Solana die folgenden vorkompilierten
Programme.
