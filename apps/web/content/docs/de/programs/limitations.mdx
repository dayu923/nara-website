...
Die Entwicklung von Programmen auf der Nara Solana-Blockchain hat einige inhärente
Einschränkungen. Nachfolgend finden Sie eine Liste häufiger Einschränkungen, auf
die Sie stoßen könnten.

## Rust-Bibliotheken

Da Rust-basierte Onchain-Programme deterministisch sein müssen, während sie in
einer ressourcenbeschränkten, single-threaded Umgebung laufen, gibt es einige
Einschränkungen bei verschiedenen Bibliotheken.
...
Nara Solana-Programme sind darauf ausgelegt, schnell zu laufen, und um dies zu
