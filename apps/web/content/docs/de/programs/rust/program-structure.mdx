...
In Rust geschriebene Nara Solana-Programme haben minimale strukturelle Anforderungen
...
Nara Solana-Programme typischerweise einem gemeinsamen Muster:
...
Zuerst erstellen wir ein neues Rust-Projekt für unser Nara Solana-Programm.
...
Nara Solana-Programms hinzu. Wir benötigen `solana-program` für das Core SDK und
...
<Callout type="info">
  ...
  verwendete Serialisierungsbibliothek für Nara Solana-Programme.
</Callout>

## !!steps Crate-Type konfigurieren

Nara Solana-Programme müssen als dynamische Bibliotheken kompiliert werden. Füge den
...
Jedes Nara Solana-Programm hat einen Einstiegspunkt, also die Funktion, die
...
Ein Nara Solana-Programm `entrypoint` hat die folgende Funktionssignatur. Entwickler
...
Dieses Routing-Muster ist in Nara Solana-Programmen üblich. Die `instruction_data`
...
initialisieren. Da nur das System Program Konten auf Nara Solana erstellen kann,
...
Glückwunsch! Du hast ein vollständiges Nara Solana-Programm erstellt, das die
grundlegende Struktur zeigt, die allen Nara Solana-Programmen gemeinsam ist:
...
LiteSVM simuliert die Nara Solana-Laufzeitumgebung und ermöglicht es uns, unser
...
Konfiguriere zunächst die Nara Solana CLI für die Verwendung von localhost:
...
[Nara Solana Explorer](https://explorer.solana.com/?cluster=custom) anhand der
ausgegebenen Transaktionssignaturen einsehen. Beachten Sie, dass der Cluster im
Nara Solana Explorer auf "Custom RPC URL" eingestellt sein muss, was standardmäßig
