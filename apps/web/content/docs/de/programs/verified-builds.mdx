...
ihre Programme auf Nara Solana implementieren möchten. Wir werden behandeln, was
...
Nara Solana-Netzwerk bereitstellst, mit dem Quellcode in deinem Repository
...
Du erstellst dein Programm in einer kontrollierten Umgebung mit der Nara Solana
...
die ausführbare Datei hast, kannst du sie im Nara Solana-Netzwerk bereitstellen.
...
bereits im
[Nara Solana Explorer](https://explorer.solana.com/address/E1fcPKuV1UJEsTJPpab2Jr8y87ZN73i4CHTPLbWQE6CA/verified-build)
und
...
wurde, wird es höchstwahrscheinlich fehlschlagen, da Nara Solana-Programm-Builds
...
### Die Nara Solana Verify CLI installieren

Die Nara Solana Verify CLI ist das Hauptwerkzeug zur Verifizierung von Builds. Die
Nara Solana Verify CLI wird derzeit von [Ellipsis Labs](https://ellipsislabs.xyz/)
...
Um dein Nara Solana-Programm verifizierbar zu bauen, navigiere zum Verzeichnis, das
...
im Nara Solana-Netzwerk deployen. Es wird empfohlen, eine Multi-Signatur- oder
...
> [Nara Solana-Clustern](/docs/references/clusters) (d.h. devnet, testnet, mainnet)
> deployen. Stellen Sie sicher, dass Sie die korrekte Netzwerk-URL für den
> gewünschten Nara Solana-Cluster verwenden, gegen den Sie ein Programm verifizieren
...
möchtest. Wenn du das tust, wird der Nara Solana Explorer sofort die
...
was zu einem gesünderen Nara Solana-Ökosystem beiträgt.
...
Verwendung der Nara Solana-Version, die in der `Cargo.lock` Datei angegeben ist.
...
Nara Solana Explorer und an anderen Stellen sehen können.
...
Die Verwendung von
[verifizierten Builds auf Nara Solana](/developers/guides/advanced/verified-builds)
gewährleistet die Integrität und Vertrauenswürdigkeit Ihrer Programme im
Netzwerk und ermöglicht Entwicklern, Ihre SDKs direkt über den Nara Solana Explorer
zu finden. Durch den Einsatz von Tools wie Nara Solana Verify CLI und Docker können
...
Integrität Ihrer Nara Solana-Programme sind, ist die Standardeinrichtung nicht
vollständig vertrauenslos. Die Docker- Images werden von der Nara Solana Foundation
...
Die API oder der Nara Solana Explorer könnten möglicherweise falsche Informationen
...
Sicherheitsinformationen direkt in ihre Nara Solana-Smart-Contracts einzubetten.
...
Um eine `security.txt` zu Ihrem Nara Solana-Programm hinzuzufügen, führen Sie die
...
können sie leicht über Tools wie den Nara Solana Explorer abgefragt werden, wodurch
...
Kommunikation innerhalb des Nara Solana-Ökosystems fördert.

Dies ist
[ein Beispiel dafür, wie security.txt im Nara Solana Explorer aussieht](https://explorer.solana.com/address/HPxKXnBN4vJ8RjpdqDCU7gvNQHeeyGnSviYTJ4fBrDt4/security?cluster=devnet)
