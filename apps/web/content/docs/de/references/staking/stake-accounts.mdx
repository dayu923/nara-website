...
Ein Stake-Konto auf Nara Solana kann verwendet werden, um Token an Validatoren im
...
System-Konto kann nur NSO von anderen Konten im Netzwerk senden und empfangen,
...
Stake-Konten auf Nara Solana funktionieren auch anders als die anderer
...
Wie andere Kontentypen im Nara Solana-Netzwerk wird ein Stake-Konto mit einem
Guthaben von 0 NSO nicht mehr verfolgt. Wenn ein Stake-Konto nicht delegiert ist
...
[Nara Solana Explorer](http://explorer.solana.com/) eingesehen werden, indem man eine
