...
title: Memo-Übertragung
description: Erfahren Sie, wie Sie die MemoTransferExtension aktivieren können.
...
erfordert, dass alle eingehenden Token-Überweisungen ein begleitendes Memo
enthalten, wenn sie auf einem Token-Konto aktiviert ist. Diese Erweiterung kann
vom Token-Kontoinhaber aktiviert oder deaktiviert werden.
