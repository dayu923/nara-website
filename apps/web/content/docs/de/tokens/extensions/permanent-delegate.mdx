...
title: Permanenter Delegierter
description:
  Erfahren Sie, wie Sie die InitializePermanentDelegate-Erweiterung
  implementieren.

---


## Wie man die InitializePermanentDelegate-Erweiterung implementiert
...
weist einen unwiderruflichen Delegierten mit Autorität über alle Token-Konten
für eine Mint zu. Im Gegensatz zu regulären Delegierten, die von
Token-Konteninhabern widerrufen werden können, kann ein permanenter Delegierter
nicht geändert oder entfernt werden. Der permanente Delegierte kann Token in
jedem Token-Konto dieser Mint übertragen, verbrennen und einfrieren.
