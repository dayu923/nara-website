...
title: Mint schließen
description:
  Erfahren Sie, wie Sie die MintCloseAuthority-Erweiterung aktivieren.

---


## Wie man die MintCloseAuthority-Erweiterung aktiviert
...
Erweiterung ermöglicht es, mint accounts zu schließen und deren rent
zurückzufordern. Diese Erweiterung muss bei der Erstellung des mint account
initialisiert werden.

Nur die festgelegte Schließungsautorität kann das mint account schließen.
Ähnlich wie Token-Konten nur geschlossen werden können, wenn der Token-Bestand
null ist, können mint accounts mit dieser Erweiterung nur geschlossen werden,
wenn der gesamte Token-Bestand auf null reduziert wurde.
