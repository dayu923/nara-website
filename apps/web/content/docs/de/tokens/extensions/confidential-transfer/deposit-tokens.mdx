...
description: Erfahre, wie du Token in den vertraulichen Status einzahlen kannst.
...
## Wie man Token auf ein vertrauliches ausstehende Guthaben einzahlt
...
1. **Vertrauliches ausstehende Guthaben**: Zunächst werden Token vom
   öffentlichen Guthaben auf ein "ausstehende" vertrauliches Guthaben
   "eingezahlt".
2. **Vertrauliches verfügbares Guthaben**: Das ausstehende Guthaben wird dann
   auf das verfügbare Guthaben "angewendet", wodurch die Token für vertrauliche
   Überweisungen verfügbar werden.

Dieser Abschnitt erklärt die erste Stufe: Das Einzahlen des öffentlichen
Token-Guthabens auf das vertrauliche ausstehende Guthaben.

Das folgende Diagramm zeigt die Schritte, die beim Einzahlen von Token vom
öffentlichen Guthaben auf das vertrauliche ausstehende Guthaben beteiligt sind:
...
Um ein öffentliches Guthaben in ein vertrauliches ausstehende Guthaben
umzuwandeln, rufen Sie die
...
Anweisung auf. Der
[maximale Betrag](https://github.com/solana-program/token-2022/blob/efd0c957fefbd79882d77df5fb2dac88c001249c/program/src/extension/confidential_transfer/mod.rs#L21)
pro Einzahlungsanweisung ist auf 2^48 begrenzt.

Das `spl_token_client` Crate bietet eine `confidential_transfer_deposit`
Methode, die eine Transaktion mit der `Deposit` Anweisung erstellt und sendet,
wie im folgenden Beispiel gezeigt.

### Beispielcode

Das folgende Beispiel zeigt, wie man öffentliches Token-Guthaben auf
vertrauliches ausstehende Guthaben einzahlt.

Um das Beispiel auszuführen, starten Sie einen lokalen Validator mit dem Token
Extensions Program, das vom Mainnet geklont wurde, mit dem folgenden Befehl. Sie
...
<Callout type="info">
  Zum Zeitpunkt des Schreibens sind die vertraulichen Überweisungen auf dem
