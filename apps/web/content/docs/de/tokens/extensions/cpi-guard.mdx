...
title: CPI Guard
description: Erfahren Sie, wie Sie die CpiGuardExtension aktivieren können.
...
Invocations (CPIs). Wenn aktiviert, stellt diese Erweiterung sicher, dass Tokens
nur durch direkte Aufrufe der Übertragungsanweisung des Token Extensions Program
übertragen werden können, wodurch alle anderen Programme daran gehindert werden,
Tokens über CPI zu übertragen.
