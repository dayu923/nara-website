...
title: Nicht-übertragbare Token
description:
  Erfahren Sie, wie Sie die InitializeNonTransferableMint-Erweiterung
  aktivieren.

---


## Wie man die InitializeNonTransferableMint-Erweiterung aktiviert
...
verhindert, dass Token nach dem Minting zwischen Token-Konten übertragen werden
können. Einmal geminted, verbleiben die Token dauerhaft im Token-Konto. Der
Besitzer des Token-Kontos kann jedoch weiterhin Token verbrennen und das
Token-Konto schließen, wenn der Kontostand null erreicht.
