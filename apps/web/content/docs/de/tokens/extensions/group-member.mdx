...
description:
  Erfahren Sie, wie Sie die GroupPointerExtension und
  GroupMemberPointerExtension aktivieren können.
...
[Gruppenkonfigurationen](https://github.com/solana-program/token-group/blob/3b4ff305452fa35754206fc1ad4addb2e2bff511/interface/src/state.rs#L16)
...
[Mitgliedschaftsdaten](https://github.com/solana-program/token-group/blob/3b4ff305452fa35754206fc1ad4addb2e2bff511/interface/src/state.rs#L67)
wie Gruppenadresse und Mitgliedsnummer enthält.

Das Token Extensions Program implementiert die
[Token Group Interface](https://github.com/solana-program/token-group) direkt,
wodurch sowohl Gruppen- als auch Mitgliedsdaten auf dem mint account selbst
gespeichert werden können. Wenn die Pointer-Extensions auf den Mint selbst
verweisen, können die
...
Extensions verwendet werden, um alle Kollektions- und Mitgliedschaftsdaten im
