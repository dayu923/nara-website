...
description:
  Erfahren Sie, wie Sie die MetadataPointerExtension und TokenMetadata-Extension
  aktivieren können.

---


## Wie man die MetadataPointerExtension und TokenMetadata-Extension aktiviert
...
ermöglicht einem mint account, die Adresse seines Metadata-Konten anzugeben.
Dieser Zeiger kann auf jedes Konto verweisen, das einem Programm gehört, das die
[Token Metadata Interface](https://github.com/solana-program/token-metadata/tree/main)
implementiert, was Flexibilität bei der Speicherung von Metadaten bietet.
...
direkt, wodurch Metadaten direkt im mint account selbst gespeichert werden
können. Dies beinhaltet den Namen des Tokens, Symbol, URI und zusätzliche
beschreibende Daten. Wenn die Pointer-Extensions auf den Mint selbst zeigen,
können die
...
Extensions verwendet werden, um alle Metadaten im mint account zu speichern.
