...
title: Ein Token Account erstellen
description: Erfahren Sie, wie Sie SPL Token Accounts erstellen.
...
<Callout type="info">
  **Verständnis der "Owner"-Terminologie**
...
um einen bestimmten Token zu halten. Es verwendet eine deterministische Adresse
(PDA), die vom
...
Das Associated Token Program ist ein Hilfsprogramm, das:

- Token Konten an deterministischen Adressen (PDAs) erstellt
- Cross-Program Invocations (CPIs) zum Token Program durchführt
