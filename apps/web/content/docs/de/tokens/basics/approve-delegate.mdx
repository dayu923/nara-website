...
Anweisung erteilt einem anderen Konto (dem Delegate) die Erlaubnis, eine
bestimmte Menge an Tokens von Ihrem Token-Konten zu übertragen. Der Delegate
kann Tokens bis zur genehmigten Menge übertragen, darf diese jedoch nicht
überschreiten. Nur der Besitzer des Token-Konten kann einen Delegate genehmigen,
und jedes Token-Konten kann nur einen Delegate zur gleichen Zeit haben. Jede
neue Genehmigung überschreibt die vorherige.
