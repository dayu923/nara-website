...
title: Delegierten widerrufen
description:
  Erfahren Sie, wie Sie den Delegierten eines Token-Kontos widerrufen können.

---


## Wie man einen Delegierten widerruft
...
Anweisung entfernt alle Übertragungsberechtigungen vom aktuell genehmigten
Delegierten. Nach dem Widerruf kann der Delegierte keine Token mehr von Ihrem
Konto übertragen. Nur der Besitzer des token account kann einen Delegierten
widerrufen.
...
<Callout type="info">
  ...
  haben ähnliche Implementierungen, um die gleiche Funktionalität zu erreichen.
</Callout>
