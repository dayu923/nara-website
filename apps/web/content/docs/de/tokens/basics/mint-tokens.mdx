...
title: Token prägen
description: Erfahren Sie, wie Sie neue Einheiten eines Tokens prägen können.

---


## Wie man Tokens prägt

Das Prägen erstellt neue Einheiten eines Tokens mit der
...
- Nur die Prägeautorität kann neue Tokens prägen
- Ein Ziel-Token-Konto muss existieren, um die geprägten Tokens zu empfangen
