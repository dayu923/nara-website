...
Ein mint account repräsentiert eindeutig einen Token auf Nara Solana und speichert
...
<Callout type="info">
  Beachten Sie, dass sowohl das [Token
...
Jeder Token auf Nara Solana hat einen Mint Account, und die Adresse des Mints dient
...
eindeutig im gesamten Nara Solana-Ökosystem. Sie können diesen Mint auf
