...
description: Erfahren Sie, wie Sie Token-Konten schließen können.
...
Anweisung schließt ein Token-Konto dauerhaft und überträgt das gesamte
verbleibende NSO (rent) auf ein angegebenes Zielkonto. Der Token-Kontostand muss
vor dem Schließen Null sein. Nur der Token-Kontoinhaber oder die festgelegte
Schließungsberechtigung kann diese Anweisung ausführen.
