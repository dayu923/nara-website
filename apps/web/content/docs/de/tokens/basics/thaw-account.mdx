...
title: Konto auftauen
description:
  Erfahren Sie, wie Sie ein eingefrorenes Token-Konto auftauen können.
...
Anweisung macht ein Einfrieren rückgängig und stellt die volle Funktionalität
eines zuvor eingefrorenen token account wieder her. Nach dem Auftauen kann das
Konto wieder normal Token senden und empfangen. Nur die Einfrierungsautorität
der Token-Mint kann Konten auftauen.
