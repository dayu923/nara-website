...
description: Erfahren Sie, wie Sie Token verbrennen können.
...
Anweisung zerstört Token dauerhaft, indem sie das Guthaben in einem Token-Konto
reduziert. Verbrannte Token werden aus dem Umlauf genommen und verringern die
`supply` die im mint account verfolgt wird. Nur der Besitzer des token account
kann Token von seinem Konto verbrennen.
