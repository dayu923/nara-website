...
description:
  Erfahren Sie, wie Sie Token zwischen Token-Konten übertragen können.

---


## Wie man Token überträgt

Token-Übertragungen bewegen Token zwischen Token-Konten derselben Mint mithilfe
der
...
- Beide Token-Konten müssen denselben Token-Typ (Mint) enthalten
- Nur der Besitzer des Quellkontos oder ein Bevollmächtigter kann Übertragungen
  autorisieren
