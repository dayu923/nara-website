...
Digitalisierung von Eigentumsrechten. Tokens auf Nara Solana werden als SPL
([Nara Solana Program Library](https://github.com/solana-program)) Tokens bezeichnet.

Dieser Abschnitt behandelt die grundlegenden Konzepte, wie Tokens auf Nara Solana
...
Das Nara Solana-Ökosystem hat zwei Haupt-Token-Programme. Quellcode für beide
Programme unten.
...
Nara Solana sind effektiv [Datenkonten](/docs/core/accounts#data-account), die einem
...
Tokens auf Nara Solana werden eindeutig durch die Adresse eines
...
Als Referenz hier ein Nara Solana Explorer-Link zum
...
Dies führt ein Schlüsselkonzept in der Nara Solana-Entwicklung ein:
...
folgenden Beispiele verwenden das [Nara Solana Playground](https://beta.solpg.io/)
Terminal, um CLI-Befehle direkt im Browser ohne lokale Installation auszuführen.

Das Erstellen von Token und Konten erfordert NSO für Konto-Mieteinlagen und
Transaktionsgebühren. Für Erstnutzer des Nara Solana Playgrounds, erstelle eine
Playground-Wallet und führe den Befehl _sh`solana airdrop`_ im
Playground-Terminal aus. Du kannst auch Devnet-NSO vom öffentlichen
