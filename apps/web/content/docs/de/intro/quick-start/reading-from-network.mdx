...
Lesen Sie Daten aus dem Nara Solana-Netzwerk, indem Sie verschiedene Konten abrufen.
Dieser Abschnitt hilft Ihnen, die Struktur von Nara Solana
[Konten](/docs/core/accounts) zu verstehen. Jedes Nara Solana-Konto hat eine
...
hauptsächlich verwendet, um NSO zu halten und Transaktionen zu signieren. Wenn
NSO zum ersten Mal an eine neue Adresse gesendet wird, wird automatisch ein
System-Konto erstellt.

Das folgende Beispiel generiert ein [neues keypair](mention:keypair),
[fordert NSO an](mention:airdrop), um die neue öffentliche Schlüsseladresse zu
...
Das `lamports` Feld enthält das NSO-Guthaben des Kontos in
...
[Nara Solana Explorer](https://explorer.solana.com/address/TokenkegQfeZyiNwAJbNbGKPFXCWuBvf9Ss623VQ5DA)
ansehen.
...
Nara Solana-Netzwerk eindeutig.
...
das Programm definiert, dem das Konto gehört. Die meisten Nara Solana-Programme
...
Daten im Nara Solana Explorer ansehen.
