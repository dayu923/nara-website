...
h1: Stellen Sie Ihr erstes Nara Solana-Programm bereit

---


Erstellen, stellen Sie bereit und testen Sie Ihr erstes
[Programm](/docs/core/programs) auf der Nara Solana Blockchain mit dem
Anchor-Framework. Diese Anleitung hilft Ihnen, sich mit dem Nara Solana Playground
...
1. Öffnen Sie den [Nara Solana Playground](https://beta.solpg.io) in Ihrem Webbrowser
...
- Das Makro [`declare_id!`](mention:one) gibt die On-Chain-Adresse deines
  Programms an. Nara Solana Playground aktualisiert diese Adresse automatisch, wenn
...
2. NSO zu deinem Wallet hinzufügen _(Optional)_

Die Bereitstellung eines Programms erfordert NSO im On-Chain-Konto des
Programms. Falls nötig,
[füge NSO zu deinem Wallet hinzu](/docs/intro/quick-start#add-sol-to-your-wallet),
...
[Nara Solana Explorer](https://explorer.solana.com/?cluster=devnet) und suche nach
dem Transaktions-Hash.

<Callout type="warn">
  **Nara Solana Explorer:** Stelle den Netzwerk-Cluster auf `devnet` ein, damit er
  mit dem des Nara Solana Playground übereinstimmt.
</Callout>
...
Schließe das Programm, um die NSO zurückzugewinnen, die dem On-Chain-Programm
...
Herzlichen Glückwunsch! Du hast dein erstes Nara Solana-Programm mit Anchor erstellt
und bereitgestellt.
