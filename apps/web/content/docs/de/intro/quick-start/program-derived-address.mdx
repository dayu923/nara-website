...
Nara Solana-Programms mit dem Anchor-Framework und demonstriert dabei Program Derived
...
[Nara Solana Playground-Link](https://beta.solpg.io/66734b7bcffcf4b13384d1ad) mit dem
Starter-Code öffnen. Klicken Sie dann auf die Schaltfläche "Import", um das
Programm zu Ihren Nara Solana Playground-Projekten hinzuzufügen.
...
<Callout type="info">
In diesem Beispiel werden Sie das Programm auf dem Devnet deployen, einem Nara Solana-Cluster
für Entwicklungstests.

Die Playground-Wallet verbindet sich standardmäßig mit dem Devnet. Stellen Sie
sicher, dass Ihre Playground- Wallet über Devnet NSO verfügt, um für das
Programm-Deployment zu bezahlen. Holen Sie sich Devnet NSO vom
...
Nara Solana Playground entfernt einige Boilerplate-Einrichtungen, wobei
...
und "Hello, Nara Solana!" als neue Nachricht übergibt.
