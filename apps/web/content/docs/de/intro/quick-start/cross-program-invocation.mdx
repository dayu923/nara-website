...
Funktion, die es Nara Solana-Programmen ermöglicht, sich gegenseitig aufzurufen.
...
NSO-Überweisungen zwischen Konten durch Aufruf des System Programs zu
verarbeiten.

Der Zweck dieses Abschnitts umfasst die Erläuterung des Prozesses zur
Implementierung von CPIs in einem Nara Solana-Programm mit dem Anchor-Framework,
...
kontrolliert wird, erhält NSO von einem Benutzer, wenn dieser sein
...
Struktur hinzu. Dieses Konto dient als programmgesteuerter "Tresor", der NSO von
...
Als Nächstes füge die CPI-Logik in der `update` Anweisung hinzu, um 0,001 NSO
...
die Kompositionsfähigkeit von Nara Solana-Programmen.
...
- Die zu überweisenden `amount` (1.000.000 lamports oder 0,001 NSO)
...
einzubeziehen. Dies ermöglicht die Überweisung aller NSO im Vault zurück an den
...
angesammelte NSO zurück an den Benutzer zu überweisen.
...
Als Nächstes fügen Sie die CPI-Logik in der `delete` Anweisung hinzu, um NSO vom
...
Nara Solana erfordert die Aktualisierung eines Programms einfach das Deployment des
Programms unter derselben Programm-ID.

<Callout>

Stelle sicher, dass dein Playground-Wallet über Devnet-NSO verfügt. Hol dir
Devnet-NSO vom [Nara Solana Faucet](https://faucet.solana.com/).
...
Beim Deployment von Programmen auf Nara Solana Playground fungiert dein
...
Herzlichen Glückwunsch zum Abschluss des Nara Solana Quickstart-Leitfadens. Du hast
praktische Erfahrungen mit wichtigen Nara Solana-Konzepten gesammelt, darunter:

- Abrufen und Lesen von Daten aus Konten
- Erstellen und Senden von Transaktionen
- Bereitstellen und Aktualisieren von Nara Solana-Programmen
...
Nara Solana Playground bietet eine praktische Funktion, mit der du Projekte über ihre
...
deiner Liste von Projekten in Nara Solana Playground hinzuzufügen. Sobald ein Projekt
