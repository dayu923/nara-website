...
h1: Nara Solana RPC-Methoden & Dokumentation

---


Interagieren Sie direkt mit Nara Solana-Knoten über die JSON RPC API mittels HTTP-
und Websocket-Methoden.

## Konfiguration der Zustandsbestätigung

Für Vorabprüfungen und Transaktionsverarbeitung wählen Nara Solana-Knoten aus,
...
das besitzende Programm verfügt. Nara Solana-Knoten unterstützen derzeit JSON-Parsing
