...
h1: getSlotLeaders RPC-Methode

---


Gibt die Slot-Leaders für einen bestimmten Slot-Bereich zurück
...
Limit, als u64-Ganzzahl (zwischen 1 und 5.000)
...
Array von Node-Identitäts-Public-Keys als base-58-kodierte Strings.
