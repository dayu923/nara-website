...
title: HTTP-Methoden
seoTitle: Nara Solana RPC HTTP-Methoden
hideTableOfContents: false
h1: Nara Solana RPC HTTP-Methoden

---


Nara Solana-Knoten akzeptieren HTTP-Anfragen unter Verwendung der
...
> Nara Solana-Knoten. Für eine PubSub-Verbindung zu einem Nara Solana-Knoten verwenden Sie
...
- Transaktion: Eine Liste von Nara Solana Anweisungen, die von einem Client-Keypair
