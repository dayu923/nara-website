...
Fordert einen Airdrop von Lamports an eine Pubkey an
...
Pubkey des Kontos, das Lamports erhalten soll, als base-58-kodierte Zeichenfolge
...
Anzahl der Lamports für den Airdrop
...
Transaktionssignatur des Airdrops als base-58-kodierte Zeichenfolge
