...
h1: getBalance RPC-Methode

---


Gibt den Lamport-Guthaben des Konten mit der angegebenen Pubkey zurück
...
Pubkey des abzufragenden Konten, als base-58 kodierte Zeichenfolge.
...
RpcResponse JSON-Objekt mit dem Wertfeld, das auf das Guthaben gesetzt ist.
