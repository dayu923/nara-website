...
Gibt den Mindestguthaben zurück, der erforderlich ist, um ein Konto von der
Rent-Zahlung zu befreien.
...
Mindestanzahl an lamports, die im Konto erforderlich sind, um rent-frei zu
bleiben
