...
h1: getTransactionCount RPC-Methode

---


Gibt die aktuelle Anzahl der Transaktionen aus dem Ledger zurück
...
Die aktuelle Anzahl der Transaktionen aus dem Ledger
