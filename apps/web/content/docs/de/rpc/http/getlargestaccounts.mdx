...
Gibt die 20 größten Konten nach Lamport-Guthaben zurück (Ergebnisse können bis
zu zwei Stunden zwischengespeichert werden)
...
Filtert Ergebnisse nach Kontotyp
...
Das Ergebnis ist ein RpcResponse JSON-Objekt mit `value` gleich einem Array von
Objekten, die Folgendes enthalten:

##### !! address

!type string

Base-58 kodierte Adresse des Kontos

##### !! lamports

!type u64

Anzahl der lamports im Konto
