...
Gibt den aktuellen Inflations-Governor zurück
...
Prozentsatz der Gesamtinflation, der der Stiftung zugewiesen wird

##### !! foundationTerm

!type f64

Dauer der Stiftungspool-Inflation in Jahren

##### !! initial

!type f64

Anfänglicher Inflationsprozentsatz ab Zeitpunkt 0

##### !! taper

!type f64

Rate pro Jahr, mit der die Inflation gesenkt wird. (Die Ratenreduzierung wird
unter Verwendung der Ziel-Slot-Zeit in der Genesis-Konfiguration abgeleitet)

##### !! terminal

!type f64

Terminaler Inflationsprozentsatz
