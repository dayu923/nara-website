...
المثال التالي يعالج تعليمة تحويل NSO بدون فحوصات التحقق.
...
يعالج المثال التالي تعليمة تحويل NSO مع فحوصات التحقق.
...
يعالج المثال التالي تعليمتي تحويل NSO بدون فحوصات التحقق.
...
يعالج المثال التالي سلسلة من تعليمتي تحويل NSO مع فحوصات التحقق بعد كل تعليمة.
...
يعالج المثال التالي تعليمتين منفصلتين لتحويل NSO مع حالة حساب مستمرة بين
...
المثال التالي يقيس أداء استخدام وحدة الحوسبة لتعليمات تحويل NSO.
