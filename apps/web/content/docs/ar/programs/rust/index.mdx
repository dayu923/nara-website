...
- Nara Solana CLI: أداة سطر الأوامر لتطوير سولانا.
...
البرنامج في `src/lib.rs` لطباعة "Hello, Nara Solana!" بدلاً من "Hello, world!".
...
يجب أن ترى "Hello, Nara Solana!" في سجل البرنامج.
...
"Hello, Nara Solana!" في سجل البرنامج.
...
يمكنك إغلاق برنامج سولانا الخاص بك لاسترداد عملات NSO المخصصة للحساب. إغلاق
