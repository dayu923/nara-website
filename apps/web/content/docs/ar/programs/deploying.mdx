...
ستحتاج إلى NSO لدفع تكاليف نشر البرنامج. يعتمد المبلغ على حجم البرنامج الخاص بك.
...
هنا برنامج سولانا بسيط يطبع "Hello, Nara Solana!" في سجلات البرنامج.
...
يتطلب نشر البرنامج تخصيص NSO لحساب البرنامج بناءً على حجم البرنامج. البرامج
الأكبر حجمًا تكلف المزيد من NSO للنشر.
...
احسب كمية NSO المطلوبة لهذا الحجم (بالبايت):
...
<Callout type="info">
  ستحتاج إلى NSO أكثر قليلاً مما هو موضح لتغطية رسوم معاملات النشر.
</Callout>
...
ستقوم واجهة سطر الأوامر بحساب كمية NSO المطلوبة وخصمها من محفظتك تلقائيًا.
...
نشر التحديثات أو إغلاق البرنامج لاسترداد عملات NSO المخصصة للبرنامج.
...
الرصيد يعرض عملات NSO المخصصة لحساب البرنامج لتخزين بياناته.
...
لإغلاق برنامجك واسترداد عملات NSO المخصصة لحساب البرنامج، استخدم الأمر
...
- **`--with-compute-unit-price`**: تعيين رسوم الأولوية بالميكرو-لامبورت
  (0.000001 NSO) لكل وحدة حسابية. راجع
