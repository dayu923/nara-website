...
أساسي لحفظ NSO وتوقيع المعاملات. عندما يتم إرسال NSO إلى عنوان جديد لأول مرة،
يتم إنشاء حساب نظام تلقائيًا.

المثال أدناه يقوم بإنشاء [زوج مفاتيح جديد](mention:keypair)،
[يطلب NSO](mention:airdrop) لتمويل عنوان المفتاح العام الجديد، و
...
يحتوي حقل `lamports` على رصيد NSO للحساب، بوحدة
