...
بالتفاعل مع الشبكة. في هذا المثال، يتم تحويل NSO من حساب إلى آخر.
...
![رسم بياني لتحويل NSO](/assets/docs/core/transactions/sol-transfer.svg)

بعد إرسال المعاملة، يقوم System Program بمعالجة تعليمة التحويل وتحديث رصيد
اللامبورت لكلا الحسابين.

![رسم بياني لعملية تحويل NSO](/assets/docs/core/transactions/sol-transfer-process.svg)
...
يوضح المثال أدناه بنية تعليمة تحويل NSO.
