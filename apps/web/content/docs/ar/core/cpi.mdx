...
<Callout>
  ...
  وهو محدد بثابت [MAX_INSTRUCTION_STACK_DEPTH](https://github.com/anza-xyz/agave/blob/v2.1.13/compute-budget/src/compute_budget.rs#L13)
  بقيمة 5.
...
تأخذ هذه الدالة [بذور التوقيع](mention:signer-seeds) المستخدمة لاشتقاق
[PDAs](<(/docs/core/pda)>) الموقعة. يقوم وقت تشغيل سولانا داخلياً باستدعاء
...
يتضمن كل مثال تعليمة واحدة لتحويل NSO من PDA إلى حساب المستلم، باستخدام CPI موقع
بواسطة PDA.
...
- **المثال 3**: يبني تعليمات الـ CPI يدوياً. هذا النهج مفيد عندما لا تتوفر حزمة
...
الأصلية. يتضمن تعليمة واحدة تقوم بتحويل NSO من حساب PDA إلى حساب آخر. يتم توقيع
...
Native Rust. تتضمن تعليمة واحدة تنقل NSO من حساب إلى آخر.
...
Native Rust. يتضمن تعليمة واحدة تنقل NSO من حساب إلى آخر. (يستخدم ملف الاختبار
[LiteSVM](https://github.com/LiteSVM/litesvm) لاختبار البرنامج.)
