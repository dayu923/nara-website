...
title: الرموز المميزة ذات الفائدة
description: تعلم كيفية تمكين InterestBearingMintExtension.

---


## كيفية تمكين InterestBearingExtension
...
بتعيين معدل فائدة مباشرة على حساب mint account. تتراكم الفائدة باستمرار بناءً
على الطابع الزمني للشبكة، ولكن رصيد الرمز المميز الفعلي المخزن في كل token
account يظل دون تغيير. القيمة الإجمالية (رصيد الرمز المميز بالإضافة إلى الفائدة
المتراكمة) هي مجرد حساب. لا يتم إنشاء رموز مميزة جديدة مع هذا الامتداد.
