...
حسابات الرموز من التحويلات غير المتوقعة من خلال استدعاءات البرامج المتقاطعة
(CPIs). عند تمكينه، تضمن هذه الإضافة أنه يمكن تحويل الرموز فقط من خلال المكالمات
المباشرة لتعليمات التحويل في Token Extensions Program، مما يمنع جميع البرامج
الأخرى من تحويل الرموز من خلال CPI.
