...
title: المالك الثابت
description: تعلم كيفية تمكين امتداد المالك الثابت.

---


## كيفية تمكين امتداد المالك الثابت
...
يمنع تغييرات الملكية لحسابات الرمز المميز. عندما يتم تهيئة token account مع هذا
الامتداد، يصبح المالك المعين دائمًا ولا يمكن نقله إلى حساب آخر.
