...
title: المفوض الدائم
description: تعلم كيفية تنفيذ امتداد InitializePermanentDelegate.

---


## كيفية تنفيذ امتداد InitializePermanentDelegate
...
بتعيين مفوض دائم لا رجعة فيه مع صلاحية على جميع حسابات التوكن لعملة معينة. على
عكس المفوضين العاديين الذين يمكن لأصحاب حساب التوكن إلغاء تفويضهم، لا يمكن تغيير
المفوض الدائم أو إزالته. يمكن للمفوض الدائم نقل وحرق وتجميد التوكنات في أي حساب
توكن لتلك العملة.
