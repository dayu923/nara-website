...
title: مجموعات الرموز والأعضاء
description:
  تعلم كيفية تمكين GroupPointerExtension وGroupMemberPointerExtension.
...
[إعدادات المجموعة](https://github.com/solana-program/token-group/blob/3b4ff305452fa35754206fc1ad4addb2e2bff511/interface/src/state.rs#L16)
...
[بيانات العضوية](https://github.com/solana-program/token-group/blob/3b4ff305452fa35754206fc1ad4addb2e2bff511/interface/src/state.rs#L67)
مثل عنوان المجموعة ورقم العضو.

ينفذ Token Extensions Program
[واجهة Token Group](https://github.com/solana-program/token-group) بشكل مباشر،
مما يسمح بتخزين بيانات المجموعة والعضو على حساب mint نفسه. عندما تشير امتدادات
المؤشر إلى mint نفسه، يمكن استخدام
...
لتخزين جميع بيانات المجموعة والعضوية في حساب mint.
