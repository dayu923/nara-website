...
title: رسوم التحويل
description: تعلم كيفية تنفيذ TransferFeeExtension.

---


## كيفية تنفيذ TransferFeeExtension
...
من تحصيل الرسوم تلقائيًا على كل عملية تحويل للرموز. تتراكم الرسوم في حسابات
الرموز المستلمة ويمكن سحبها بواسطة سلطة السحب المحددة في حساب mint account.
