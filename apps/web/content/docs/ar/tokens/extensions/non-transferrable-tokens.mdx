...
description: تعلم كيفية تمكين InitializeNonTransferableMint.

---


## كيفية تمكين امتداد InitializeNonTransferableMint
...
الرموز من التحويل بين حسابات الرموز بعد سكها. بمجرد سكها، تبقى الرموز بشكل دائم
في حساب الرمز. ومع ذلك، لا يزال بإمكان مالك حساب الرمز حرق الرموز وإغلاق حساب
الرمز عندما يصل الرصيد إلى صفر.
