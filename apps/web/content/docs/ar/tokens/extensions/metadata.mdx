...
title: امتدادات البيانات الوصفية ومؤشر البيانات الوصفية
description:
  تعلم كيفية تمكين امتداد MetadataPointerExtension وامتداد TokenMetadata.

---


## كيفية تمكين امتداد MetadataPointerExtension وامتداد TokenMetadata
...
لحساب mint account تحديد عنوان حساب البيانات الوصفية الخاص به. يمكن لهذا المؤشر
الإشارة إلى أي حساب مملوك لبرنامج ينفذ
[واجهة البيانات الوصفية للرمز](https://github.com/solana-program/token-metadata/tree/main)،
مما يوفر مرونة في مكان تخزين البيانات الوصفية.

ينفذ Token Extensions Program
[واجهة البيانات الوصفية للرمز](https://github.com/solana-program/token-metadata/blob/main/interface/src/instruction.rs)
بشكل مباشر، مما يسمح بتخزين البيانات الوصفية على حساب mint account نفسه. وهذا
يشمل اسم الرمز ورمزه وعنوان URI وبيانات وصفية إضافية. عندما تشير امتدادات المؤشر
إلى mint account نفسه، يمكن استخدام امتدادات
...
لتخزين جميع البيانات الوصفية في حساب mint account.
