...
description: تعلم كيفية تمكين DefaultAccountStateExtension.

---


## كيفية تمكين DefaultAccountStateExtension
...
بتعيين حالة افتراضية لجميع token accounts الجديدة التي يتم إنشاؤها للعملة. عند
تمكينه، تقوم هذه الإضافة تلقائيًا بتهيئة كل token account جديد بحالة محددة، مثل
التجميد. هذا يسمح لمنشئي العملات بفرض سلوكيات معينة، مثل طلب تجميد جميع الحسابات
الجديدة افتراضيًا حتى يتم إلغاء تجميدها بشكل صريح.
