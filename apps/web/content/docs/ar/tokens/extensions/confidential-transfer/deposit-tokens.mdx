...
title: إيداع الرموز
description: تعلم كيفية إيداع الرموز إلى الحالة السرية.
...
## كيفية إيداع الرموز في الرصيد السري المعلق
...
1. **الرصيد السري المعلق**: في البداية، يتم "إيداع" الرموز من الرصيد العام إلى
   رصيد سري "معلق".
2. **الرصيد السري المتاح**: يتم بعد ذلك "تطبيق" الرصيد المعلق على الرصيد المتاح،
   مما يجعل الرموز متاحة للتحويلات السرية.

يشرح هذا القسم المرحلة الأولى: إيداع رصيد الرموز العام في الرصيد السري المعلق.

يوضح الرسم البياني التالي الخطوات المتضمنة في إيداع الرموز من الرصيد العام إلى
الرصيد السري المعلق:
...
لتحويل رصيد عام إلى رصيد سري معلق، قم باستدعاء تعليمة
...
[الحد الأقصى للمبلغ](https://github.com/solana-program/token-2022/blob/efd0c957fefbd79882d77df5fb2dac88c001249c/program/src/extension/confidential_transfer/mod.rs#L21)
لكل تعليمة إيداع محدود بـ 2^48.

توفر حزمة `spl_token_client` طريقة `confidential_transfer_deposit` التي تقوم
ببناء وإرسال معاملة مع تعليمة `Deposit`، كما هو موضح في المثال أدناه.

### مثال على الكود

يوضح المثال التالي كيفية إيداع رصيد الرموز العام في الرصيد السري المعلق.
...
<Callout type="info">
  في وقت كتابة هذا المقال، لم يتم تمكين التحويلات السرية على الـ validator
