...
title: تحويل المذكرة
description: تعلم كيفية تمكين MemoTransferExtension.

---


## كيفية تمكين MemoTransferExtension
...
أن تتضمن جميع تحويلات الرموز الواردة مذكرة مصاحبة عند تمكينها على token account.
يمكن تمكين أو تعطيل هذا الامتداد من قبل مالك token account.
