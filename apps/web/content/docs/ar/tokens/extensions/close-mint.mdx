...
title: إغلاق العملة
description: تعلم كيفية تمكين امتداد MintCloseAuthority.

---


## كيفية تمكين امتداد MintCloseAuthority
...
إغلاق حسابات mint واسترداد الـ rent الخاص بها. يجب تهيئة هذا الامتداد عند إنشاء
الـ mint.

فقط السلطة المخولة بالإغلاق يمكنها إغلاق حساب mint. وبشكل مشابه لكيفية إغلاق
حسابات الرموز فقط عندما يكون رصيد الرمز صفرًا، يمكن إغلاق حسابات mint التي تحتوي
على هذا الامتداد فقط عندما يتم تخفيض إجمالي عرض الرموز إلى صفر.
