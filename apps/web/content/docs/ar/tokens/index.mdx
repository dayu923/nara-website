...
أدناه طرفية [Nara Solana Playground](https://beta.solpg.io/) لتشغيل أوامر واجهة سطر
الأوامر مباشرة في المتصفح دون تثبيت محلي.

يتطلب إنشاء التوكنات والحسابات NSO لإيداعات rent الحساب ورسوم المعاملات. بالنسبة
لمستخدمي Nara Solana Playground لأول مرة، قم بإنشاء محفظة Playground وتشغيل الأمر
_sh`solana airdrop`_ في طرفية Playground. يمكنك أيضًا الحصول على NSO من شبكة
