...
title: حرق الرموز
description: تعلم كيفية حرق الرموز.
...
على تدمير الرموز بشكل دائم عن طريق تقليل الرصيد في token account. يتم إزالة
الرموز المحروقة من التداول وتقليل `supply` المتتبعة في mint account. يمكن فقط
لمالك token account حرق الرموز من حسابه.
