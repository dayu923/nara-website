...
title: تجميد الحساب
description: تعلم كيفية تجميد حسابات token.
...
تمنع جميع عمليات تحويل أو حرق الرموز من token account محدد. بمجرد تجميده، لا
يمكن للحساب إرسال الرموز أو استلامها أو إغلاقه حتى يتم إلغاء تجميده. فقط سلطة
التجميد الخاصة بـ mint الرمز يمكنها تجميد الحسابات. إذا تم إلغاء سلطة التجميد
(تعيينها إلى null) على mint account، فلا يمكن تجميد الرموز أبدًا.
