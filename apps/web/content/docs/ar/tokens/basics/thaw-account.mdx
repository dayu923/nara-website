...
title: إلغاء تجميد الحساب
description: تعلم كيفية إلغاء تجميد حساب توكن مجمد.
...
تعكس عملية التجميد، مما يعيد الوظائف الكاملة لحساب token account الذي تم تجميده
سابقًا. بعد إلغاء التجميد، يمكن للحساب إرسال واستقبال التوكنات بشكل طبيعي مرة
أخرى. فقط سلطة التجميد الخاصة بمنشئ التوكن يمكنها إلغاء تجميد الحسابات.

<Callout type="info">
  يشترك [برنامج التوكن (Token
  ...
  و[برنامج امتداد التوكن (Token Extension
