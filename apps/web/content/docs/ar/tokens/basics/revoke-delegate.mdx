...
title: إلغاء المفوض
description: تعلم كيفية إلغاء مفوض حساب الرمز المميز.
...
تزيل جميع أذونات التحويل من المفوض المعتمد حاليًا. بعد الإلغاء، لن يتمكن المفوض
من تحويل أي رموز مميزة من حسابك. يمكن لمالك حساب token account فقط إلغاء المفوض.

<Callout type="info">
  يشترك [برنامج الرمز المميز (Token
  ...
  و[برنامج امتداد الرمز المميز (Token Extension
