...
حسابات الـtoken الناتجة مملوكة من قبل Token Program وتستخدم بنية `Account`
القياسية.
...
انظر
[التنفيذ هنا](https://github.com/solana-program/token/blob/a7c488ca39ed4cd71a87950ed854929816e9099f/program/src/processor.rs#L83).

تحتاج إلى تعليمتين لإنشاء حساب token:

1. System Program: إنشاء حساب بمساحة مخصصة لحساب token ونقل الملكية إلى Token
   Program
2. Token Program: تهيئة بيانات حساب الـtoken
...
تتعامل هذه التعليمة الواحدة تلقائيًا مع إنشاء حساب token وتهيئته من خلال
