...
title: إغلاق حساب التوكن
description: تعلم كيفية إغلاق حسابات التوكن.
...
تقوم بإغلاق حساب التوكن بشكل دائم وتحويل جميع عملات NSO المتبقية (الإيجار) إلى
حساب الوجهة المحدد. يجب أن يكون رصيد حساب التوكن صفرًا قبل الإغلاق. فقط مالك
حساب التوكن أو سلطة الإغلاق المعينة يمكنهم تنفيذ هذه التعليمة.
