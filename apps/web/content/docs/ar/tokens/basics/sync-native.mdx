...
title: مزامنة NSO الأصلي
description: تعلم كيفية تحويل NSO الأصلي إلى NSO المغلف.
...
NSO المغلف (WSOL) هو حساب رمز يتتبع كمية اللامبورت في الحساب كرصيد للرمز. يتيح
WSOL التكامل مع بروتوكولات التمويل اللامركزي (DeFi) لنقل NSO كرمز SPL.
...
تقوم بمزامنة رصيد حساب رمز NSO المغلف (WSOL) مع NSO الفعلي (لامبورت) المخزن فيه.
عندما تقوم بتحويل NSO الأصلي إلى حساب رمز WSOL، لا يتم تحديث رصيد الرمز
تلقائيًا. يجب عليك استدعاء SyncNative لعكس رصيد WSOL الصحيح.

<Callout type="info">
  يشترك [برنامج
  الرمز](https://github.com/solana-program/token/blob/a7c488ca39ed4cd71a87950ed854929816e9099f/interface/src/instruction.rs#L387)
  و[برنامج امتداد
  الرمز](https://github.com/solana-program/token-2022/blob/efd0c957fefbd79882d77df5fb2dac88c001249c/program/src/instruction.rs#L182)
