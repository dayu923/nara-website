...
title: تحويل الرموز
description: تعلم كيفية تحويل الرموز بين حسابات الرموز.
...
تقوم عمليات تحويل الرموز بنقل الرموز بين حسابات الرموز من نفس العملة باستخدام
تعليمة
...
- يجب أن يحتوي كلا حسابي الرموز على نفس نوع الرمز (العملة)
- فقط مالك الحساب المصدر أو المفوض يمكنه تفويض عمليات التحويل

<Callout type="info">
  يشترك [برنامج
  الرموز](https://github.com/solana-program/token/blob/3daf44899f0bd71c879d28dffdfb788dd944f3c5/program/src/processor.rs#L227)
  و[برنامج امتداد
  الرموز](https://github.com/solana-program/token-2022/blob/efd0c957fefbd79882d77df5fb2dac88c001249c/program/src/processor.rs#L300)
