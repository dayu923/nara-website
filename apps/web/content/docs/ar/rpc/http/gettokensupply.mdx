...
h1: طريقة RPC getTokenSupply

---


يُرجع إجمالي عرض نوع رمز SPL.
...
مفتاح pubkey لسك الرمز المراد الاستعلام عنه، كسلسلة مشفرة بنظام base-58
...
إجمالي عرض الرمز الخام بدون كسور عشرية، تمثيل نصي لـ u64
...
إجمالي المعروض من الرموز، باستخدام الأرقام العشرية المحددة من قبل العملة

##### !! uiAmountString

!type string

إجمالي المعروض من الرموز كسلسلة نصية، باستخدام الأرقام العشرية المحددة من قبل
العملة
