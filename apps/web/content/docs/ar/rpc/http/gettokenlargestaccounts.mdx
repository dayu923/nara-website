...
h1: طريقة getTokenLargestAccounts RPC

---


تُرجع أكبر 20 حسابًا لنوع معين من رموز SPL.
...
pubkey الخاص بـ token Mint المراد الاستعلام عنه، كسلسلة مشفرة بنظام base-58
...
رصيد token account الخام بدون كسور عشرية، تمثيل نصي لـ u64

##### !! decimals

!type u8

عدد الأرقام العشرية على يمين الفاصلة العشرية بالأساس 10

##### !! uiAmount

!type number | null

رصيد token account، باستخدام الكسور العشرية المحددة من قبل العملة **مهمل**

##### !! uiAmountString

!type string

رصيد token account كسلسلة نصية، باستخدام الكسور العشرية المحددة من قبل العملة
