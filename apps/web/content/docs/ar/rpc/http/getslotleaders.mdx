...
h1: طريقة getSlotLeaders RPC

---


تُرجع قادة الـslot لنطاق slot معين
...
الحد، كعدد صحيح u64 (بين 1 و5,000)
...
مصفوفة من مفاتيح الهوية العامة للعقد كسلاسل مشفرة بنظام base-58.
