...
h1: طريقة getBalance RPC

---


يُرجع رصيد lamport للحساب المُقدم بواسطة Pubkey
...
Pubkey للحساب المراد الاستعلام عنه، كسلسلة مشفرة بنظام base-58.
...
يصف الـ commitment مدى اكتمال الكتلة في تلك النقطة الزمنية. راجع
...
كائن RpcResponse بتنسيق JSON مع تعيين حقل القيمة إلى الرصيد.
