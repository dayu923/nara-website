...
h1: طريقة RPC لـ getRecentPrioritizationFees

---


تُرجع قائمة برسوم الأولوية من الكتل الحديثة.

<Callout type="info">
  حاليًا، يخزن ذاكرة التخزين المؤقت لرسوم الأولوية في العقدة بيانات من حتى 150
  كتلة.
</Callout>
...
مصفوفة من عناوين الحسابات (حتى 128 عنوانًا كحد أقصى)، كسلاسل مشفرة بنظام base-58

<Callout type="info">
  إذا تم توفير هذه المعلمة، ستعكس الاستجابة رسومًا لإتمام معاملة تقوم بقفل جميع
  الحسابات المقدمة كقابلة للكتابة.
</Callout>
...
مصفوفة من كائنات رسوم الأولوية تحتوي على:

##### !! slot

!type u64

الـ slot الذي تمت ملاحظة الرسوم فيه

##### !! prioritizationFee

!type u64

الرسوم لكل وحدة حوسبة المدفوعة من قبل معاملة واحدة ناجحة على الأقل، محددة
بزيادات من micro-lamports (0.000001 lamport)
