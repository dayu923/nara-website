...
h1: طريقة RPC لـ requestAirdrop

---


يطلب إسقاطًا جويًا من lamport إلى Pubkey
...
pubkey للحساب المستلم لـ lamports، كسلسلة مشفرة بنظام base-58
...
كمية الـ lamports المراد إسقاطها جويًا
...
توقيع المعاملة للإسقاط الجوي، كسلسلة مشفرة بنظام base-58
