...
h1: طريقة getLargestAccounts RPC

---


تُرجع الحسابات العشرين الأكبر، حسب رصيد لامبورت (قد يتم تخزين النتائج مؤقتًا
لمدة تصل إلى ساعتين)
...
ستكون النتيجة كائن RpcResponse JSON مع `value` يساوي مصفوفة من الكائنات التي
تحتوي على:
...
عنوان الحساب المشفر بنظام Base-58

##### !! lamports

!type u64

عدد lamports في الحساب
