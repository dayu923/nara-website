...
h1: طريقة minimumLedgerSlot RPC

---


تُرجع أدنى slot يمتلك عنه العقدة معلومات في دفترها.

<Callout type="info">
  قد تزداد هذه القيمة مع مرور الوقت إذا تم تكوين العقدة لتطهير بيانات الدفتر
  القديمة
</Callout>
