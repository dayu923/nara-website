...
h1: طريقة getFeeForMessage RPC

---


الحصول على الرسوم التي ستفرضها الشبكة على رسالة معينة

<Callout type="warn" title={"قيود الإصدار"}>
  هذه الطريقة متاحة فقط في `solana-core` الإصدار 1.9 أو أحدث. يرجى استخدام
  [getFees](/docs/rpc/deprecated/getfees) لـ `solana-core` الإصدار 1.8 وما قبله.
</Callout>
...
الرسوم المقابلة للرسالة في البلوكهاش المحدد
