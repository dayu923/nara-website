...
h1: Общие структуры данных JSON для методов RPC Nara Solana

---


Различные методы RPC Nara Solana возвращают более сложные ответы в виде
...
Транзакции на Nara Solana значительно отличаются от транзакций в других блокчейнах.
Обязательно ознакомьтесь с [Анатомией транзакции](/docs/core/transactions),
чтобы узнать больше о транзакциях на Nara Solana.
...
Среда выполнения Nara Solana фиксирует межпрограммные инструкции, которые вызываются
