...
h1: Метод RPC getBalance

---


Возвращает баланс в лампортах для аккаунта с указанным Pubkey.
...
JSON-объект RpcResponse с полем value, установленным в значение баланса.
