...
title: HTTP-методы
seoTitle: HTTP-методы RPC Nara Solana
hideTableOfContents: false
h1: HTTP-методы RPC Nara Solana

---


Узлы Nara Solana принимают HTTP-запросы, используя спецификацию
...
> интерфейс для методов RPC для взаимодействия с узлом Nara Solana. Для подключения
> PubSub к узлу Nara Solana используйте [Websocket API](/docs/rpc/websocket/).
...
- Транзакция: Список инструкций Nara Solana, подписанных парой ключей клиента для
