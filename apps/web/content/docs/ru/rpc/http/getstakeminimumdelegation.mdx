...
h1: Метод RPC getStakeMinimumDelegation

---


Возвращает минимальную делегацию стейка в лампортах.
...
Параметр commitment описывает, насколько завершённым является блок на данный
момент времени. См.
...
Минимальная делегация стейка в лампортах
