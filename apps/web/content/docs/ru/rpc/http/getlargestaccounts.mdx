...
h1: Метод RPC getLargestAccounts

---


Возвращает 20 крупнейших аккаунтов по балансу в лампортах (результаты могут
кэшироваться до двух часов).
...
Фильтрация результатов по типу аккаунта.
...
Результат будет представлен в виде JSON-объекта RpcResponse с `value`, равным
массиву объектов, содержащих:

##### !! address

!type string

Адрес аккаунта, закодированный в формате Base-58.

##### !! lamports

!type u64

Количество lamports в аккаунте
