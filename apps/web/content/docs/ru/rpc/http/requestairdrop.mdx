...
h1: Метод RPC requestAirdrop

---


Запрашивает эирдроп лампортов на Pubkey
...
Pubkey аккаунта, который получит лампорты, в виде строки, закодированной в
base-58
...
Количество лампортов для эирдропа
...
Подпись транзакции эирдропа, в виде строки, закодированной в base-58
