...
Начальный слот в виде целого числа u64
...
Лимит в виде целого числа u64 (от 1 до 5 000)
...
Массив публичных ключей идентификации узлов в формате строк, закодированных в
base-58.
