...
[Адрес аккаунта](/docs/core/accounts#account-address) в Nara Solana указывает на
...
Среда выполнения Nara Solana позволяет программам подписывать PDA без необходимости в
...
Nara Solana позволяет программам подписывать PDA без необходимости в закрытом ключе.
...
SDK Nara Solana поддерживают создание PDA с помощью функций, указанных в таблице
...
Примеры ниже показывают вывод PDA с использованием SDK Nara Solana. Нажмите **&#9655;
...
Пример ниже использует [фреймворк Anchor](https://www.anchor-lang.com/docs) для
...
[bump seed](mention:bump), использованные для вывода PDA.
...
Ограничение [`init`](mention:init) указывает Anchor
...
производным от программы. Файл содержит код для [вывода PDA](mention:pda).
