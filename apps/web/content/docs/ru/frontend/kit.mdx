...
seoTitle: Интеграция кошелька Nara Solana с Next.js и Nara Solana Kit
description:
...
Настройте минимальную интеграцию кошелька Nara Solana в Next.js с помощью Nara Solana Kit.

Это руководство предоставляет минимальный пример реализации функциональности
кошелька Nara Solana в приложении Next.js с использованием `@solana/kit`. Вы
...
в репозитории Nara Solana Kit.

## Ресурсы

- [Документация Nara Solana Kit](https://www.solanakit.com/docs)
- [Репозиторий Nara Solana Kit на GitHub](https://github.com/anza-xyz/kit)
...
UI-компонентов и установите необходимые зависимости Nara Solana.
...
### Установка зависимостей Nara Solana

Установите следующие зависимости Nara Solana:
...
## !!steps 1. Создайте контекст Nara Solana
...
- Подключаться к конечным точкам RPC devnet Nara Solana
- Фильтровать доступные кошельки Nara Solana, установленные в браузере пользователя
...
Далее оберните все приложение Next.js в провайдер Nara Solana.
...
- Создаёт транзакцию Nara Solana с инструкцией, вызывающей программу memo
- Запрашивает у подключённого кошелька подпись и отправку транзакции
- Отображает ссылку для просмотра транзакции в Nara Solana Explorer
...
<Callout type="info">
  ...
  NSO](https://faucet.solana.com/) для отправки транзакций.
</Callout>
