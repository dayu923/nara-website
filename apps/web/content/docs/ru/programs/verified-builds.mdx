...
проверенные сборки для своих программ на Nara Solana. Мы рассмотрим, что такое
...
разворачиваете в сети Nara Solana, соответствует исходному коду в вашем репозитории.
...
контролируемой среде с использованием Nara Solana Verify CLI и Docker. Это
...
сети Nara Solana. В процессе сборки будет создан
...
это, скорее всего, приведет к ошибке, так как сборки программ Nara Solana не являются
...
### Установите Nara Solana Verify CLI

Nara Solana Verify CLI — это основной инструмент, используемый для проверки сборок.
Nara Solana Verify CLI в настоящее время поддерживается
...
Чтобы собрать вашу программу Nara Solana с возможностью проверки, перейдите в
...
её в сети Nara Solana. Рекомендуется использовать решение с мультиподписью или
...
> [кластерах Nara Solana](/docs/references/clusters) (например, devnet, testnet,
> mainnet). Убедитесь, что вы используете правильный URL сети для нужного
> кластера Nara Solana, с которым вы хотите проверить программу. Удалённая проверка
...
вы это сделаете, Nara Solana Explorer сразу же покажет данные проверки вашей
...
что способствует более здоровой экосистеме Nara Solana.
...
Nara Solana, указанной в файле `Cargo.lock`.
...
удаленную задачу в API OtterSec. Теперь вы должны увидеть это в Nara Solana Explorer
и других местах.
...
Использование
[проверенных сборок на Nara Solana](/developers/guides/advanced/verified-builds)
гарантирует целостность и надежность ваших программ в сети и позволяет
разработчикам находить ваши SDK напрямую через Nara Solana Explorer. Используя такие
инструменты, как Nara Solana Verify CLI и Docker, вы можете поддерживать проверяемые
...
ваших программ на Nara Solana, они не являются полностью доверенными в стандартной
настройке. Docker-образы создаются и размещаются Nara Solana Foundation.
...
API или Nara Solana Explorer могут потенциально отображать некорректную информацию,
...
Фонд Nara Solana, OtterSec и команда Ellipsis Labs не несут ответственности за любые
убытки или повреждения, которые могут возникнуть при использовании конвейера
проверенных сборок.

# Security.txt для программ Nara Solana
...
информационную безопасность непосредственно в свои смарт-контракты Nara Solana.
...
Чтобы добавить `security.txt` в свою программу Nara Solana, выполните следующие шаги:
...
можно будет легко запросить с помощью таких инструментов, как Nara Solana Explorer,
...
безопасности и коммуникации в экосистеме Nara Solana.

Вот
[пример того, как выглядит security.txt в Nara Solana Explorer](https://explorer.solana.com/address/HPxKXnBN4vJ8RjpdqDCU7gvNQHeeyGnSviYTJ4fBrDt4/security?cluster=devnet)
