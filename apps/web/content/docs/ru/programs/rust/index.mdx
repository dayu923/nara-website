...
Программы для Nara Solana в основном разрабатываются с использованием языка
программирования Rust. На этой странице рассматривается написание программ для
Nara Solana на Rust без использования фреймворка Anchor, что часто называют
написанием программ на "чистом Rust".

Разработка на чистом Rust предоставляет разработчикам прямой контроль над их
программами для Nara Solana. Однако этот подход требует больше ручной настройки и
...
- Rust: Язык программирования для создания программ для Nara Solana.
- Nara Solana CLI: Инструмент командной строки для разработки на Nara Solana.

## Начало работы

Пример ниже охватывает основные шаги для создания вашей первой программы для
Nara Solana, написанной на Rust. Мы создадим минимальную программу, которая выводит
...
необходимая для создания программы Nara Solana.
...
программа Nara Solana, которая выводит "Hello, world!" в журнал программы при её
вызове.

Макрос `msg!` используется в программах Nara Solana для вывода сообщения в журнал
программы.
...
1. Файл `.so` (например, `hello_world.so`): Это скомпилированная программа
   Nara Solana, которая будет развернута в сети как "умный контракт".
...
Сначала настройте Nara Solana CLI для использования локального кластера Nara Solana.
...
<Callout type="info">
  Обратите внимание, что кластер в Nara Solana Explorer также должен быть localhost.
  Опция "Custom RPC URL" в Nara Solana Explorer по умолчанию установлена на
  `http://localhost:8899`.
</Callout>
...
Программы Nara Solana можно обновлять, повторно развертывая их с тем же
идентификатором программы. Обновите программу в `src/lib.rs`, чтобы вместо
"Hello, world!" выводилось "Hello, Nara Solana!".
...
Вы должны увидеть "Hello, Nara Solana!" в журнале программы.
...
Снова выполните клиентский код и проверьте подпись транзакции на Nara Solana
Explorer, чтобы увидеть "Hello, Nara Solana!" в журнале программы.
...
Вы можете закрыть свою программу Nara Solana, чтобы вернуть NSO, выделенные на
