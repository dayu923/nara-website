...
Программы Nara Solana, написанные на Rust, имеют минимальные требования к структуре,
...
Хотя строгих правил для структуры файлов нет, программы Nara Solana обычно следуют
общему шаблону:
...
Сначала давайте создадим новый проект на Rust для нашей программы Nara Solana.
...
Теперь давайте добавим необходимые зависимости для создания программы Nara Solana.
...
<Callout type="info">
  ...
  библиотека сериализации для программ Nara Solana.
</Callout>

## !!steps Настройте тип crate

Программы Nara Solana должны компилироваться как динамические библиотеки. Добавьте
...
Каждая программа Nara Solana имеет точку входа, которая представляет собой функцию,
...
Программа Nara Solana `entrypoint` имеет следующую сигнатуру функции. Разработчики
...
Этот шаблон маршрутизации является общим для программ Nara Solana. `instruction_data`
...
счетчика. Поскольку только System Program может создавать аккаунты в Nara Solana, мы
...
Поздравляем! Вы создали полную программу Nara Solana, которая демонстрирует базовую
структуру, общую для всех программ Nara Solana:
...
LiteSVM симулирует среду выполнения Nara Solana, позволяя тестировать нашу программу
...
Сначала настройте Nara Solana CLI для использования localhost:
...
[Nara Solana Explorer](https://explorer.solana.com/?cluster=custom), используя
подписи транзакций из вывода. Обратите внимание, что кластер в Nara Solana Explorer
