...
Nara Solana с использованием фреймворка Anchor, демонстрируя использование Program
...
[ссылки на Nara Solana Playground](https://beta.solpg.io/66734b7bcffcf4b13384d1ad) с
исходным кодом. Затем нажмите кнопку "Import", чтобы добавить программу в ваши
проекты Nara Solana Playground.
...
<Callout type="info">
В этом примере вы развернете программу на devnet, кластере Nara Solana
для тестирования разработки.

Кошелек Playground подключается к devnet по умолчанию. Убедитесь, что ваш
кошелек Playground имеет devnet NSO для оплаты развертывания программы. Получите
devnet NSO из [Nara Solana Faucet](https://faucet.solana.com/).
...
Nara Solana Playground убирает часть шаблонной настройки, где
...
передавая "Hello, Nara Solana!" в качестве нового сообщения.
