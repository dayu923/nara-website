...
description:
  Узнайте, как включить GroupPointerExtension и GroupMemberPointerExtension.
...
обозначает mint аккаунт как групповой mint (например, коллекционный NFT),
указывая на аккаунт, содержащий
[групповые конфигурации](https://github.com/solana-program/token-group/blob/3b4ff305452fa35754206fc1ad4addb2e2bff511/interface/src/state.rs#L16),
такие как полномочия на обновление и максимальный размер.
...
обозначает mint аккаунт как участника группы (например, NFT в коллекции),
указывая на аккаунт, содержащий
[данные об участии](https://github.com/solana-program/token-group/blob/3b4ff305452fa35754206fc1ad4addb2e2bff511/interface/src/state.rs#L67),
такие как адрес группы и номер участника.

Token Extensions Program напрямую реализует
[интерфейс Token Group](https://github.com/solana-program/token-group), позволяя
хранить как данные группы, так и данные участников непосредственно в mint
аккаунте. Когда указатели расширений ссылаются на сам mint аккаунт, расширения
...
могут быть использованы для хранения всех данных коллекции и участия в самом
mint аккаунте.
