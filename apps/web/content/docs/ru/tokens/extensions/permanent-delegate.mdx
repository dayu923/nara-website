...
title: Постоянный делегат
description: Узнайте, как реализовать расширение InitializePermanentDelegate.

---


## Как реализовать расширение InitializePermanentDelegate
...
назначает безотзывного делегата с полномочиями над всеми токен-аккаунтами для
минта. В отличие от обычных делегатов, которых владельцы токен-аккаунтов могут
отозвать, постоянный делегат не может быть изменен или удален. Постоянный
делегат может переводить, сжигать и замораживать токены в любом токен-аккаунте
этого минта.
