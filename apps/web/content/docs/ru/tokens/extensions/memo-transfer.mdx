...
требует, чтобы все входящие переводы токенов сопровождались заметкой, если эта
функция включена для токен-аккаунта. Эту функцию может включать или отключать
владелец токен-аккаунта.
