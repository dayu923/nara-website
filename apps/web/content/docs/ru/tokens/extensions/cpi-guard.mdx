...
title: CPI Guard
description: Узнайте, как включить CpiGuardExtension.

---


## Как включить CpiGuardExtension
...
защищает аккаунты токенов от неожиданных переводов через вызовы программ (CPI).
При включении это расширение гарантирует, что токены могут быть переведены
только через прямые вызовы инструкции передачи Token Extensions Program,
блокируя все другие программы от перевода токенов через CPI.
