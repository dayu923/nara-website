...
предотвращает передачу токенов между токен-аккаунтами после их выпуска. После
выпуска токены остаются навсегда в токен-аккаунте. Однако владелец
токен-аккаунта все еще может сжигать токены и закрывать токен-аккаунт, когда
баланс достигает нуля.
