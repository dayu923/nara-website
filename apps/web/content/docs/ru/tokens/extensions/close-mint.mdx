...
title: Закрытие Mint
description: Узнайте, как включить расширение MintCloseAuthority.

---


## Как включить расширение MintCloseAuthority
...
позволяет закрывать аккаунты mint и возвращать их rent. Это расширение должно
быть инициализировано при создании mint.

Только назначенный close authority может закрыть аккаунт mint. Аналогично тому,
как аккаунты токенов могут быть закрыты только при нулевом балансе токенов,
аккаунты mint с этим расширением могут быть закрыты только тогда, когда весь
объем токенов сведен к нулю.
