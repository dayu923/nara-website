...
title: Токены с начислением процентов
description: Узнайте, как включить InterestBearingMintExtension.

---


## Как включить InterestBearingExtension
...
позволяет установить процентную ставку непосредственно на аккаунте выпуска (mint
account). Проценты непрерывно начисляются на основе сетевого временного штампа,
но фактический баланс токенов, хранящийся в каждом токен-аккаунте, остается
неизменным. Общая стоимость (баланс токенов плюс начисленные проценты) является
лишь расчетной величиной. Новые токены с этим расширением не выпускаются.
