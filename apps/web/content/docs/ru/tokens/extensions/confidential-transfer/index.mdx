...
title: Конфиденциальный перевод
description:
  Узнайте о расширении Confidential Transfer и о том, как использовать его для
  добавления дополнительных функций к токенам и аккаунтам.
...
Конфиденциальные переводы позволяют переводить токены между токен-аккаунтами, не
раскрывая сумму перевода. Это полезно для транзакций, сохраняющих
конфиденциальность. Только суммы переводов и балансы токенов остаются
приватными. Адреса токен-аккаунтов остаются публичными.

- [Обзор протокола](https://www.solana-program.com/docs/confidential-balances/overview) -
  Подробности о криптографическом протоколе
...
- [Справочник по конфиденциальным балансам](https://github.com/solana-developers/Confidential-Balances-Sample) -
  Примеры кода для использования расширения Confidential Transfer

### Как это работает?

Расширение Confidential Transfer добавляет
...
в программу Token Extension, которые позволяют переводить токены между
...
Основной процесс конфиденциальных переводов токенов выглядит следующим образом:

1. Создайте аккаунт mint с расширением конфиденциального перевода.
2. Создайте токен-аккаунты с расширением конфиденциального перевода для
   отправителя и получателя.
3. Выпустите токены на аккаунт отправителя.
4. **Депозит** публичного баланса отправителя в **конфиденциальный ожидающий
   баланс**.
5. **Примените** ожидающий баланс отправителя к **конфиденциальному доступному
   балансу**.
6. Конфиденциально **переведите** токены с токен-аккаунта отправителя на
   токен-аккаунт получателя.
...
Для получения более подробной информации о шагах процесса конфиденциального
перевода, смотрите соответствующие страницы:

<Cards>
  <Card
    title="Создание аккаунта Mint"
    href="/docs/tokens/extensions/confidential-transfer/create-mint"
  >
    Как создать аккаунт mint с расширением Confidential Transfer
  </Card>
  <Card
    title="Создание токен-аккаунта"
    href="/docs/tokens/extensions/confidential-transfer/create-token-account"
  >
    Как настроить токен-аккаунт с расширением Confidential Transfer
  </Card>
  <Card
  ...
  >
    Как вывести токены из доступного конфиденциального баланса
  </Card>
  <Card
    title="Перевод токенов"
    href="/docs/tokens/extensions/confidential-transfer/transfer-tokens"
  >
    Как конфиденциально перевести токены между токен-аккаунтами
  </Card>
</Cards>

Диаграмма ниже показывает подробную последовательность базового процесса для
...
Пример на Rust ниже показывает шаги для конфиденциальных переводов токенов,
соответствующие предыдущей диаграмме. Шаги разделены на вспомогательные функции
для ясности.
...
использования локального валидатора необходимо установить Nara Solana CLI.
...
## Инструкции по конфиденциальным переводам

Полный список инструкций расширения конфиденциальных переводов
...
| Инструкция                          | Описание                                                                                                                                                                         |
| ----------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| _rs`InitializeMint`_                | Настраивает аккаунт выпуска для конфиденциальных переводов. Эта инструкция должна быть включена в ту же транзакцию, что и инструкция _rs`TokenInstruction::InitializeMint`_.     |
| _rs`UpdateMint`_                    | Обновляет настройки конфиденциальных переводов для аккаунта выпуска.                                                                                                             |
| _rs`ConfigureAccount`_              | Настраивает токен-аккаунт для конфиденциальных переводов.                                                                                                                        |
| _rs`ApproveAccount`_                | Одобряет токен-аккаунт для конфиденциальных переводов, если аккаунт выпуска требует одобрения для новых токен-аккаунтов.                                                         |
| _rs`EmptyAccount`_                  | Очищает ожидаемые и доступные конфиденциальные балансы для закрытия токен-аккаунта.                                                                                              |
| _rs`Deposit`_                       | Конвертирует публичный баланс токенов в ожидаемый конфиденциальный баланс.                                                                                                       |
| _rs`Withdraw`_                      | Конвертирует доступный конфиденциальный баланс обратно в публичный баланс.                                                                                                       |
| _rs`Transfer`_                      | Переводит токены между токен-аккаунтами конфиденциально.                                                                                                                         |
| _rs`ApplyPendingBalance`_           | Конвертирует ожидаемый баланс в доступный баланс после депозитов или переводов.                                                                                                  |
| _rs`EnableConfidentialCredits`_     | Позволяет токен-аккаунту принимать конфиденциальные переводы токенов.                                                                                                            |
| _rs`DisableConfidentialCredits`_    | Блокирует входящие конфиденциальные переводы, при этом позволяя публичные переводы.                                                                                              |
| _rs`EnableNonConfidentialCredits`_  | Позволяет токен-аккаунту принимать публичные переводы токенов.                                                                                                                   |
| _rs`DisableNonConfidentialCredits`_ | Блокирует обычные переводы, чтобы аккаунт принимал только конфиденциальные переводы.                                                                                             |
| _rs`TransferWithFee`_               | Переводит токены между токен-аккаунтами конфиденциально с комиссией.                                                                                                             |
| _rs`ConfigureAccountWithRegistry`_  | Альтернативный способ настройки токен-аккаунтов для конфиденциальных переводов с использованием аккаунта _rs`ElGamalRegistry`_ вместо доказательства _rs`VerifyPubkeyValidity`_. |

| Инструкция                          | Описание                                                                                                                                                                           |
| ----------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| _rs`InitializeMint`_                | Настраивает аккаунт mint для конфиденциальных переводов. Эта инструкция должна быть включена в ту же транзакцию, что и инструкция _rs`TokenInstruction::InitializeMint`_.          |
| _rs`UpdateMint`_                    | Обновляет настройки конфиденциальных переводов для mint.                                                                                                                           |
| _rs`ConfigureAccount`_              | Настраивает аккаунт токена для конфиденциальных переводов.                                                                                                                         |
| _rs`ApproveAccount`_                | Одобряет аккаунт токена для конфиденциальных переводов, если mint требует одобрения для новых аккаунтов токенов.                                                                   |
| _rs`EmptyAccount`_                  | Очищает ожидаемые и доступные конфиденциальные балансы, чтобы закрыть аккаунт токена.                                                                                              |
| _rs`Deposit`_                       | Конвертирует публичный баланс токена в ожидаемый конфиденциальный баланс.                                                                                                          |
| _rs`Withdraw`_                      | Конвертирует доступный конфиденциальный баланс обратно в публичный баланс.                                                                                                         |
| _rs`Transfer`_                      | Переводит токены между аккаунтами токенов конфиденциально.                                                                                                                         |
| _rs`ApplyPendingBalance`_           | Конвертирует ожидаемый баланс в доступный баланс после депозитов или переводов.                                                                                                    |
| _rs`EnableConfidentialCredits`_     | Позволяет аккаунту токена принимать конфиденциальные переводы токенов.                                                                                                             |
| _rs`DisableConfidentialCredits`_    | Блокирует входящие конфиденциальные переводы, но позволяет публичные переводы.                                                                                                     |
| _rs`EnableNonConfidentialCredits`_  | Позволяет аккаунту токена принимать публичные переводы токенов.                                                                                                                    |
| _rs`DisableNonConfidentialCredits`_ | Блокирует обычные переводы, чтобы аккаунт принимал только конфиденциальные переводы.                                                                                               |
| _rs`TransferWithFee`_               | Переводит токены между аккаунтами токенов конфиденциально с комиссией.                                                                                                             |
| _rs`ConfigureAccountWithRegistry`_  | Альтернативный способ настройки аккаунтов токенов для конфиденциальных переводов с использованием аккаунта _rs`ElGamalRegistry`_ вместо доказательства _rs`VerifyPubkeyValidity`_. |
