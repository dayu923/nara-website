...
title: Неизменяемый владелец
description: Узнайте, как включить расширение ImmutableOwner.

---


## Как включить расширение ImmutableOwner
...
предотвращает изменения владельца для токен-аккаунтов. Когда токен-аккаунт
инициализируется с этим расширением, назначенный владелец становится постоянным
и не может быть передан другому аккаунту.
