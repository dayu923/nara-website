...
title: Установить полномочия
description:
  Узнайте, как установить полномочия для mint аккаунтов или token аккаунтов.

---


## Понимание полномочий токенов

### Полномочия mint аккаунтов

- **Полномочия на выпуск (Mint Authority)**: Контролируют создание новых
  токенов. Могут выпускать токены на любой token аккаунт. Часто отзываются после
  создания начального запаса, чтобы создать токен с фиксированным запасом.
- **Полномочия на заморозку (Freeze Authority)**: Контролируют возможность
  замораживать и размораживать token аккаунты. Могут предотвратить передачу
  токенов с любого token аккаунта. Часто отзываются, чтобы гарантировать
  пользователям, что их токены не могут быть заморожены.

### Полномочия token аккаунтов

- **Владелец аккаунта (Account Owner)**: Имеет полный контроль над token
  аккаунтом. Может передавать токены, сжигать токены, одобрять делегатов и
  закрывать аккаунт, если баланс равен нулю.
- **Полномочия на закрытие (Close Authority)**: Могут закрыть token аккаунт,
  если его баланс равен нулю. По умолчанию это владелец аккаунта, но полномочия
  могут быть делегированы другому аккаунту.
...
изменяет или отзывает полномочия на mint аккаунты и token аккаунты. Только
текущий владелец полномочий может передать свои права новому адресу или отозвать
их навсегда, установив полномочия в null. После отзыва полномочия не могут быть
восстановлены.
