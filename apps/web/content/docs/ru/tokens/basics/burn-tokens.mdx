...
навсегда уничтожает токены, уменьшая баланс в токен-аккаунте. Сожжённые токены
удаляются из обращения и уменьшают `supply`, отслеживаемый в mint аккаунте.
Только владелец токен-аккаунта может сжигать токены со своего аккаунта.
