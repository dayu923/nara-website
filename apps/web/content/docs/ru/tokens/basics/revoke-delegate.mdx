...
title: Отозвать делегата
description: Узнайте, как отозвать делегата токенного аккаунта.

---


## Как отозвать делегата
...
удаляет все разрешения на передачу у текущего утвержденного делегата. После
отзыва делегат больше не сможет переводить токены с вашего аккаунта. Только
владелец токенного аккаунта может отозвать делегата.
