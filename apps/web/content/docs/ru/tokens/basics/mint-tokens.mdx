...
Выпуск создает новые единицы токена с использованием инструкции
...
- Только владелец прав на выпуск может выпускать новые токены
- Должен существовать целевой токен-аккаунт для получения выпущенных токенов
