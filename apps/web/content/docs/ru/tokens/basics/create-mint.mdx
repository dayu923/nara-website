...
Аккаунт минта уникально представляет токен в Nara Solana и хранит его глобальные
метаданные.
...
Каждый токен в Nara Solana имеет аккаунт минта, а адрес минта служит уникальным
...
идентифицирует USDC во всей экосистеме Nara Solana. Вы можете просмотреть этот минт
на
