...
description: Узнайте, как создавать SPL токен-аккаунты.
...
Создание ассоциированного токен-аккаунта (ATA) требует инструкции
...
его инициализацию через вызовы программ (CPI).
