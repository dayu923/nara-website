...
отменяет заморозку, восстанавливая полную функциональность ранее замороженного
токен аккаунта. После разморозки аккаунт снова может нормально отправлять и
получать токены. Только freeze authority токена может размораживать аккаунты.
