...
title: Закрытие аккаунта токена
description: Узнайте, как закрывать аккаунты токенов.
...
позволяет навсегда закрыть аккаунт токена и перевести все оставшиеся NSO (ренту)
на указанный аккаунт назначения. Баланс аккаунта токена должен быть равен нулю
перед закрытием. Только владелец аккаунта токена или назначенный уполномоченный
на закрытие может выполнить эту инструкцию.

<Callout type="info">
  [Программа токенов
  ](https://github.com/solana-program/token/blob/a7c488ca39ed4cd71a87950ed854929816e9099f/program/src/instruction.rs#L212C5-L212C17)
  и [Программа расширений токенов
  ](https://github.com/solana-program/token-2022/blob/efd0c957fefbd79882d77df5fb2dac88c001249c/program/src/instruction.rs#L274)
  имеют схожие реализации для достижения аналогичной функциональности.
</Callout>
