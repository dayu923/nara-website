...
h1: Metoda RPC getTokenLargestAccounts

---


Zwraca 20 największych kont dla określonego typu tokena SPL.
...
Pubkey tokena Mint do zapytania, zakodowany jako ciąg znaków w formacie base-58
...
Surowy balans token account bez miejsc dziesiętnych, reprezentacja ciągu znaków
u64
...
Liczba cyfr dziesiętnych po prawej stronie przecinka dziesiętnego

##### !! uiAmount

!type number | null

Balans token account z użyciem miejsc dziesiętnych określonych przez mint
**PRZESTARZAŁE**
...
Balans token account jako ciąg znaków, z użyciem miejsc dziesiętnych określonych
przez mint
