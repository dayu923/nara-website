...
h1: Metoda RPC getLargestAccounts

---


Zwraca 20 największych kont według salda w lamportach (wyniki mogą być
buforowane do dwóch godzin)
...
Filtruj wyniki według typu konta
...
Wynik będzie obiektem JSON RpcResponse z `value` równym tablicy obiektów
zawierających:
...
Adres konta zakodowany w Base-58

##### !! lamports

!type u64

Liczba lamportów na koncie
