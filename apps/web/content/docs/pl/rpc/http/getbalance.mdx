...
h1: Metoda RPC getBalance

---


Zwraca saldo w lamportach dla konta o podanym Pubkey.
...
Pubkey konta, które ma zostać zapytane, w formacie zakodowanym w base-58.
...
Obiekt JSON RpcResponse z polem value ustawionym na saldo.
