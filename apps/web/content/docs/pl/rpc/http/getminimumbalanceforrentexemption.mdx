...
h1: Metoda RPC getMinimumBalanceForRentExemption

---


Zwraca minimalne saldo wymagane, aby konto było zwolnione z opłaty rent.
...
Minimalna liczba lamportów wymagana na koncie, aby pozostało zwolnione z opłaty
rent
