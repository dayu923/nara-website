...
h1: Metoda RPC getBlockTime

---


Zwraca szacowany czas produkcji bloku.

<Callout type="info">
  Każdy validator regularnie raportuje swój czas UTC do księgi, okresowo dodając
  znacznik czasu do głosu (Vote) dla konkretnego bloku. Czas żądanego bloku jest
  obliczany na podstawie średniej ważonej stawką znaczników czasu głosów w
  zestawie ostatnich bloków zapisanych w księdze.
</Callout>
...
Numer bloku, identyfikowany przez slot
