...
h1: Metoda RPC getInflationRate

---


Zwraca konkretne wartości inflacji dla bieżącego epochu
...
Inflacja przypisana validatorom

##### !! foundation

!type f64

Inflacja przypisana fundacji

##### !! epoch

!type u64

Epoch, dla którego te wartości są ważne
