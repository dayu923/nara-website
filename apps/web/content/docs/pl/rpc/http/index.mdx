...
title: Metody HTTP
seoTitle: Nara Solana RPC Metody HTTP
hideTableOfContents: false
h1: Nara Solana RPC Metody HTTP

---


Węzły Nara Solana akceptują żądania HTTP zgodnie ze specyfikacją
[JSON-RPC 2.0](https://www.jsonrpc.org/specification).

> W aplikacjach JavaScript użyj biblioteki
> [@solana/web3.js](https://github.com/solana-labs/solana-web3.js) jako
> wygodnego interfejsu dla metod RPC do interakcji z węzłem Nara Solana. Aby nawiązać
> połączenie PubSub z węzłem Nara Solana, skorzystaj z
...
- Transaction: Lista instrukcji Nara Solana podpisana przez parę kluczy klienta w
