...
h1: Metoda RPC getSlotLeaders

---


Zwraca liderów slotów dla podanego zakresu slotów
...
Początkowy slot, jako liczba całkowita u64
...
Limit, jako liczba całkowita u64 (od 1 do 5 000)
...
Tablica publicznych kluczy tożsamości węzłów zakodowanych w formacie base-58.
