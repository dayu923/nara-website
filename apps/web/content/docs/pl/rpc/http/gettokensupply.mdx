...
h1: Metoda RPC getTokenSupply

---


Zwraca całkowitą podaż tokena typu SPL.
...
Pubkey tokena Mint do zapytania, zakodowany jako ciąg base-58
...
Surowa całkowita podaż tokenów bez uwzględnienia miejsc dziesiętnych,
reprezentowana jako ciąg u64

##### !! decimals

!type u8

Liczba cyfr dziesiętnych po prawej stronie separatora dziesiętnego
...
Całkowita podaż tokenów, z uwzględnieniem liczby miejsc dziesiętnych określonych
przez mint
...
Całkowita podaż tokenów jako ciąg znaków, z uwzględnieniem liczby miejsc
dziesiętnych określonych przez mint
