...
title: Metody RPC Nara Solana
seoTitle: "Metody RPC Nara Solana: HTTP i Websockets"
hideTableOfContents: false
h1: Metody RPC Nara Solana i dokumentacja

---


Interakcja z węzłami Nara Solana bezpośrednio za pomocą JSON RPC API poprzez metody
HTTP i Websocket.

## Konfigurowanie zaangażowania stanu

Podczas kontroli wstępnych i przetwarzania transakcji węzły Nara Solana wybierają,
...
Nara Solana obecnie obsługują parsowanie JSON dla następujących natywnych i SPL
programów:
