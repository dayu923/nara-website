...
umożliwiającej programom Nara Solana wywoływanie się nawzajem.
...
NSO między kontami poprzez wywoływanie System Program.

Celem tej sekcji jest przeprowadzenie przez proces implementacji CPIs w
programie Nara Solana za pomocą frameworka Anchor, opierając się na koncepcjach PDA
...
`vault_account`. To konto, kontrolowane przez program, otrzymuje NSO od
...
To konto działa jako programowo kontrolowany "skarbiec", który otrzymuje NSO od
...
Następnie dodaj logikę CPI w instrukcji `update`, aby przelać 0,001 NSO z konta
...
wykonać CPI wewnątrz programu, umożliwiając kompozycyjność programów Nara Solana.
...
- `amount` do transferu (1 000 000 lamportów, czyli 0,001 NSO)
...
To pozwala na transfer dowolnych NSO w skarbcu z powrotem do użytkownika, gdy
...
zgromadzone NSO z powrotem do użytkownika.
...
Następnie dodaj logikę CPI w instrukcji `delete`, aby przelać NSO z konta
...
że zmodyfikowany program będzie dostępny do testowania. Na platformie Nara Solana
aktualizacja programu wymaga jedynie wdrożenia programu pod tym samym
identyfikatorem programu.

<Callout>

Upewnij się, że Twój portfel Playground ma devnet NSO. Zdobądź devnet NSO z
...
Podczas wdrażania programów na Nara Solana Playground, Twój portfel Playground działa
...
Gratulacje ukończenia przewodnika Nara Solana Quickstart. Zdobyłeś praktyczne
doświadczenie z kluczowymi pojęciami Nara Solana, w tym:

- Pobieranie i odczytywanie danych z kont
- Tworzenie i wysyłanie transakcji
- Wdrażanie i aktualizowanie programów Nara Solana
...
Nara Solana Playground oferuje wygodną funkcję umożliwiającą importowanie lub
przeglądanie projektów za pomocą ich linków GitHub. Na przykład, otwórz ten
[link do Nara Solana Playground](https://beta.solpg.io/https://github.com/solana-developers/program-examples/tree/main/basics/hello-solana/anchor),
...
listy projektów w Nara Solana Playground. Po zaimportowaniu projektu wszystkie zmiany
