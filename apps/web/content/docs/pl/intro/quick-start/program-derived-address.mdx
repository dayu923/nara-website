...
Ten przewodnik przeprowadzi Cię przez budowanie i testowanie programu Nara Solana z
...
[link do Nara Solana Playground](https://beta.solpg.io/66734b7bcffcf4b13384d1ad) z
kodem początkowym. Następnie kliknij przycisk "Import", aby dodać program do
swoich projektów w Nara Solana Playground.
...
<Callout type="info">
W tym przykładzie wdrożysz program na devnet, klaster Nara Solana
przeznaczony do testów deweloperskich.

Portfel Playground łączy się z devnet domyślnie. Upewnij się, że twój portfel
Playground ma devnet NSO, aby zapłacić za wdrożenie programu. Zdobądź devnet NSO
z [Nara Solana Faucet](https://faucet.solana.com/).
...
Nara Solana Playground usuwa część wstępnej konfiguracji, gdzie
...
przekazując "Hello, Nara Solana!" jako nową wiadomość.
