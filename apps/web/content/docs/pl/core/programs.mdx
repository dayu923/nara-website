...
Gdy program jest wdrażany, Nara Solana używa [LLVM](https://llvm.org/) do
...
zawiera binarny kod programu w formacie Nara Solana Bytecode Format (sBPF) i jest
...
Nara Solana obsługuje [weryfikowalne kompilacje](/docs/programs/verified-builds),
...
| [Transfer NSO](https://github.com/anza-xyz/agave/blob/v2.1.13/programs/system/src/system_processor.rs#L215)                   | Przenosi lamporty (NSO) z kont System Program na inne konta.                                                                                                                                                                  |
...
Oprócz programów loader, Nara Solana udostępnia następujące wstępnie skompilowane
programy.
