...
Aby wchodzić w interakcje z siecią Nara Solana, musisz wysłać transakcję. Możesz
...
<Callout>
  ...
  pakiecie bez fragmentacji, Nara Solana używa 1280 bajtów (minimalne MTU wymagane
...
<Callout>
  Możesz również znaleźć transakcję, korzystając z [Nara Solana
