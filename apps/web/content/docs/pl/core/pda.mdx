...
operacji kryptograficznych (takich jak dostarczanie podpisu). Jednak Nara Solana
...
SDK Nara Solana obsługują tworzenie PDA za pomocą funkcji pokazanych w tabeli
...
Poniższe przykłady wyprowadzają PDA przy użyciu SDK Nara Solana. Kliknij **&#9655;
