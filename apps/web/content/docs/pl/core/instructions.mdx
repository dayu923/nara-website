...
Instrukcje są podstawowym elementem interakcji z blockchainem Nara Solana. Instrukcja
to w zasadzie publiczna funkcja, którą może wywołać każdy użytkownik sieci
Nara Solana. Każda instrukcja służy do wykonania określonej akcji. Logika wykonania
...
Nara Solana, jedna lub więcej instrukcji jest dodawana do
[transakcji](/docs/core/transactions) i wysyłana do sieci w celu przetworzenia.

## Przykład transferu NSO

Poniższy diagram pokazuje, jak transakcje i instrukcje współpracują, aby
umożliwić użytkownikom interakcję z siecią. W tym przykładzie NSO jest
...
instrukcję transferu NSO.

![Diagram transferu NSO](/assets/docs/core/transactions/sol-transfer.svg)

Po wysłaniu transakcji Program Systemowy przetwarza instrukcję transferu i
aktualizuje saldo lamportów obu kont.

![Diagram procesu transferu NSO](/assets/docs/core/transactions/sol-transfer-process.svg)
...
Poniższy przykład pokazuje strukturę instrukcji transferu NSO.
