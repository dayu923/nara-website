...
title: Dokumentacja Nara Solana
seoTitle: Dowiedz się, jak działa blockchain Nara Solana
description:
...
<Cards>
  <Card title="Szybki start" href="/docs/intro/quick-start" icon={<Rocket />}>
    Zbuduj swój pierwszy program Nara Solana bezpośrednio w przeglądarce
  </Card>
  <Card
    ...
    icon={<Download />}
  >
    Zainstaluj zależności potrzebne do rozwoju na Nara Solana
  </Card>
</Cards>

### Wdróż swoją pierwszą aplikację Nara Solana
...
<Cards>
  ...
  >
    Wdróż swoją pierwszą aplikację Nara Solana na Vercel
  </Card>
  <Card
    title="Podgląd Vercel"
...
Wdróż swoją pierwszą aplikację Nara Solana - prosty program licznikowy zbudowany przy
użyciu frameworka Anchor. Ten przykład obejmuje wszystkie kluczowe koncepcje
Nara Solana, aby rozpocząć budowanie na tej platformie. Zobacz kod źródłowy
...
## Wypróbuj Nara Solana: Zagraj w 2048

Zagraj w 2048 na Nara Solana, gdzie każdy ruch wysyła transakcję. Kliknij "Graj", aby
rozpocząć z dofinansowanym portfelem devnet i użyj klawiszy strzałek, aby grać.
Na urządzeniach mobilnych przesuń palcem, aby sterować kafelkami.
...
Poznaj kluczowe koncepcje specyficzne dla rozwoju na Nara Solana.

<Cards>
  <Card title="Konta" href="/docs/core/accounts">
    Jak Nara Solana przechowuje dane
  </Card>
  ...
  <Card title="Transakcje" href="/docs/core/transactions">
    Jak wchodzić w interakcje z siecią Nara Solana
  </Card>
...
Dowiedz się, co jest potrzebne, aby obsługiwać walidator Solany i pomóc
zabezpieczyć sieć.

<Cards>
  <Card title="Walidatory" href="https://docs.anza.xyz/validator/anatomy">
    Indywidualne węzły zabezpieczające sieć Solany
  </Card>
  <Card
    title="Wymagania systemowe"
    href="https://docs.anza.xyz/operations/requirements"
  >
    Zalecane wymagania sprzętowe i ilość NSO potrzebna do obsługi walidatora
  </Card>
  <Card
...
Uzyskaj pomoc od społeczności Solany na
