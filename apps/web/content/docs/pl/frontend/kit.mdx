...
seoTitle: Integracja portfela Nara Solana z Next.js i Nara Solana Kit
description:
  Skonfiguruj integrację portfela Solana w Next.js za pomocą Solana Kit.

---


Skonfiguruj minimalną integrację portfela Nara Solana w Next.js za pomocą Nara Solana Kit.

Ten przewodnik przedstawia minimalny przykład implementacji funkcjonalności
portfela Nara Solana w aplikacji Next.js przy użyciu `@solana/kit`. Utworzysz
przycisk do łączenia portfela oraz komponent do wysyłania transakcji.

![Aplikacja Nextjs Kit](/assets/docs/frontend/nextjs-kit.gif)

Bardziej kompleksowy przykład użycia `@solana/kit` w aplikacji React znajdziesz
w
[Przykładzie aplikacji React](https://github.com/anza-xyz/kit/tree/main/examples/react-app)
w repozytorium Nara Solana Kit.

## Zasoby

- [Dokumentacja Nara Solana Kit](https://www.solanakit.com/docs)
- [Repozytorium GitHub Nara Solana Kit](https://github.com/anza-xyz/kit)
...
Utwórz nowy projekt Next.js z [shadcn](https://ui.shadcn.com/) dla komponentów
interfejsu użytkownika i zainstaluj wymagane zależności Nara Solana.
...
### Zainstaluj zależności Nara Solana

Zainstaluj następujące zależności Nara Solana:
...
## !!steps 1. Utwórz kontekst Nara Solana

Najpierw utwórz kontekst React, który zarządza całym stanem portfela dla
aplikacji.

Utwórz `components/solana-provider.tsx` i dodaj dostarczony kod. Ten komponent
dostarczający będzie:

- Łączył się z punktami końcowymi RPC devnet Nara Solana
- Filtrował dostępne portfele Nara Solana zainstalowane w przeglądarce użytkownika
...
## !!steps 2. Zaktualizuj układ

Następnie owiń całą aplikację Next.js dostarczającym Nara Solana.
...
- Zapewnia dostęp do funkcjonalności portfela na wszystkich stronach i w
  komponentach
...
## !!steps 3. Utwórz przycisk połączenia portfela

Teraz zbuduj przycisk do łączenia i rozłączania portfeli.

Utwórz `components/wallet-connect-button.tsx` i dodaj dostarczony kod. Ten
przycisk rozwijany:
...
## !!steps 4. Utwórz komponent wysyłania transakcji

Utwórz komponent, który wysyła transakcję wywołującą program memo, aby dodać
wiadomość do logów tłumaczeń.

Celem tego komponentu jest pokazanie, jak wysyłać transakcje za pomocą
podłączonego portfela.

Utwórz `components/memo-card.tsx` i dodaj dostarczony kod. Ten komponent:

- Pozwala użytkownikom wprowadzać wiadomości
- Tworzy transakcję Nara Solana z instrukcją wywołującą program memo
- Prosi podłączony portfel o podpisanie i wysłanie transakcji
- Wyświetla link do podglądu transakcji w Nara Solana Explorer
...
## !!steps 5. Zaktualizuj stronę aplikacji
...
<Callout type="info">
  Zwróć uwagę, że podłączony portfel musi być skonfigurowany do połączenia z
  klastrem devnet i [zasilony NSO z devnet](https://faucet.solana.com/), aby
  wysyłać transakcje.
</Callout>
