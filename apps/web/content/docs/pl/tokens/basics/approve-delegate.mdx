...
title: Zatwierdź delegata
description: Dowiedz się, jak zatwierdzić delegatów dla konta tokena.

---


## Jak zatwierdzić delegata
...
przyznaje innemu kontu (delegatowi) uprawnienia do transferu określonej liczby
tokenów z twojego konta tokena. Delegat może przelać tokeny do zatwierdzonej
kwoty, ale nie może jej przekroczyć. Tylko właściciel konta tokena może
zatwierdzić delegata, a każde konto tokena może mieć tylko jednego delegata
jednocześnie. Każde nowe zatwierdzenie nadpisuje poprzednie.

<Callout type="info">
  [Program
  Tokenów](https://github.com/solana-program/token/blob/a7c488ca39ed4cd71a87950ed854929816e9099f/program/src/instruction.rs#L295)
  oraz [Program Rozszerzeń
  Tokenów](https://github.com/solana-program/token-2022/blob/efd0c957fefbd79882d77df5fb2dac88c001249c/program/src/instruction.rs#L361)
