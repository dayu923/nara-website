...
title: Odmrożenie konta
description: Dowiedz się, jak odmrozić zamrożone konto tokena.
...
cofa zamrożenie, przywracając pełną funkcjonalność wcześniej zamrożonemu kontu
tokena. Po odmrożeniu konto może ponownie normalnie wysyłać i odbierać tokeny.
Tylko autorytet zamrażania tokena może odmrażać konta.
