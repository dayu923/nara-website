...
description: Dowiedz się, jak zamienić natywny NSO na opakowany NSO.

---


## Synchronizacja natywnego NSO

Opakowany NSO (WSOL) to konto tokenowe, które śledzi liczbę lamportów na koncie
jako saldo tokena. WSOL umożliwia integrację z protokołami DeFi, aby przesyłać
NSO jako token SPL.
...
synchronizuje saldo konta tokenowego opakowanego NSO (WSOL) z rzeczywistym NSO
(lamportami) przechowywanym na nim. Gdy przesyłasz natywny NSO na konto tokenowe
WSOL, saldo tokena nie aktualizuje się automatycznie. Musisz wywołać SyncNative,
aby odzwierciedlić poprawne saldo WSOL.

<Callout type="info">
  [Program
  Tokenów](https://github.com/solana-program/token/blob/a7c488ca39ed4cd71a87950ed854929816e9099f/interface/src/instruction.rs#L387)
  oraz [Program Rozszerzeń
  Tokenów](https://github.com/solana-program/token-2022/blob/efd0c957fefbd79882d77df5fb2dac88c001249c/program/src/instruction.rs#L182)
