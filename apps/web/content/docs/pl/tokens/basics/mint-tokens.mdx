...
title: Tworzenie tokenów
description: Dowiedz się, jak tworzyć nowe jednostki tokena.
...
Tworzenie tokenów polega na generowaniu nowych jednostek tokena za pomocą
instrukcji
...
- Tylko autorytet emisji może tworzyć nowe tokeny
- Musi istnieć docelowe konto tokena, aby odebrać utworzone tokeny

<Callout type="info">
  [Program Tokenów
  ](https://github.com/solana-program/token/blob/3daf44899f0bd71c879d28dffdfb788dd944f3c5/program/src/processor.rs#L521)
  oraz [Program Rozszerzeń Tokenów
  ](https://github.com/solana-program/token-2022/blob/efd0c957fefbd79882d77df5fb2dac88c001249c/program/src/processor.rs#L973)
