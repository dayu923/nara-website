...
description: Dowiedz się, jak tworzyć konta tokenów SPL.
...
<Callout type="info">
  Zwróć uwagę, że w kodzie źródłowym deweloperzy nazywają konto tokena typem
  `Account`. Zarówno [Token
...
Utworzenie powiązanego konta tokena (ATA) wymaga instrukcji
