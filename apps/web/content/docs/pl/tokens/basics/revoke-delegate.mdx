...
title: Cofnij delegowanie
description: Dowiedz się, jak cofnąć delegowanie konta tokenów.

---


## Jak cofnąć delegowanie
...
usuwa wszystkie uprawnienia do transferu od obecnie zatwierdzonego delegata. Po
cofnięciu delegowania delegat nie będzie już mógł przenosić żadnych tokenów z
Twojego konta. Tylko właściciel konta tokenów może cofnąć delegowanie.
