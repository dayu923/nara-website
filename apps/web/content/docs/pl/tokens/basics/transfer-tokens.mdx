...
description: Dowiedz się, jak przenosić tokeny między kontami tokenów.

---


## Jak przenosić tokeny

Przelewy tokenów przenoszą tokeny między kontami tokenów tego samego minta za
pomocą
...
- Oba konta tokenów muszą przechowywać ten sam typ tokena (mint)
- Tylko właściciel konta źródłowego lub delegat może autoryzować przelewy

<Callout type="info">
  [Program Tokenów
  ](https://github.com/solana-program/token/blob/3daf44899f0bd71c879d28dffdfb788dd944f3c5/program/src/processor.rs#L227)
  oraz [Program Rozszerzeń Tokenów
  ](https://github.com/solana-program/token-2022/blob/efd0c957fefbd79882d77df5fb2dac88c001249c/program/src/processor.rs#L300)
