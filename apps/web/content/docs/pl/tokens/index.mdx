...
jako tokeny SPL ([Nara Solana Program Library](https://github.com/solana-program)).
...
Dla odniesienia, oto link do Nara Solana Explorer dla
...
korzystają z terminala [Nara Solana Playground](https://beta.solpg.io/), aby
uruchamiać polecenia CLI bezpośrednio w przeglądarce bez konieczności lokalnej
instalacji.

Tworzenie tokenów i kont wymaga NSO na depozyty za wynajem kont oraz opłaty
transakcyjne. Dla nowych użytkowników Nara Solana Playground należy utworzyć portfel
Playground i uruchomić polecenie _sh`solana airdrop`_ w terminalu Playground.
Można również uzyskać devnet NSO z publicznego
...
na [Nara Solana Playground](https://beta.solpg.io/660ce716cffcf4b13384d010).
