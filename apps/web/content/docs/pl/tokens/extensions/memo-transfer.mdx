...
wymaga, aby wszystkie przychodzące transfery tokenów zawierały towarzyszące
memo, gdy zostanie włączony na koncie tokena. To rozszerzenie może być włączane
