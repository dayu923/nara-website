...
title: Rozszerzenia Metadata i Metadata Pointer
description:
  Dowiedz się, jak włączyć rozszerzenia MetadataPointerExtension i
  TokenMetadata.
...
pozwala kontu mint określić adres swojego konta metadata. Ten wskaźnik może
odnosić się do dowolnego konta należącego do programu implementującego
[Token Metadata Interface](https://github.com/solana-program/token-metadata/tree/main),
zapewniając elastyczność w przechowywaniu metadanych.

Program Token Extensions implementuje
[Token Metadata Interface](https://github.com/solana-program/token-metadata/blob/main/interface/src/instruction.rs)
bezpośrednio, umożliwiając przechowywanie metadanych na samym koncie mint.
Obejmuje to nazwę tokena, symbol, URI i dodatkowe dane opisowe. Gdy rozszerzenia
wskaźnika wskazują na sam mint,
