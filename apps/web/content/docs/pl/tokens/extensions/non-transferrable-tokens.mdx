...
title: Tokeny nieprzenoszalne
description: Dowiedz się, jak włączyć InitializeNonTransferableMint.

---


## Jak włączyć rozszerzenie InitializeNonTransferableMint
...
zapobiega przenoszeniu tokenów między kontami tokenów po ich wyemitowaniu. Po
emisji tokeny pozostają na stałe na koncie tokenów. Jednak właściciel konta
tokenów nadal może spalać tokeny i zamknąć konto tokenów, gdy saldo osiągnie
zero.
