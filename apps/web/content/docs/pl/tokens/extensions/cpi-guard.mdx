...
title: CPI Guard
description: Dowiedz się, jak włączyć CpiGuardExtension.

---


## Jak włączyć CpiGuardExtension
...
chroni konta tokenów przed nieoczekiwanymi transferami za pośrednictwem Cross
Program Invocations (CPI). Po włączeniu to rozszerzenie zapewnia, że tokeny mogą
być przenoszone wyłącznie poprzez bezpośrednie wywołania instrukcji transferu
Token Extensions Program, blokując wszystkie inne programy przed transferem
tokenów za pomocą CPI.
