...
title: Niezmienny właściciel
description: Dowiedz się, jak włączyć rozszerzenie ImmutableOwner.

---


## Jak włączyć rozszerzenie ImmutableOwner
...
zapobiega zmianom właściciela dla token accounts. Gdy token account jest
zainicjalizowany z tym rozszerzeniem, wyznaczony właściciel jest stały i nie
może być przeniesiony na inne konto.
