...
description: Dowiedz się, jak zaimplementować TransferFeeExtension.
...
umożliwia automatyczne pobieranie opłat przy każdym transferze tokenów. Opłaty
gromadzą się na kontach tokenów odbiorców i mogą być wypłacane przez
uprawnionego do wypłat ustawionego na mint account.
