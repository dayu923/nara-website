...
title: Stały delegat
description:
  Dowiedz się, jak zaimplementować rozszerzenie InitializePermanentDelegate.

---


## Jak zaimplementować rozszerzenie InitializePermanentDelegate
...
przypisuje nieodwołalnego delegata z uprawnieniami do wszystkich kont tokenów
dla danej emisji (mint). W przeciwieństwie do zwykłych delegatów, których
właściciele kont tokenów mogą odwołać, stały delegat nie może zostać zmieniony
ani usunięty. Stały delegat może przenosić, palić i zamrażać tokeny na dowolnym
koncie tokenów tej emisji.
