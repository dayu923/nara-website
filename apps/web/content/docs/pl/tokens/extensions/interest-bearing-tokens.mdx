...
description: Dowiedz się, jak włączyć InterestBearingMintExtension.

---


## Jak włączyć InterestBearingExtension
...
pozwala ustawić stopę procentową bezpośrednio na koncie mint. Odsetki są
nieustannie kapitalizowane na podstawie znacznika czasu sieci, ale rzeczywisty
stan tokenów przechowywany na każdym koncie tokenów pozostaje niezmieniony.
Całkowita wartość (stan tokenów plus naliczone odsetki) jest jedynie
obliczeniem. Żadne nowe tokeny nie są emitowane w ramach tego rozszerzenia.
