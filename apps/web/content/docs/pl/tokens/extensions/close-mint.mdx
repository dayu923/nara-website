...
title: Zamknij Mint
description: Dowiedz się, jak włączyć rozszerzenie MintCloseAuthority.

---


## Jak włączyć rozszerzenie MintCloseAuthority
...
pozwala na zamykanie kont mint i odzyskiwanie ich rent. To rozszerzenie musi
zostać zainicjalizowane w momencie tworzenia mint.

Tylko wyznaczony autorytet zamknięcia może zamknąć konto mint. Podobnie jak
konta tokenów mogą być zamykane tylko wtedy, gdy saldo tokenów wynosi zero,
konta mint z tym rozszerzeniem mogą być zamykane tylko wtedy, gdy cała podaż
tokenów zostanie zredukowana do zera.
