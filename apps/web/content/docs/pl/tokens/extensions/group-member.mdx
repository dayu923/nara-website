...
description:
  Dowiedz się, jak włączyć GroupPointerExtension i GroupMemberPointerExtension.

---


## Jak włączyć GroupPointerExtension i GroupMemberPointerExtension
...
określa mint jako grupowy mint (np. kolekcja NFT), wskazując na konto
zawierające
[konfiguracje grupowe](https://github.com/solana-program/token-group/blob/3b4ff305452fa35754206fc1ad4addb2e2bff511/interface/src/state.rs#L16),
takie jak autorytet aktualizacji i maksymalny rozmiar.
...
określa mint jako członkowski mint (np. NFT w kolekcji), wskazując na konto
zawierające
[dane członkowskie](https://github.com/solana-program/token-group/blob/3b4ff305452fa35754206fc1ad4addb2e2bff511/interface/src/state.rs#L67),
takie jak adres grupy i numer członka.

Token Extensions Program implementuje
[Token Group Interface](https://github.com/solana-program/token-group)
bezpośrednio, pozwalając na przechowywanie zarówno danych grupowych, jak i
członkowskich bezpośrednio w mint account. Gdy rozszerzenia wskaźników wskazują
na sam mint, rozszerzenia
...
mogą być używane do przechowywania wszystkich danych kolekcji i członkostwa w
mint account.
