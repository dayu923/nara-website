...
jedynie wysyłać i odbierać NSO od innych kont w sieci, podczas gdy konto
...
Podobnie jak inne typy kont w sieci Nara Solana, konto stakingowe z saldem 0 NSO nie
...
[Nara Solana Explorer](http://explorer.solana.com/) poprzez skopiowanie i wklejenie
