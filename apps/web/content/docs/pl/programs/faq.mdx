...
Programy on-chain Nara Solana są kompilowane za pomocą
...
Ponieważ Nara Solana korzysta z infrastruktury kompilatora LLVM, program może być
...
Wirtualna mapa adresów pamięci używana przez programy SBF Nara Solana jest stała i
wygląda następująco:
