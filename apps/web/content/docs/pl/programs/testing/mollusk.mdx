...
testowy do testowania programów Nara Solana. Oferuje prosty interfejs do testowania
instrukcji programów Nara Solana w zminimalizowanym środowisku Nara Solana Virtual Machine
...
programu Nara Solana za pomocą Mollusk.

<ScrollyCoding>

## !!steps Program Hello World

Ten przykład demonstruje, jak testować podstawowy program Nara Solana za pomocą
...
Aby przetestować program Nara Solana za pomocą Mollusk:
...
zapewnia prosty interfejs do testowania programów Nara Solana. Wszystkie pola mogą
...
Poniższy przykład przetwarza instrukcję transferu NSO bez sprawdzania
poprawności.
...
Poniższy przykład przetwarza instrukcję transferu NSO z kontrolą poprawności.
...
Poniższy przykład przetwarza dwie instrukcje transferu NSO bez kontroli
poprawności.
...
Poniższy przykład przetwarza łańcuch dwóch instrukcji transferu NSO z kontrolą
...
Poniższy przykład przetwarza dwie oddzielne instrukcje transferu NSO z trwałym
