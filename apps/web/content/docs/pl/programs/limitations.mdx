...
Tworzenie programów na blockchainie Nara Solana wiąże się z pewnymi wrodzonymi
ograniczeniami. Poniżej znajduje się lista typowych ograniczeń, na które możesz
natrafić.

## Biblioteki Rust

Ponieważ programy onchain oparte na języku Rust muszą być deterministyczne
podczas działania w środowisku o ograniczonych zasobach i jednowątkowym, mają
pewne ograniczenia dotyczące różnych bibliotek.
...
Programy Nara Solana są ograniczone do szybkiego działania, a aby to umożliwić,
