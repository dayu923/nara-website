...
O desenvolvimento de programas na blockchain Nara Solana tem algumas limitações
inerentes associadas a ele. Abaixo está uma lista de limitações comuns que você
pode encontrar.
...
restrições em várias bibliotecas.
...
Os programas Nara Solana são limitados a executar rapidamente e, para facilitar isso,
...
Os testes da
[biblioteca de matemática da Nara Solana Program Library](https://github.com/solana-labs/solana-program-library/tree/master/libraries/math)
