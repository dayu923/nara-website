...
builds verificados para seus programas na Nara Solana. Vamos abordar o que são builds
...
Nara Solana corresponde ao código-fonte em seu repositório. Com isso, desenvolvedores
...
constrói seu programa em um ambiente controlado usando a CLI Nara Solana Verify e
...
implantá-lo na rede Nara Solana. Durante o processo de construção, uma
...
provavelmente falhará porque as compilações de programas Nara Solana não são
...
### Instale a CLI Nara Solana Verify

A CLI Nara Solana Verify é a principal ferramenta usada para verificar compilações. A
CLI Nara Solana Verify atualmente é mantida pela
...
Para compilar de forma verificável seu programa Nara Solana, navegue até o diretório
...
rede Nara Solana. É recomendado usar uma solução de assinatura múltipla ou governança
...
> [clusters Nara Solana](/docs/references/clusters) (ou seja, devnet, testnet,
> mainnet). Certifique-se de usar a URL de rede correta para o cluster Nara Solana
...
na blockchain. Se fizer isso, o Nara Solana Explorer mostrará imediatamente os dados
...
contribuindo para um ecossistema Nara Solana mais saudável.
...
no explorador da Nara Solana e em outros lugares.
...
Usar [builds verificadas na Nara Solana](/developers/guides/advanced/verified-builds)
garante a integridade e confiabilidade dos seus programas na rede e permite que
desenvolvedores encontrem seus SDKs diretamente no Nara Solana Explorer. Ao
aproveitar ferramentas como o Nara Solana Verify CLI e Docker, você pode manter
...
integridade dos seus programas Nara Solana, elas não são completamente independentes
de confiança na configuração padrão. As imagens docker são construídas e
hospedadas pela Nara Solana Foundation.
...
A API ou o Nara Solana Explorer podem potencialmente exibir informações incorretas se
forem comprometidos.
...
A Fundação Nara Solana, OtterSec e a equipe Ellipsis Labs não são responsáveis por
quaisquer perdas ou danos que possam ocorrer ao usar o pipeline de builds
verificados.

# Security.txt para programas Nara Solana
...
de contato e segurança diretamente em seus contratos inteligentes Nara Solana.
...
Para adicionar um `security.txt` ao seu programa Nara Solana, inclua os seguintes
passos:
...
Nara Solana Explorer, garantindo que seus contatos e detalhes de segurança estejam
...
promovendo melhor segurança e comunicação dentro do ecossistema Nara Solana.

Este é
[um exemplo de como o security.txt aparece no Nara Solana Explorer](https://explorer.solana.com/address/HPxKXnBN4vJ8RjpdqDCU7gvNQHeeyGnSviYTJ4fBrDt4/security?cluster=devnet)
