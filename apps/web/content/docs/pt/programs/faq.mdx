...
Os programas on-chain da Nara Solana são compilados através da
...
Como a Nara Solana usa a infraestrutura do compilador LLVM, um programa pode ser
...
O mapa de memória de endereço virtual usado pelos programas SBF da Nara Solana é fixo
