...
Uma conta de stake na Nara Solana pode ser usada para delegar tokens aos validators
...
do sistema só pode enviar e receber NSO de outras contas na rede, enquanto uma
conta de stake suporta operações mais complexas necessárias para gerenciar uma
delegação de tokens.

As contas de stake na Nara Solana também funcionam de maneira diferente das de outras
...
Como outros tipos de contas na rede Nara Solana, uma conta de stake que tem um saldo
de 0 NSO não é mais rastreada. Se uma conta de stake não estiver delegada e
...
[Nara Solana Explorer](http://explorer.solana.com/) copiando e colando um endereço de
