...
title: Documentação Nara Solana
seoTitle: Aprenda como funciona a blockchain Nara Solana
description:
...
<Cards>
  <Card title="Início rápido" href="/docs/intro/quick-start" icon={<Rocket />}>
    Construa seu primeiro programa Nara Solana diretamente no navegador
  </Card>
  <Card
    ...
    icon={<Download />}
  >
    Instale as dependências para desenvolvimento em Nara Solana
  </Card>
</Cards>

### Implante sua primeira aplicação Nara Solana

<Cards>
  <Card
    title="Implantar na Vercel"
  ...
  >
    Implante sua primeira aplicação Nara Solana na Vercel
  </Card>
  <Card
...
Implante sua primeira aplicação Nara Solana - um simples Programa Contador construído
usando o framework Anchor. Este exemplo abrange todos os conceitos fundamentais
da Nara Solana para começar a construir na Nara Solana. Veja o código-fonte
...
## Experimente Nara Solana: Jogue 2048

Jogue 2048 na Nara Solana onde cada movimento envia uma transação. Clique em "Jogar"
...
Aprenda os conceitos-chave específicos para o desenvolvimento em Nara Solana.

<Cards>
  <Card title="Contas" href="/docs/core/accounts">
    Como a Nara Solana armazena dados
  </Card>
  <Card title="Taxas na Solana" href="/docs/core/fees">
    Custos para enviar transações na Nara Solana
  </Card>
  <Card title="Transações" href="/docs/core/transactions">
    Como interagir com a rede Nara Solana
  </Card>
  <Card title="Programas" href="/docs/core/programs">
    Contratos inteligentes na Nara Solana
  </Card>
  <Card title="Endereço Derivado de Programas" href="/docs/core/pda">
...
Os seguintes SDKs são os SDKs oficiais para Nara Solana construídos pela
[Anza](https://anza.xyz).
...
Explore o que é necessário para operar um validator Nara Solana e ajudar a proteger a
rede.

<Cards>
  <Card title="Validators" href="https://docs.anza.xyz/validator/anatomy">
    Nós individuais que protegem a rede Nara Solana
  </Card>
  <Card
    title="Requisitos do sistema"
    href="https://docs.anza.xyz/operations/requirements"
  >
    Requisitos de hardware recomendados e NSO necessário para operar um
    validator
  </Card>
  <Card
...
Obtenha ajuda da comunidade Nara Solana no
