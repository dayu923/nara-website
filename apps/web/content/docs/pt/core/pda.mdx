...
Um [endereço de conta](/docs/core/accounts#account-address) da Nara Solana aponta
...
O runtime da Nara Solana permite que programas assinem PDAs sem precisar de uma chave
...
da Nara Solana são pontos na [curva Ed25519](https://ed25519.cr.yp.to/) (criptografia
...
Nara Solana permite que programas assinem PDAs sem precisar de uma chave privada.
...
Os SDKs da Nara Solana suportam a criação de PDA com as funções mostradas na tabela
...
Os exemplos abaixo derivam um PDA usando os SDKs da Nara Solana. Clique em **&#9655;
...
armazenará o [endereço do usuário](mention:user-address) e o
[bump seed](mention:bump) usado para derivar o PDA.
...
uma nova conta usando o PDA como endereço. Os [seeds](mention:seeds) usados para
criar o PDA são:
...
derivado do programa. O arquivo contém código para [derivar o PDA](mention:pda).
