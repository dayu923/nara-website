...
h1: Método RPC getSlotLeaders

---


Retorna os líderes de slot para um determinado intervalo de slots
...
Limite, como inteiro u64 (entre 1 e 5.000)
...
Array de chaves públicas de identidade do nó como strings codificadas em
base-58.
