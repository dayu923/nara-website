...
Retorna o tempo estimado de produção de um bloco.

<Callout type="info">
  Cada validator reporta seu tempo UTC para o ledger em intervalos regulares,
  adicionando periodicamente um timestamp a um Voto para um bloco específico. O
  tempo de um bloco solicitado é calculado a partir da média ponderada por stake
  dos timestamps de Votos em um conjunto de blocos recentes registrados no
  ledger.
</Callout>
