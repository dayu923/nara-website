...
h1: Método RPC requestAirdrop

---


Solicita um airdrop de lamports para uma Pubkey
...
Pubkey da conta para receber lamports, como uma string codificada em base-58
...
Quantidade de lamports para airdrop
...
Assinatura da transação do airdrop, como uma string codificada em base-58
