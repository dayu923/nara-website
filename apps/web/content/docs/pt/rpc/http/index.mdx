...
title: Métodos HTTP
seoTitle: Métodos HTTP RPC da Nara Solana
hideTableOfContents: false
h1: Métodos HTTP RPC da Nara Solana

---


Os nós da Nara Solana aceitam solicitações HTTP usando a especificação
[JSON-RPC 2.0](https://www.jsonrpc.org/specification).

> Para aplicações JavaScript, use a biblioteca
> [@solana/web3.js](https://github.com/solana-labs/solana-web3.js) como uma
> interface conveniente para os métodos RPC para interagir com um nó Nara Solana.
> Para uma conexão PubSub a um nó Nara Solana, use a
...
- Transaction: Uma lista de instruções da Nara Solana assinadas por um keypair do
