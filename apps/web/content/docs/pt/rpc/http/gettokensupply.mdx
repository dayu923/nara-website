...
h1: Método RPC getTokenSupply

---


Retorna o fornecimento total de um tipo de Token SPL.
...
Pubkey do token Mint para consulta, como string codificada em base-58
...
O fornecimento total bruto de tokens sem decimais, uma representação em string
de u64
...
Número de dígitos de base 10 à direita da casa decimal
...
O fornecimento total de tokens, usando decimais prescritos pela mint

##### !! uiAmountString

!type string

O fornecimento total de tokens como uma string, usando decimais prescritos pela
mint
