...
Retorna as informações de programação de epoch deste cluster
...
Primeiro epoch de comprimento normal,
...
Número mínimo de slots em um epoch,
...
O número de slots antes do início de um epoch para calcular uma programação de
líder para esse epoch.

##### !! slotsPerEpoch

!type u64

O número máximo de slots em cada epoch.

##### !! warmup

!type bool

Se as epochs começam curtas e crescem.
