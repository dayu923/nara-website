...
h1: Estruturas de Dados JSON Comuns para Métodos RPC da Nara Solana

---


Vários métodos RPC da Nara Solana retornam respostas mais complexas como objetos JSON
...
aprender sobre transações na Nara Solana.
...
O runtime da Nara Solana registra as instruções entre programas que são invocadas
