...
title: Métodos RPC da Nara Solana
seoTitle: "Métodos RPC da Nara Solana: HTTP e Websockets"
hideTableOfContents: false
h1: Métodos RPC da Nara Solana e Documentação

---


Interaja diretamente com os nós da Nara Solana através da API JSON RPC via métodos
HTTP e Websocket.

## Configurando o Compromisso de Estado

Para verificações prévias e processamento de transações, os nós da Nara Solana
...
Nara Solana atualmente suportam análise JSON para os seguintes programas nativos e
SPL:
