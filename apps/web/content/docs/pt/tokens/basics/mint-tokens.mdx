...
title: Cunhar Tokens
description: Aprenda como cunhar novas unidades de um token.
...
A cunhagem cria novas unidades de um token usando a instrução
...
- Apenas a autoridade de cunhagem pode cunhar novos tokens
- Uma token account de destino deve existir para receber os tokens cunhados
