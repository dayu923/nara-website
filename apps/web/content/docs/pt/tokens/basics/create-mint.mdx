...
description: Aprenda como criar um mint de Token SPL.
...
Uma mint account representa exclusivamente um token na Nara Solana e armazena seus
metadados globais.
...
Cada token na Nara Solana possui uma mint account, e o endereço do mint serve como
...
exclusivamente o USDC em todo o ecossistema Nara Solana. Você pode visualizar este
mint no
