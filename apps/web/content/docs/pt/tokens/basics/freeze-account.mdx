...
description: Aprenda como congelar token accounts.
...
impede todas as transferências ou queimas de tokens de uma token account
específica. Uma vez congelada, a conta não pode enviar tokens, receber tokens ou
ser fechada até que seja descongelada. Apenas a autoridade de congelamento do
mint do token pode congelar contas. Se a autoridade de congelamento for revogada
(definida como nula) na mint account, os tokens nunca poderão ser congelados.
