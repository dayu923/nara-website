...
description: Aprenda como aprovar delegados para uma token account.
...
concede a outra conta (o delegado) permissão para transferir uma quantidade
específica de tokens da sua token account. O delegado pode transferir tokens até
o valor aprovado, mas não pode excedê-lo. Apenas o proprietário da token account
pode aprovar um delegado, e cada token account pode ter apenas um delegado por
vez. Qualquer nova aprovação substitui a anterior.
