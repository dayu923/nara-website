...
title: Descongelar conta
description: Aprenda como descongelar uma conta de token congelada.
...
reverte um congelamento, restaurando a funcionalidade completa para uma token
account previamente congelada. Após o descongelamento, a conta pode novamente
enviar e receber tokens normalmente. Apenas a autoridade de congelamento do mint
do token pode descongelar contas.
