...
title: Queimar Tokens
description: Aprenda como queimar tokens.
...
destrói permanentemente tokens ao reduzir o saldo em uma token account. Os
tokens queimados são removidos de circulação e diminuem o `supply` rastreado na
mint account. Apenas o proprietário da token account pode queimar tokens de sua
conta.
