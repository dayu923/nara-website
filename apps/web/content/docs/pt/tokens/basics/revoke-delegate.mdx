...
title: Revogar Delegado
description: Aprenda como revogar o delegado da token account.

---


## Como revogar um delegado
...
remove todas as permissões de transferência do delegado atualmente aprovado.
Após a revogação, o delegado não pode mais transferir nenhum token da sua conta.
Apenas o proprietário da token account pode revogar um delegado.
