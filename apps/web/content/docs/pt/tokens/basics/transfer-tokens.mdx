...
description: Aprenda como transferir tokens entre contas de tokens.
...
As transferências de tokens movem tokens entre contas de tokens do mesmo mint
usando a instrução
...
- Ambas as contas de tokens devem conter o mesmo tipo de token (mint)
- Apenas o proprietário da conta de origem ou o delegado pode autorizar
  transferências
