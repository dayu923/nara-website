...
description: Aprenda como implementar o TransferFeeExtension.

---


## Como implementar o TransferFeeExtension
...
permite a cobrança automática de taxas em cada transferência de token. As taxas
se acumulam nas contas de token do destinatário e podem ser retiradas pela
autoridade de retirada definida na mint account.
