...
title: Tokens com rendimento de juros
description: Aprenda como habilitar o InterestBearingMintExtension.

---


## Como habilitar o InterestBearingExtension
...
permite definir uma taxa de juros diretamente em uma mint account. Os juros são
continuamente compostos com base no timestamp da rede, mas o saldo real do token
armazenado em cada token account permanece inalterado. O valor total (saldo do
token mais juros acumulados) é apenas um cálculo. Nenhum novo token é criado com
esta extensão.
