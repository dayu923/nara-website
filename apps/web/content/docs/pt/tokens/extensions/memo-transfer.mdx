...
title: Transferência com memo
description: Aprenda como habilitar a MemoTransferExtension.

---


## Como habilitar a MemoTransferExtension
...
exige que todas as transferências de tokens recebidas incluam um memo anexo
quando habilitada em uma token account. Esta extensão pode ser habilitada ou
desabilitada pelo proprietário da token account.
