...
title: CPI Guard
description: Aprenda como habilitar a CpiGuardExtension.

---


## Como habilitar a CpiGuardExtension
...
protege contas de token contra transferências inesperadas através de Invocações
de Programa Cruzado (CPIs). Quando habilitada, esta extensão garante que os
tokens só possam ser transferidos através de chamadas diretas para a instrução
de transferência do Token Extensions Program, bloqueando todos os outros
programas de transferir tokens através de CPI.
