...
title: Tokens não transferíveis
description: Aprenda como habilitar o InitializeNonTransferableMint.

---


## Como habilitar a extensão InitializeNonTransferableMint
...
impede que tokens sejam transferidos entre token accounts após a cunhagem. Uma
vez cunhados, os tokens permanecem permanentemente no token account. No entanto,
o proprietário do token account ainda pode queimar tokens e fechar o token
account quando o saldo chegar a zero.
