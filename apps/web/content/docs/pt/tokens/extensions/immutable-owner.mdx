...
description: Aprenda como habilitar a Extensão ImmutableOwner.

---


## Como habilitar a Extensão ImmutableOwner
...
extensão impede mudanças de propriedade para token accounts. Quando uma token
account é inicializada com esta extensão, o proprietário designado é permanente
e não pode ser transferido para outra conta.
