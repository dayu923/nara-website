...
title: Fechar Mint
description: Aprenda como habilitar a extensão MintCloseAuthority.

---


## Como habilitar a extensão MintCloseAuthority
...
extensão permite que mint accounts sejam fechadas e seu rent seja recuperado.
Esta extensão deve ser inicializada quando o mint é criado.

Apenas a autoridade de fechamento designada pode fechar o mint account.
Semelhante a como contas de token só podem ser fechadas quando o saldo de tokens
é zero, mint accounts com esta extensão só podem ser fechadas quando todo o
fornecimento de tokens foi reduzido a zero.
