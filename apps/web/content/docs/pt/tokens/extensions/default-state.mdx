...
title: Estado padrão
description: Aprenda como habilitar o DefaultAccountStateExtension.

---


## Como habilitar o DefaultAccountStateExtension
...
define um estado padrão para todas as novas token accounts criadas para uma
mint. Quando habilitada, esta extensão inicializa automaticamente cada nova
token account com um estado específico, como congelado. Isso permite que os
criadores de tokens imponham comportamentos específicos, como exigir que todas
as novas contas sejam congeladas por padrão até serem explicitamente
descongeladas.
