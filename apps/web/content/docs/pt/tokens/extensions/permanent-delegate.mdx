...
description: Aprenda como implementar a extensão InitializePermanentDelegate.

---


## Como implementar a extensão InitializePermanentDelegate
...
atribui um delegado irrevogável com autoridade sobre todas as token accounts
para uma mint. Diferentemente dos delegados regulares que os proprietários de
token account podem revogar, um delegado permanente não pode ser alterado ou
removido. O delegado permanente pode transferir, queimar e congelar tokens em
qualquer token account dessa mint.
