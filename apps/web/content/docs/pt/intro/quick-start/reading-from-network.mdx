...
Leia dados da rede Nara Solana buscando diferentes contas. Esta seção va ajudá-lo a
entender a estrutura das [contas](/docs/core/accounts) Nara Solana. Cada conta Nara Solana
...
principalmente usadas para armazenar NSO e assinar transações. Quando NSO é
...
[solicita NSO](mention:airdrop) para financiar o novo endereço de chave pública
...
O campo `lamports` contém o saldo de NSO da conta, em
...
account identifica exclusivamente um token na rede Nara Solana.
...
Nara Solana fornece bibliotecas de cliente com funções auxiliares que abstraem o
