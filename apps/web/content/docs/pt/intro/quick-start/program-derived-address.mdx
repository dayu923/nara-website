...
Este guia orienta você na construção e teste de um programa Nara Solana usando o
...
Comece abrindo este
[link do Nara Solana Playground](https://beta.solpg.io/66734b7bcffcf4b13384d1ad) com
o código inicial. Em seguida, clique no botão "Import" para adicionar o programa
aos seus projetos do Nara Solana Playground.
...
<Callout type="info">
Neste exemplo, você implantará o programa na devnet, um cluster Nara Solana
para testes de desenvolvimento.

A carteira do Playground se conecta à devnet por padrão. Certifique-se de que
sua carteira do Playground tenha NSO da devnet para pagar pela implantação do
programa. Obtenha NSO da devnet no [Nara Solana Faucet](https://faucet.solana.com/).
...
O Nara Solana Playground remove algumas configurações padrão onde
...
passando "Hello, Nara Solana!" como a nova mensagem.
