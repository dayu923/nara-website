...
seoTitle: Instale a CLI da Nara Solana e o Anchor com um único comando
description:
...
Nara Solana com um único comando. Instale Rust, a CLI da Nara Solana e o Framework Anchor
...
- Instalar o [Rust](/docs/intro/installation/dependencies#install-rust), a
  [CLI da Nara Solana](/docs/intro/installation/dependencies#install-solana-cli) e a
