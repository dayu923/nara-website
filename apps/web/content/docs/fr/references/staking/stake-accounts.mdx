...
Un compte de staking sur Nara Solana peut être utilisé pour déléguer des tokens aux
...
_compte système_. Un compte système ne peut qu'envoyer et recevoir du NSO depuis
...
Les comptes de staking sur Nara Solana fonctionnent également différemment de ceux
...
Comme d'autres types de comptes sur le réseau Nara Solana, un compte de stake ayant
un solde de 0 NSO n'est plus suivi. Si un compte de stake n'est pas délégué et
...
l'[Explorateur Nara Solana](http://explorer.solana.com/) en copiant et collant une
