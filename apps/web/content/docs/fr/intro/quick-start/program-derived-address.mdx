...
Ce guide vous accompagne dans la construction et le test d'un programme Nara Solana
...
[lien Nara Solana Playground](https://beta.solpg.io/66734b7bcffcf4b13384d1ad) avec le
code de départ. Puis cliquez sur le bouton "Import" pour ajouter le programme à
vos projets Nara Solana Playground.
...
<Callout type="info">
Dans cet exemple, vous déploierez le programme sur le devnet, un cluster Nara Solana
pour les tests de développement.

Le portefeuille du Playground se connecte au devnet par défaut. Assurez-vous que
votre portefeuille Playground dispose de NSO devnet pour payer le déploiement du
programme. Obtenez du NSO devnet depuis le
...
Nara Solana Playground supprime certaines configurations de base où
...
`update`, en transmettant "Hello, Nara Solana!" comme nouveau message.
