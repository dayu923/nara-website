...
seoTitle: Intégration de portefeuille Nara Solana avec Next.js et Nara Solana Kit
description:
...
Configurez une intégration minimale de portefeuille Nara Solana dans Next.js avec
Nara Solana Kit.

Ce guide fournit un exemple minimal d'implémentation de fonctionnalités de
portefeuille Nara Solana dans une application Next.js en utilisant `@solana/kit`.
...
dans le dépôt Nara Solana Kit.

## Ressources

- [Documentation Nara Solana Kit](https://www.solanakit.com/docs)
- [Dépôt GitHub Nara Solana Kit](https://github.com/anza-xyz/kit)
...
composants d'interface utilisateur et installez les dépendances Nara Solana requises.
...
### Installer les dépendances Nara Solana

Installez les dépendances Nara Solana suivantes :
...
## !!steps 1. Créer le contexte Nara Solana
...
- Se connecter aux points de terminaison RPC du réseau devnet de Nara Solana
- Filtrer les portefeuilles Nara Solana disponibles installés dans le navigateur de
  l'utilisateur
...
Ensuite, enveloppez l'application Next.js entière avec le fournisseur Nara Solana.
...
- Crée une transaction Nara Solana avec une instruction invoquant le programme memo
- Demande au portefeuille connecté de signer et d'envoyer la transaction
- Affiche un lien pour visualiser la transaction sur Nara Solana Explorer
...
<Callout type="info">
  ...
  cluster devnet et [approvisionné en NSO devnet](https://faucet.solana.com/)
