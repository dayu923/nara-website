...
title: Révoquer un délégué
description: Apprenez comment révoquer le délégué d'un token account.

---


## Comment révoquer un délégué

L'instruction
[`Revoke`](https://github.com/solana-program/token/blob/a7c488ca39ed4cd71a87950ed854929816e9099f/instruction.rs#L133C5-L133C11)
supprime toutes les permissions de transfert du délégué actuellement approuvé.
Après révocation, le délégué ne peut plus transférer de tokens depuis votre
compte. Seul le propriétaire du token account peut révoquer un délégué.
