...
Voir
[l'implémentation ici](https://github.com/solana-program/token/blob/a7c488ca39ed4cd71a87950ed854929816e9099f/program/src/processor.rs#L83).
...
La création d'un compte de jetons associé (ATA) nécessite l'instruction
...
son initialisation via des invocations inter-programmes (CPI).
