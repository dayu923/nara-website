...
title: Dégeler un compte
description: Apprenez comment dégeler un token account gelé.
...
annule un gel, restaurant toutes les fonctionnalités d'un token account
précédemment gelé. Après le dégel, le compte peut à nouveau envoyer et recevoir
des tokens normalement. Seule l'autorité de gel du mint du token peut dégeler
les comptes.
