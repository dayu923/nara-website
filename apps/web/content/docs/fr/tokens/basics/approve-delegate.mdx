...
title: Approuver un délégué
description: Apprenez comment approuver des délégués pour un token account.
...
accorde à un autre compte (le délégué) la permission de transférer un montant
spécifique de tokens depuis votre token account. Le délégué peut transférer des
tokens jusqu'à concurrence du montant approuvé, mais ne peut pas le dépasser.
Seul le propriétaire du token account peut approuver un délégué, et chaque token
account ne peut avoir qu'un seul délégué à la fois. Toute nouvelle approbation
