...
title: Fermer un compte de token
description: Apprenez comment fermer des comptes de token.
...
ferme définitivement un token account et transfère tout le NSO restant (rent)
vers un compte de destination spécifié. Le solde du token account doit être à
zéro avant la fermeture. Seul le propriétaire du token account ou l'autorité de
fermeture désignée peut exécuter cette instruction.
