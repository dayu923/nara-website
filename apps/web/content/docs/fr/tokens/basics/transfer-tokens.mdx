...
description: Apprenez comment transférer des jetons entre comptes de jetons.
...
Les transferts de jetons déplacent des jetons entre comptes de jetons du même
émetteur en utilisant l'instruction
...
- Les deux comptes de jetons doivent détenir le même type de jeton (émetteur)
- Seul le propriétaire du compte source ou son délégué peut autoriser les
  transferts

<Callout type="info">
  Le [Programme de Jetons (Token
  ...
  et le [Programme d'Extension de Jetons (Token Extension
