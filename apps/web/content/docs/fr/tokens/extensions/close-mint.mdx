...
title: Fermeture de mint
description: Apprenez comment activer l'extension MintCloseAuthority.
...
permet de fermer les mint accounts et de récupérer leur rent. Cette extension
doit être initialisée lors de la création du mint account.

Seule l'autorité de fermeture désignée peut fermer le mint account. Similaire à
la façon dont les comptes de jetons ne peuvent être fermés que lorsque le solde
de jetons est à zéro, les mint accounts avec cette extension ne peuvent être
