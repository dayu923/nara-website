...
title: Transfert avec mémo
description: Apprenez comment activer l'extension MemoTransferExtension.

---


## Comment activer l'extension MemoTransferExtension
...
exige que tous les transferts de tokens entrants incluent un mémo
d'accompagnement lorsqu'elle est activée sur un token account. Cette extension
peut être activée ou désactivée par le propriétaire du token account.
