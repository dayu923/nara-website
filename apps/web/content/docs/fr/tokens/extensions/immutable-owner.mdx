...
title: Propriétaire immuable
description: Apprenez comment activer l'extension ImmutableOwner.

---


## Comment activer l'extension ImmutableOwner
...
empêche les changements de propriétaire pour les token accounts. Lorsqu'un token
account est initialisé avec cette extension, le propriétaire désigné est
permanent et ne peut pas être transféré à un autre compte.
