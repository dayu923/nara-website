...
title: Délégué permanent
description: Apprenez à implémenter l'extension InitializePermanentDelegate.

---


## Comment implémenter l'extension InitializePermanentDelegate
...
assigne un délégué irrévocable avec autorité sur tous les token accounts pour un
mint. Contrairement aux délégués ordinaires que les propriétaires de token
account peuvent révoquer, un délégué permanent ne peut être ni modifié ni
supprimé. Le délégué permanent peut transférer, brûler et geler des tokens dans
n'importe quel token account de ce mint.
