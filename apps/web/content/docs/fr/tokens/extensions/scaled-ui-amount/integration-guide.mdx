...
# Prise en charge de l'extension Scaled UI Amount sur Nara Solana
...
- Les services qui fournissent des données historiques devraient stocker et
  **afficher à la fois les prix mis à l'échelle et non mis à l'échelle pour
  l'extension d'interface utilisateur des montants mis à l'échelle**.
- Nous prévoyons que les montants mis à l'échelle seront utilisés plus
  fréquemment car cela correspond à la façon dont le monde de la finance
  traditionnelle traite les graphiques liés aux jetons avec des divisions
  d'actions.
- Les mises à jour du multiplicateur peuvent inclure un horodatage qui se situe
  dans le passé. Nous recommandons d'utiliser l'horodatage du bloc pour les
  données historiques.
- Notez que le multiplicateur actif peut être le "multiplicateur" ou le
  ...
  multiplicateur est programmé pour être actif.
...
| Exigence                                        | Description                                                                                                                                                                                                                                                                                                                                                        | Priorité |
| :---------------------------------------------- | :----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :------- |
| Mises à jour API pour données mises à l'échelle | Étendre la fonctionnalité de l'API pour inclure les changements de multiplicateur au fil du temps ainsi que le flux de prix mis à l'échelle.                                                                                                                                                                                                                       | **P0**   |
...
| Suivi historique des prix                       | Fournir un graphique historique des prix en utilisant le prix mis à l'échelle au fil du temps.                                                                                                                                                                                                                                                                     | **P1**   |
| Suivi historique des multiplicateurs            | Fournir des marqueurs historiques des mises à jour de multiplicateur pour les jetons portant intérêt. Notez que les mises à jour du multiplicateur peuvent inclure un horodatage qui se situe dans le passé. Nous recommandons d'utiliser l'horodatage du bloc plutôt que l'horodatage indiqué dans la mise à jour du multiplicateur pour les données historiques. | **P2**   |
| Contenu éducatif ou explications                | Inclure de brèves descriptions ou infobulles expliquant comment fonctionnent les jetons mis à l'échelle.                                                                                                                                                                                                                                                           | **P2**   |
...
| Exigence                                | Description                                                                                                                                                                                                                                                                                                        | Priorité |
| :-------------------------------------- | :----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :------- |
| Flux de prix mis à l'échelle et non     | Fournir des flux de prix pour les prix mis à l'échelle et non mis à l'échelle.                                                                                                                                                                                                                                     | **P0**   |
| Données historiques des multiplicateurs | Offrir des API avec les changements historiques des multiplicateurs. Notez que les mises à jour des multiplicateurs peuvent inclure un horodatage antérieur. Nous recommandons d'utiliser l'horodatage du bloc plutôt que l'horodatage indiqué dans la mise à jour du multiplicateur pour les données historiques. | **P0**   |
| Données de prix historiques             | Offrir des API avec les prix historiques basés sur les montants mis à l'échelle et non mis à l'échelle.                                                                                                                                                                                                            | **P0**   |
