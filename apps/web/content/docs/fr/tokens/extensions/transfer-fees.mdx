...
description: Apprenez à implémenter l'extension TransferFeeExtension.

---


## Comment implémenter l'extension TransferFeeExtension
...
permet la collecte automatique de frais sur chaque transfert de jetons. Les
frais s'accumulent dans les comptes de jetons du destinataire et peuvent être
retirés par l'autorité de retrait définie sur le mint account.
