...
description:
  Apprenez comment activer GroupPointerExtension et GroupMemberPointerExtension.

---


## Comment activer GroupPointerExtension et GroupMemberPointerExtension
...
désigne un mint comme un mint de groupe (comme un NFT de collection) en pointant
vers un compte contenant des
[configurations de groupe](https://github.com/solana-program/token-group/blob/3b4ff305452fa35754206fc1ad4addb2e2bff511/interface/src/state.rs#L16)
comme l'autorité de mise à jour et la taille maximale.
...
désigne un mint comme un mint membre (comme un NFT dans une collection) en
pointant vers un compte contenant des
[données d'adhésion](https://github.com/solana-program/token-group/blob/3b4ff305452fa35754206fc1ad4addb2e2bff511/interface/src/state.rs#L67)
comme l'adresse du groupe et le numéro de membre.

Token Extensions Program implémente directement
[Token Group Interface](https://github.com/solana-program/token-group),
permettant de stocker les données du groupe et des membres sur le compte mint
lui-même. Lorsque les extensions de pointeur pointent vers le mint lui-même, les
extensions
...
peuvent être utilisées pour stocker toutes les données de collection et
d'adhésion dans le compte mint.
