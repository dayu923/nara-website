...
description: Apprenez comment activer l'extension DefaultAccountStateExtension.

---


## Comment activer l'extension DefaultAccountStateExtension
...
définit un état par défaut pour tous les nouveaux token accounts créés pour un
mint. Lorsqu'elle est activée, cette extension initialise automatiquement chaque
nouveau token account avec un état spécifié, comme gelé. Cela permet aux
créateurs de tokens d'imposer des comportements spécifiques, comme exiger que
tous les nouveaux comptes soient gelés par défaut jusqu'à ce qu'ils soient
explicitement dégelés.
