...
title: Tokens sur Nara Solana
description: Découvrez les Token Programs de Nara Solana.
...
propriété. Les tokens sur Nara Solana sont appelés tokens SPL
...
Nara Solana. Consultez la section
...
L'écosystème Nara Solana possède deux Token Programs principaux. Code source pour les
...
tokens sur Nara Solana sont effectivement des
...
Les tokens sur Nara Solana sont identifiés de manière unique par l'adresse d'un
...
Pour référence, voici un lien Nara Solana Explorer vers le
...
Cela introduit un concept clé dans le développement Nara Solana :
...
[Nara Solana Playground](https://beta.solpg.io/) pour exécuter des commandes CLI
directement dans le navigateur sans installation locale.

La création de tokens et de comptes nécessite du NSO pour les dépôts de rent de
compte et les frais de transaction. Pour les nouveaux utilisateurs de Nara Solana
...
du NSO devnet depuis le [faucet web](https://faucet.solana.com/) public.
