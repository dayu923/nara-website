...
h1: Méthode RPC getTokenAccountsByDelegate

---


Renvoie tous les comptes SPL Token par Délégué approuvé.
...
Pubkey du compte délégué à interroger, sous forme de chaîne encodée en base-58
...
chaîne encodée en base-58 ; ou

##### !! programId

!type string

Pubkey du programme Token qui possède les comptes, sous forme de chaîne encodée
en base-58
