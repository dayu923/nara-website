...
h1: Méthode RPC getLargestAccounts

---


Renvoie les 20 plus grands comptes, par solde en lamport (les résultats peuvent
être mis en cache jusqu'à deux heures)
...
Le commitment décrit à quel point un bloc est finalisé à ce moment précis. Voir
...
Filtrer les résultats par type de compte
...
Le résultat sera un objet JSON RpcResponse avec `value` égal à un tableau
d'objets contenant :
...
Adresse du compte encodée en base-58

##### !! lamports

!type u64

Nombre de lamports dans le compte
