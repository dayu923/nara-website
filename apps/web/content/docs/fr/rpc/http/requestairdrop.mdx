...
h1: Méthode RPC requestAirdrop

---


Demande un airdrop de lamports vers une pubkey
...
Pubkey du compte qui recevra les lamports, sous forme de chaîne encodée en
base-58
...
Montant de lamports à airdropper
...
Signature de transaction de l'airdrop, sous forme de chaîne encodée en base-58
