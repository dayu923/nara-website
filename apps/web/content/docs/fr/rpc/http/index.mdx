...
title: Méthodes HTTP
seoTitle: Méthodes HTTP RPC de Nara Solana
hideTableOfContents: false
h1: Méthodes HTTP RPC de Nara Solana

---


Les nœuds Nara Solana acceptent les requêtes HTTP en utilisant la spécification
...
> interface pratique pour les méthodes RPC afin d'interagir avec un nœud Nara Solana.
> Pour une connexion PubSub à un nœud Nara Solana, utilisez
...
- Transaction : Une liste d'instructions Nara Solana signées par une paire de clés
