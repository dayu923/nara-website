...
h1: Méthode RPC getTokenLargestAccounts

---


Renvoie les 20 plus grands comptes d'un type de jeton SPL particulier.
...
L'adresse du token account

##### !! amount

!type string

Le solde brut du token account sans décimales, une représentation sous forme de
chaîne de caractères d'un u64
...
Le solde du token account, utilisant les décimales prescrites par le mint
**OBSOLÈTE**
...
Le solde du token account sous forme de chaîne de caractères, utilisant les
