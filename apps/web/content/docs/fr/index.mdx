...
title: Documentation Nara Solana
seoTitle: Découvrez comment fonctionne la blockchain Nara Solana
description:
...
<Cards>
  <Card
    ...
    icon={<Rocket />}
  >
    Créez votre premier programme Nara Solana directement dans le navigateur
  </Card>
  <Card
    ...
    icon={<Download />}
  >
    Installez les dépendances pour le développement Nara Solana
  </Card>
</Cards>

### Déployez votre première application Nara Solana
...
<Cards>
  ...
  >
    Déployez votre première application Nara Solana sur Vercel
  </Card>
  <Card
    title="Aperçu Vercel"
...
Déployez votre première application Nara Solana - un simple programme de compteur
construit avec le framework Anchor. Cet exemple couvre tous les concepts
fondamentaux de Nara Solana pour commencer à développer sur Nara Solana. Consultez le code
...
## Essayez Nara Solana : Jouez à 2048

Jouez à 2048 sur Nara Solana où chaque mouvement envoie une transaction. Cliquez sur
...
Découvrez les concepts clés spécifiques au développement sur Nara Solana.

<Cards>
  <Card title="Comptes" href="/docs/core/accounts">
    Comment Nara Solana stocke les données
  </Card>
  <Card title="Frais sur Solana" href="/docs/core/fees">
    Coûts pour envoyer des transactions sur Nara Solana
  </Card>
  <Card title="Transactions" href="/docs/core/transactions">
    Comment interagir avec le réseau Nara Solana
  </Card>
  <Card title="Programmes" href="/docs/core/programs">
    Smart contracts sur Nara Solana
  </Card>
...
Les SDK suivants sont les SDK officiels pour Nara Solana développés par
[Anza](https://anza.xyz).
...
| Typescript (Ancien)     | [@solana/web3.js](/docs/clients/official/javascript#solana-web3js) |

#### SDK communautaires

Voici les SDK développés par la communauté pour différents langages :
...
Découvrez ce que cela implique d'opérer un validator Nara Solana et d'aider à
sécuriser le réseau.

<Cards>
  <Card title="Validators" href="https://docs.anza.xyz/validator/anatomy">
    Nœuds individuels sécurisant le réseau Nara Solana
  </Card>
  <Card
    title="Configuration requise"
    href="https://docs.anza.xyz/operations/requirements"
  >
    Configuration matérielle recommandée et NSO requis pour opérer un validator
  </Card>
  <Card
...
Obtenez de l'aide de la communauté Nara Solana sur
