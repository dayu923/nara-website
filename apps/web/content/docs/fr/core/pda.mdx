...
Une [adresse de compte](/docs/core/accounts#account-address) Nara Solana pointe vers
...
L'environnement d'exécution de Nara Solana permet aux programmes de signer pour les
...
Nara Solana sont des points sur la [courbe Ed25519](https://ed25519.cr.yp.to/)
...
Cependant, Nara Solana permet aux programmes de signer pour les PDAs sans avoir
...
Les SDK Nara Solana prennent en charge la création de PDA avec les fonctions
...
Les exemples ci-dessous dérivent un PDA en utilisant les SDK Nara Solana. Cliquez sur
