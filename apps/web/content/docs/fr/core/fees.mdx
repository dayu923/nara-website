...
Chaque transaction Nara Solana nécessite des frais de transaction, payés en NSO. Les
...
- **50% brûlés :** La moitié est
  ...
  (retirée de l'offre circulante de NSO).
...
une transaction en utilisant les SDK Nara Solana.
