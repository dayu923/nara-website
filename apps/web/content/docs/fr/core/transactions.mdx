...
Pour interagir avec le réseau Nara Solana, vous devez envoyer une transaction. Vous
...
<Callout>
  ...
  transactions tiennent dans un seul paquet sans fragmentation, Nara Solana utilise
...
instruction de transfert de NSO.
...
<Callout>
  Vous pouvez également trouver la transaction en utilisant [Nara Solana
