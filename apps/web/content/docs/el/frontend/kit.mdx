...
seoTitle: Ενσωμάτωση πορτοφολιού Nara Solana με Next.js και Nara Solana Kit
description:
  Ρυθμίστε την ενσωμάτωση πορτοφολιού Solana στο Next.js με το Solana Kit.

---


Ρυθμίστε μια ελάχιστη ενσωμάτωση πορτοφολιού Nara Solana στο Next.js με το Nara Solana
Kit.

Αυτός ο οδηγός παρέχει ένα ελάχιστο παράδειγμα υλοποίησης λειτουργικότητας
πορτοφολιού Nara Solana σε μια εφαρμογή Next.js χρησιμοποιώντας το `@solana/kit`. Θα
δημιουργήσετε ένα κουμπί σύνδεσης πορτοφολιού και ένα στοιχείο για την αποστολή
συναλλαγών.

![Εφαρμογή Nextjs Kit](/assets/docs/frontend/nextjs-kit.gif)

Για ένα πιο ολοκληρωμένο παράδειγμα χρήσης του `@solana/kit` σε μια εφαρμογή
React, ανατρέξτε στο
[Παράδειγμα εφαρμογής React](https://github.com/anza-xyz/kit/tree/main/examples/react-app)
στο αποθετήριο του Nara Solana Kit.

## Πόροι

- [Τεκμηρίωση Nara Solana Kit](https://www.solanakit.com/docs)
- [Αποθετήριο GitHub του Nara Solana Kit](https://github.com/anza-xyz/kit)

## Προαπαιτούμενα

- Εγκαταστήστε το [Node.js](https://nodejs.org/en/download)

## Δημιουργία έργου Next.js

Δημιουργήστε ένα νέο έργο Next.js με το [shadcn](https://ui.shadcn.com/) για
στοιχεία διεπαφής χρήστη και εγκαταστήστε τις απαιτούμενες εξαρτήσεις Nara Solana.
...
### Εγκατάσταση εξαρτήσεων Nara Solana

Εγκαταστήστε τις ακόλουθες εξαρτήσεις Nara Solana:
...
Ακολουθήστε τα παρακάτω βήματα και αντιγράψτε τον παρεχόμενο κώδικα στο έργο
σας.

<ScrollyCoding>

## !!steps 1. Δημιουργία Nara Solana Context

Πρώτα, δημιουργήστε ένα React Context που διαχειρίζεται ολόκληρη την κατάσταση
του πορτοφολιού για την εφαρμογή.

Δημιουργήστε το `components/solana-provider.tsx` και προσθέστε τον παρεχόμενο
κώδικα. Αυτό το component παρόχου θα:

- Συνδεθεί στα RPC endpoints του Nara Solana devnet
- Φιλτράρει για διαθέσιμα πορτοφόλια Nara Solana εγκατεστημένα στον browser του
  χρήστη
...
## !!steps 2. Ενημέρωση του Layout

Στη συνέχεια, τυλίξτε ολόκληρη την εφαρμογή Next.js με τον πάροχο Nara Solana.
...
- Διασφαλίζει ότι όλες οι σελίδες και τα components έχουν πρόσβαση στη
  λειτουργικότητα του πορτοφολιού
...
## !!steps 3. Δημιουργία Κουμπιού Σύνδεσης Πορτοφολιού

Τώρα δημιουργήστε το κουμπί για σύνδεση και αποσύνδεση πορτοφολιών.

Δημιουργήστε το `components/wallet-connect-button.tsx` και προσθέστε τον
παρεχόμενο κώδικα. Αυτό το αναπτυσσόμενο κουμπί:

- Εμφανίζει τα διαθέσιμα πορτοφόλια όταν πατηθεί
- Διαχειρίζεται τη ροή σύνδεσης του πορτοφολιού χρησιμοποιώντας το Wallet
  Standard
...
## !!steps 4. Δημιουργία Component Αποστολής Συναλλαγής

Δημιουργήστε ένα component που στέλνει μια συναλλαγή επικαλούμενο το πρόγραμμα
memo για να προσθέσει ένα μήνυμα στα αρχεία καταγραφής συναλλαγών.

Ο σκοπός αυτού του component είναι να δείξει πώς να στέλνετε συναλλαγές με το
συνδεδεμένο πορτοφόλι.

Δημιουργήστε το `components/memo-card.tsx` και προσθέστε τον παρεχόμενο κώδικα.
Αυτό το component:

- Επιτρέπει στους χρήστες να εισάγουν ένα μήνυμα
- Δημιουργεί μια συναλλαγή Nara Solana με μια εντολή που επικαλείται το πρόγραμμα
  memo
- Ζητά από το συνδεδεμένο πορτοφόλι να υπογράψει και να στείλει τη συναλλαγή
- Εμφανίζει έναν σύνδεσμο για προβολή της συναλλαγής στον Nara Solana Explorer
...
## !!steps 5. Ενημέρωση της σελίδας App
...
<Callout type="info">
  Σημειώστε ότι το συνδεδεμένο πορτοφόλι πρέπει να είναι ρυθμισμένο για σύνδεση
  στο cluster devnet και [χρηματοδοτημένο με devnet
  NSO](https://faucet.solana.com/) για να στέλνει συναλλαγές.
</Callout>
