...
Μια [διεύθυνση λογαριασμού](/docs/core/accounts#account-address) της Nara Solana
...
Το περιβάλλον εκτέλεσης της Nara Solana επιτρέπει στα προγράμματα να υπογράφουν για
...
της Nara Solana είναι σημεία στην [καμπύλη Ed25519](https://ed25519.cr.yp.to/)
...
Nara Solana επιτρέπει στα προγράμματα να υπογράφουν για PDAs χωρίς να χρειάζεται
ιδιωτικό κλειδί.
...
Τα Nara Solana SDKs υποστηρίζουν τη δημιουργία PDA με τις συναρτήσεις που φαίνονται
...
Τα παρακάτω παραδείγματα παράγουν ένα PDA χρησιμοποιώντας τα Nara Solana SDKs. Κάντε
...
περιλαμβάνει μια μοναδική εντολή [`initialize`](mention:initialize) για τη
...
Ο περιορισμός [`init`](mention:init) λέει στο Anchor να
...
[την παραγωγή του PDA](mention:pda).
