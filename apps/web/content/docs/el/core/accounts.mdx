...
Όλα τα δεδομένα στο δίκτυο Nara Solana αποθηκεύονται σε λογαριασμούς. Μπορείτε να
σκεφτείτε το δίκτυο Nara Solana ως μια δημόσια βάση δεδομένων με έναν μοναδικό πίνακα
...
χρησιμοποιείται για τον εντοπισμό του λογαριασμού στο blockchain της Nara Solana. Οι
...
τους, αλλά αυτό δεν είναι απαραίτητο, καθώς η Nara Solana υποστηρίζει επίσης
...
Το παρακάτω παράδειγμα δείχνει πώς να χρησιμοποιήσετε το Nara Solana SDK για να
...
να χρησιμοποιήσετε το Nara Solana SDK για να δημιουργήσετε μια program derived
address.
...
Η ανάγνωση δεδομένων από έναν λογαριασμό Nara Solana περιλαμβάνει δύο βήματα:
...
Κάθε λογαριασμός Nara Solana έχει ένα [πρόγραμμα](/docs/core/programs) που ορίζεται
...
ένα βασικό χαρακτηριστικό του μοντέλου λογαριασμών της Nara Solana. (Παρόμοια με τα
...
Όταν το NSO αποστέλλεται σε μια νέα διεύθυνση για πρώτη φορά, δημιουργείται ένας
...
NSO. Μετά την εκτέλεση του κώδικα, μπορείτε να δείτε ότι η διεύθυνση του `owner`
