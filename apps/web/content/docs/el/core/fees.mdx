...
Κάθε συναλλαγή Nara Solana απαιτεί ένα τέλος συναλλαγής, που πληρώνεται σε NSO. Τα
...
ανά συμπεριλαμβανόμενη υπογραφή. Αυτή η χρέωση καταβάλλεται από τον πρώτο
υπογράφοντα της συναλλαγής. Μόνο οι λογαριασμοί που ανήκουν στο System Program
μπορούν να πληρώσουν χρεώσεις συναλλαγών. Η βασική χρέωση κατανέμεται ως εξής:

- **50% καίγεται:** Το μισό
  [καίγεται](https://github.com/anza-xyz/agave/blob/v2.1.13/sdk/fee-calculator/src/lib.rs#L70)
  (αφαιρείται από την κυκλοφορούσα προσφορά NSO).
...
μια συναλλαγή χρησιμοποιώντας τα SDK της Nara Solana.
