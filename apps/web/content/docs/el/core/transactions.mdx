...
Για να αλληλεπιδράσετε με το δίκτυο Nara Solana, πρέπει να στείλετε μια συναλλαγή.
...
<Callout>
  ...
  ένα μόνο πακέτο χωρίς κατακερματισμό, η Nara Solana χρησιμοποιεί 1280 bytes (το
...
<Callout>
  Μπορείτε επίσης να βρείτε τη συναλλαγή χρησιμοποιώντας τον [Nara Solana
