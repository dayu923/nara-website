...
Στο Nara Solana, ένα έξυπνο συμβόλαιο ονομάζεται πρόγραμμα. Ένα πρόγραμμα είναι ένας
...
Όταν ένα πρόγραμμα αναπτύσσεται, το Nara Solana χρησιμοποιεί το
...
αρχείο ELF περιέχει το δυαδικό του προγράμματος σε Μορφή Bytecode Nara Solana (sBPF)
και αποθηκεύεται στην αλυσίδα σε έναν εκτελέσιμο λογαριασμό.

<Callout>
  Το sBPF είναι η προσαρμοσμένη έκδοση του Nara Solana για το
...
- [Anchor](https://www.anchor-lang.com/docs): Το Anchor είναι ένα πλαίσιο
  σχεδιασμένο για γρήγορη και εύκολη ανάπτυξη στο Nara Solana. Χρησιμοποιεί
...
[Εξερευνητή Nara Solana](https://explorer.solana.com/address/PhoeNiXZ8ByJGLkxNfZRnkUfjvmuYqLR89jjFHGqdXY).
...
αν και πολλοί αποδίδονται σε νέο ιδιοκτήτη κατά τη δημιουργία τους. Το System
Program εκτελεί τις ακόλουθες βασικές λειτουργίες:
...
| [Ανάθεση ιδιοκτησίας προγράμματος](https://github.com/anza-xyz/agave/blob/v2.1.13/programs/system/src/system_processor.rs#L113) | Μόλις το System Program δημιουργήσει έναν λογαριασμό, μπορεί να επαναπροσδιορίσει τον καθορισμένο ιδιοκτήτη προγράμματος σε διαφορετικό program account. Έτσι τα προσαρμοσμένα προγράμματα αποκτούν την ιδιοκτησία νέων λογαριασμών που δημιουργούνται από το System Program. |
| [Μεταφορά NSO](https://github.com/anza-xyz/agave/blob/v2.1.13/programs/system/src/system_processor.rs#L215)                     | Μεταφέρει lamports (NSO) από System Accounts σε άλλους λογαριασμούς.                                                                                                                                                                                                          |
...
Τα προγράμματα που αναπτύσσονται με το loader-v3 ή το loader-v4 μπορεί να είναι
τροποποιήσιμα μετά την ανάπτυξη, όπως καθορίζεται από την αρχή αναβάθμισής τους.

<Callout>
  Όταν αναπτύσσεται ένα νέο πρόγραμμα, η τελευταία έκδοση του φορτωτή θα
  χρησιμοποιηθεί από προεπιλογή.
</Callout>

### Προκαταρτισμένα προγράμματα

Εκτός από τα προγράμματα φόρτωσης, η Nara Solana παρέχει τα ακόλουθα προκαταρτισμένα
προγράμματα.
...
Το πρόγραμμα ed25519 επεξεργάζεται μια εντολή. Το πρώτο byte της εντολής
περιέχει έναν αριθμό των υπογραφών που πρέπει να ελεγχθούν, ακολουθούμενο από
ένα μόνο byte συμπλήρωσης. Μετά από αυτό, η ακόλουθη δομή σειριοποιείται, μία
για κάθε υπογραφή που πρέπει να ελεγχθεί.
...
συνέχεια σειριοποιείται και προστίθεται στα δεδομένα της εντολής.
