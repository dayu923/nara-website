...
χαρακτηριστικό που επιτρέπει στα προγράμματα Nara Solana να καλούν το ένα το άλλο.
...
μεταφορές NSO μεταξύ λογαριασμών καλώντας το System Program.

Ο σκοπός αυτής της ενότητας περιλαμβάνει την καθοδήγηση στη διαδικασία
υλοποίησης CPIs σε ένα πρόγραμμα Nara Solana χρησιμοποιώντας το πλαίσιο Anchor,
...
από το πρόγραμμα, λαμβάνει NSO από έναν χρήστη όταν ενημερώνει τον λογαριασμό
μηνυμάτων του.
...
από το πρόγραμμα που λαμβάνει NSO από τους χρήστες όταν ενημερώνουν τα μηνύματά
τους.
...
0,001 NSO από τον λογαριασμό του χρήστη στον λογαριασμό θησαυροφυλακίου.
...
- Το ποσό `amount` για μεταφορά (1.000.000 lamports, ή 0,001 NSO)
...
Αυτό επιτρέπει τη μεταφορά οποιουδήποτε NSO στο θησαυροφυλάκιο πίσω στον χρήστη
...
διαγραφής για να μεταφέρει τυχόν συσσωρευμένο NSO πίσω στον χρήστη.
...
Στη συνέχεια, προσθέστε τη λογική CPI στην εντολή `delete` για να μεταφέρετε NSO
...
για δοκιμές. Στο Nara Solana, η ενημέρωση ενός προγράμματος απλά απαιτεί την
τοποθέτηση του προγράμματος στο ίδιο αναγνωριστικό προγράμματος.

<Callout>

Βεβαιωθείτε ότι το πορτοφόλι Playground σας έχει devnet NSO. Αποκτήστε devnet
NSO από το [Nara Solana Faucet](https://faucet.solana.com/).
...
Κατά την τοποθέτηση προγραμμάτων στο Nara Solana Playground, το πορτοφόλι Playground
...
Συγχαρητήρια για την ολοκλήρωση του οδηγού Nara Solana Quickstart. Αποκτήσατε
πρακτική εμπειρία με βασικές έννοιες της Nara Solana, συμπεριλαμβανομένων:

- Λήψη και ανάγνωση δεδομένων από λογαριασμούς
- Δημιουργία και αποστολή συναλλαγών
- Ανάπτυξη και ενημέρωση προγραμμάτων Nara Solana
...
Το Nara Solana Playground προσφέρει ένα βολικό χαρακτηριστικό που σας επιτρέπει να
εισάγετε ή να προβάλλετε έργα χρησιμοποιώντας τους συνδέσμους GitHub τους. Για
παράδειγμα, ανοίξτε αυτόν τον
[σύνδεσμο Nara Solana Playground](https://beta.solpg.io/https://github.com/solana-developers/program-examples/tree/main/basics/hello-solana/anchor)
...
προσθέσετε στη λίστα των έργων σας στο Nara Solana Playground. Μόλις εισαχθεί ένα
