...
Διαβάστε δεδομένα από το δίκτυο Nara Solana ανακτώντας διαφορετικούς λογαριασμούς.
Αυτή η ενότητα θα σας βοηθήσει να κατανοήσετε τη δομή των
[λογαριασμών](/docs/core/accounts) της Nara Solana. Κάθε λογαριασμός Nara Solana έχει μια
...
χρησιμοποιούνται κυρίως για την αποθήκευση NSO και την υπογραφή συναλλαγών. Όταν
αποστέλλεται NSO σε μια νέα διεύθυνση για πρώτη φορά, δημιουργείται αυτόματα
ένας λογαριασμός συστήματος.

Το παρακάτω παράδειγμα δημιουργεί ένα [νέο keypair](mention:keypair),
[ζητά NSO](mention:airdrop) για τη χρηματοδότηση της νέας διεύθυνσης δημόσιου
...
Το πεδίο `lamports` περιέχει το υπόλοιπο NSO του λογαριασμού, σε
...
προσδιορίζει μοναδικά ένα token στο δίκτυο Nara Solana.
...
προγράμματα Nara Solana παρέχουν βιβλιοθήκες πελάτη με βοηθητικές συναρτήσεις που
