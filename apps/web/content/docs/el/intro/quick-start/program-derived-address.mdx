...
Nara Solana χρησιμοποιώντας το πλαίσιο Anchor, ενώ παράλληλα επιδεικνύει τα Program
...
[σύνδεσμο Nara Solana Playground](https://beta.solpg.io/66734b7bcffcf4b13384d1ad) με
τον αρχικό κώδικα. Στη συνέχεια, κάντε κλικ στο κουμπί "Import" για να
προσθέσετε το πρόγραμμα στα έργα σας στο Nara Solana Playground.
...
<Callout type="info">
Σε αυτό το παράδειγμα, θα αναπτύξετε το πρόγραμμα στο devnet, ένα Nara Solana cluster
για δοκιμές ανάπτυξης.

Το πορτοφόλι του Playground συνδέεται στο devnet από προεπιλογή. Βεβαιωθείτε ότι
το πορτοφόλι του Playground έχει devnet NSO για να πληρώσει για την ανάπτυξη του
προγράμματος. Αποκτήστε devnet NSO από το
...
Το Nara Solana Playground αφαιρεί κάποιες τυποποιημένες ρυθμίσεις όπου το
...
Πρώτα, το αρχείο δοκιμής στέλνει μια συναλλαγή που επικαλείται την εντολή
`update`, περνώντας το "Hello, Nara Solana!" ως το νέο μήνυμα.
