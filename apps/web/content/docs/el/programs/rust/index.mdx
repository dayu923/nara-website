...
Τα προγράμματα Nara Solana αναπτύσσονται κυρίως χρησιμοποιώντας τη γλώσσα
προγραμματισμού Rust. Αυτή η σελίδα επικεντρώνεται στη συγγραφή προγραμμάτων
Nara Solana σε Rust χωρίς τη χρήση του πλαισίου Anchor, μια προσέγγιση που συχνά
αναφέρεται ως συγγραφή προγραμμάτων "native Rust".

Η ανάπτυξη σε native Rust παρέχει στους προγραμματιστές άμεσο έλεγχο των
προγραμμάτων Nara Solana τους. Ωστόσο, αυτή η προσέγγιση απαιτεί περισσότερη
...
- Rust: Η γλώσσα προγραμματισμού για την ανάπτυξη προγραμμάτων Nara Solana.
- Nara Solana CLI: Εργαλείο γραμμής εντολών για την ανάπτυξη Nara Solana.

## Ξεκινώντας

Το παρακάτω παράδειγμα καλύπτει τα βασικά βήματα για τη δημιουργία του πρώτου
σας προγράμματος Nara Solana γραμμένο σε Rust. Θα δημιουργήσουμε ένα ελάχιστο
...
εξάρτηση που απαιτείται για τη δημιουργία ενός προγράμματος Nara Solana.
...
κώδικα. Αυτό είναι ένα ελάχιστο πρόγραμμα Nara Solana που εκτυπώνει "Hello, world!"
στο αρχείο καταγραφής του προγράμματος όταν γίνεται επίκληση του προγράμματος.

Η μακροεντολή `msg!` χρησιμοποιείται στα προγράμματα Nara Solana για την εκτύπωση
...
1. Ένα αρχείο `.so` (π.χ., `hello_world.so`): Αυτό είναι το μεταγλωττισμένο
   πρόγραμμα Nara Solana που θα αναπτυχθεί στο δίκτυο ως "έξυπνο συμβόλαιο".
...
Πρώτα, ρυθμίστε το Nara Solana CLI ώστε να χρησιμοποιεί το τοπικό σύμπλεγμα Nara Solana.
...
<Callout type="info">
  Σημειώστε ότι το cluster στον Nara Solana Explorer πρέπει επίσης να είναι
  localhost. Η επιλογή "Custom RPC URL" στον Nara Solana Explorer έχει προεπιλεγμένη
...
Τα προγράμματα Nara Solana μπορούν να ενημερωθούν με επανατοποθέτηση στο ίδιο
αναγνωριστικό προγράμματος. Ενημερώστε το πρόγραμμα στο `src/lib.rs` ώστε να
εμφανίζει "Hello, Nara Solana!" αντί για "Hello, world!".
...
Θα πρέπει να δείτε το "Hello, Nara Solana!" στο αρχείο καταγραφής του προγράμματος.
...
στον Nara Solana Explorer για να δείτε το "Hello, Nara Solana!" στο αρχείο καταγραφής του
προγράμματος.
...
Μπορείτε να κλείσετε το πρόγραμμα Nara Solana για να ανακτήσετε το NSO που έχει
