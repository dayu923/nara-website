...
h1: Μέθοδος RPC requestAirdrop

---


Αιτείται ένα airdrop lamports σε ένα Pubkey
...
Pubkey του λογαριασμού που θα λάβει τα lamports, ως συμβολοσειρά κωδικοποιημένη
σε base-58
...
Υπογραφή συναλλαγής του airdrop, ως συμβολοσειρά κωδικοποιημένη σε base-58
