...
h1: Μέθοδος RPC getSlotLeaders

---


Επιστρέφει τους ηγέτες slot για ένα συγκεκριμένο εύρος slot
...
Όριο, ως ακέραιος u64 (μεταξύ 1 και 5.000)
...
Πίνακας δημόσιων κλειδιών ταυτότητας κόμβων ως συμβολοσειρές κωδικοποιημένες σε
base-58.
