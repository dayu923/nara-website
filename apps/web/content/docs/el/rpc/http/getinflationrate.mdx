...
h1: Μέθοδος RPC getInflationRate

---


Επιστρέφει τις συγκεκριμένες τιμές πληθωρισμού για την τρέχουσα epoch
...
Πληθωρισμός που κατανέμεται στους validators

##### !! foundation

!type f64

Πληθωρισμός που κατανέμεται στο ίδρυμα

##### !! epoch

!type u64

Epoch για την οποία ισχύουν αυτές οι τιμές
