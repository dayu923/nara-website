...
h1: Μέθοδος RPC getFeeForMessage

---


Λάβετε την προμήθεια που θα χρεώσει το δίκτυο για ένα συγκεκριμένο Μήνυμα

<Callout type="warn" title={"Περιορισμός Έκδοσης"}>
  Αυτή η μέθοδος είναι διαθέσιμη μόνο στην `solana-core` v1.9 ή νεότερη.
  Παρακαλώ χρησιμοποιήστε [getFees](/docs/rpc/deprecated/getfees) για
  `solana-core` v1.8 και παλαιότερες.
</Callout>
...
Μήνυμα κωδικοποιημένο σε Base-64
...
Τέλος που αντιστοιχεί στο μήνυμα στο καθορισμένο blockhash
