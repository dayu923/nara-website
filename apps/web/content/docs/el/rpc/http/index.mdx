...
title: Μέθοδοι HTTP
seoTitle: Μέθοδοι HTTP RPC του Nara Solana
hideTableOfContents: false
h1: Μέθοδοι HTTP RPC του Nara Solana

---


Οι κόμβοι του Nara Solana δέχονται αιτήματα HTTP χρησιμοποιώντας την προδιαγραφή
...
> διεπαφή για τις μεθόδους RPC για αλληλεπίδραση με έναν κόμβο Nara Solana. Για μια
> σύνδεση PubSub σε έναν κόμβο Nara Solana, χρησιμοποιήστε το
...
- Transaction: Μια λίστα οδηγιών Nara Solana υπογεγραμμένη από ένα ζεύγος κλειδιών
