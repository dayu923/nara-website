...
h1: Μέθοδος RPC getBlocks

---


Επιστρέφει μια λίστα επιβεβαιωμένων μπλοκ μεταξύ δύο slot
...
Τελικό slot (πρέπει να μην είναι περισσότερα από 500.000 μπλοκ υψηλότερα από το
`start_slot`)
...
Ένας πίνακας ακεραίων u64 που παραθέτει επιβεβαιωμένα blocks μεταξύ `start_slot`
και είτε `end_slot` - αν παρέχεται, είτε του τελευταίου επιβεβαιωμένου slot,
συμπεριλαμβανομένου. Το μέγιστο επιτρεπόμενο εύρος είναι 500.000 slots.
