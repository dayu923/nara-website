...
h1: Μέθοδος RPC getLeaderSchedule

---


Επιστρέφει το πρόγραμμα ηγέτη για ένα epoch
...
Ανακτά το πρόγραμμα ηγέτη για το epoch που αντιστοιχεί στο παρεχόμενο slot. Εάν
δεν καθοριστεί, ανακτάται το πρόγραμμα ηγέτη για το τρέχον epoch.
...
Επιστρέφει `null` εάν το ζητούμενο epoch δεν βρεθεί, διαφορετικά επιστρέφει ένα
αντικείμενο όπου:

- Τα κλειδιά είναι ταυτότητες validator (ως συμβολοσειρές κωδικοποιημένες σε
  base-58)
- Οι τιμές είναι πίνακες δεικτών slot ηγέτη σχετικά με το πρώτο slot στην
  αιτούμενη epoch
