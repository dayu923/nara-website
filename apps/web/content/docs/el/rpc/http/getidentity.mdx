...
h1: Μέθοδος RPC getIdentity

---


Επιστρέφει το pubkey ταυτότητας για τον τρέχοντα κόμβο
...
Το pubkey ταυτότητας του τρέχοντος κόμβου (ως συμβολοσειρά κωδικοποιημένη σε
base-58)
