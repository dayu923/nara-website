...
h1: Μέθοδος RPC getEpochSchedule

---


Επιστρέφει τις πληροφορίες χρονοδιαγράμματος epoch από αυτό το cluster
...
Το πρώτο epoch κανονικού μήκους,
...
Ελάχιστος αριθμός slot σε ένα epoch,
...
Ο αριθμός των slot πριν από την έναρξη ενός epoch για τον υπολογισμό του
χρονοδιαγράμματος ηγέτη για αυτό το epoch.

##### !! slotsPerEpoch

!type u64

Ο μέγιστος αριθμός slot σε κάθε epoch.

##### !! warmup

!type bool

Εάν οι epoch ξεκινούν σύντομες και αυξάνονται.
