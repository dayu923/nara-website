...
h1: Μέθοδος RPC getLargestAccounts

---


Επιστρέφει τους 20 μεγαλύτερους λογαριασμούς, με βάση το υπόλοιπο σε lamport (τα
αποτελέσματα μπορεί να αποθηκευτούν στην cache για έως και δύο ώρες)
...
Φιλτράρισμα αποτελεσμάτων ανά τύπο λογαριασμού
...
Το αποτέλεσμα θα είναι ένα αντικείμενο JSON RpcResponse με `value` ίσο με έναν
πίνακα αντικειμένων που περιέχουν:

##### !! address

!type string

Διεύθυνση του λογαριασμού κωδικοποιημένη σε Base-58

##### !! lamports

!type u64

Αριθμός lamports στον λογαριασμό
