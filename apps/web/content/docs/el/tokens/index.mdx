...
title: Tokens στο Nara Solana
description: Μάθετε για τα Token Programs του Nara Solana.
...
ψηφιοποίηση των δικαιωμάτων ιδιοκτησίας. Τα tokens στο Nara Solana αναφέρονται ως SPL
([Nara Solana Program Library](https://github.com/solana-program)) Tokens.

Αυτή η ενότητα καλύπτει τις βασικές έννοιες του πώς αναπαρίστανται τα tokens στο
Nara Solana. Ανατρέξτε στην ενότητα [SPL Token Basics](/docs/tokens/basics) για
παραδείγματα κώδικα.
...
Το οικοσύστημα του Nara Solana έχει δύο κύρια Token Programs. Ο πηγαίος κώδικας και
...
στο δίκτυο (τόσο fungible όσο και non-fungible). Όλα τα tokens στο Nara Solana είναι
...
Τα tokens στο Nara Solana προσδιορίζονται μοναδικά από τη διεύθυνση ενός
...
Για αναφορά, εδώ είναι ένας σύνδεσμος Nara Solana Explorer προς τον
...
Αυτό εισάγει μια βασική έννοια στην ανάπτυξη Nara Solana:
...
[Nara Solana Playground](https://beta.solpg.io/) για να εκτελέσουν εντολές CLI
απευθείας στο πρόγραμμα περιήγησης χωρίς τοπική εγκατάσταση.

Η δημιουργία tokens και λογαριασμών απαιτεί NSO για καταθέσεις rent λογαριασμών
και χρεώσεις συναλλαγών. Για τους χρήστες του Nara Solana Playground που το
...
επίσης να λάβετε devnet NSO από το δημόσιο
