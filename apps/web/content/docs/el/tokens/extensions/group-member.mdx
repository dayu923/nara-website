...
description:
  Μάθετε πώς να ενεργοποιήσετε το GroupPointerExtension και το
...
ορίζει ένα mint ως mint ομάδας (όπως ένα Collection NFT) δείχνοντας σε έναν
λογαριασμό που περιέχει
[ρυθμίσεις ομάδας](https://github.com/solana-program/token-group/blob/3b4ff305452fa35754206fc1ad4addb2e2bff511/interface/src/state.rs#L16)
όπως αρχή ενημέρωσης και μέγιστο μέγεθος.
...
ορίζει ένα mint ως mint μέλους (όπως ένα NFT σε μια συλλογή) δείχνοντας σε έναν
λογαριασμό που περιέχει
[δεδομένα μέλους](https://github.com/solana-program/token-group/blob/3b4ff305452fa35754206fc1ad4addb2e2bff511/interface/src/state.rs#L67)
όπως διεύθυνση ομάδας και αριθμό μέλους.

Το Token Extensions Program υλοποιεί το
[Token Group Interface](https://github.com/solana-program/token-group)
απευθείας, επιτρέποντας τόσο στα δεδομένα ομάδας όσο και στα δεδομένα μέλους να
αποθηκεύονται στον ίδιο τον λογαριασμό mint. Όταν οι επεκτάσεις δείκτη δείχνουν
στο ίδιο το mint, οι επεκτάσεις
...
μπορούν να χρησιμοποιηθούν για την αποθήκευση όλων των δεδομένων συλλογής και
μέλους στον λογαριασμό mint.
