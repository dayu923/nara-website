...
description: Μάθετε πώς να ενεργοποιήσετε το InitializeNonTransferableMint.

---


## Πώς να ενεργοποιήσετε την επέκταση InitializeNonTransferableMint
...
εμποδίζει τα tokens να μεταφέρονται μεταξύ token accounts μετά τη δημιουργία
τους. Μόλις δημιουργηθούν, τα tokens παραμένουν μόνιμα στο token account.
Ωστόσο, ο ιδιοκτήτης του token account μπορεί ακόμα να κάψει tokens και να
κλείσει το token account όταν το υπόλοιπο φτάσει στο μηδέν.
