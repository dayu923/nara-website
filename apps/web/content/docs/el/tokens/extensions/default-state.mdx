...
title: Προεπιλεγμένη κατάσταση
description: Μάθετε πώς να ενεργοποιήσετε το DefaultAccountStateExtension.

---


## Πώς να ενεργοποιήσετε το DefaultAccountStateExtension
...
ορίζει μια προεπιλεγμένη κατάσταση για όλους τους νέους token accounts που
δημιουργούνται για ένα mint. Όταν είναι ενεργοποιημένο, αυτή η επέκταση
αρχικοποιεί αυτόματα κάθε νέο token account με μια συγκεκριμένη κατάσταση, όπως
παγωμένο. Αυτό επιτρέπει στους δημιουργούς token να επιβάλλουν συγκεκριμένες
συμπεριφορές, όπως να απαιτούν όλοι οι νέοι λογαριασμοί να είναι παγωμένοι από
προεπιλογή μέχρι να ξεπαγώσουν ρητά.
