...
title: Μόνιμος Αντιπρόσωπος
description: Μάθετε πώς να υλοποιήσετε την επέκταση InitializePermanentDelegate.

---


## Πώς να υλοποιήσετε την επέκταση InitializePermanentDelegate
...
ορίζει έναν αμετάκλητο αντιπρόσωπο με εξουσία σε όλους τους λογαριασμούς token
για ένα mint. Σε αντίθεση με τους κανονικούς αντιπροσώπους που οι ιδιοκτήτες
λογαριασμών token μπορούν να ανακαλέσουν, ένας μόνιμος αντιπρόσωπος δεν μπορεί
να αλλάξει ή να αφαιρεθεί. Ο μόνιμος αντιπρόσωπος μπορεί να μεταφέρει, να κάψει
και να παγώσει tokens σε οποιονδήποτε λογαριασμό token αυτού του mint.
