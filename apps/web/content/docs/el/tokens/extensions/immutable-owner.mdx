...
επέκταση αποτρέπει τις αλλαγές ιδιοκτησίας για τους token accounts. Όταν ένας
token account αρχικοποιείται με αυτή την επέκταση, ο καθορισμένος ιδιοκτήτης
