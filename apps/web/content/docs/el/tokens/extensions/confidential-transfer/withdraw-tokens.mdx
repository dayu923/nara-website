...
description: Μάθετε πώς να κάνετε ανάληψη tokens από την εμπιστευτική κατάσταση.

---


## Πώς να κάνετε ανάληψη tokens από το εμπιστευτικό διαθέσιμο υπόλοιπο

Για να κάνετε ανάληψη tokens από το εμπιστευτικό διαθέσιμο υπόλοιπο στο δημόσιο
υπόλοιπο:

1. Δημιουργήστε
   [δύο αποδείξεις](https://github.com/solana-program/token-2022/blob/efd0c957fefbd79882d77df5fb2dac88c001249c/confidential-transfer/proof-generation/src/withdraw.rs#L22)
   ...
   **Απόδειξη Ισότητας
   ...
   Επαληθεύει ότι το κρυπτογράφημα του εναπομείναντος διαθέσιμου υπολοίπου μετά
   την ανάληψη αντιστοιχεί στη σχετική
   [δέσμευση Pedersen](https://en.wikipedia.org/wiki/Commitment_scheme),
   διασφαλίζοντας ότι το νέο διαθέσιμο υπόλοιπο του λογαριασμού υπολογίζεται
   σωστά ως `remaining_balance = current_balance - withdraw_amount`.
   ...
   **Απόδειξη Εύρους
   ...
   Επαληθεύει ότι το εναπομείναν διαθέσιμο υπόλοιπο μετά την ανάληψη είναι μη
   αρνητικό και εντός συγκεκριμένου εύρους.

2. Για κάθε απόδειξη:
   - Καλέστε το πρόγραμμα απόδειξης ZK ElGamal για να επαληθεύσετε τα δεδομένα
     της απόδειξης.
   - Αποθηκεύστε τα συγκεκριμένα μεταδεδομένα της απόδειξης σε έναν λογαριασμό
     "κατάστασης πλαισίου" απόδειξης για χρήση σε άλλες εντολές.
...
3. Καλέστε την εντολή
   ...
   παρέχοντας τους δύο λογαριασμούς απόδειξης.

4. Κλείστε τους λογαριασμούς απόδειξης για να ανακτήσετε το NSO που
   χρησιμοποιήθηκε για τη δημιουργία τους.

Το παρακάτω διάγραμμα δείχνει τα βήματα που εμπλέκονται στην ανάληψη tokens από
το εμπιστευτικό διαθέσιμο υπόλοιπο στο δημόσιο υπόλοιπο:
...
- Δημιουργήσετε μια απόδειξη ισότητας και μια απόδειξη εύρους στην πλευρά του
  πελάτη
- Καλέσετε το πρόγραμμα απόδειξης Zk ElGamal για να επαληθεύσετε τις αποδείξεις
  και να αρχικοποιήσετε τους λογαριασμούς "κατάστασης πλαισίου"
- Καλέσετε την εντολή
  [ConfidentialTransferInstruction::Withdraw](https://github.com/solana-program/token-2022/blob/efd0c957fefbd79882d77df5fb2dac88c001249c/program/src/extension/confidential_transfer/processor.rs#L493)
  παρέχοντας τους δύο λογαριασμούς απόδειξης.
- Κλείσετε τους δύο λογαριασμούς απόδειξης για να ανακτήσετε το rent.

Το crate `spl_token_client` παρέχει τις ακόλουθες μεθόδους:

- Μέθοδος `confidential_transfer_create_context_state_account` που δημιουργεί
  έναν λογαριασμό απόδειξης.
- Μέθοδος `confidential_transfer_withdraw` που καλεί την εντολή `Withdraw`.
- Μέθοδος `confidential_transfer_close_context_state_account` που κλείνει έναν
  λογαριασμό απόδειξης.

### Παράδειγμα Κώδικα

Το παρακάτω παράδειγμα δείχνει πώς να κάνετε ανάληψη tokens από το εμπιστευτικό
διαθέσιμο υπόλοιπο στο δημόσιο υπόλοιπο.

Για να εκτελέσετε το παράδειγμα, ξεκινήστε έναν τοπικό validator με το Token
Extension Program κλωνοποιημένο από το mainnet χρησιμοποιώντας την ακόλουθη
...
<Callout type="info">
  ...
  το Token Extension Program από το mainnet για να εκτελέσετε τον παράδειγμα
  κώδικα.
</Callout>
