...
description: Μάθετε πώς να καταθέτετε tokens σε εμπιστευτική κατάσταση.
...
## Πώς να καταθέσετε tokens σε εμπιστευτικό εκκρεμές υπόλοιπο
...
Αυτή η ενότητα εξηγεί το πρώτο στάδιο: την κατάθεση του δημόσιου υπολοίπου
tokens στο εμπιστευτικό εκκρεμές υπόλοιπο.

Το ακόλουθο διάγραμμα δείχνει τα βήματα που εμπλέκονται στην κατάθεση tokens από
το δημόσιο υπόλοιπο στο εμπιστευτικό εκκρεμές υπόλοιπο:
...
Για να μετατρέψετε ένα δημόσιο υπόλοιπο σε εμπιστευτικό εκκρεμές υπόλοιπο,
καλέστε την
...
εντολή. Το
[μέγιστο ποσό](https://github.com/solana-program/token-2022/blob/efd0c957fefbd79882d77df5fb2dac88c001249c/program/src/extension/confidential_transfer/mod.rs#L21)
ανά εντολή κατάθεσης περιορίζεται στο 2^48.

Το `spl_token_client` crate παρέχει μια μέθοδο `confidential_transfer_deposit`
που δημιουργεί και στέλνει μια συναλλαγή με την εντολή `Deposit`, όπως φαίνεται
στο παρακάτω παράδειγμα.

### Παράδειγμα Κώδικα

Το ακόλουθο παράδειγμα δείχνει πώς να καταθέσετε δημόσιο υπόλοιπο token σε
εμπιστευτικό εκκρεμές υπόλοιπο.
