...
title: Εμπιστευτική Μεταφορά
description:
  Μάθετε για την επέκταση Εμπιστευτικής Μεταφοράς και πώς να τη χρησιμοποιήσετε
  για να προσθέσετε προαιρετικές λειτουργίες σε mint και λογαριασμούς token.

---


<Callout type="warn">
  Το ZK ElGamal Program είναι προσωρινά απενεργοποιημένο στο mainnet και devnet
  καθώς υποβάλλεται σε έλεγχο ασφαλείας. Αυτό σημαίνει ότι η επέκταση
...
συναλλαγές που διαφυλάσσουν την ιδιωτικότητα. Μόνο τα ποσά μεταφοράς και τα
υπόλοιπα των tokens είναι ιδιωτικά. Οι διευθύνσεις των token accounts παραμένουν
δημόσιες.

- [Επισκόπηση πρωτοκόλλου](https://www.solana-program.com/docs/confidential-balances/overview) -
  Λεπτομέρειες σχετικά με το υποκείμενο κρυπτογραφικό πρωτόκολλο
- [Οδηγός γρήγορης εκκίνησης](https://www.solana-program.com/docs/confidential-balances#setup) -
  Ρύθμιση και βασικές εντολές CLI
- [Οδηγός εμπιστευτικών υπολοίπων](https://github.com/solana-developers/Confidential-Balances-Sample) -
  Αποσπάσματα κώδικα για τη χρήση της επέκτασης εμπιστευτικής μεταφοράς

### Πώς λειτουργεί;

Η επέκταση εμπιστευτικής μεταφοράς προσθέτει
[οδηγίες](https://github.com/solana-program/token-2022/blob/efd0c957fefbd79882d77df5fb2dac88c001249c/program/src/extension/confidential_transfer/instruction.rs#L29)
στο Token Extensions Program που σας επιτρέπει να μεταφέρετε tokens μεταξύ
...
Η βασική ροή των εμπιστευτικών μεταφορών token είναι η εξής:

1. Δημιουργήστε ένα mint account με την επέκταση εμπιστευτικής μεταφοράς.
2. Δημιουργήστε token accounts με επέκταση εμπιστευτικής μεταφοράς για τον
   αποστολέα και τον παραλήπτη.
3. Εκδώστε tokens στον λογαριασμό του αποστολέα.
4. **Καταθέστε** το δημόσιο υπόλοιπο του αποστολέα σε **εμπιστευτικό εκκρεμές
   υπόλοιπο**.
5. **Εφαρμόστε** το εκκρεμές υπόλοιπο του αποστολέα στο **εμπιστευτικό διαθέσιμο
   υπόλοιπο**.
6. Μεταφέρετε εμπιστευτικά tokens από τον token account του αποστολέα στον token
   account του παραλήπτη.
7. **Εφαρμόστε** το εκκρεμές υπόλοιπο του παραλήπτη στο **εμπιστευτικό διαθέσιμο
   υπόλοιπο**.
8. **Αποσύρετε** το εμπιστευτικό διαθέσιμο υπόλοιπο του παραλήπτη στο **δημόσιο
   υπόλοιπο**.

Για περισσότερες λεπτομέρειες σχετικά με τα βήματα στη ροή εμπιστευτικής
...
<Cards>
  ...
  >
    Πώς να διαμορφώσετε ένα token account με την επέκταση Confidential Transfer
  </Card>
  <Card
    title="Κατάθεση Tokens"
    href="/docs/tokens/extensions/confidential-transfer/deposit-tokens"
  >
    Πώς να καταθέσετε tokens σε εκκρεμές εμπιστευτικό υπόλοιπο
  </Card>
  <Card
  ...
  >
    Πώς να κάνετε ανάληψη tokens από το διαθέσιμο εμπιστευτικό υπόλοιπο
  </Card>
  <Card
...
εμπιστευτικές μεταφορές tokens:
...
Το παρακάτω παράδειγμα σε Rust δείχνει τα βήματα για εμπιστευτικές μεταφορές
tokens που αντιστοιχούν στο προηγούμενο διάγραμμα. Τα βήματα χωρίζονται σε
βοηθητικές συναρτήσεις για μεγαλύτερη σαφήνεια.
...
εντολή. Πρέπει να έχετε εγκατεστημένο το Nara Solana CLI για να χρησιμοποιήσετε τον
τοπικό validator.
...
## Εντολές Confidential Transfer

Η πλήρης λίστα των εντολών της επέκτασης Confidential Transfer
...
| Εντολή                              | Περιγραφή                                                                                                                                                                      |
| ----------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| _rs`InitializeMint`_                | Ρυθμίζει το mint account για εμπιστευτικές μεταφορές. Αυτή η εντολή πρέπει να συμπεριληφθεί στην ίδια συναλλαγή με την εντολή _rs`TokenInstruction::InitializeMint`_.          |
| _rs`UpdateMint`_                    | Ενημερώνει τις ρυθμίσεις εμπιστευτικών μεταφορών για ένα mint.                                                                                                                 |
...
| _rs`DisableConfidentialCredits`_    | Αποκλείει εισερχόμενες εμπιστευτικές μεταφορές ενώ εξακολουθεί να επιτρέπει δημόσιες μεταφορές.                                                                                |
| _rs`EnableNonConfidentialCredits`_  | Επιτρέπει σε ένα token account να λαμβάνει δημόσιες μεταφορές token.                                                                                                           |
| _rs`DisableNonConfidentialCredits`_ | Αποκλείει τις κανονικές μεταφορές ώστε ο λογαριασμός να λαμβάνει μόνο εμπιστευτικές μεταφορές.                                                                                 |
| _rs`TransferWithFee`_               | Μεταφέρει tokens μεταξύ token accounts εμπιστευτικά με χρέωση.                                                                                                                 |
| _rs`ConfigureAccountWithRegistry`_  | Εναλλακτικός τρόπος διαμόρφωσης token accounts για εμπιστευτικές μεταφορές χρησιμοποιώντας έναν λογαριασμό _rs`ElGamalRegistry`_ αντί για απόδειξη _rs`VerifyPubkeyValidity`_. |
