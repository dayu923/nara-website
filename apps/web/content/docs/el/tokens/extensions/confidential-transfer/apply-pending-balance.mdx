...
description:
  Μάθετε πώς να εφαρμόζετε το εκκρεμές υπόλοιπο για να καταστήσετε τα κεφάλαια
  διαθέσιμα.
...
## Πώς να εφαρμόσετε το εκκρεμές υπόλοιπο στο διαθέσιμο υπόλοιπο

Πριν τα tokens μπορέσουν να μεταφερθούν εμπιστευτικά, το δημόσιο υπόλοιπο tokens
πρέπει να μετατραπεί σε εμπιστευτικό υπόλοιπο. Αυτή η μετατροπή συμβαίνει σε δύο
στάδια:

1. **Εμπιστευτικό Εκκρεμές Υπόλοιπο**: Αρχικά, τα tokens "κατατίθενται" από το
   δημόσιο υπόλοιπο σε ένα "εκκρεμές" εμπιστευτικό υπόλοιπο.
2. **Εμπιστευτικό Διαθέσιμο Υπόλοιπο**: Το εκκρεμές υπόλοιπο στη συνέχεια
   "εφαρμόζεται" στο διαθέσιμο υπόλοιπο, καθιστώντας τα tokens διαθέσιμα για
   εμπιστευτικές μεταφορές.

Αυτή η ενότητα εξηγεί το δεύτερο στάδιο: την εφαρμογή του εκκρεμούς υπολοίπου
στο διαθέσιμο υπόλοιπο.

Όταν τα tokens "κατατίθενται" από το δημόσιο υπόλοιπο ή όταν τα tokens
μεταφέρονται εμπιστευτικά από ένα token account σε άλλο, τα tokens αρχικά
προστίθενται στο εμπιστευτικό εκκρεμές υπόλοιπο. Πριν τα tokens μπορέσουν να
χρησιμοποιηθούν για εμπιστευτικές μεταφορές, το εκκρεμές υπόλοιπο πρέπει να
"εφαρμοστεί" στο διαθέσιμο υπόλοιπο.
...
Το παρακάτω διάγραμμα δείχνει τα βήματα που εμπλέκονται στην εφαρμογή του
εκκρεμούς υπολοίπου στο διαθέσιμο υπόλοιπο:
...
Για να μετατρέψετε ένα εκκρεμές υπόλοιπο σε διαθέσιμο υπόλοιπο, καλέστε την
εντολή
...
Το crate `spl_token_client` παρέχει μια μέθοδο
`confidential_transfer_apply_pending_balance` που δημιουργεί και στέλνει μια
συναλλαγή με την εντολή `ApplyPendingBalance`, όπως φαίνεται στο παράδειγμα
παρακάτω.

### Παράδειγμα Κώδικα

Το παρακάτω παράδειγμα δείχνει πώς να εφαρμόσετε το εμπιστευτικό εκκρεμές
υπόλοιπο στο εμπιστευτικό διαθέσιμο υπόλοιπο.

Για να εκτελέσετε το παράδειγμα, ξεκινήστε έναν τοπικό validator με το Token
Extensions Program κλωνοποιημένο από το mainnet χρησιμοποιώντας την παρακάτω
...
<Callout type="info">
  ...
  το Token Extension Program του mainnet για να εκτελέσετε τον παράδειγμα
  κώδικα.
</Callout>
