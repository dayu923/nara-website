...
title: Κλείσιμο Mint
description: Μάθετε πώς να ενεργοποιήσετε την επέκταση MintCloseAuthority.

---


## Πώς να ενεργοποιήσετε την επέκταση MintCloseAuthority
...
επέκταση επιτρέπει το κλείσιμο των mint account και την ανάκτηση του rent τους.
Αυτή η επέκταση πρέπει να αρχικοποιηθεί κατά τη δημιουργία του mint.

Μόνο η καθορισμένη αρχή κλεισίματος μπορεί να κλείσει το mint account. Παρόμοια
με τον τρόπο που τα token accounts μπορούν να κλείσουν μόνο όταν το υπόλοιπο των
token είναι μηδέν, τα mint accounts με αυτή την επέκταση μπορούν να κλείσουν
μόνο όταν ολόκληρη η προσφορά token έχει μειωθεί στο μηδέν.
