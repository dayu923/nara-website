...
title: Τόκενς που φέρουν τόκο
description: Μάθετε πώς να ενεργοποιήσετε το InterestBearingMintExtension.

---


## Πώς να ενεργοποιήσετε το InterestBearingExtension
...
σας επιτρέπει να ορίσετε ένα επιτόκιο απευθείας σε ένα mint account. Ο τόκος
ανατοκίζεται συνεχώς με βάση τη χρονική σήμανση του δικτύου, αλλά το πραγματικό
υπόλοιπο του token που αποθηκεύεται σε κάθε token account παραμένει αμετάβλητο.
Η συνολική αξία (υπόλοιπο του token συν τους δεδουλευμένους τόκους) είναι μόνο
ένας υπολογισμός. Δεν δημιουργούνται νέα tokens με αυτή την επέκταση.
