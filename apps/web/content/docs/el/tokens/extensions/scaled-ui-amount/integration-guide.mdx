...
# Υποστήριξη της επέκτασης Scaled UI Amount στο Nara Solana
...
- Αναμένουμε ότι τα κλιμακωμένα ποσά θα χρησιμοποιούνται συχνότερα, καθώς αυτό
  ...
  αντιμετωπίζει τα γραφήματα που σχετίζονται με tokens με διάσπαση μετοχών.
- Οι ενημερώσεις πολλαπλασιαστή μπορεί να περιλαμβάνουν χρονική σήμανση που
  ανήκει στο παρελθόν. Συνιστούμε τη χρήση της χρονικής σήμανσης του block για
  ιστορικά δεδομένα.
...
| Απαίτηση                                    | Περιγραφή                                                                                                                                                                                                                                                                                                                                                | Προτεραιότητα |
| :------------------------------------------ | :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :------------ |
| Ενημερώσεις API για Κλιμακωμένα Δεδομένα    | Επέκταση της λειτουργικότητας του API ώστε να περιλαμβάνει αλλαγές πολλαπλασιαστή με την πάροδο του χρόνου καθώς και την τροφοδοσία κλιμακωμένων τιμών.                                                                                                                                                                                                  | **P0**        |
...
| Παρακολούθηση Ιστορικού Πολλαπλασιαστή      | Παροχή ιστορικών δεικτών ενημερώσεων πολλαπλασιαστή για tokens που φέρουν τόκους. Σημειώστε ότι οι ενημερώσεις πολλαπλασιαστή μπορεί να περιλαμβάνουν χρονική σήμανση που ανήκει στο παρελθόν. Συνιστούμε τη χρήση της χρονικής σήμανσης του block αντί της χρονικής σήμανσης που υποδεικνύεται στην ενημέρωση του πολλαπλασιαστή για ιστορικά δεδομένα. | **P2**        |
| Εκπαιδευτικό Περιεχόμενο ή Επεξηγήσεις      | Συμπερίληψη σύντομων περιγραφών ή επεξηγηματικών σημειώσεων που εξηγούν πώς λειτουργούν τα κλιμακωμένα tokens.                                                                                                                                                                                                                                           | **P2**        |
...
| Απαίτηση                             | Περιγραφή                                                                                                                                                                                                                                                                                                                | Προτεραιότητα |
| :----------------------------------- | :----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :------------ |
| Κλιμακωμένες & μη κλιμακωμένες τιμές | Παροχή ροών τιμών τόσο για κλιμακωμένες όσο και για μη κλιμακωμένες τιμές.                                                                                                                                                                                                                                               | **P0**        |
| Ιστορικά δεδομένα πολλαπλασιαστή     | Προσφορά API με ιστορικές αλλαγές πολλαπλασιαστή. Σημειώστε ότι οι ενημερώσεις πολλαπλασιαστή μπορεί να περιλαμβάνουν χρονική σήμανση που ανήκει στο παρελθόν. Συνιστούμε τη χρήση της χρονικής σήμανσης του μπλοκ αντί της χρονικής σήμανσης που υποδεικνύεται στην ενημέρωση του πολλαπλασιαστή για ιστορικά δεδομένα. | **P0**        |
| Ιστορικά δεδομένα τιμών              | Προσφορά API με ιστορικές τιμές βάσει τόσο κλιμακωμένων όσο και μη κλιμακωμένων ποσών.                                                                                                                                                                                                                                   | **P0**        |
