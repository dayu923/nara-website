...
title: CPI Guard
description: Μάθετε πώς να ενεργοποιήσετε το CpiGuardExtension.

---


## Πώς να ενεργοποιήσετε το CpiGuardExtension
...
προστατεύει τους λογαριασμούς token από μη αναμενόμενες μεταφορές μέσω Cross
Program Invocations (CPIs). Όταν είναι ενεργοποιημένο, αυτό το extension
διασφαλίζει ότι τα tokens μπορούν να μεταφερθούν μόνο μέσω άμεσων κλήσεων στην
εντολή μεταφοράς του Token Extensions Program, αποκλείοντας όλα τα άλλα
προγράμματα από τη μεταφορά tokens μέσω CPI.
