...
description: Μάθετε πώς να ενεργοποιήσετε το MemoTransferExtension.

---


## Πώς να ενεργοποιήσετε το MemoTransferExtension
...
απαιτεί όλες οι εισερχόμενες μεταφορές token να περιλαμβάνουν ένα συνοδευτικό
υπόμνημα όταν είναι ενεργοποιημένο σε ένα token account. Αυτή η επέκταση μπορεί
να ενεργοποιηθεί ή να απενεργοποιηθεί από τον ιδιοκτήτη του token account.
