...
title: Επεκτάσεις Metadata & Metadata Pointer
description:
  Μάθετε πώς να ενεργοποιήσετε τις επεκτάσεις MetadataPointerExtension και
  TokenMetadata.

---


## Πώς να ενεργοποιήσετε τις επεκτάσεις MetadataPointerExtension και TokenMetadata
...
επιτρέπει σε ένα mint account να καθορίσει τη διεύθυνση του λογαριασμού
μεταδεδομένων του. Αυτός ο δείκτης μπορεί να αναφέρεται σε οποιονδήποτε
λογαριασμό που ανήκει σε ένα πρόγραμμα που υλοποιεί το
[Token Metadata Interface](https://github.com/solana-program/token-metadata/tree/main),
παρέχοντας ευελιξία στο πού αποθηκεύονται τα μεταδεδομένα.
...
άμεσα, επιτρέποντας την αποθήκευση μεταδεδομένων στον ίδιο τον λογαριασμό mint.
Αυτό περιλαμβάνει το όνομα του token, το σύμβολο, το URI και πρόσθετα
περιγραφικά δεδομένα. Όταν οι επεκτάσεις δείκτη δείχνουν στο ίδιο το mint, οι
επεκτάσεις
...
μπορούν να χρησιμοποιηθούν για την αποθήκευση όλων των μεταδεδομένων στον
λογαριασμό mint.
