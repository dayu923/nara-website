...
title: Έκδοση Tokens
description: Μάθετε πώς να εκδίδετε νέες μονάδες ενός token.

---


## Πώς να εκδώσετε Tokens

Η έκδοση δημιουργεί νέες μονάδες ενός token χρησιμοποιώντας την εντολή
...
- Μόνο η αρχή έκδοσης (mint authority) μπορεί να εκδώσει νέα tokens
- Πρέπει να υπάρχει ένα token account προορισμού για να λάβει τα νεοεκδοθέντα
  tokens
