...
title: Έγκριση Αντιπροσώπου
description: Μάθετε πώς να εγκρίνετε αντιπροσώπους για ένα token account.

---


## Πώς να εγκρίνετε έναν αντιπρόσωπο
...
παραχωρεί σε έναν άλλο λογαριασμό (τον αντιπρόσωπο) την άδεια να μεταφέρει ένα
συγκεκριμένο ποσό tokens από το token account σας. Ο αντιπρόσωπος μπορεί να
μεταφέρει tokens μέχρι το εγκεκριμένο ποσό, αλλά δεν μπορεί να το υπερβεί. Μόνο
ο ιδιοκτήτης του token account μπορεί να εγκρίνει έναν αντιπρόσωπο, και κάθε
token account μπορεί να έχει μόνο έναν αντιπρόσωπο κάθε φορά. Κάθε νέα έγκριση
