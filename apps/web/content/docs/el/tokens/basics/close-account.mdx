...
κλείνει μόνιμα έναν token account και μεταφέρει όλα τα υπόλοιπα NSO (rent) σε
έναν καθορισμένο λογαριασμό προορισμού. Το υπόλοιπο του token account πρέπει να
είναι μηδέν πριν το κλείσιμο. Μόνο ο ιδιοκτήτης του token account ή η
καθορισμένη αρχή κλεισίματος μπορεί να εκτελέσει αυτή την εντολή.
