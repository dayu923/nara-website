...
description: Μάθετε πώς να δημιουργήσετε ένα SPL Token mint.
...
Ένας mint account αντιπροσωπεύει μοναδικά ένα token στο Nara Solana και αποθηκεύει τα
...
Κάθε token στο Nara Solana έχει έναν mint account, και η διεύθυνση του mint
...
μοναδικά το USDC σε ολόκληρο το οικοσύστημα του Nara Solana. Μπορείτε να δείτε αυτό
το mint στον
