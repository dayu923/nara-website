...
title: Ανάκληση Εκπροσώπου
description: Μάθετε πώς να ανακαλέσετε τον εκπρόσωπο του token account.

---


## Πώς να ανακαλέσετε τον εκπρόσωπο
...
αφαιρεί όλα τα δικαιώματα μεταφοράς από τον τρέχοντα εγκεκριμένο εκπρόσωπο. Μετά
την ανάκληση, ο εκπρόσωπος δεν μπορεί πλέον να μεταφέρει tokens από τον
λογαριασμό σας. Μόνο ο ιδιοκτήτης του token account μπορεί να ανακαλέσει έναν
εκπρόσωπο.
