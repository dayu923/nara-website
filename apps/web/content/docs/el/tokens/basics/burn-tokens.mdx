...
title: Καταστροφή Tokens
description: Μάθετε πώς να καταστρέφετε tokens.
...
καταστρέφει μόνιμα tokens μειώνοντας το υπόλοιπο σε ένα token account. Τα
κατεστραμμένα tokens αφαιρούνται από την κυκλοφορία και μειώνεται το `supply`
που παρακολουθείται στο mint account. Μόνο ο ιδιοκτήτης του token account μπορεί
να καταστρέψει tokens από τον λογαριασμό του.
