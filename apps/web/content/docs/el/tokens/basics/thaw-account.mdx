...
title: Ξεπάγωμα Λογαριασμού
description: Μάθετε πώς να ξεπαγώσετε έναν παγωμένο token account.

---


## Ξεπάγωμα Λογαριασμού
...
αναιρεί το πάγωμα, επαναφέροντας την πλήρη λειτουργικότητα σε έναν προηγουμένως
παγωμένο token account. Μετά το ξεπάγωμα, ο λογαριασμός μπορεί και πάλι να
στέλνει και να λαμβάνει τόκεν κανονικά. Μόνο η αρχή παγώματος του mint του τόκεν
μπορεί να ξεπαγώσει λογαριασμούς.
