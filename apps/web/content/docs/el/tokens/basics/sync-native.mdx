...
title: Συγχρονισμός Native
description: Μάθετε πώς να μετατρέψετε native NSO σε wrapped NSO.

---


## Συγχρονισμός Native NSO

Το Wrapped NSO (WSOL) είναι ένας λογαριασμός token που παρακολουθεί την ποσότητα
των lamports στον λογαριασμό ως υπόλοιπο token. Το WSOL επιτρέπει την ενσωμάτωση
με πρωτόκολλα DeFi για τη μεταφορά του NSO ως SPL token.
...
συγχρονίζει το υπόλοιπο ενός λογαριασμού wrapped NSO (WSOL) με τα πραγματικά NSO
(lamports) που είναι αποθηκευμένα σε αυτόν. Όταν μεταφέρετε native NSO σε έναν
λογαριασμό WSOL token, το υπόλοιπο του token δεν ενημερώνεται αυτόματα. Πρέπει
να καλέσετε το SyncNative για να αντικατοπτριστεί το σωστό υπόλοιπο WSOL.
