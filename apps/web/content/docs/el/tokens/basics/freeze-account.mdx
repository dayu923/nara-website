...
title: Πάγωμα Λογαριασμού
description: Μάθετε πώς να παγώνετε λογαριασμούς token.
...
αποτρέπει όλες τις μεταφορές ή καταστροφές token από έναν συγκεκριμένο token
account. Μόλις παγώσει, ο λογαριασμός δεν μπορεί να στείλει token, να λάβει
token ή να κλείσει μέχρι να ξεπαγώσει. Μόνο η αρχή παγώματος του mint του token
μπορεί να παγώσει λογαριασμούς. Εάν η αρχή παγώματος ανακληθεί (οριστεί ως null)
στον mint account, τα token δεν μπορούν ποτέ να παγώσουν.
