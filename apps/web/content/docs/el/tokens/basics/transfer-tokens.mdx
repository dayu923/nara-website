...
description: Μάθετε πώς να μεταφέρετε tokens μεταξύ λογαριασμών token.
...
Οι μεταφορές token μετακινούν tokens μεταξύ λογαριασμών token του ίδιου mint
...
- Και οι δύο λογαριασμοί token πρέπει να περιέχουν τον ίδιο τύπο token (mint)
- Μόνο ο ιδιοκτήτης του λογαριασμού προέλευσης ή ο εξουσιοδοτημένος αντιπρόσωπος
  μπορεί να εγκρίνει μεταφορές
