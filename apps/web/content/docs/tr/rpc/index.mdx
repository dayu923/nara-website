...
title: Nara Solana RPC Metodları
seoTitle: "Nara Solana RPC Metodları: HTTP ve Websockets"
hideTableOfContents: false
h1: Nara Solana RPC Metodları ve Dokümantasyonu

---


HTTP ve Websocket metodları aracılığıyla JSON RPC API kullanarak Nara Solana
düğümleriyle doğrudan etkileşime geçin.

## Durum Taahhüdünü Yapılandırma

Uçuş öncesi kontroller ve işlem işleme için Nara Solana düğümleri, istemci tarafından
...
döndürebilir. Nara Solana düğümleri şu anda aşağıdaki yerel ve SPL programları için
