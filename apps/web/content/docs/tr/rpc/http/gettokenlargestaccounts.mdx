...
h1: getTokenLargestAccounts RPC Metodu

---


Belirli bir SPL Token türünün en büyük 20 hesabını döndürür.
...
Sorgulanacak token Mint'in base-58 kodlanmış dize olarak pubkey'i
...
Aşağıdakileri içeren JSON nesnelerinden oluşan bir dizi:

##### !! address

!type string

Token hesabının adresi

##### !! amount

!type string

Ondalık olmayan ham token account bakiyesi, u64'ün string gösterimi
...
Token account bakiyesi, mint tarafından belirlenen ondalık sayıları kullanır
**KULLANIMI BIRAKILMIŞTIR**

##### !! uiAmountString

!type string

Token account bakiyesi string olarak, mint tarafından belirlenen ondalık
sayıları kullanır
