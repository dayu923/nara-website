...
h1: getEpochSchedule RPC Metodu

---


Bu kümedeki epoch planı bilgilerini döndürür
...
Bir epoch'taki minimum slot sayısı,
...
Bir epoch başlamadan önce, o epoch için lider planını hesaplamak için gereken
slot sayısı.
...
Her epoch'taki maksimum slot sayısı.

##### !! warmup

!type bool

Epoch'ların kısa başlayıp büyüyüp büyümediği.
