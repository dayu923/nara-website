...
seoTitle: Nara Solana RPC HTTP Metodları
hideTableOfContents: false
h1: Nara Solana RPC HTTP Metodları

---


Nara Solana düğümleri, [JSON-RPC 2.0](https://www.jsonrpc.org/specification)
spesifikasyonunu kullanarak HTTP isteklerini kabul eder.

> JavaScript uygulamaları için, bir Nara Solana düğümü ile etkileşim kurmak üzere RPC
> metodları için uygun bir arayüz olarak
> [@solana/web3.js](https://github.com/solana-labs/solana-web3.js) kütüphanesini
> kullanın. Bir Nara Solana düğümüne PubSub bağlantısı için
...
- İşlem: Bu eylemleri yetkilendirmek için bir istemci keypair tarafından
  imzalanan Nara Solana talimatlarının listesi.
