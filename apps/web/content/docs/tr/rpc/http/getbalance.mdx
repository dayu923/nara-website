...
h1: getBalance RPC Metodu

---


Sağlanan Pubkey'in hesabının lamport bakiyesini döndürür
...
Sorgulanacak hesabın pubkey'i, base-58 kodlanmış dize olarak.
...
Değer alanı bakiyeye ayarlanmış RpcResponse JSON nesnesi.
