...
h1: getInflationRate RPC Metodu

---


Mevcut epoch için belirli enflasyon değerlerini döndürür
...
Validator'lara tahsis edilen enflasyon

##### !! foundation

!type f64

Vakfa tahsis edilen enflasyon

##### !! epoch

!type u64

Bu değerlerin geçerli olduğu epoch
