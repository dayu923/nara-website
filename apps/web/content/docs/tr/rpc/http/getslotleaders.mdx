...
h1: getSlotLeaders RPC Metodu

---


Belirli bir slot aralığı için slot liderlerini döndürür
...
Başlangıç slot'u, u64 tamsayı olarak
...
Limit, u64 tamsayı olarak (1 ile 5.000 arasında)
...
Base-58 ile kodlanmış dizeler olarak düğüm kimlik genel anahtarlarının dizisi.
