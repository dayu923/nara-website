...
h1: getInflationReward RPC Metodu

---


Bir epoch için adres listesinin enflasyon / stake ödülünü döndürür
...
Base-58 kodlu dizeler olarak sorgulanacak adres dizisi
...
Ödülün gerçekleştiği bir epoch. Belirtilmezse, önceki epoch kullanılacaktır
...
Sonuç alanı, aşağıdakileri içeren JSON nesne dizisi olacaktır:

##### !! epoch

!type u64

Ödülün gerçekleştiği epoch
...
Hesabın lamport cinsinden işlem sonrası bakiyesi

##### !! commission

!type u8 | undefined

Ödül alacaklandırıldığında oy hesabı komisyonu
