...
h1: minimumLedgerSlot RPC Metodu

---


Düğümün defterinde bilgi sahibi olduğu en düşük slot'u döndürür.

<Callout type="info">
  Eğer düğüm eski defter verilerini temizleyecek şekilde yapılandırılmışsa, bu
  değer zamanla artabilir
</Callout>
