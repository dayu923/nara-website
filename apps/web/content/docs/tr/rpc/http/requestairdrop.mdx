...
h1: requestAirdrop RPC Metodu

---


Bir Pubkey'e lamport airdrop'u talep eder
...
Lamport alacak hesabın pubkey'i, base-58 kodlu bir dize olarak
...
Airdrop edilecek lamport miktarı
...
Airdrop'un işlem imzası, base-58 kodlu bir dize olarak
