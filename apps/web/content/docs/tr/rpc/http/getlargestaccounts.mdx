...
h1: getLargestAccounts RPC Metodu

---


Lamport bakiyesine göre en büyük 20 hesabı döndürür (sonuçlar iki saate kadar
...
Sonuçları hesap türüne göre filtrele
...
Sonuç, `value` değeri aşağıdakileri içeren nesnelerden oluşan bir diziye eşit
olan bir RpcResponse JSON nesnesi olacaktır:

##### !! address

!type string

Hesabın Base-58 ile kodlanmış adresi
