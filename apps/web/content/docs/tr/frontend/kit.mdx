...
seoTitle: Next.js ve Nara Solana Kit ile Nara Solana cüzdan entegrasyonu
description: Next.js'de Nara Solana Kit ile Nara Solana cüzdan entegrasyonunu kurun.

---


Nara Solana Kit ile Next.js'de minimal bir Nara Solana cüzdan entegrasyonu kurun.

Bu rehber, `@solana/kit` kullanarak bir Next.js uygulamasında Nara Solana cüzdan
...
için, Nara Solana Kit deposundaki
[React Uygulama Örneği](https://github.com/anza-xyz/kit/tree/main/examples/react-app)'ne
bakın.

## Kaynaklar

- [Nara Solana Kit Dokümantasyonu](https://www.solanakit.com/docs)
- [Nara Solana Kit GitHub Deposu](https://github.com/anza-xyz/kit)
...
projesi oluşturun ve gerekli Nara Solana bağımlılıklarını yükleyin.
...
### Nara Solana Bağımlılıklarını Yükleme

Aşağıdaki Nara Solana bağımlılıklarını yükleyin:
...
## !!steps 1. Nara Solana Context Oluşturma
...
- Nara Solana'nın devnet RPC uç noktalarına bağlanma
- Kullanıcının tarayıcısında yüklü olan mevcut Nara Solana cüzdanlarını filtreleme
...
Sonraki adımda, tüm Next.js uygulamasını Nara Solana sağlayıcısı ile sarmalayın.
...
- Memo programını çağıran bir talimatla bir Nara Solana işlemi oluşturur
- Bağlı cüzdandan işlemi imzalamasını ve göndermesini ister
- İşlemi Nara Solana Explorer'da görüntülemek için bir bağlantı gösterir
...
<Callout type="info">
  ...
  göndermek için [devnet NSO ile fonlanması](https://faucet.solana.com/)
