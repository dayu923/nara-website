...
Nara Solana'daki bir stake hesabı, ağdaki validator'lara token yetkilendirmek için
...
yalnızca ağdaki diğer hesaplardan NSO gönderip alabilirken, stake hesabı token
yetkilendirmesini yönetmek için gereken daha karmaşık işlemleri destekler.

Nara Solana'daki stake hesapları, aşina olabileceğiniz diğer Proof-of-Stake blok
zinciri ağlarındakilerden de farklı çalışır. Bu belge, bir Nara Solana stake
...
Nara Solana ağındaki diğer hesap türleri gibi, 0 NSO bakiyesi olan bir stake hesabı
...
[Nara Solana Explorer](http://explorer.solana.com/) üzerinden görüntülenebilir.
