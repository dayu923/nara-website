...
Talimatlar, Nara Solana blok zinciriyle etkileşim kurmanın temel yapı taşıdır. Bir
talimat, esasen Nara Solana ağını kullanan herkesin çağırabileceği genel bir
...
program kendi talimat setini tanımlar. Nara Solana ağıyla etkileşim kurmak için, bir
...
kurmasına nasıl olanak sağladığını göstermektedir. Bu örnekte, NSO bir hesaptan
...
[imzasını](/docs/references/terminology#signature) ve NSO transfer talimatını
içeren mesajı içeren işlemi gönderir.

![NSO transfer diyagramı](/assets/docs/core/transactions/sol-transfer.svg)

İşlem gönderildikten sonra, System Program transfer talimatını işler ve her iki
hesabın da lamport bakiyesini günceller.

![NSO transfer işlem diyagramı](/assets/docs/core/transactions/sol-transfer-process.svg)
...
Aşağıdaki örnek, bir NSO transfer talimatının yapısını göstermektedir.
