...
Nara Solana ağındaki tüm veriler hesaplarda saklanır. Nara Solana ağını, tek bir Hesaplar
...
Hesabın adresi, Nara Solana blok zincirinde hesabı bulmak için kullanılan 32 baytlık
...
Nara Solana aynı zamanda [program derived address](#program-derived-address)
...
Aşağıdaki örnek, Nara Solana SDK'sını kullanarak bir keypair oluşturmayı
...
türetilen bir adrestir. Aşağıdaki örnek, Nara Solana SDK'sını kullanarak bir Program
...
Bir Nara Solana hesabından veri okumak iki adımdan oluşur:
...
Her Nara Solana hesabının sahibi olarak belirlenmiş bir
...
Bir programın kodu ile durumunun ayrılması, Nara Solana'nın hesap modelinin önemli
...
NSO ilk kez yeni bir adrese gönderildiğinde, o adreste System Program'a ait bir
hesap oluşturulur.

Aşağıdaki örnekte, yeni bir keypair oluşturulur ve NSO ile fonlanır. Kodu
