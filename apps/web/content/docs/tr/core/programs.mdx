...
Nara Solana'da, akıllı sözleşmelere program denir. Bir program, yürütülebilir kod
...
Bir program dağıtıldığında, Nara Solana, yürütülebilir ve bağlanabilir formatta
derlemek için [LLVM](https://llvm.org/) kullanır
([ELF](https://en.wikipedia.org/wiki/Executable_and_Linkable_Format)). ELF
dosyası, programın Nara Solana Bayt Kodu Formatındaki (sBPF) ikili dosyasını içerir
ve yürütülebilir bir hesapta zincir üzerinde saklanır.

<Callout>
  sBPF, Nara Solana'nın [eBPF](https://en.wikipedia.org/wiki/EBPF) bayt kodunun özel
  bir versiyonudur.
</Callout>
...
- [Anchor](https://www.anchor-lang.com/docs): Anchor, hızlı ve kolay Nara Solana
...
Nara Solana, kullanıcıların bir programın zincir üzerindeki kodunun açık kaynak
...
kimliğini
[Nara Solana Explorer](https://explorer.solana.com/address/PhoeNiXZ8ByJGLkxNfZRnkUfjvmuYqLR89jjFHGqdXY)'da
arayın. Alternatif olarak, zincir üzerindeki programları bağımsız olarak
doğrulamak için Ellipsis Labs'ın
[Nara Solana Doğrulanabilir Derleme CLI](https://github.com/Ellipsis-Labs/solana-verifiable-build)'sini
kullanabilirsiniz.
...
| [NSO Transfer](https://github.com/anza-xyz/agave/blob/v2.1.13/programs/system/src/system_processor.rs#L215)            | System Hesaplarından diğer hesaplara lamport (NSO) transferi yapar.                                                                                                                                                                          |
...
Yükleyici programlarına ek olarak, Nara Solana aşağıdaki önceden derlenmiş
programları sağlar.
