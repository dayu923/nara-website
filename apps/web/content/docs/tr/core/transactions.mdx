...
Nara Solana ağıyla etkileşim kurmak için bir işlem göndermeniz gerekir. Bir işlemi,
...
<Callout>
  ...
  sağlamak için Nara Solana, 1280 bayt (IPv6 için gereken minimum MTU) eksi 48 bayt
...
Aşağıdaki örnek, tek bir NSO transfer talimatı içeren bir işlemin yapısını
göstermektedir.
...
<Callout>
  İşlemi [Nara Solana Explorer](https://explorer.solana.com) kullanarak da
  bulabilirsiniz.
</Callout>
