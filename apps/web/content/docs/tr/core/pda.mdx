...
Bir Nara Solana [hesap adresi](/docs/core/accounts#account-address), hesabın blok
...
Nara Solana çalışma zamanı, programların özel bir anahtar gerektirmeden PDA'lar için
...
gerçekleştiremeyeceği anlamına gelir. (İmza sağlamak gibi.) Ancak, Nara Solana,
...
Nara Solana SDK'ları, aşağıdaki tabloda gösterilen fonksiyonlarla PDA oluşturulmasını
...
Aşağıdaki örnekler, Nara Solana SDK'larını kullanarak bir PDA türetmektedir. Kodu
