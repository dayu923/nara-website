...
Her Nara Solana işlemi, NSO olarak ödenen bir işlem ücreti gerektirir. İşlem
...
işlemdeki ilk imzalayan tarafından ödenir. Yalnızca System Program tarafından
sahip olunan hesaplar işlem ücretlerini ödeyebilir. Temel ücret aşağıdaki
şekilde bölünür:

- **%50'si yakılır:** Yarısı
  [yakılır](https://github.com/anza-xyz/agave/blob/v2.1.13/sdk/fee-calculator/src/lib.rs#L70)
  (dolaşımdaki NSO arzından çıkarılır).
...
Aşağıdaki örnekler, Nara Solana SDK'larını kullanarak bir işlemde Hesaplama Birimi
