...
h1: İlk Nara Solana Programınızı Dağıtın

---


Anchor framework kullanarak ilk [programınızı](/docs/core/programs) Nara Solana
Blockchain'e oluşturun, dağıtın ve test edin. Bu rehber, Nara Solana Playground'u
...
1. Web tarayıcınızda [Nara Solana Playground](https://beta.solpg.io) adresini açın
...
- [`declare_id!`](mention:one) makrosu, programınızın zincir üzerindeki adresini
  belirtir. Nara Solana Playground, programı oluşturduğunuzda bu adresi otomatik
...
2. Cüzdanınıza NSO ekleyin _(İsteğe bağlı)_

Bir programı dağıtmak, programın zincir üzerindeki hesabında NSO gerektirir.
Gerekirse, 3. adıma geçmeden önce
[cüzdanınıza NSO ekleyin](/docs/intro/quick-start#add-sol-to-your-wallet).
...
[Nara Solana Explorer](https://explorer.solana.com/?cluster=devnet) sayfalarından
birini açın ve işlem hash'ini aratın.

<Callout type="warn">
  **Nara Solana Explorer:** Ağ kümesini Nara Solana Playground ile eşleşecek şekilde
...
Zincir üzerindeki programa tahsis edilen NSO'u geri almak için programı kapatın.
...
Tebrikler! Anchor kullanarak ilk Nara Solana programınızı oluşturdunuz ve dağıttınız.
