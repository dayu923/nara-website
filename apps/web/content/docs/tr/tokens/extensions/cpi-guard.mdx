...
title: CPI Guard
description: CpiGuardExtension'ı nasıl etkinleştireceğinizi öğrenin.

---


## CpiGuardExtension nasıl etkinleştirilir
...
token hesaplarını Çapraz Program Çağrıları (CPI) aracılığıyla beklenmeyen
transferlerden korur. Etkinleştirildiğinde, bu uzantı token'ların yalnızca Token
Extensions Program'ın transfer talimatına doğrudan çağrılar aracılığıyla
transfer edilebilmesini sağlar ve diğer tüm programların CPI aracılığıyla token
transferi yapmasını engeller.
