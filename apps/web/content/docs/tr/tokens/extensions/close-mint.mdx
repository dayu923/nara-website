...
title: Mint'i Kapat
description: MintCloseAuthority uzantısını nasıl etkinleştireceğinizi öğrenin.

---


## MintCloseAuthority uzantısını nasıl etkinleştirirsiniz
...
uzantısı, mint hesaplarının kapatılmasına ve rent ücretlerinin geri alınmasına
olanak tanır. Bu uzantı, mint oluşturulduğunda başlatılmalıdır.

Mint hesabını yalnızca belirlenen kapatma yetkilisi kapatabilir. Token
hesaplarının yalnızca token bakiyesi sıfır olduğunda kapatılabilmesine benzer
şekilde, bu uzantıya sahip mint hesapları yalnızca tüm token arzı sıfıra
düşürüldüğünde kapatılabilir.
