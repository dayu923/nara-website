...
description: DefaultAccountStateExtension'ı nasıl etkinleştireceğinizi öğrenin.

---


## DefaultAccountStateExtension'ı nasıl etkinleştirirsiniz
...
bir mint için oluşturulan tüm yeni token account'lar için varsayılan bir durum
belirler. Bu uzantı etkinleştirildiğinde, her yeni token account otomatik olarak
dondurulmuş gibi belirli bir durumla başlatılır. Bu, token oluşturucularının,
açıkça çözülene kadar tüm yeni hesapların varsayılan olarak dondurulması gibi
belirli davranışları uygulamasına olanak tanır.
