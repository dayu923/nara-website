...
description:
  GroupPointerExtension ve GroupMemberPointerExtension'ı nasıl
  etkinleştireceğinizi öğrenin.

---


## GroupPointerExtension ve GroupMemberPointerExtension nasıl etkinleştirilir
...
bir mint'i güncelleme yetkisi ve maksimum boyut gibi
[grup yapılandırmalarını](https://github.com/solana-program/token-2022/blob/6f2473344d70271f632c3e9b7e945be00186c536/interface/src/instruction.rs#L718)
içeren bir hesaba işaret ederek grup mint'i (Koleksiyon NFT'si gibi) olarak
belirler.
...
bir mint'i grup adresi ve üye numarası gibi
[üyelik verilerini](https://github.com/solana-program/token-group/blob/3b4ff305452fa35754206fc1ad4addb2e2bff511/interface/src/state.rs#L67)
içeren bir hesaba işaret ederek üye mint'i (bir koleksiyondaki NFT gibi) olarak
belirler.

Token Extensions Program,
[Token Group Interface](https://github.com/solana-program/token-group)'i
doğrudan uygulayarak hem grup hem de üye verilerinin mint hesabının kendisinde
saklanmasına olanak tanır. İşaretçi uzantıları mint'in kendisine işaret
ettiğinde,
...
uzantıları, tüm koleksiyon ve üyelik verilerini mint hesabında depolamak için
kullanılabilir.
