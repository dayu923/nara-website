...
description: MemoTransferExtension'ı nasıl etkinleştireceğinizi öğrenin.
...
bir token account üzerinde etkinleştirildiğinde, gelen tüm token transferlerinin
beraberinde bir memo içermesini gerektirir. Bu uzantı, token account sahibi
tarafından etkinleştirilebilir veya devre dışı bırakılabilir.
