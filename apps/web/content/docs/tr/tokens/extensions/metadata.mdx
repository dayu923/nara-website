...
title: Metadata ve Metadata İşaretçi Uzantıları
description:
  MetadataPointerExtension ve TokenMetadata uzantısını nasıl
  etkinleştireceğinizi öğrenin.

---


## MetadataPointerExtension ve TokenMetadata uzantısını nasıl etkinleştirirsiniz
...
bir mint hesabının metadata hesabının adresini belirtmesini sağlar. Bu işaretçi,
[Token Metadata Interface](https://github.com/solana-program/token-metadata/tree/main)
uygulayan bir program tarafından sahip olunan herhangi bir hesaba referans
verebilir ve metadata'nın nerede saklanacağı konusunda esneklik sağlar.

Token Extensions Program, doğrudan
[Token Metadata Interface](https://github.com/solana-program/token-metadata/blob/main/interface/src/instruction.rs)
uygulamasını gerçekleştirir ve metadata'nın mint hesabının kendisinde
saklanmasına olanak tanır. Bu, token'ın adını, sembolünü, URI'sini ve ek
açıklayıcı verileri içerir. İşaretçi uzantıları mint'in kendisine işaret
ettiğinde,
...
uzantıları tüm metadata'yı mint hesabında saklamak için kullanılabilir.
