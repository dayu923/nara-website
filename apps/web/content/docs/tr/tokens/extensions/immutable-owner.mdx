...
description: ImmutableOwner Uzantısını nasıl etkinleştireceğinizi öğrenin.

---


## ImmutableOwner Uzantısını nasıl etkinleştirirsiniz
...
uzantısı, token account'ları için sahiplik değişikliklerini engeller. Bir token
account bu uzantı ile başlatıldığında, belirlenen sahip kalıcıdır ve başka bir
hesaba aktarılamaz.
