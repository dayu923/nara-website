...
description: InterestBearingMintExtension'ı nasıl etkinleştireceğinizi öğrenin.

---


## InterestBearingExtension nasıl etkinleştirilir
...
bir mint account üzerinde doğrudan faiz oranı belirlemenize olanak tanır. Faiz,
ağ zaman damgasına göre sürekli olarak bileşik şekilde işler, ancak her token
account'ta saklanan gerçek token bakiyesi değişmez. Toplam değer (token bakiyesi
artı tahakkuk eden faiz) sadece bir hesaplamadır. Bu uzantı ile yeni tokenler
mint edilmez.
