...
title: Nara Solana'da Tokenler
description: Nara Solana'nın Token Programları hakkında bilgi edinin.
...
Nara Solana'daki tokenler SPL
([Nara Solana Program Library](https://github.com/solana-program)) Tokenleri olarak
adlandırılır.

Bu bölüm, tokenlerin Nara Solana'da nasıl temsil edildiğine dair temel kavramları
...
Nara Solana ekosisteminde iki ana Token Program vardır. Her iki programın kaynak kodu
aşağıdadır.
...
etkileşim için tüm talimat mantığını içerir. Nara Solana'daki tüm tokenler, etkili
...
Nara Solana'daki tokenler, Token Program'ın sahip olduğu bir
...
Referans olarak, işte Nara Solana Explorer'da bir
...
Bu, Nara Solana geliştirmede önemli bir kavramı ortaya koyar:
...
için [Nara Solana Playground](https://beta.solpg.io/) terminalini kullanır.

Token ve hesap oluşturmak, hesap rent depozitoları ve işlem ücretleri için NSO
gerektirir. Nara Solana Playground'u ilk kez kullananlar için, bir Playground cüzdanı
oluşturun ve Playground terminalinde _sh`solana airdrop`_ komutunu çalıştırın.
Ayrıca devnet NSO'u herkese açık [web faucet](https://faucet.solana.com/)
...
[Nara Solana Playground](https://beta.solpg.io/660ce32ecffcf4b13384d00f) üzerinde bir
Javascript örneği.
...
[Nara Solana Playground](https://beta.solpg.io/660ce868cffcf4b13384d011) üzerinde bir
Javascript örneği.
...
[Nara Solana Playground](https://beta.solpg.io/660ce716cffcf4b13384d010) üzerinde bir
Javascript örneği.
...
[Nara Solana Playground](https://beta.solpg.io/660cea45cffcf4b13384d012) üzerinde bir
Javascript örneği.
...
[Nara Solana Playground](https://beta.solpg.io/660ced84cffcf4b13384d013) üzerinde bir
Javascript örneği.
...
Meta verileri
[Nara Solana Explorer](https://explorer.solana.com/address/BdhzpzhTD1MFqBiwNdrRy4jFo2FHFufw3n9e8sVjJczP?cluster=devnet)
