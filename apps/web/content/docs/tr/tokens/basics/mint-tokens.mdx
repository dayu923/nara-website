...
title: Token basma
description: Bir tokenin yeni birimlerini nasıl basacağınızı öğrenin.
...
Token basma işlemi, tokenin yeni birimlerini
...
talimatını kullanarak oluşturur.

- Yalnızca basım yetkilisi yeni token basabilir
- Basılan tokenleri almak için bir hedef token account mevcut olmalıdır
...
<Callout type="info">
  ...
  aynı işlevselliği sağlamak için benzer uygulamaları paylaşır.
</Callout>
