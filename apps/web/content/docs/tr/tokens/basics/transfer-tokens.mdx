...
description: Token hesapları arasında token transferi yapmayı öğrenin.

---


## Token Nasıl Transfer Edilir

Token transferleri, aynı mint'e ait token hesapları arasında tokenleri taşımak
için
...
- Her iki token hesabı da aynı token türünü (mint) içermelidir
- Sadece kaynak hesap sahibi veya yetkilisi transferleri onaylayabilir
