...
title: Token Hesabını Kapat
description: Token hesaplarını nasıl kapatacağınızı öğrenin.
...
talimatı, bir token hesabını kalıcı olarak kapatır ve kalan tüm NSO'u (rent)
belirtilen hedef hesaba aktarır. Token hesabı kapatılmadan önce bakiyesi sıfır
olmalıdır. Bu talimatı yalnızca token hesabı sahibi veya belirlenmiş kapatma
yetkisine sahip kişi yürütebilir.
