...
title: Hesabı Dondur
description: Token hesaplarını nasıl donduracağınızı öğrenin.
...
talimatı, belirli bir token account'tan tüm token transferlerini veya token
yakımlarını engeller. Dondurulduktan sonra, hesap çözülene kadar token
gönderemez, token alamaz veya kapatılamaz. Yalnızca token'ın mint'inin dondurma
yetkisi hesapları dondurabilir. Mint account üzerindeki dondurma yetkisi iptal
edilirse (null olarak ayarlanırsa), token'lar asla dondurulamaz.
