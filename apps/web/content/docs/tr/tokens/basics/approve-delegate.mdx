...
title: Temsilci Onaylama
description: Bir token hesabı için temsilcileri nasıl onaylayacağınızı öğrenin.

---


## Temsilci nasıl onaylanır
...
talimatı, başka bir hesaba (temsilci) token hesabınızdan belirli miktarda token
transfer etme izni verir. Temsilci, onaylanan miktara kadar token transfer
edebilir, ancak bu miktarı aşamaz. Yalnızca token hesabı sahibi bir temsilci
onaylayabilir ve her token hesabının aynı anda yalnızca bir temsilcisi olabilir.
Herhangi bir yeni onay, öncekinin üzerine yazar.
