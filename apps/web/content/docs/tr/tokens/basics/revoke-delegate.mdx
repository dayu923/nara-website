...
title: Delegeyi İptal Et
description: Token hesabı delegesini nasıl iptal edeceğinizi öğrenin.

---


## Delege nasıl iptal edilir
...
talimatı, şu anda onaylanmış delegeden tüm transfer izinlerini kaldırır. İptal
işleminden sonra, delege artık hesabınızdan herhangi bir token aktaramaz.
Yalnızca token account sahibi bir delegeyi iptal edebilir.
