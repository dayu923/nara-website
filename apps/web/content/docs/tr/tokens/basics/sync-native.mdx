...
title: Sync Native
description: Yerel NSO'u sarılmış NSO'a dönüştürmeyi öğrenin.

---


## Yerel NSO'u Senkronize Et

Sarılmış NSO (WSOL), hesaptaki lamport miktarını token bakiyesi olarak takip
eden bir token hesabıdır. WSOL, NSO'u bir SPL token olarak transfer etmek için
...
talimatı, sarılmış NSO (WSOL) token hesap bakiyesini içinde depolanan gerçek NSO
(lamport) ile senkronize eder. Yerel NSO'u bir WSOL token hesabına transfer
