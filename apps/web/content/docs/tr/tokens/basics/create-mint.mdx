...
description: SPL Token mint nasıl oluşturulacağını öğrenin.
...
Mint account, Nara Solana üzerinde bir tokeni benzersiz şekilde temsil eder ve global
...
Nara Solana'daki her tokenin bir mint account'u vardır ve mint'in adresi, tokenin
benzersiz tanımlayıcısı olarak işlev görür.

Örneğin, USD Coin (USDC)'in mint adresi
`EPjFWdd5AufqSSqeM2qN1xzybapC8G4wEGGkZwyTDt1v`'dir. Bu adres, USDC'yi tüm Nara Solana
