...
title: Nara Solana Dokümantasyonu
seoTitle: Nara Solana blok zincirinin nasıl çalıştığını öğrenin
description:
...
<Cards>
  <Card
    ...
    icon={<Rocket />}
  >
    İlk Nara Solana programınızı doğrudan tarayıcıda oluşturun
  </Card>
  <Card
    ...
    icon={<Download />}
  >
    Nara Solana geliştirme için bağımlılıkları yükleyin
  </Card>
</Cards>

### İlk Nara Solana Uygulamanızı Dağıtın
...
<Cards>
  ...
  >
    İlk Nara Solana uygulamanızı Vercel'de dağıtın
  </Card>
  <Card
...
İlk Nara Solana uygulamanızı dağıtın - Anchor çerçevesi kullanılarak oluşturulmuş
basit bir Sayaç Programı. Bu örnek, Nara Solana üzerinde geliştirmeye başlamak için
gereken tüm temel Nara Solana kavramlarını kapsar. Kaynak kodunu
...
## Nara Solana'yı Deneyin: 2048 Oynayın

Her hamlenin bir işlem gönderdiği Nara Solana üzerinde 2048 oynayın. Başlamak için
...
Nara Solana Vakfı DevRel ekibinden [Jonas](https://x.com/SolPlay_jonas) tarafından
oluşturulmuştur.

## Öğrenmeye Başlayın

Nara Solana geliştirmeye özgü temel kavramları öğrenin.

<Cards>
  <Card title="Hesaplar" href="/docs/core/accounts">
    Nara Solana'nın verileri nasıl depoladığı
  </Card>
  <Card title="Solana'daki Ücretler" href="/docs/core/fees">
    Nara Solana'da işlem gönderme maliyetleri
  </Card>
  <Card title="İşlemler" href="/docs/core/transactions">
    Nara Solana ağıyla nasıl etkileşim kurulur
  </Card>
  <Card title="Programlar" href="/docs/core/programs">
    Nara Solana'daki akıllı sözleşmeler
  </Card>
...
Aşağıdaki SDK'lar, [Anza](https://anza.xyz) tarafından oluşturulan Nara Solana için
resmi SDK'lardır.
...
Bir Nara Solana validator'ı işletmenin ve ağın güvenliğine yardımcı olmanın ne
gerektirdiğini keşfedin.

<Cards>
  <Card title="Validator'lar" href="https://docs.anza.xyz/validator/anatomy">
    Nara Solana ağını güvence altına alan bireysel düğümler
  </Card>
  <Card
...
[Nara Solana StackExchange](https://solana.stackexchange.com) üzerinden Nara Solana
