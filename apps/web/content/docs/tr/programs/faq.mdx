...
Nara Solana zincir üstü programları, [LLVM derleyici altyapısı](https://llvm.org/)
aracılığıyla
...
Nara Solana LLVM derleyici altyapısını kullandığı için, bir program LLVM'nin BPF arka
...
Nara Solana SBF programları tarafından kullanılan sanal adres bellek haritası
