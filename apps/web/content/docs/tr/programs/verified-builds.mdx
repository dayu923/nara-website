...
Bu kılavuz, Nara Solana üzerindeki programları için doğrulanmış derlemeleri uygulamak
...
Doğrulanmış derlemeler, Nara Solana ağına dağıttığınız çalıştırılabilir programın,
...
Programınızı Nara Solana Verify CLI ve Docker kullanarak kontrollü bir ortamda
...
Nara Solana ağına dağıtabilirsiniz. Derleme süreci sırasında
...
olasılıkla başarısız olacaktır çünkü Nara Solana program yapıları farklı sistemlerde
...
### Nara Solana Verify CLI'yi yükleyin

Nara Solana Verify CLI, yapıları doğrulamak için kullanılan temel araçtır. Nara Solana
...
Nara Solana programınızı doğrulanabilir şekilde oluşturmak için, çalışma alanınızın
...
Programınızı derledikten ve hash değerini aldıktan sonra, Nara Solana ağına
...
> Farklı [Nara Solana kümelerinde](/docs/references/clusters) (yani devnet, testnet,
> mainnet) farklı sürümler dağıtmış olabilirsiniz. Bir programa karşı doğrulamak
> istediğiniz Nara Solana kümesi için doğru ağ URL'sini kullandığınızdan emin olun.
...
istemediğiniz sorulacaktır. Bunu yaparsanız, Nara Solana Explorer hemen programınızın
...
[Nara Solana Explorer'da](https://explorer.solana.com/address/PhoeNiXZ8ByJGLkxNfZRnkUfjvmuYqLR89jjFHGqdXY/verified-build),
...
ve son olarak daha sağlıklı bir Nara Solana ekosistemine katkıda bulunan
...
[Nara Solana'daki doğrulanmış yapıları](/developers/guides/advanced/verified-builds)
kullanmak, ağdaki programlarınızın bütünlüğünü ve güvenilirliğini sağlar ve
geliştiricilerin SDK'larınızı doğrudan Nara Solana Explorer'dan bulmalarına olanak
tanır. Nara Solana Verify CLI ve Docker gibi araçları kullanarak, kaynak kodunuzla
...
Doğrulanmış yapılar, Nara Solana programlarınızın bütünlüğünü sağlamak için güçlü bir
araç olsa da, varsayılan kurulumda tamamen güvensiz değildir. Docker imajları
Nara Solana Vakfı tarafından oluşturulur ve barındırılır.
...
[Nara Solana Explorer'a](https://explorer.solana.com/address/PhoeNiXZ8ByJGLkxNfZRnkUfjvmuYqLR89jjFHGqdXY)
belirli bir dereceye kadar güveniyorsunuz.

API veya Nara Solana Explorer, ele geçirilirse potansiyel olarak yanlış bilgiler
gösterebilir.
...
Nara Solana Vakfı, OtterSec ve Ellipsis Labs ekibi, doğrulanmış derleme hattının
kullanımından kaynaklanabilecek herhangi bir kayıp veya hasardan sorumlu
değildir.

# Nara Solana programları için security.txt
...
doğrudan Nara Solana akıllı sözleşmelerine gömmelerine olanak tanır.
...
Nara Solana programınıza bir `security.txt` eklemek için aşağıdaki adımları izleyin:
...
`security.txt` bilgileri programınıza gömüldükten sonra, Nara Solana Explorer gibi
...
size ulaşmasını kolaylaştırır, Nara Solana ekosistemi içinde daha iyi güvenlik ve
iletişimi teşvik edersiniz.

Bu,
[Nara Solana Explorer'da security.txt'in nasıl göründüğüne dair bir örnektir](https://explorer.solana.com/address/HPxKXnBN4vJ8RjpdqDCU7gvNQHeeyGnSviYTJ4fBrDt4/security?cluster=devnet)
