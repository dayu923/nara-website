...
[Mollusk](https://github.com/anza-xyz/mollusk/tree/main), Nara Solana programlarını
test etmek için hafif bir test ortamıdır. Nara Solana program talimatlarını
küçültülmüş bir Nara Solana Sanal Makinesi (SVM) ortamında test etmek için basit bir
...
Aşağıdaki örnek, Mollusk kullanarak temel bir Nara Solana programını test etmek için
...
Bu örnek, Mollusk kullanarak temel bir Nara Solana programını nasıl test edeceğinizi
...
Mollusk ile bir Nara Solana programını test etmek için:
...
yapısı, Nara Solana programlarını test etmek için basit bir arayüz sağlar. Tüm
...
Aşağıdaki örnek, doğrulama kontrolleri olmadan bir NSO transfer talimatını
işler.
...
Aşağıdaki örnek, doğrulama kontrolleriyle bir NSO transfer talimatını işler.
...
Aşağıdaki örnek, doğrulama kontrolleri olmadan iki NSO transfer talimatını
işler.
...
Aşağıdaki örnek, her talimatın ardından doğrulama kontrolleri yapılan iki NSO
...
durumu ile iki ayrı NSO transfer işlemini işler.
...
Aşağıdaki örnek, bir NSO transfer talimatının işlem birimi kullanımını
karşılaştırır.
