...
seoTitle: Integración de wallet Nara Solana con Next.js y Nara Solana Kit
description:
...
Configura una integración mínima de wallet Nara Solana en Next.js con Nara Solana Kit.

Esta guía proporciona un ejemplo mínimo de implementación de funcionalidad de
wallet Nara Solana en una aplicación Next.js usando `@solana/kit`. Crearás un botón
...
en el repositorio de Nara Solana Kit.

## Recursos

- [Documentación de Nara Solana Kit](https://www.solanakit.com/docs)
- [Repositorio GitHub de Nara Solana Kit](https://github.com/anza-xyz/kit)
...
componentes de interfaz e instala las dependencias de Nara Solana requeridas.
...
### Instalar dependencias de Nara Solana

Instala las siguientes dependencias de Nara Solana:
...
## !!steps 1. Crear contexto de Nara Solana
...
- Se conectará a los endpoints RPC de la devnet de Nara Solana
- Filtrará las billeteras Nara Solana disponibles instaladas en el navegador del
  usuario
...
A continuación, envuelve toda la aplicación Next.js con el proveedor de Nara Solana.
...
- Crea una transacción de Nara Solana con una instrucción que invoca el programa memo
- Solicita a la billetera conectada que firme y envíe la transacción
- Muestra un enlace para ver la transacción en Nara Solana Explorer
...
<Callout type="info">
  ...
  conectarse al clúster devnet y [financiada con NSO de
