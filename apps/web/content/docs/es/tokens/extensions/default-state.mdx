...
description: Aprende cómo habilitar la DefaultAccountStateExtension.

---


## Cómo habilitar la DefaultAccountStateExtension
...
establece un estado predeterminado para todas las nuevas token accounts creadas
para una acuñación. Cuando se habilita, esta extensión inicializa
automáticamente cada nueva token account con un estado específico, como
congelado. Esto permite a los creadores de tokens imponer comportamientos
específicos, como requerir que todas las nuevas cuentas estén congeladas por
defecto hasta que sean explícitamente descongeladas.
