...
description: Aprende cómo habilitar la extensión ImmutableOwner.

---


## Cómo habilitar la extensión ImmutableOwner
...
evita cambios de propiedad para las token account. Cuando una token account se
inicializa con esta extensión, el propietario designado es permanente y no puede
ser transferido a otra cuenta.
