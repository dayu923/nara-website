...
title: CPI Guard
description: Aprende cómo habilitar la CpiGuardExtension.

---


## Cómo habilitar la CpiGuardExtension
...
protege las cuentas de tokens contra transferencias inesperadas a través de
Invocaciones de Programas Cruzados (CPIs). Cuando está habilitada, esta
extensión asegura que los tokens solo puedan ser transferidos mediante llamadas
directas a la instrucción de transferencia del Token Extensions Program,
bloqueando a todos los demás programas de transferir tokens a través de CPI.
