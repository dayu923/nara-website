...
title: Cerrar Mint
description: Aprende cómo habilitar la extensión MintCloseAuthority.

---


## Cómo habilitar la extensión MintCloseAuthority
...
extensión permite que las mint account se cierren y se recupere su rent. Esta
extensión debe inicializarse cuando se crea el mint.

Solo la autoridad de cierre designada puede cerrar la mint account. De manera
similar a cómo las cuentas de token solo pueden cerrarse cuando el saldo de
tokens es cero, las mint account con esta extensión solo pueden cerrarse cuando
todo el suministro de tokens se ha reducido a cero.
