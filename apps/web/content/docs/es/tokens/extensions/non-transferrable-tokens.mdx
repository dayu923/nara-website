...
title: Tokens no transferibles
description: Aprende cómo habilitar el InitializeNonTransferableMint.

---


## Cómo habilitar la extensión InitializeNonTransferableMint
...
impide que los tokens sean transferidos entre token accounts después de ser
acuñados. Una vez acuñados, los tokens permanecen permanentemente en el token
account. Sin embargo, el propietario del token account todavía puede quemar
tokens y cerrar el token account cuando el saldo llegue a cero.
