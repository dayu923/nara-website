...
description: Aprende cómo implementar la TransferFeeExtension.

---


## Cómo implementar la TransferFeeExtension
...
permite la recolección automática de tarifas en cada transferencia de tokens.
Las tarifas se acumulan en las cuentas de tokens del destinatario y pueden ser
retiradas por la autoridad de retiro establecida en la mint account.
