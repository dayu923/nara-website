...
title: Transferencia con memo
description: Aprende cómo habilitar la MemoTransferExtension.

---


## Cómo habilitar la MemoTransferExtension
...
requiere que todas las transferencias de tokens entrantes incluyan un memo
adjunto cuando esté habilitada en una token account. Esta extensión puede ser
habilitada o deshabilitada por el propietario de la token account.
