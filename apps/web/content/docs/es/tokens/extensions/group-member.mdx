...
description:
  Aprende cómo habilitar GroupPointerExtension y GroupMemberPointerExtension.

---


## Cómo habilitar GroupPointerExtension y GroupMemberPointerExtension
...
designa una acuñación como una acuñación de grupo (como un NFT de Colección)
apuntando a una cuenta que contiene
[configuraciones de grupo](https://github.com/solana-program/token-group/blob/3b4ff305452fa35754206fc1ad4addb2e2bff511/interface/src/state.rs#L16)
como la autoridad de actualización y el tamaño máximo.
...
designa una acuñación como una acuñación miembro (como un NFT en una colección)
apuntando a una cuenta que contiene
[datos de membresía](https://github.com/solana-program/token-group/blob/3b4ff305452fa35754206fc1ad4addb2e2bff511/interface/src/state.rs#L67)
como la dirección del grupo y el número de miembro.

Token Extensions Program implementa la
[Interfaz de Grupo de Tokens](https://github.com/solana-program/token-group)
directamente, permitiendo que tanto los datos del grupo como los del miembro se
almacenen en la propia cuenta de acuñación. Cuando las extensiones de puntero
apuntan a la propia acuñación, las extensiones
...
pueden utilizarse para almacenar todos los datos de colección y membresía en la
cuenta de acuñación.
