...
title: Delegado permanente
description: Aprende cómo implementar la extensión InitializePermanentDelegate.

---


## Cómo implementar la extensión InitializePermanentDelegate
...
asigna un delegado irrevocable con autoridad sobre todas las token account para
una mint. A diferencia de los delegados regulares que los propietarios de token
account pueden revocar, un delegado permanente no puede ser cambiado ni
eliminado. El delegado permanente puede transferir, quemar y congelar tokens en
cualquier token account de esa mint.
