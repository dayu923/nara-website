...
# Soporte de la extensión de cantidad escalada de UI en Nara Solana
...
- Los servicios que proporcionan datos históricos deberían almacenar y **mostrar
...
- Las actualizaciones del multiplicador pueden incluir una marca de tiempo que
  esté en el pasado. Recomendamos usar la marca de tiempo del bloque para datos
  históricos.
- Tenga en cuenta que el multiplicador activo puede ser el "multiplicador" o el
  "nuevoMultiplicador" dependiendo de la marca de tiempo actual y cuándo se
