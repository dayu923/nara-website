...
<Callout type="warn">
  El ZK ElGamal Program está temporalmente deshabilitado en la mainnet y devnet
...
crear un mint de token con esta extensión habilitada.
...
3. **Inicializar Mint**: Invocar la instrucción
