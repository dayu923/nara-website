...
description: Aprende cómo habilitar la InterestBearingMintExtension.

---


## Cómo habilitar la InterestBearingExtension
...
te permite establecer una tasa de interés directamente en una mint account. El
interés se acumula continuamente según la marca de tiempo de la red, pero el
saldo real de tokens almacenado en cada token account permanece sin cambios. El
valor total (saldo de tokens más intereses acumulados) es solo un cálculo. No se
acuñan nuevos tokens con esta extensión.
