...
hasta la cantidad aprobada, pero no puede excederla. Solo el propietario de la
token account puede aprobar un delegado, y cada token account puede tener solo
un delegado a la vez. Cualquier nueva aprobación sobrescribe la anterior.
