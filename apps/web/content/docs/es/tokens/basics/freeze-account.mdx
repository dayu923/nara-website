...
description: Aprende cómo congelar token accounts.
...
evita todas las transferencias de tokens o quemado de tokens desde un token
account específico. Una vez congelada, la cuenta no puede enviar tokens, recibir
tokens o ser cerrada hasta que se descongele. Solo la autoridad de congelación
del mint del token puede congelar cuentas. Si la autoridad de congelación es
revocada (establecida como null) en el mint account, los tokens nunca podrán ser
congelados.
