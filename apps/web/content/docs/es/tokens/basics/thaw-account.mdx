...
description: Aprende cómo descongelar una cuenta de token congelada.
...
revierte una congelación, restaurando la funcionalidad completa a una token
account previamente congelada. Después de descongelar, la cuenta puede enviar y
recibir tokens normalmente de nuevo. Solo la autoridad de congelación del mint
del token puede descongelar cuentas.
