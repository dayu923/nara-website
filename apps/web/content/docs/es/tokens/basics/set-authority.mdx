...
title: Establecer autoridad
description:
  Aprende cómo establecer autoridad para mint accounts o token accounts.

---


## Entendiendo las autoridades de tokens

### Autoridades de mint account

- **Autoridad de emisión (Mint Authority)**: Controla la creación de nuevos
  tokens. Puede emitir tokens a cualquier token account. A menudo se revoca
  después de crear el suministro inicial para establecer un token con suministro
  fijo.
- **Autoridad de congelación (Freeze Authority)**: Controla la capacidad de
  congelar y descongelar token accounts. Puede impedir que cualquier token
  account transfiera tokens. A menudo se revoca para garantizar a los usuarios
  que sus tokens no pueden ser congelados.

### Autoridades de token account

- **Propietario de la cuenta (Account Owner)**: Tiene control total sobre el
  token account. Puede transferir tokens, quemar tokens, aprobar delegados y
  cerrar la cuenta cuando el saldo es cero.
- **Autoridad de cierre (Close Authority)**: Puede cerrar el token account
  cuando su saldo es cero. Por defecto, este es el propietario de la cuenta,
  pero puede delegarse a otra cuenta.

## Cómo establecer autoridad
...
cambia o revoca autoridades en mint accounts y token accounts. Solo la autoridad
actual puede transferir sus permisos a una nueva dirección o revocarlos
permanentemente estableciendo la autoridad como nula. Una vez revocada, la
autoridad no puede ser restaurada.
