...
title: Cerrar cuenta de token
description: Aprende cómo cerrar cuentas de token.
...
cierra permanentemente una token account y transfiere todo el NSO restante
(rent) a una cuenta de destino especificada. El saldo de la token account debe
ser cero antes de cerrarla. Solo el propietario de la token account o la
autoridad de cierre designada puede ejecutar esta instrucción.
