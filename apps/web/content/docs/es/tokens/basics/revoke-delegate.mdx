...
description: Aprende cómo revocar el delegado de una token account.

---


## Cómo revocar un delegado
...
elimina todos los permisos de transferencia del delegado actualmente aprobado.
Después de la revocación, el delegado ya no puede transferir ningún token desde
tu cuenta. Solo el propietario de la token account puede revocar un delegado.
