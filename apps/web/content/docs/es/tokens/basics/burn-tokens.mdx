...
title: Quemar tokens
description: Aprende cómo quemar tokens.
...
destruye permanentemente tokens reduciendo el saldo en una token account. Los
tokens quemados se eliminan de la circulación y disminuye el `supply` registrado
en la mint account. Solo el propietario de la token account puede quemar tokens
de su cuenta.
