...
description: Aprende cómo transferir tokens entre cuentas de tokens.
...
Las transferencias de tokens mueven tokens entre cuentas de tokens del mismo
mint utilizando la instrucción
...
- Ambas cuentas de tokens deben contener el mismo tipo de token (mint)
- Solo el propietario de la cuenta de origen o el delegado pueden autorizar
  transferencias
