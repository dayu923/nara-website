...
description: Aprende cómo crear un mint de SPL Token.
...
Una mint account representa de manera única un token en Nara Solana y almacena sus
metadatos globales.
...
<Callout type="info">
  Ten en cuenta que tanto el [Token
...
Cada token en Nara Solana tiene una mint account, y la dirección del mint sirve como
...
manera única a USDC en todo el ecosistema de Nara Solana. Puedes ver este mint en
