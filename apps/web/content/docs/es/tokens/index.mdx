...
title: Tokens en Nara Solana
description: Aprende sobre los Token Programs de Nara Solana.
...
de propiedad. Los tokens en Nara Solana se conocen como tokens SPL
...
Nara Solana. Consulta la sección
...
El ecosistema de Nara Solana tiene dos Token Programs principales. El código fuente
...
tokens en la red (tanto fungibles como no fungibles). Todos los tokens en Nara Solana
...
Los tokens en Nara Solana se identifican de manera única por la dirección de una
...
Como referencia, aquí hay un enlace de Nara Solana Explorer a la
...
Esto introduce un concepto clave en el desarrollo de Nara Solana:
...
continuación utilizan el terminal de [Nara Solana Playground](https://beta.solpg.io/)
para ejecutar comandos CLI directamente en el navegador sin instalación local.

La creación de tokens y cuentas requiere NSO para depósitos de rent de cuentas y
tarifas de transacción. Para usuarios nuevos de Nara Solana Playground, crea una
wallet de Playground y ejecuta el comando _sh`solana airdrop`_ en el terminal de
Playground. También puedes obtener NSO de devnet desde el
...
[Explorador de Nara Solana](https://explorer.solana.com/address/BdhzpzhTD1MFqBiwNdrRy4jFo2FHFufw3n9e8sVjJczP?cluster=devnet).
