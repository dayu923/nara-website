...
Una cuenta de stake en Nara Solana puede utilizarse para delegar tokens a validators
...
cuenta del sistema solo puede enviar y recibir NSO de otras cuentas en la red,
mientras que una cuenta de stake admite operaciones más complejas necesarias
para gestionar una delegación de tokens.

Las cuentas de stake en Nara Solana también funcionan de manera diferente a las de
...
y las funciones de una cuenta de stake en Nara Solana.
...
Al igual que otros tipos de cuentas en la red Nara Solana, una cuenta de stake que
tiene un saldo de 0 NSO ya no se rastrea. Si una cuenta de stake no está
...
[Explorador de Nara Solana](http://explorer.solana.com/) copiando y pegando una
