...
comenzar a usar [Anchor CLI](https://www.anchor-lang.com/docs).
...
continuación. Creará un nuevo directorio con el nombre del proyecto y lo
utilizará para inicializar un nuevo proyecto de Anchor.
...
2. Si la solución anterior no funciona, limpia la caché de Nara Solana:
...
<Callout>
  Cuando se usa el cluster `localnet`, Anchor inicia automáticamente un
  validator local, despliega el programa, ejecuta las pruebas y luego detiene el
  validator.
</Callout>
