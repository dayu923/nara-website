...
Esta guía te lleva a través de la construcción y prueba de un programa Nara Solana
...
[enlace de Nara Solana Playground](https://beta.solpg.io/66734b7bcffcf4b13384d1ad)
con el código inicial. Luego haz clic en el botón "Import" para añadir el
programa a tus proyectos de Nara Solana Playground.
...
<Callout type="info">
En este ejemplo, desplegarás el programa en la devnet, un clúster de Nara Solana
para pruebas de desarrollo.

La cartera del Playground se conecta a la devnet por defecto. Asegúrate de que
tu cartera del Playground tenga NSO de devnet para pagar por el despliegue del
programa. Obtén NSO de devnet desde el
...
Nara Solana Playground elimina parte de la configuración inicial donde
...
`update`, pasando "Hello, Nara Solana!" como el nuevo mensaje.
