...
Lee datos de la red de Nara Solana obteniendo diferentes cuentas. Esta sección te
ayudará a entender la estructura de las [cuentas](/docs/core/accounts) de
Nara Solana. Cada cuenta de Nara Solana tiene una
...
utilizan principalmente para almacenar NSO y firmar transacciones. Cuando se
envía NSO a una nueva dirección por primera vez, se crea automáticamente una
cuenta del sistema.

El ejemplo a continuación genera un [nuevo keypair](mention:keypair),
[solicita NSO](mention:airdrop) para financiar la nueva dirección de clave
...
El campo `lamports` contiene el saldo de NSO de la cuenta, en
...
[Explorador de Nara Solana](https://explorer.solana.com/address/TokenkegQfeZyiNwAJbNbGKPFXCWuBvf9Ss623VQ5DA).
...
la mint account identifica de manera única a un token en la red de Nara Solana.
...
los programas de Nara Solana proporcionan bibliotecas cliente con funciones
...
en el Explorador de Nara Solana.
