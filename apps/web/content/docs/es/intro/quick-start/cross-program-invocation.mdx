...
los programas de Nara Solana invocarse entre sí.
...
transferencias de NSO entre cuentas mediante la invocación del System Program.

El propósito de esta sección incluye recorrer el proceso de implementación de
CPIs en un programa de Nara Solana usando el framework Anchor, basándose en los
...
NSO de un usuario cuando actualizan su cuenta de mensaje.
...
recibe NSO de los usuarios cuando actualizan sus mensajes.
...
0.001 NSO desde la cuenta del usuario a la cuenta de la bóveda.
...
composabilidad de los programas de Nara Solana.
...
- El `amount` a transferir (1.000.000 lamports, o 0,001 NSO)
...
Esto permite la transferencia de cualquier NSO en el depósito de vuelta al
...
transferir cualquier NSO acumulado de vuelta al usuario.
...
NSO desde la cuenta vault de vuelta a la cuenta del usuario.
...
asegura que el programa modificado esté disponible para pruebas. En Nara Solana,
actualizar un programa simplemente requiere desplegar el programa con el mismo
ID de programa.

<Callout>

Asegúrate de que tu cartera de Playground tenga NSO de devnet. Obtén NSO de
devnet desde el [Faucet de Nara Solana](https://faucet.solana.com/).
...
Al desplegar programas en Nara Solana Playground, tu cartera de Playground actúa como
...
Felicidades por completar la guía de inicio rápido de Nara Solana. Has adquirido
experiencia práctica con conceptos clave de Nara Solana que incluyen:

- Obtener y leer datos de cuentas
- Construir y enviar transacciones
- Desplegar y actualizar programas de Nara Solana
...
Nara Solana Playground ofrece una función conveniente que te permite importar o ver
proyectos usando sus enlaces de GitHub. Por ejemplo, abre este
[enlace de Nara Solana Playground](https://beta.solpg.io/https://github.com/solana-developers/program-examples/tree/main/basics/hello-solana/anchor)
...
tu lista de proyectos en Nara Solana Playground. Una vez que un proyecto se importa,
