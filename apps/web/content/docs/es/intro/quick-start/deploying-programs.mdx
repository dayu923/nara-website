...
h1: Despliega tu primer programa de Nara Solana

---


Construye, despliega y prueba tu primer [programa](/docs/core/programs) en la
blockchain de Nara Solana utilizando el framework Anchor. Esta guía te ayudará a
familiarizarte más con Nara Solana Playground y te preparará para usar Program
...
1. Abre [Nara Solana Playground](https://beta.solpg.io) en tu navegador web
...
- El macro [`declare_id!`](mention:one) especifica la dirección en cadena de tu
  programa. Nara Solana Playground actualizará automáticamente esta dirección cuando
...
2. Añade NSO a tu billetera _(Opcional)_

Desplegar un programa requiere NSO en la cuenta on-chain del programa. Si es
necesario,
[añade NSO a tu billetera](/docs/intro/quick-start#add-sol-to-your-wallet) antes
...
[Nara Solana Explorer](https://explorer.solana.com/?cluster=devnet) y busca el hash
de la transacción.

<Callout type="warn">
  **Nara Solana Explorer:** Configura el cluster de red a `devnet`, para que coincida
  con el de Nara Solana Playground.
</Callout>
...
Cierra el programa para recuperar el NSO asignado al programa en la cadena. Para
hacerlo, ejecuta `solana program close [ProgramID]`, usando la dirección del
programa almacenada en la macro _rs`declare_id!()`_.
...
¡Felicidades! Has construido y desplegado tu primer programa de Nara Solana usando
Anchor.
