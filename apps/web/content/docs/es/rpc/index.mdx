...
title: Métodos RPC de Nara Solana
seoTitle: "Métodos RPC de Nara Solana: HTTP y Websockets"
hideTableOfContents: false
h1: Métodos RPC de Nara Solana y documentación

---


Interactúa directamente con los nodos de Nara Solana mediante la API JSON RPC a
...
los nodos de Nara Solana eligen qué estado del banco consultar basándose en un
...
propietario. Los nodos de Nara Solana actualmente admiten análisis JSON para los
