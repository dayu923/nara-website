...
h1: Estructuras de datos JSON comunes para métodos RPC de Nara Solana

---


Varios métodos RPC de Nara Solana devolverán respuestas más complejas como objetos
...
sobre las transacciones en Nara Solana.
...
El entorno de ejecución de Nara Solana registra las instrucciones entre programas que
