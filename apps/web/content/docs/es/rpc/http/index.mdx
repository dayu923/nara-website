...
title: Métodos HTTP
seoTitle: Métodos HTTP RPC de Nara Solana
hideTableOfContents: false
h1: Métodos HTTP RPC de Nara Solana

---


Los nodos de Nara Solana aceptan solicitudes HTTP utilizando la especificación
...
> Nara Solana. Para una conexión PubSub a un nodo de Nara Solana, utiliza la
...
- Transacción: Una lista de instrucciones de Nara Solana firmadas por un keypair de
