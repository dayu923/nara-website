...
Devuelve las 20 cuentas más grandes, por saldo en lamports (los resultados
pueden estar almacenados en caché hasta dos horas)
...
Filtrar resultados por tipo de cuenta
...
El resultado será un objeto JSON RpcResponse con `value` igual a un array de
...
Dirección de la cuenta codificada en Base-58

##### !! lamports

!type u64

Número de lamports en la cuenta
