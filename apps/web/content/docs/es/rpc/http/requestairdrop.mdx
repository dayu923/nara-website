...
Solicita un airdrop de lamports a una Pubkey
...
Pubkey de la cuenta que recibirá los lamports, como una cadena codificada en
base-58
...
Cantidad de lamports para el airdrop
...
Firma de transacción del airdrop, como una cadena codificada en base-58
