...
Slot final (no debe ser más de 500.000 bloques superior al `start_slot`)
...
Un array de enteros u64 que enumera los bloques confirmados entre `start_slot` y
sea `end_slot` - si se proporciona, o el último slot confirmado, inclusive. El
rango máximo permitido es de 500.000 slots.
