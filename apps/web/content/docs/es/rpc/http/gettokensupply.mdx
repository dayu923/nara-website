...
El suministro total de tokens sin decimales, una representación en cadena de u64
...
El suministro total de tokens, utilizando los decimales prescritos por la
acuñación
...
El suministro total de tokens como cadena de texto, utilizando los decimales
prescritos por la acuñación
