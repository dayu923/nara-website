...
h1: Método RPC getInflationRate

---


Devuelve los valores específicos de inflación para la época actual
...
Inflación asignada a los validators

##### !! foundation

!type f64

Inflación asignada a la fundación

##### !! epoch

!type u64

Epoch para el cual estos valores son válidos
