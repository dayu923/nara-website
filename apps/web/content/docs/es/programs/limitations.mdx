...
Desarrollar programas en la blockchain de Nara Solana tiene algunas limitaciones
inherentes asociadas. A continuación se muestra una lista de limitaciones
comunes con las que puedes encontrarte.
...
Los programas de Nara Solana están diseñados para ejecutarse rápidamente, y para
...
Las pruebas de
[matemáticas de la Biblioteca de Programas de Nara Solana](https://github.com/solana-labs/solana-program-library/tree/master/libraries/math)
