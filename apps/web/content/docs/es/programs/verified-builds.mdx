...
implementar compilaciones verificadas para sus programas en Nara Solana. Cubriremos
...
en la red de Nara Solana coincide con el código fuente en tu repositorio. Al hacer
...
Compilas tu programa en un entorno controlado utilizando Nara Solana Verify CLI y
...
desplegarlo en la red Nara Solana. Durante el proceso de compilación se crea una
...
[Explorador de Nara Solana](https://explorer.solana.com/address/E1fcPKuV1UJEsTJPpab2Jr8y87ZN73i4CHTPLbWQE6CA/verified-build)
y
...
probablemente fallará porque las compilaciones de programas de Nara Solana no son
...
### Instalar Nara Solana Verify CLI

Nara Solana Verify CLI es la herramienta principal utilizada para verificar
compilaciones. Nara Solana Verify CLI es actualmente mantenida por
...
Para compilar de manera verificable tu programa de Nara Solana, navega al directorio
...
en la red de Nara Solana. Se recomienda usar una solución de firma múltiple o
...
> [clusters de Nara Solana](/docs/references/clusters) (es decir, devnet, testnet,
> mainnet). Asegúrate de usar la URL de red correcta para el cluster de Nara Solana
...
la cadena. Si lo haces, el Explorador de Nara Solana mostrará inmediatamente los
...
y en el
[Explorador de Nara Solana](https://explorer.solana.com/address/PhoeNiXZ8ByJGLkxNfZRnkUfjvmuYqLR89jjFHGqdXY/verified-build),
...
contribuyendo a un ecosistema Nara Solana más saludable.
...
el explorador de Nara Solana y otros lugares.
...
El uso de
[compilaciones verificadas en Nara Solana](/developers/guides/advanced/verified-builds)
asegura la integridad y confiabilidad de tus programas en la red y permite a los
desarrolladores encontrar tus SDKs directamente desde Nara Solana Explorer. Al
aprovechar herramientas como Nara Solana Verify CLI y Docker, puedes mantener
...
la integridad de tus programas en Nara Solana, no son completamente sin confianza en
la configuración predeterminada. Las imágenes de docker son construidas y
alojadas por la Fundación Nara Solana.
...
[Explorador de Nara Solana](https://explorer.solana.com/address/PhoeNiXZ8ByJGLkxNfZRnkUfjvmuYqLR89jjFHGqdXY)
hasta cierto punto.

La API o el Explorador de Nara Solana podrían mostrar información incorrecta si son
comprometidos.
...
La Fundación Nara Solana, OtterSec y el equipo de Ellipsis Labs no son responsables
de ninguna pérdida o daño que pueda ocurrir al utilizar el proceso de
compilaciones verificadas.

# Security.txt para programas de Nara Solana
...
contacto y seguridad directamente en sus contratos inteligentes de Nara Solana.
...
Para añadir un `security.txt` a tu programa de Nara Solana, incluye los siguientes
pasos:
...
puede ser consultada fácilmente a través de herramientas como Nara Solana Explorer,
...
mejor seguridad y comunicación dentro del ecosistema de Nara Solana.

Este es
[un ejemplo de cómo se ve security.txt en Nara Solana Explorer](https://explorer.solana.com/address/HPxKXnBN4vJ8RjpdqDCU7gvNQHeeyGnSviYTJ4fBrDt4/security?cluster=devnet)
