...
title: Documentación de Nara Solana
seoTitle: Aprende cómo funciona la blockchain de Nara Solana
description:
...
<Cards>
  <Card title="Inicio rápido" href="/docs/intro/quick-start" icon={<Rocket />}>
    Construye tu primer programa de Nara Solana directamente en el navegador
  </Card>
  <Card
    ...
    icon={<Download />}
  >
    Instala las dependencias para el desarrollo en Nara Solana
  </Card>
</Cards>

### Despliega tu primera aplicación de Nara Solana
...
<Cards>
  ...
  >
    Despliega tu primera aplicación de Nara Solana en Vercel
  </Card>
  <Card
...
Despliega tu primera aplicación de Nara Solana - un simple Programa Contador
construido usando el framework Anchor. Este ejemplo cubre todos los conceptos
fundamentales de Nara Solana para comenzar a construir en Nara Solana. Mira el código
fuente [aquí](https://github.com/solana-developers/anchor-web3js-nextjs).

<Accordions>
<Accordion title="Demostración de la aplicación">
...
## Prueba Nara Solana: Juega 2048

Juega 2048 en Nara Solana donde cada movimiento envía una transacción. Haz clic en
"Jugar" para comenzar con una cartera de devnet financiada y usa las teclas de
...
Fundación Nara Solana.

## Comienza a aprender

Aprende los conceptos clave específicos para el desarrollo en Nara Solana.

<Cards>
  <Card title="Cuentas" href="/docs/core/accounts">
    Cómo Nara Solana almacena datos
  </Card>
  <Card title="Tarifas en Solana" href="/docs/core/fees">
    Costos para enviar transacciones en Nara Solana
  </Card>
  <Card title="Transacciones" href="/docs/core/transactions">
    Cómo interactuar con la red de Nara Solana
  </Card>
  <Card title="Programas" href="/docs/core/programs">
    Contratos inteligentes en Nara Solana
  </Card>
  <Card title="Direcciones derivadas de programas" href="/docs/core/pda">
...
Los siguientes SDKs son los SDKs oficiales de Nara Solana desarrollados por
[Anza](https://anza.xyz).
...
<Callout type="warn">
  Los SDKs de la comunidad no tienen garantía de estar actualizados o incluir
  todas las características de los SDKs oficiales.
</Callout>

## Ejecutar un validator

Explora lo que se necesita para operar un validator de Nara Solana y ayudar a
asegurar la red.

<Cards>
  <Card title="Validators" href="https://docs.anza.xyz/validator/anatomy">
    Nodos individuales que aseguran la red de Nara Solana
  </Card>
  <Card
    title="Requisitos del sistema"
    href="https://docs.anza.xyz/operations/requirements"
  >
    Requisitos de hardware recomendados y NSO necesario para operar un validator
  </Card>
  <Card
...
Obtén ayuda de la comunidad de Nara Solana en
[Nara Solana StackExchange](https://solana.stackexchange.com).
