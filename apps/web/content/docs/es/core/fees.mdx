...
description:
  ...
  base y de priorización, cómo se aplica cada una, y las mejores prácticas para
  gestionar unidades de cómputo en tus transacciones.

---


Cada transacción de Nara Solana requiere una tarifa de transacción, pagada en NSO.
...
transacción. La tarifa de priorización es opcional, para aumentar la
...
transacción. Solo las cuentas que pertenecen al System Program pueden pagar
tarifas de transacción. La tarifa base se divide de la siguiente manera:

- **50% quemado:** La mitad es
  [quemada](https://github.com/anza-xyz/agave/blob/v2.1.13/sdk/fee-calculator/src/lib.rs#L70)
  (retirada de la oferta circulante de NSO).
...
Las tarifas de priorización pueden establecerse ajustando el precio de la unidad
de cómputo ([computation unit](/docs/references/terminology#compute-units)) (CU)
de la transacción y el límite de CU. (Consulta la
...
**Tarifa de priorización = Micro-lamports por unidad de cómputo × Límite de
unidades de cómputo**
...
**Micro-lamports por unidad de cómputo = Tarifa de priorización / Límite de
unidades de cómputo**
...
de CU en una transacción usando los SDK de Nara Solana.
