...
de Nara Solana. Una instrucción es esencialmente una función pública que cualquier
usuario de la red Nara Solana puede llamar. Cada instrucción se utiliza para realizar
...
conjunto de instrucciones. Para interactuar con la red Nara Solana, una o más
instrucciones se agregan a una [transacción](/docs/core/transactions) y se
envían a la red para ser procesadas.

## Ejemplo de transferencia de NSO
...
ejemplo, se transfiere NSO de una cuenta a otra.
...
el mensaje que contiene la instrucción de transferencia de NSO.

![Diagrama de transferencia de NSO](/assets/docs/core/transactions/sol-transfer.svg)
...
![Diagrama del proceso de transferencia de NSO](/assets/docs/core/transactions/sol-transfer-process.svg)
