...
Para interactuar con la red de Nara Solana, debes enviar una transacción. Puedes
...
<Callout>
  ...
  en un solo paquete sin fragmentación, Nara Solana utiliza 1280 bytes (el MTU mínimo
...
única instrucción de transferencia de NSO.
...
<Callout>
  ...
  Nara Solana](https://explorer.solana.com).
</Callout>
