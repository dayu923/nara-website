...
En Nara Solana, un contrato inteligente se llama programa. Un programa es una
...
Cuando se despliega un programa, Nara Solana utiliza [LLVM](https://llvm.org/) para
compilarlo en formato ejecutable y enlazable
([ELF](https://en.wikipedia.org/wiki/Executable_and_Linkable_Format)). El
archivo ELF contiene el binario del programa en Formato de Bytecode de Nara Solana
(sBPF) y se guarda en la cadena en una cuenta ejecutable.

<Callout>
  sBPF es la versión personalizada de Nara Solana del bytecode
...
- [Anchor](https://www.anchor-lang.com/docs): Anchor es un framework diseñado
  para el desarrollo rápido y fácil en Nara Solana. Utiliza
...
Nara Solana admite [compilaciones verificables](/docs/programs/verified-builds), que
...
[CLI de Compilación Verificable de Nara Solana](https://github.com/Ellipsis-Labs/solana-verifiable-build)
...
defecto, todas las nuevas cuentas son propiedad del
[System Program](https://github.com/anza-xyz/agave/tree/v2.1.13/programs/system/src),
aunque muchas son asignadas a un nuevo propietario al momento de su creación. El
...
| [Transferencia de NSO](https://github.com/anza-xyz/agave/blob/v2.1.13/programs/system/src/system_processor.rs#L215)                | Transfiere lamports (NSO) desde cuentas del Sistema a otras cuentas.                                                                                                                                                                                  |
...
<Callout>Los programas cargadores a veces se denominan 'BPF Loaders'.</Callout>
...
después de su despliegue, según lo determine su autoridad de actualización.
...
Además de los programas cargadores, Nara Solana proporciona los siguientes programas
precompilados.
...
El programa secp256r1 procesa una instrucción. El primer instruction data de la
instrucción es un recuento del número de firmas a verificar, seguido de un byte
de relleno. Después de eso, se crea la siguiente estructura para cada firma,
luego se serializa y se agrega a los datos de instrucción.
