...
h1: Поширені структури даних JSON для методів Nara Solana RPC

---


Різні методи Nara Solana RPC повертають складніші відповіді у вигляді структурованих
...
Транзакції в Nara Solana суттєво відрізняються від транзакцій в інших блокчейнах.
Обов'язково ознайомтеся з [Анатомією транзакції](/docs/core/transactions), щоб
дізнатися про транзакції в Nara Solana.
...
Середовище виконання Nara Solana записує міжпрограмні інструкції, які викликаються
