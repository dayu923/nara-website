...
title: HTTP методи
seoTitle: HTTP методи Nara Solana RPC
hideTableOfContents: false
h1: HTTP методи Nara Solana RPC

---


Вузли Nara Solana приймають HTTP-запити, використовуючи
...
> інтерфейс для RPC-методів взаємодії з вузлом Nara Solana. Для PubSub-з'єднання з
> вузлом Nara Solana використовуйте [Websocket API](/docs/rpc/websocket/).
...
- Transaction: Список інструкцій Nara Solana, підписаних клієнтською keypair для
  авторизації цих дій.
