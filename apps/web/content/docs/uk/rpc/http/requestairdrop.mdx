...
h1: RPC метод requestAirdrop

---


Запитує аірдроп lamports на Pubkey
...
Pubkey облікового запису для отримання lamports, у вигляді рядка, кодованого в
base-58
...
Кількість lamports для аірдропу
...
Підпис транзакції аірдропу у вигляді рядка, кодованого в base-58
