...
h1: RPC-метод getMinimumBalanceForRentExemption

---


Повертає мінімальний баланс, необхідний для звільнення облікового запису від
rent.
...
Довжина даних облікового запису
...
Мінімальна кількість lamports, необхідна для облікового запису, щоб залишатися
вільним від rent
