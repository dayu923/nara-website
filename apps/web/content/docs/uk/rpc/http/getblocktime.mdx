...
h1: RPC-метод getBlockTime

---


Повертає орієнтовний час створення блоку.

<Callout type="info">
  Кожен validator регулярно повідомляє свій час UTC у реєстр, періодично додаючи
  часову мітку до голосування за певний блок. Час запитуваного блоку
  обчислюється як середньозважене за ставками значення часових міток голосувань
  у наборі останніх блоків, записаних у реєстрі.
</Callout>
