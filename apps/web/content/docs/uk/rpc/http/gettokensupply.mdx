...
h1: RPC-метод getTokenSupply

---


Повертає загальну пропозицію токенів типу SPL.
...
Pubkey токена Mint для запиту, у вигляді рядка, закодованого в base-58
...
Загальна пропозиція токенів без десяткових знаків, рядкове представлення u64
...
Загальна пропозиція токенів із використанням десяткових знаків, визначених
монетою
...
Загальна пропозиція токенів у вигляді рядка, із використанням десяткових знаків,
визначених монетою
