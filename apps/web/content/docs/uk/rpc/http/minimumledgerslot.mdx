...
h1: RPC-метод minimumLedgerSlot

---


Повертає найнижчий slot, про який вузол має інформацію у своєму реєстрі.

<Callout type="info">
  Це значення може збільшуватися з часом, якщо вузол налаштований на очищення
  старіших даних реєстру
</Callout>
...
Мінімальний номер slot реєстру
