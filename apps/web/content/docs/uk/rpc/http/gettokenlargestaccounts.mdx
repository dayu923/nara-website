...
h1: RPC-метод getTokenLargestAccounts

---


Повертає 20 найбільших рахунків певного типу SPL токенів.
...
Pubkey токенового Mint для запиту, у вигляді рядка, закодованого в base-58
...
Адреса token account

##### !! amount

!type string

Необроблений баланс token account без десяткових знаків, рядкове представлення
u64
...
Кількість десяткових знаків праворуч від десяткової коми

##### !! uiAmount

!type number | null

Баланс token account з використанням десяткових знаків, визначених монетою
**ЗАСТАРІЛО**
...
Баланс token account у вигляді рядка, з використанням десяткових знаків,
визначених монетою
