...
h1: RPC-метод getSlotLeaders

---


Повертає лідерів слотів для заданого діапазону слотів
...
Початковий slot, як ціле число u64
...
Ліміт, як ціле число u64 (від 1 до 5 000)
...
Масив публічних ключів ідентифікації вузлів у вигляді рядків, кодованих у
base-58.
