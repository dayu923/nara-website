...
h1: RPC метод getInflationRate

---


Повертає конкретні значення інфляції для поточного epoch
...
Інфляція, розподілена між validator

##### !! foundation

!type f64

Інфляція, розподілена для фонду

##### !! epoch

!type u64

Epoch, для якого дійсні ці значення
