...
title: Встановлення повноважень
description:
  Дізнайтеся, як встановлювати повноваження для mint account або token account.

---


## Розуміння повноважень токенів

### Повноваження mint account

- **Mint Authority**: Контролює створення нових токенів. Може карбувати токени
  на будь-який token account. Часто відкликається після створення початкової
  пропозиції для створення токена з фіксованою пропозицією.
- **Freeze Authority**: Контролює можливість заморожування та розморожування
  token account. Може запобігти передачі токенів з будь-якого token account.
  Часто відкликається, щоб гарантувати користувачам, що їхні токени не можуть
  бути заморожені.

### Повноваження token account

- **Власник облікового запису**: Має повний контроль над token account. Може
  переказувати токени, спалювати токени, затверджувати делегатів та закривати
  обліковий запис, коли баланс дорівнює нулю.
- **Close Authority**: Може закрити token account, коли його баланс дорівнює
  нулю. За замовчуванням це власник облікового запису, але може бути делеговано
  іншому обліковому запису.

## Як встановити повноваження
...
змінює або відкликає повноваження на mint account та token account. Тільки
поточний власник повноважень може передати свої дозволи новій адресі або
відкликати їх назавжди, встановивши повноваження на null. Після відкликання
повноваження не можуть бути відновлені.
...
<Callout type="info">
  ...
  мають подібні реалізації для досягнення однакової функціональності.
</Callout>
