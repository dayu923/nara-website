...
title: Затвердження делегата
description: Дізнайтеся, як затверджувати делегатів для token account.

---


## Як затвердити делегата
...
надає іншому обліковому запису (делегату) дозвіл на переказ певної кількості
токенів з вашого token account. Делегат може переказувати токени до затвердженої
суми, але не може перевищувати її. Лише власник token account може затверджувати
делегата, і кожен token account може мати лише одного делегата одночасно.
Будь-яке нове затвердження перезаписує попереднє.
