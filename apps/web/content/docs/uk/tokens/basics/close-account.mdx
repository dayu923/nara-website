...
description: Дізнайтеся, як закривати токен-рахунки.
...
назавжди закриває token account і переказує всі залишкові NSO (rent) на вказаний
цільовий рахунок. Баланс token account повинен бути нульовим перед закриттям.
Лише власник token account або призначений уповноважений на закриття може
виконати цю інструкцію.
