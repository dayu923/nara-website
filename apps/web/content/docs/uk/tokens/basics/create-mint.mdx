...
Mint account унікально представляє токен у мережі Nara Solana та зберігає його
глобальні метадані.
...
Кожен токен у мережі Nara Solana має mint account, а адреса мінту слугує унікальним
...
USDC у всій екосистемі Nara Solana. Ви можете переглянути цей мінт на
