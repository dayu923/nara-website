...
description: Дізнайтеся, як карбувати нові одиниці токена.
...
Карбування створює нові одиниці токена за допомогою інструкції
...
- Лише орган карбування може карбувати нові токени
- Має існувати цільовий token account для отримання карбованих токенів
