...
title: Розморозити рахунок
description: Дізнайтеся, як розморозити заморожений token account.
...
скасовує заморозку, відновлюючи повну функціональність раніше замороженого token
account. Після розморожування рахунок знову може надсилати та отримувати токени
у звичайному режимі. Лише орган заморожування (freeze authority) монети токена
може розморожувати рахунки.
