...
description: Дізнайтеся, як відкликати делегата token account.

---


## Як відкликати делегата
...
видаляє всі дозволи на переказ від поточного затвердженого делегата. Після
відкликання делегат більше не може переказувати жодні токени з вашого рахунку.
Лише власник token account може відкликати делегата.
