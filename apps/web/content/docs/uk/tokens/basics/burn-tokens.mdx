...
title: Спалювання токенів
description: Дізнайтеся, як спалювати токени.
...
назавжди знищує токени шляхом зменшення балансу в token account. Спалені токени
видаляються з обігу та зменшують `supply`, що відстежується на mint account.
Лише власник token account може спалювати токени зі свого рахунку.
