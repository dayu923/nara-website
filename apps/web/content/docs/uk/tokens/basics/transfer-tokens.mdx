...
description: Дізнайтеся, як переказувати токени між рахунками токенів.

---


## Як переказувати токени

Перекази токенів переміщують токени між рахунками токенів одного й того ж
випуску, використовуючи інструкцію
...
- Обидва рахунки токенів повинні містити токени одного типу (випуску)
- Лише власник вихідного рахунку або делегат може авторизувати перекази

<Callout type="info">
  [Програма
  токенів](https://github.com/solana-program/token/blob/3daf44899f0bd71c879d28dffdfb788dd944f3c5/program/src/processor.rs#L227)
  та [Програма розширення
  токенів](https://github.com/solana-program/token-2022/blob/efd0c957fefbd79882d77df5fb2dac88c001249c/program/src/processor.rs#L300)
