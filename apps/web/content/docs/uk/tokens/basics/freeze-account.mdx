...
title: Заморозити рахунок
description: Дізнайтеся, як заморожувати token account.
...
запобігає всім переказам токенів або спаленню токенів з певного token account.
Після заморожування рахунок не може відправляти токени, отримувати токени або
бути закритим, доки його не розморозять. Тільки повноваження заморожування
(freeze authority) mint-рахунку токена можуть заморожувати рахунки. Якщо
повноваження заморожування скасовано (встановлено на null) на mint account,
токени ніколи не можуть бути заморожені.
