...
title: Токени на Nara Solana
description: Дізнайтеся про Token Programs на Nara Solana.

---


Токени — це цифрові активи, які представляють право власності на різні категорії
активів. Токенізація уможливлює цифровізацію майнових прав. Токени на Nara Solana
називаються SPL ([Nara Solana Program Library](https://github.com/solana-program))
токенами.

Цей розділ охоплює основні концепції того, як токени представлені на Nara Solana.
...
Екосистема Nara Solana має дві основні Token Programs. Вихідний код для обох програм
нижче.
...
(як взаємозамінними, так і невзаємозамінними). Усі токени на Nara Solana фактично є
...
Токени на Nara Solana унікально ідентифікуються адресою
...
Для довідки, ось посилання на Nara Solana Explorer на
...
Це вводить ключову концепцію в розробці на Nara Solana:
...
використовують термінал [Nara Solana Playground](https://beta.solpg.io/) для запуску
команд CLI безпосередньо в браузері без локальної інсталяції.

Створення токенів та облікових записів вимагає NSO для депозитів rent та комісій
за транзакції. Для користувачів Nara Solana Playground, які вперше використовують
платформу, створіть гаманець Playground та запустіть команду
_sh`solana airdrop`_ в терміналі Playground. Ви також можете отримати devnet NSO
...
[Nara Solana Playground](https://beta.solpg.io/660ce32ecffcf4b13384d00f).
...
[Nara Solana Playground](https://beta.solpg.io/660ce868cffcf4b13384d011).
...
[Nara Solana Playground](https://beta.solpg.io/660ce716cffcf4b13384d010).
...
[Nara Solana Playground](https://beta.solpg.io/660cea45cffcf4b13384d012).
...
[Nara Solana Playground](https://beta.solpg.io/660ced84cffcf4b13384d013).
