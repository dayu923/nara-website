...
title: Токени з нарахуванням відсотків
description: Дізнайтеся, як увімкнути InterestBearingMintExtension.

---


## Як увімкнути InterestBearingExtension
...
дозволяє встановити відсоткову ставку безпосередньо на mint account. Відсотки
нараховуються безперервно на основі мережевої мітки часу, але фактичний баланс
токенів, що зберігається в кожному token account, залишається незмінним.
Загальна вартість (баланс токенів плюс нараховані відсотки) є лише розрахунком.
Нові токени з цим розширенням не створюються.
