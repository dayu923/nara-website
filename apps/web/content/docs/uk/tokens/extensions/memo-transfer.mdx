...
title: Передача з мемо
description: Дізнайтеся, як увімкнути MemoTransferExtension.

---


## Як увімкнути MemoTransferExtension
...
вимагає, щоб усі вхідні перекази токенів включали супровідне мемо, коли це
розширення увімкнено для token account. Це розширення може бути увімкнено або
вимкнено власником token account.
