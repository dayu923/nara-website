...
title: Застосування відкладеного балансу
description:
  Дізнайтеся, як застосувати відкладений баланс, щоб зробити кошти доступними.

---


## Як застосувати відкладений баланс до доступного балансу

Перш ніж токени можна буде конфіденційно переказувати, публічний баланс токенів
має бути конвертований у конфіденційний баланс. Ця конвертація відбувається у
два етапи:

1. **Конфіденційний відкладений баланс**: Спочатку токени "депонуються" з
   публічного балансу до "відкладеного" конфіденційного балансу.
2. **Конфіденційний доступний баланс**: Потім відкладений баланс
   "застосовується" до доступного балансу, роблячи токени доступними для
   конфіденційних переказів.

Цей розділ пояснює другий етап: застосування відкладеного балансу до доступного
балансу.

Коли токени "депонуються" з публічного балансу або коли токени конфіденційно
переказуються з одного token account на інший, токени спочатку додаються до
конфіденційного відкладеного балансу. Перш ніж токени можна буде використовувати
для конфіденційних переказів, відкладений баланс має бути "застосований" до
доступного балансу.
...
Наступна діаграма показує кроки, пов'язані із застосуванням відкладеного балансу
до доступного балансу:
...
Щоб конвертувати відкладений баланс у доступний баланс, викличте інструкцію
...
Крейт `spl_token_client` надає метод
`confidential_transfer_apply_pending_balance`, який створює та надсилає
транзакцію з інструкцією `ApplyPendingBalance`, як показано в прикладі нижче.

### Приклад коду

Наступний приклад демонструє, як застосувати конфіденційний відкладений баланс
до конфіденційного доступного балансу.

Щоб запустити приклад, запустіть локальний validator з Token Extensions Program,
клонованою з мережі mainnet, використовуючи наступну команду. У вас має бути
встановлений Nara Solana CLI для запуску локального validator.
...
<Callout type="info">
  На момент написання, Конфіденційні перекази не активовані у стандартному
  локальному валідаторі. Вам потрібно клонувати програму Token Extension з
  основної мережі, щоб запустити приклад коду.
</Callout>
