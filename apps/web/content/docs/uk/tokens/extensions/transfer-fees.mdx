...
title: Комісії за переказ
description: Дізнайтеся, як реалізувати TransferFeeExtension.

---


## Як реалізувати TransferFeeExtension
...
дозволяє автоматично збирати комісію за кожен переказ токенів. Комісії
накопичуються на рахунках токенів отримувача і можуть бути зняті органом зняття,
встановленим на mint account.
