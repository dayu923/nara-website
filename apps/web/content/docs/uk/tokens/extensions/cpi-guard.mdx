...
title: CPI Guard
description: Дізнайтеся, як увімкнути CpiGuardExtension.

---


## Як увімкнути CpiGuardExtension
...
захищає токен-рахунки від несподіваних переказів через міжпрограмні виклики
(CPI). Коли цей розширення увімкнено, воно гарантує, що токени можуть бути
переказані лише через прямі виклики до інструкції переказу Token Extensions
Program, блокуючи всі інші програми від переказу токенів через CPI.
