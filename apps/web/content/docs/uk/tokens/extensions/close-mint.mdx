...
title: Закрити мінт
description: Дізнайтеся, як увімкнути розширення MintCloseAuthority.

---


## Як увімкнути розширення MintCloseAuthority
...
дозволяє закривати mint account та повертати їх rent. Це розширення необхідно
ініціалізувати під час створення мінту.

Тільки призначений authority для закриття може закрити mint account. Подібно до
того, як токен-акаунти можна закрити лише коли баланс токенів дорівнює нулю,
mint account з цим розширенням можна закрити лише тоді, коли весь обсяг токенів
було зменшено до нуля.
