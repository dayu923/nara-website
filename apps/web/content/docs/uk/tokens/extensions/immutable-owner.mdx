...
title: Незмінний власник
description: Дізнайтеся, як увімкнути розширення ImmutableOwner.

---


## Як увімкнути розширення ImmutableOwner
...
розширення запобігає зміні власника для token account. Коли token account
ініціалізується з цим розширенням, призначений власник є постійним і не може
бути переданий іншому обліковому запису.
