...
title: Розширення метаданих та вказівника метаданих
description:
  Дізнайтеся, як увімкнути розширення MetadataPointerExtension та TokenMetadata.

---


## Як увімкнути розширення MetadataPointerExtension та TokenMetadata
...
дозволяє mint account вказати адресу свого облікового запису метаданих. Цей
вказівник може посилатися на будь-який обліковий запис, яким володіє програма,
що реалізує
[інтерфейс Token Metadata](https://github.com/solana-program/token-metadata/tree/main),
що забезпечує гнучкість у зберіганні метаданих.

Token Extensions Program реалізує
[інтерфейс Token Metadata](https://github.com/solana-program/token-metadata/blob/main/interface/src/instruction.rs)
безпосередньо, дозволяючи зберігати метадані в самому mint account. Це включає
назву токена, символ, URI та додаткові описові дані. Коли розширення вказівника
вказують на сам mint, розширення
...
можна використовувати для зберігання всіх метаданих у mint account.
