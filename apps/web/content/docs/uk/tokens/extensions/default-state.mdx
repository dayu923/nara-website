...
title: Стан за замовчуванням
description: Дізнайтеся, як увімкнути DefaultAccountStateExtension.

---


## Як увімкнути DefaultAccountStateExtension
...
встановлює стан за замовчуванням для всіх нових token account, створених для
монети. Коли це розширення увімкнено, воно автоматично ініціалізує кожен новий
token account із вказаним станом, наприклад, замороженим. Це дозволяє творцям
токенів забезпечувати певну поведінку, наприклад, вимагати, щоб усі нові
облікові записи були заморожені за замовчуванням, доки їх явно не розморозять.
