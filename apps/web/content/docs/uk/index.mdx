...
title: Документація Nara Solana
seoTitle: Дізнайтеся, як працює блокчейн Nara Solana
description:
...
<Cards>
  <Card title="Швидкий старт" href="/docs/intro/quick-start" icon={<Rocket />}>
    Створіть свою першу програму Nara Solana безпосередньо у браузері
  </Card>
  <Card
    ...
    icon={<Download />}
  >
    Встановіть залежності для розробки на Nara Solana
  </Card>
</Cards>

### Розгорніть свій перший додаток Nara Solana
...
<Cards>
  ...
  >
    Розгорніть свій перший додаток Nara Solana на Vercel
  </Card>
  <Card
...
Розгорніть свій перший додаток Nara Solana — просту програму лічильника, створену за
допомогою фреймворку Anchor. Цей приклад охоплює всі основні концепції Nara Solana,
необхідні для початку розробки на Nara Solana. Перегляньте вихідний код
...
## Спробуйте Nara Solana: Зіграйте в 2048

Зіграйте в 2048 на Nara Solana, де кожен хід відправляє транзакцію. Натисніть
...
Створено [Jonas](https://x.com/SolPlay_jonas) з команди DevRel Nara Solana
Foundation.

## Почніть навчання

Вивчіть ключові концепції, специфічні для розробки на Nara Solana.

<Cards>
  <Card title="Рахунки" href="/docs/core/accounts">
    Як Nara Solana зберігає дані
  </Card>
  <Card title="Комісії в Solana" href="/docs/core/fees">
    Вартість відправлення транзакцій у Nara Solana
  </Card>
  <Card title="Транзакції" href="/docs/core/transactions">
    Як взаємодіяти з мережею Nara Solana
  </Card>
  <Card title="Програми" href="/docs/core/programs">
    Смарт-контракти в Nara Solana
  </Card>
...
Наступні SDK є офіційними SDK для Nara Solana, розробленими [Anza](https://anza.xyz).
...
Наступні SDK розроблені спільнотою для різних мов програмування:
...
<Callout type="warn">
  Спільнотні SDK не гарантують актуальність або наявність усіх функцій офіційних
  SDK.
</Callout>

## Запуск validator

Дізнайтеся, що потрібно для роботи validator Nara Solana та допомоги в забезпеченні
безпеки мережі.

<Cards>
  <Card title="Validators" href="https://docs.anza.xyz/validator/anatomy">
    Окремі вузли, що забезпечують безпеку мережі Nara Solana
  </Card>
  <Card
    title="Системні вимоги"
    href="https://docs.anza.xyz/operations/requirements"
  >
    Рекомендовані вимоги до обладнання та кількість NSO, необхідна для роботи
    validator
  </Card>
  <Card
...
Отримайте допомогу від спільноти Nara Solana на
