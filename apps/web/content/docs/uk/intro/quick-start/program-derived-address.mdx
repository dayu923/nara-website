...
Цей посібник проведе вас через процес створення та тестування програми Nara Solana за
...
[посилання на Nara Solana Playground](https://beta.solpg.io/66734b7bcffcf4b13384d1ad)
з початковим кодом. Потім натисніть кнопку "Import", щоб додати програму до
ваших проєктів Nara Solana Playground.
...
<Callout type="info">
У цьому прикладі ви розгорнете програму в devnet, кластері Nara Solana
для тестування розробки.

Гаманець Playground за замовчуванням підключається до devnet. Переконайтеся, що
ваш гаманець Playground має devnet NSO для оплати розгортання програми.
Отримайте devnet NSO з [Nara Solana Faucet](https://faucet.solana.com/).
...
Nara Solana Playground видаляє деякі шаблонні налаштування, де
...
передаючи "Hello, Nara Solana!" як нове повідомлення.
