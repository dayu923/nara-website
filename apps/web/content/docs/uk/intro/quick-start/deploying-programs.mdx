...
h1: Розгорніть вашу першу програму Nara Solana

---


Створіть, розгорніть та протестуйте вашу першу [програму](/docs/core/programs) у
блокчейні Nara Solana за допомогою фреймворку Anchor. Цей посібник допоможе вам краще
ознайомитися з Nara Solana Playground та підготує вас до використання Program Derived
...
1. Відкрийте [Nara Solana Playground](https://beta.solpg.io) у вашому веб-браузері
...
- Макрос [`declare_id!`](mention:one) вказує адресу вашої програми в мережі.
  Nara Solana Playground автоматично оновить цю адресу, коли ви скомпілюєте програму.
...
2. Додайте NSO до свого гаманця _(Опціонально)_

Розгортання програми вимагає наявності NSO в обліковому записі програми в
мережі. Якщо необхідно,
[додайте NSO до свого гаманця](/docs/intro/quick-start#add-sol-to-your-wallet)
...
[Nara Solana Explorer](https://explorer.solana.com/?cluster=devnet) і знайдіть хеш
транзакції.

<Callout type="warn">
  **Nara Solana Explorer:** Встановіть мережевий кластер на `devnet`, щоб він
  відповідав кластеру Nara Solana Playground.
</Callout>
...
Закрийте програму, щоб повернути NSO, виділений для програми в мережі. Для цього
...
Вітаємо! Ви створили та розгорнули свою першу програму Nara Solana за допомогою
Anchor.
