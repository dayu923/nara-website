...
Читайте дані з мережі Nara Solana, отримуючи різні рахунки. Цей розділ допоможе вам
зрозуміти структуру [рахунків](/docs/core/accounts) Nara Solana. Кожен рахунок Nara Solana
...
використовуються для зберігання NSO та підписання транзакцій. Коли NSO вперше
...
[запитує NSO](mention:airdrop) для фінансування нової адреси публічного ключа та
...
Поле `lamports` містить баланс NSO рахунку в
...
токени. Адреса mint account унікально ідентифікує токен у мережі Nara Solana.
...
визначається програмою, якій належить обліковий запис. Більшість програм Nara Solana
