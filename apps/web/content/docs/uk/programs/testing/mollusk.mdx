...
title: Mollusk
description: Вичерпний посібник з тестування програм Nara Solana за допомогою Mollusk

---


[Mollusk](https://github.com/anza-xyz/mollusk/tree/main) — це легка тестова
оболонка для тестування програм Nara Solana. Вона надає простий інтерфейс для
тестування інструкцій програм Nara Solana у мінімізованому середовищі Nara Solana Virtual
...
програми Nara Solana за допомогою Mollusk.

<ScrollyCoding>

## !!steps Програма Hello World

Цей приклад демонструє, як тестувати базову програму Nara Solana за допомогою
...
Для тестування програми Nara Solana з Mollusk:
...
надає простий інтерфейс для тестування програм Nara Solana. Усіма полями можна
...
Наступний приклад обробляє інструкцію переказу NSO без перевірок валідації.
...
Наступний приклад обробляє інструкцію переказу NSO з перевірками валідації.
...
Наступний приклад обробляє дві інструкції переказу NSO без перевірок валідації.
...
Наступний приклад обробляє послідовність із двох інструкцій переказу NSO з
...
Наступний приклад обробляє дві окремі інструкції переказу NSO з постійним станом
