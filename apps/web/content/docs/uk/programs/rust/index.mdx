...
Програми Nara Solana переважно розробляються за допомогою мови програмування Rust. Ця
сторінка зосереджена на написанні програм Nara Solana на Rust без використання
...
програмами Nara Solana. Однак цей підхід вимагає більше ручного налаштування та
...
- Rust: Мова програмування для створення програм Nara Solana.
- Nara Solana CLI: Інструмент командного рядка для розробки на Nara Solana.

## Початок роботи

Приклад нижче охоплює основні кроки для створення вашої першої програми Nara Solana,
...
для створення програми Nara Solana.
...
Далі замініть вміст `src/lib.rs` наступним кодом. Це мінімальна програма Nara Solana,
яка виводить "Hello, world!" у журнал програми, коли програма викликається.

Макрос `msg!` використовується в програмах Nara Solana для виведення повідомлення в
журнал програми.
...
1. Файл `.so` (наприклад, `hello_world.so`): Це скомпільована програма Nara Solana,
...
Спочатку налаштуйте Nara Solana CLI для використання локального кластера Nara Solana.
...
<Callout type="info">
  Зверніть увагу, що кластер у Nara Solana Explorer також має бути localhost. Опція
  "Custom RPC URL" у Nara Solana Explorer за замовчуванням встановлена на
  `http://localhost:8899`.
</Callout>
...
Програми Nara Solana можна оновлювати, повторно розгортаючи їх з тим самим
ідентифікатором програми. Оновіть програму в `src/lib.rs`, щоб вона виводила
"Hello, Nara Solana!" замість "Hello, world!".
...
Ви повинні побачити "Hello, Nara Solana!" у журналі програми.
...
Запустіть клієнтський код знову та перевірте підпис транзакції в Nara Solana
Explorer, щоб побачити "Hello, Nara Solana!" у журналі програми.
...
Ви можете закрити свою програму Nara Solana, щоб повернути NSO, виділений для
