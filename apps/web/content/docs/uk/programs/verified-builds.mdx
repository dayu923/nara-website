...
перевірені збірки для своїх програм на Nara Solana. Ми розглянемо, що таке перевірені
...
мережі Nara Solana, відповідає вихідному коду у вашому репозиторії. Завдяки цьому
...
контрольованому середовищі за допомогою Nara Solana Verify CLI та Docker. Це
забезпечує детермінований та послідовний процес збірки на різних системах. Після
отримання виконуваного файлу ви можете розгорнути його в мережі Nara Solana. Під час
...
за все, не пройде перевірку, оскільки збірки програм Nara Solana не є детермінованими
на різних системах.
...
### Встановіть Nara Solana Verify CLI

Nara Solana Verify CLI — це основний інструмент, який використовується для перевірки
збірок. Nara Solana Verify CLI наразі підтримується
...
Щоб перевірено зібрати вашу програму Nara Solana, перейдіть до каталогу, що містить
...
мережі Nara Solana. Рекомендується використовувати рішення з мультипідписом або
...
> [кластерах Nara Solana](/docs/references/clusters) (тобто devnet, testnet,
> mainnet). Переконайтеся, що ви використовуєте правильну URL-адресу мережі для
> потрібного кластера Nara Solana, на якому хочете перевірити програму. Віддалена
...
Якщо ви це зробите, Nara Solana Explorer одразу покаже дані верифікації вашої
...
сприяючи більш здоровій екосистемі Nara Solana.
...
провіднику Nara Solana та інших місцях.
...
Використання
[перевірених збірок на Nara Solana](/developers/guides/advanced/verified-builds)
забезпечує цілісність і надійність ваших програм у мережі та дозволяє
розробникам знаходити ваші SDK безпосередньо з Nara Solana Explorer. Використовуючи
інструменти, такі як Nara Solana Verify CLI та Docker, ви можете підтримувати
...
програм Nara Solana, вони не є повністю безтрастовими у стандартній конфігурації.
Docker-образи будуються та розміщуються Nara Solana Foundation.
...
API або Nara Solana Explorer можуть потенційно відображати неправильну інформацію у
разі компрометації.
...
Nara Solana Foundation, OtterSec та команда Ellipsis Labs не несуть відповідальності
за будь-які збитки чи шкоду, які можуть виникнути внаслідок використання
конвеєра верифікованих збірок.

# Security.txt для програм Nara Solana
...
інформацію безпосередньо в їхні смарт-контракти Nara Solana. Натхненний
...
Щоб додати `security.txt` до вашої програми Nara Solana, виконайте такі кроки:
...
запитати за допомогою таких інструментів, як Nara Solana Explorer, що гарантує
...
екосистемі Nara Solana.

Це
[приклад того, як security.txt виглядає в Nara Solana Explorer](https://explorer.solana.com/address/HPxKXnBN4vJ8RjpdqDCU7gvNQHeeyGnSviYTJ4fBrDt4/security?cluster=devnet)
