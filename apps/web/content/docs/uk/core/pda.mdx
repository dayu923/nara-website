...
[Адреса рахунку](/docs/core/accounts#account-address) Nara Solana вказує на
...
Середовище виконання Nara Solana дозволяє програмам підписувати PDA без необхідності
...
Nara Solana — це точки на [кривій Ed25519](https://ed25519.cr.yp.to/) (криптографія
...
криптографічні операції. (Наприклад, надавати підпис.) Однак Nara Solana дозволяє
...
SDK Nara Solana підтримують створення PDA за допомогою функцій, показаних у таблиці
...
Наведені нижче приклади отримують PDA за допомогою SDK Nara Solana. Натисніть
...
містить єдину інструкцію [`initialize`](mention:initialize) для створення нового
облікового запису, який зберігатиме [адресу користувача](mention:user-address)
та [bump seed](mention:bump), використаний для отримання PDA.
...
нового облікового запису, використовуючи PDA як адресу. [Seeds](mention:seeds),
