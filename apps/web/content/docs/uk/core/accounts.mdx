...
Усі дані в мережі Nara Solana зберігаються в акаунтах. Мережу Nara Solana можна уявити як
...
для пошуку акаунта в блокчейні Nara Solana. Адреси акаунтів часто відображаються як
...
адресу, але це не обов'язково, оскільки Nara Solana також підтримує
...
Приклад нижче демонструє, як використовувати Nara Solana SDK для створення keypair.
keypair включає:
...
вхідних даних (seeds). Приклад нижче демонструє, як використовувати Nara Solana SDK
...
Читання даних із акаунта Nara Solana включає два кроки:
...
Кожен акаунт Nara Solana має [програму](/docs/core/programs), призначену як його
...
записів Nara Solana. (Подібно до операційних систем, які зазвичай мають окремі файли
...
Коли NSO вперше надсилається на нову адресу, на цій адресі створюється акаунт,
яким володіє System Program.

У наведеному нижче прикладі генерується нова пара ключів і фінансується NSO.
