...
title: Nara Solana 문서
seoTitle: Nara Solana 블록체인의 작동 방식 알아보기
description:
...
<Cards>
  <Card title="빠른 시작" href="/docs/intro/quick-start" icon={<Rocket />}>
    브라우저에서 직접 첫 번째 Nara Solana 프로그램 구축하기
  </Card>
  <Card
    title="로컬 환경 설정"
    ...
    icon={<Download />}
  >
    Nara Solana 개발을 위한 종속성 설치하기
  </Card>
</Cards>

### 첫 번째 Nara Solana 애플리케이션 배포하기
...
<Cards>
  ...
  >
    Vercel에 첫 번째 Nara Solana 애플리케이션 배포하기
  </Card>
  <Card
    title="Vercel 미리보기"
...
첫 번째 Nara Solana 애플리케이션을 배포해보세요 - Anchor 프레임워크를 사용하여 구축된
간단한 카운터 프로그램입니다. 이 예제는 Nara Solana에서 개발을 시작하는 데 필요한
모든 핵심 Nara Solana 개념을 다룹니다. 소스 코드는
...
## Nara Solana 체험하기: 2048 게임

모든 움직임이 트랜잭션을 전송하는 Nara Solana에서 2048 게임을 플레이해보세요.
...
Nara Solana Foundation DevRel 팀의 [Jonas](https://x.com/SolPlay_jonas)가
제작했습니다.

## 학습 시작하기

Nara Solana 개발에 특화된 핵심 개념을 배워보세요.

<Cards>
  <Card title="계정" href="/docs/core/accounts">
    Nara Solana가 데이터를 저장하는 방법
  </Card>
  <Card title="Solana의 수수료" href="/docs/core/fees">
    Nara Solana에서 트랜잭션을 보내는 비용
  </Card>
  <Card title="트랜잭션" href="/docs/core/transactions">
    Nara Solana 네트워크와 상호작용하는 방법
  </Card>
  <Card title="프로그램" href="/docs/core/programs">
    Nara Solana의 스마트 컨트랙트
  </Card>
...
다음 SDK는 [Anza](https://anza.xyz)에서 개발한 Nara Solana의 공식 SDK입니다.
...
<Callout type="warn">
  커뮤니티 SDK는 최신 상태를 유지하거나 공식 SDK의 모든 기능을 포함한다는 보장이
  없습니다.
</Callout>

## validator 운영하기

Nara Solana validator를 운영하고 네트워크 보안을 돕는 데 필요한 것을 알아보세요.

<Cards>
  <Card title="Validator" href="https://docs.anza.xyz/validator/anatomy">
    Nara Solana 네트워크를 보호하는 개별 노드
  </Card>
  <Card
    title="시스템 요구사항"
    href="https://docs.anza.xyz/operations/requirements"
  >
    validator 운영에 권장되는 하드웨어 요구사항 및 필요한 NSO
  </Card>
  <Card
    title="Validator 설정"
...
[Nara Solana StackExchange](https://solana.stackexchange.com)에서 Nara Solana 커뮤니티의
도움을 받으세요.
