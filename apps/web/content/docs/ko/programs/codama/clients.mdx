...
| 패키지                                                                                                   | 설명                                                                                   |
| -------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------- |
| [`@codama/renderers-js`](https://github.com/codama-idl/renderers-js)                                     | [`@solana/kit`](https://www.solanakit.com)와 호환되는 TypeScript 클라이언트 생성       |
| [`@codama/renderers-rust`](https://github.com/codama-idl/renderers-rust)                                 | [`solana_sdk`](https://github.com/anza-xyz/solana-sdk)와 호환되는 Rust 클라이언트 생성 |
| [`@codama/nodes-from-anchor`](https://github.com/codama-idl/codama/tree/main/packages/nodes-from-anchor) | Anchor IDL을 Codama IDL로 변환하여 클라이언트 생성                                     |
...
또는 `Cargo.toml`에 필요한 종속성을 추가하세요.
...
들어, `clients/js/`에 `package.json`를 추가하고 `clients/rust/`에 `Cargo.toml`를
추가하세요.
