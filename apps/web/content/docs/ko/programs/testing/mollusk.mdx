...
title: Mollusk
description: Mollusk를 사용한 Nara Solana 프로그램 테스팅 종합 가이드

---


[Mollusk](https://github.com/anza-xyz/mollusk/tree/main)는 Nara Solana 프로그램을
테스트하기 위한 경량 테스트 하네스입니다. 간소화된 Nara Solana 가상 머신(SVM)
환경에서 Nara Solana 프로그램 명령어를 테스트하기 위한 간단한 인터페이스를
...
다음 예제는 Mollusk를 사용하여 기본 Nara Solana 프로그램을 테스트하기 위한 최소한의
설정을 보여줍니다.
...
이 예제는 Mollusk를 사용하여 기본 Nara Solana 프로그램을 테스트하는 방법을
...
Mollusk로 Nara Solana 프로그램을 테스트하려면:
...
구조체는 Nara Solana 프로그램을 테스트하기 위한 간단한 인터페이스를 제공합니다. 모든
...
다음 예제는 검증 검사 없이 NSO 전송 명령어를 처리합니다.
...
다음 예제는 검증 확인이 포함된 NSO 전송 명령어를 처리합니다.
...
다음 예제는 검증 확인 없이 두 개의 NSO 전송 명령어를 처리합니다.
...
다음 예제는 각 명령어 후 검증 확인이 포함된 두 개의 NSO 전송 명령어 체인을
처리합니다.
...
다음 예제는 NSO 전송 명령어의 컴퓨트 유닛 사용량을 벤치마킹합니다.
