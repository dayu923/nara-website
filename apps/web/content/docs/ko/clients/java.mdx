...
description:
  ...
  알아보세요.
h1: Nara Solana용 Java SDK

---


[Sava Engineering](https://sava.engineering/)에서 개발한
[Java SDK](https://sava.software/welcome)는 Nara Solana와 상호작용하기 위한 대부분의
기능을 지원합니다. Nara Solana 프로그램에 Anchor를 사용하고 있다면,
...
이 Java SDK를 Nara Solana와 함께 사용하는 방법에 대한 자세한 정보는
