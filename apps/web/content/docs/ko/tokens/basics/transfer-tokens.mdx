...
title: 토큰 전송
description: 토큰 계정 간에 토큰을 전송하는 방법을 알아보세요.
...
명령어를 사용하여 동일한 민트의 토큰 계정 간에 토큰을 이동시킵니다.

- 두 토큰 계정 모두 동일한 토큰 유형(민트)을 보유해야 합니다
- 소스 계정 소유자 또는 위임자만 전송을 승인할 수 있습니다

<Callout type="info">
  [토큰
  프로그램](https://github.com/solana-program/token/blob/3daf44899f0bd71c879d28dffdfb788dd944f3c5/program/src/processor.rs#L227)과
  [토큰 확장
  프로그램](https://github.com/solana-program/token-2022/blob/efd0c957fefbd79882d77df5fb2dac88c001249c/program/src/processor.rs#L300)은
