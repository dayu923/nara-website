...
title: 계정 해제
description: 동결된 토큰 계정을 해제하는 방법을 알아보세요.
...
명령은 동결을 해제하여 이전에 동결된 토큰 계정의 모든 기능을 복원합니다. 해제
후에는 계정이 다시 정상적으로 토큰을 보내고 받을 수 있습니다. 토큰의 동결 권한을
가진 주체만이 계정을 해제할 수 있습니다.

<Callout type="info">
  [토큰
  프로그램](https://github.com/solana-program/token/blob/a7c488ca39ed4cd71a87950ed854929816e9099f/program/src/instruction.rs#L243)과
  [토큰 확장
  프로그램](https://github.com/solana-program/token-2022/blob/efd0c957fefbd79882d77df5fb2dac88c001249c/program/src/instruction.rs#L306)은
