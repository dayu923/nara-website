...
title: 토큰 발행하기
description: 새로운 토큰 단위를 발행하는 방법을 알아보세요.
...
명령어를 사용하여 토큰의 새로운 단위를 생성합니다.

- 오직 발행 권한자(mint authority)만 새 토큰을 발행할 수 있습니다
- 발행된 토큰을 받기 위한 대상 token account가 존재해야 합니다

<Callout type="info">
  [토큰
  프로그램](https://github.com/solana-program/token/blob/3daf44899f0bd71c879d28dffdfb788dd944f3c5/program/src/processor.rs#L521)과
  [토큰 확장
  프로그램](https://github.com/solana-program/token-2022/blob/efd0c957fefbd79882d77df5fb2dac88c001249c/program/src/processor.rs#L973)은
