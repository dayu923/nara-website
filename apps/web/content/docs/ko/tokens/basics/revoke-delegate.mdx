...
title: 위임자 취소하기
description: 토큰 계정 위임자를 취소하는 방법을 알아보세요.
...
명령어는 현재 승인된 위임자로부터 모든 전송 권한을 제거합니다. 취소 후에는
위임자가 더 이상 귀하의 계정에서 토큰을 전송할 수 없습니다. 토큰 계정 소유자만
위임자를 취소할 수 있습니다.

<Callout type="info">
  [토큰
  프로그램](https://github.com/solana-program/token/blob/a7c488ca39ed4cd71a87950ed854929816e9099f/program/src/instruction.rs#L140)과
  [토큰 확장
  프로그램](https://github.com/solana-program/token-2022/blob/efd0c957fefbd79882d77df5fb2dac88c001249c/program/src/instruction.rs#L182)은
