...
title: 토큰 소각하기
description: 토큰을 소각하는 방법을 알아보세요.
...
명령어는 토큰 계정의 잔액을 줄여 토큰을 영구적으로 제거합니다. 소각된 토큰은
유통에서 제거되며 mint account에서 추적되는 `supply`가 감소합니다. 오직 토큰
계정 소유자만이 자신의 계정에서 토큰을 소각할 수 있습니다.

<Callout type="info">
  [Token
  Program](https://github.com/solana-program/token/blob/a7c488ca39ed4cd71a87950ed854929816e9099f/interface/src/instruction.rs#L359C5-L359C16)과
  [Token Extension
  Program](https://github.com/solana-program/token-2022/blob/efd0c957fefbd79882d77df5fb2dac88c001249c/program/src/instruction.rs#L413)은
  동일한 기능을 구현하기 위해 유사한 방식을 공유합니다.
</Callout>
