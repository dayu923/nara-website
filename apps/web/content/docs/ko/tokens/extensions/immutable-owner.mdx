...
title: 변경 불가능한 소유자
description: ImmutableOwner 확장 기능을 활성화하는 방법을 알아보세요.

---


## ImmutableOwner 확장 기능 활성화 방법
...
확장 기능은 token account의 소유권 변경을 방지합니다. 이 확장 기능으로 token
account가 초기화되면, 지정된 소유자는 영구적이며 다른 계정으로 이전될 수
없습니다.
