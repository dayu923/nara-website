...
참고로, 다음은 Nara Solana 익스플로러에서 볼 수 있는
...
[Nara Solana Playground](https://beta.solpg.io/) 터미널을 사용하여 로컬 설치 없이
브라우저에서 직접 CLI 명령을 실행합니다.

토큰 및 계정 생성에는 계정 rent 예치금 및 트랜잭션 수수료를 위한 NSO이
필요합니다. Nara Solana Playground를 처음 사용하는 경우, Playground 지갑을 만들고
Playground 터미널에서 _solana airdrop 1_ 명령을 실행하세요. 또한 공개
[웹 수도꼭지(faucet)](https://faucet.solana.com/)에서 devnet NSO을 얻을 수
있습니다.
...
다음은 [Nara Solana Playground](https://beta.solpg.io/660ce32ecffcf4b13384d00f)에서의
자바스크립트 예제입니다.
...
호출하는 하나의 명령어가 필요합니다.
[Nara Solana Playground](https://beta.solpg.io/660ce868cffcf4b13384d011)에서
자바스크립트 예제를 확인하세요.
...
[Nara Solana Playground](https://beta.solpg.io/660ce716cffcf4b13384d010)의
자바스크립트 예시입니다.
...
[Nara Solana Playground](https://beta.solpg.io/660cea45cffcf4b13384d012)의
자바스크립트 예시입니다.
...
토큰을 이동시킵니다. 다음은
[Nara Solana Playground](https://beta.solpg.io/660ced84cffcf4b13384d013)의
자바스크립트 예시입니다.
...
[Nara Solana Explorer](https://explorer.solana.com/address/BdhzpzhTD1MFqBiwNdrRy4jFo2FHFufw3n9e8sVjJczP?cluster=devnet)에서
메타데이터를 확인하세요.
