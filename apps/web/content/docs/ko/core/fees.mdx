...
모든 Nara Solana 트랜잭션은 NSO로 지불하는 트랜잭션 수수료가 필요합니다. 트랜잭션
...
[램포트](/docs/references/terminology#lamport)의 비용이 발생합니다. 이 수수료는
...
아래 예시는 Nara Solana SDK를 사용하여 트랜잭션에 CU 한도와 CU 가격을 설정하는 방법을
보여줍니다.
