...
h1: Nara Solana RPC 메소드를 위한 일반적인 JSON 데이터 구조

---


다양한 Nara Solana RPC 메소드는 특정 키 값으로 채워진 구조화된 JSON 객체 형태로 더
복잡한 응답을 반환합니다.
...
Nara Solana의 트랜잭션은 다른 블록체인의 트랜잭션과 상당히 다릅니다. Nara Solana의
...
Nara Solana 런타임은 트랜잭션 처리 중에 호출되는 크로스 프로그램 명령어를 기록하고,
