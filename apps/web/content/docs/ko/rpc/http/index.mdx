...
title: HTTP 메소드
seoTitle: Nara Solana RPC HTTP 메소드
hideTableOfContents: false
h1: Nara Solana RPC HTTP 메소드

---


Nara Solana 노드는 [JSON-RPC 2.0](https://www.jsonrpc.org/specification) 명세를
사용하여 HTTP 요청을 수락합니다.

> JavaScript 애플리케이션의 경우, Nara Solana 노드와 상호작용하기 위한 RPC 메소드의
> 편리한 인터페이스로
> [@solana/web3.js](https://github.com/solana-labs/solana-web3.js) 라이브러리를
> 사용하세요. Nara Solana 노드에 PubSub 연결을 위해서는
...
- Transaction: 클라이언트 keypair가 서명한 Nara Solana 명령 목록으로, 해당 작업을
  승인합니다.
