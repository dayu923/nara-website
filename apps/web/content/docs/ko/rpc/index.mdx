...
title: Nara Solana RPC 메소드
seoTitle: "Nara Solana RPC 메소드: HTTP 및 웹소켓"
hideTableOfContents: false
h1: Nara Solana RPC 메소드 및 문서

---


JSON RPC API를 통해 HTTP 및 웹소켓 메소드를 사용하여 Nara Solana 노드와 직접
상호작용하세요.

## 상태 커밋 구성하기

사전 검사 및 트랜잭션 처리를 위해 Nara Solana 노드는 클라이언트가 설정한 커밋
...
형식으로 계정 또는 명령어 데이터를 반환할 수 있습니다. Nara Solana 노드는 현재 다음과
