...
seoTitle: Nara Solana-lompakon integrointi Next.js:n ja Nara Solana Kitin avulla
description:
...
Määritä minimaalinen Nara Solana-lompakon integrointi Next.js:ssä Nara Solana Kitin
avulla.

Tämä opas tarjoaa minimaalisen esimerkin Nara Solana-lompakon toiminnallisuuden
...
Nara Solana Kit -repositoriossa.

## Resurssit

- [Nara Solana Kit -dokumentaatio](https://www.solanakit.com/docs)
- [Nara Solana Kit GitHub -repositorio](https://github.com/anza-xyz/kit)
...
käyttöliittymäkomponentteja varten ja asenna tarvittavat Nara Solana-riippuvuudet.
...
### Asenna Nara Solana-riippuvuudet

Asenna seuraavat Nara Solana-riippuvuudet:
...
## !!steps 1. Luo Nara Solana-konteksti
...
- Suodattaa käyttäjän selaimeen asennetut saatavilla olevat Nara Solana-lompakot
...
Seuraavaksi kääri koko Next.js-sovellus Nara Solana-tarjoajalla.
...
- Luo Nara Solana-tapahtuman ohjeella, joka kutsuu memo-ohjelmaa
- Pyytää yhdistettyä lompakkoa allekirjoittamaan ja lähettämään tapahtuman
- Näyttää linkin tapahtuman tarkasteluun Nara Solana Explorerissa
...
<Callout type="info">
  ...
  devnet-klusteriin ja [rahoittaa devnet NSO:lla](https://faucet.solana.com/)
