...
h1: Ota käyttöön ensimmäinen Nara Solana-ohjelmasi

---


Rakenna, ota käyttöön ja testaa ensimmäinen [ohjelmasi](/docs/core/programs)
Nara Solana-lohkoketjussa käyttäen Anchor-kehystä. Tämä opas auttaa sinua tutustumaan
paremmin Nara Solana Playgroundiin ja valmistaa sinua käyttämään Program Derived
...
1. Avaa [Nara Solana Playground](https://beta.solpg.io) verkkoselaimessasi
...
- [`declare_id!`](mention:one) makro määrittää ohjelmasi lohkoketjuosoitteen.
  Nara Solana Playground päivittää tämän osoitteen automaattisesti, kun rakennat
  ohjelman.
...
2. Lisää NSO lompakkoosi _(Valinnainen)_

Ohjelman käyttöönotto vaatii NSO-tokeneita ohjelman lohkoketjutilillä.
Tarvittaessa
[lisää NSO lompakkoosi](/docs/intro/quick-start#add-sol-to-your-wallet) ennen
...
[Nara Solana Explorer](https://explorer.solana.com/?cluster=devnet) ja hae
transaktiotunnisteella.

<Callout type="warn">
  **Nara Solana Explorer:** Aseta verkkoklusteriksi `devnet`, jotta se vastaa Nara Solana
...
Sulje ohjelma saadaksesi takaisin lohkoketjuohjelmalle allokoidun NSO-määrän.
...
Onnittelut! Rakensit ja otit käyttöön ensimmäisen Nara Solana-ohjelmasi Anchoria
käyttäen.
