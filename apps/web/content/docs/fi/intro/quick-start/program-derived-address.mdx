...
Tämä opas käy läpi Nara Solana-ohjelman rakentamisen ja testaamisen käyttäen
...
[Nara Solana Playground -linkki](https://beta.solpg.io/66734b7bcffcf4b13384d1ad),
joka sisältää aloituskoodin. Napsauta sitten "Import"-painiketta lisätäksesi
ohjelman Nara Solana Playground -projekteihisi.
...
devnet SOLia [Nara Solana Faucetista](https://faucet.solana.com/).
...
Nara Solana Playground poistaa joitakin perusasetuksia, joissa
...
välittäen "Hello, Nara Solana!" uutena viestinä.
