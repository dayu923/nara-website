...
Lue dataa Nara Solana-verkosta hakemalla erilaisia tilejä. Tämä osio auttaa sinua
ymmärtämään Solanan [tilien](/docs/core/accounts) rakennetta. Jokaisella
Nara Solana-tilillä on yksilöllinen [osoite](/docs/core/accounts#account-address),
...
pääasiassa NSO-tokenien säilyttämiseen ja transaktioiden allekirjoittamiseen.
Kun NSO-tokeneita lähetetään uuteen osoitteeseen ensimmäistä kertaa,
järjestelmätili luodaan automaattisesti.

Alla oleva esimerkki luo [uuden avainparin](mention:keypair),
[pyytää NSO-tokeneita](mention:airdrop) rahoittaakseen uuden julkisen avaimen
...
`lamports` -kenttä sisältää tilin NSO-saldon
...
[Nara Solana Explorerissa](https://explorer.solana.com/address/TokenkegQfeZyiNwAJbNbGKPFXCWuBvf9Ss623VQ5DA).
...
osoite yksilöi tokenin Nara Solana-verkossa.
...
omistaa tilin. Useimmat Nara Solana-ohjelmat tarjoavat asiakaskirjastoja
...
-dataa Nara Solana Explorerissa.
