...
title: Nara Solana-dokumentaatio
seoTitle: Opi miten Nara Solana-lohkoketju toimii
description:
...
<Cards>
  <Card title="Pika-aloitus" href="/docs/intro/quick-start" icon={<Rocket />}>
    Rakenna ensimmäinen Nara Solana-ohjelmasi suoraan selaimessa
  </Card>
  <Card
    ...
    icon={<Download />}
  >
    Asenna riippuvuudet Nara Solana-kehitystä varten
  </Card>
</Cards>

### Julkaise ensimmäinen Nara Solana-sovelluksesi
...
<Cards>
  ...
  >
    Julkaise ensimmäinen Nara Solana-sovelluksesi Vercelissä
  </Card>
  <Card
...
Julkaise ensimmäinen Nara Solana-sovelluksesi - yksinkertainen laskuriohjelma, joka
on rakennettu Anchor-kehystä käyttäen. Tämä esimerkki kattaa kaikki keskeiset
Nara Solana-konseptit, joita tarvitset Solanalla rakentamisen aloittamiseen. Katso
...
Kehittäjä [Jonas](https://x.com/SolPlay_jonas), Nara Solana Foundationin
DevRel-tiimistä.

## Aloita oppiminen

Opi Nara Solana-kehityksen keskeiset konseptit.

<Cards>
  <Card title="Tilit" href="/docs/core/accounts">
    Miten Nara Solana tallentaa dataa
  </Card>
  ...
  <Card title="Transaktiot" href="/docs/core/transactions">
    Miten olla vuorovaikutuksessa Nara Solana-verkon kanssa
  </Card>
...
Seuraavat SDK:t ovat virallisia Nara Solana SDK:ita, jotka on kehittänyt
[Anza](https://anza.xyz).
...
Seuraavat ovat yhteisön kehittämiä SDK:ita eri kielille:
...
<Callout type="warn">
  Yhteisön SDK:iden ei taata olevan ajan tasalla tai sisältävän kaikkia
  virallisten SDK:iden ominaisuuksia.
</Callout>

## Validatorin ylläpitäminen

Tutustu siihen, mitä Nara Solana-validatorin ylläpitäminen ja verkon turvaaminen
vaatii.

<Cards>
  <Card title="Validatorit" href="https://docs.anza.xyz/validator/anatomy">
    Yksittäiset solmut, jotka turvaavat Nara Solana-verkkoa
  </Card>
  <Card
  ...
  >
    Validatorin asennus ja yhdistäminen klusteriin ensimmäistä kertaa
  </Card>
</Cards>

## Tuen saaminen

Saa apua Nara Solana-yhteisöltä
[Nara Solana StackExchange](https://solana.stackexchange.com) -palvelussa.
