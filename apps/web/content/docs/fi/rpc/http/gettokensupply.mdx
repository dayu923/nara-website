...
h1: getTokenSupply RPC-metodi

---


Palauttaa SPL Token -tyypin kokonaistarjonnan.
...
Kyseltävän token Mint -kohteen pubkey base-58-koodattuna merkkijonona
...
Raaka tokenien kokonaistarjonta ilman desimaaleja, u64:n merkkijonomuotoinen
esitys
...
Kokonaisvaluutan tarjonta käyttäen rahayksikön määrittämiä desimaaleja

##### !! uiAmountString

!type string

Kokonaisvaluutan tarjonta merkkijonona käyttäen rahayksikön määrittämiä
desimaaleja
