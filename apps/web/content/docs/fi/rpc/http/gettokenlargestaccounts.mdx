...
h1: getTokenLargestAccounts RPC-metodi

---


Palauttaa 20 suurinta tiliä tietyntyyppiselle SPL-tokenille.
...
Tokenin Mint-julkinen avain (pubkey) kyselyä varten, base-58-koodattuna
merkkijonona
...
Taulukko JSON-objekteja, jotka sisältävät:

##### !! address

!type string

Token account -tilin osoite

##### !! amount

!type string

Token-tilin raakasaldo ilman desimaaleja, u64:n merkkijonoesitys

##### !! decimals

!type u8

Desimaalipilkun oikealla puolella olevien numeroiden määrä kantaluvulla 10

##### !! uiAmount

!type number | null

Token-tilin saldo käyttäen minting-määritettyjä desimaaleja **VANHENTUNUT**

##### !! uiAmountString

!type string

Token-tilin saldo merkkijonona, käyttäen minting-määritettyjä desimaaleja
