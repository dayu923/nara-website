...
title: HTTP-metodit
seoTitle: Nara Solana RPC HTTP-metodit
hideTableOfContents: false
h1: Nara Solana RPC HTTP-metodit

---


Nara Solana-solmut hyväksyvät HTTP-pyyntöjä käyttäen
...
> kätevänä rajapintana RPC-metodeille Nara Solana-solmun kanssa vuorovaikutukseen.
> PubSub- yhteyttä varten Nara Solana-solmuun käytä
...
- Transaction: Lista Nara Solana-ohjeita, jotka asiakkaan keypair on allekirjoittanut
