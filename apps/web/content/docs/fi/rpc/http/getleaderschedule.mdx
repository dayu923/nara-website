...
h1: getLeaderSchedule RPC-metodi

---


Palauttaa johtaja-aikataulun epochille
...
Hakee johtaja-aikataulun epochille, joka vastaa annettua slotia. Jos ei
määritetty, haetaan nykyisen epochin johtaja-aikataulu.
...
Palauta tulokset vain tälle validatorin identiteetille (base-58-koodattu)
...
Palauttaa `null` jos pyydettyä epochia ei löydy, muuten palauttaa objektin
jossa:

- Avaimet ovat validator-identiteettejä (base-58-koodattuina merkkijonoina)
- Arvot ovat taulukoita johtaja-slot-indekseistä suhteessa ensimmäiseen slotiin
  pyydetyssä epochissa
