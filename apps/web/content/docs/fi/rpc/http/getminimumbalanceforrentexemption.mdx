...
h1: getMinimumBalanceForRentExemption RPC-metodi

---


Palauttaa vähimmäissaldon, joka vaaditaan tilin rent-vapautukseen.
...
Vähimmäismäärä lamport-yksiköitä, jotka vaaditaan tilillä rent-vapautuksen
säilyttämiseksi
