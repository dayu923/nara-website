...
h1: getEpochSchedule RPC-metodi

---


Palauttaa epoch-aikataulutiedot tästä klusterista
...
Ensimmäinen normaalipituinen epoch,
...
Vähimmäismäärä sloteja yhdessä epochissa,
...
Slotien määrä ennen epochin alkua, jolloin lasketaan johtaja-aikataulu
kyseiselle epochille.

##### !! slotsPerEpoch

!type u64

Slotien enimmäismäärä kussakin epochissa.

##### !! warmup

!type bool

Määrittää, alkavatko epochit lyhyinä ja kasvavatko ne.
