...
h1: minimumLedgerSlot RPC-metodi

---


Palauttaa alimman slotin, josta solmulla on tietoa kirjanpidossaan.

<Callout type="info">
  Tämä arvo saattaa kasvaa ajan myötä, jos solmu on määritetty poistamaan
  vanhempia kirjanpitotietoja
</Callout>
