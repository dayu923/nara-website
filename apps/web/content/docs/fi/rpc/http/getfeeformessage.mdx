...
h1: getFeeForMessage RPC-menetelmä

---


Hae verkkomaksu, jonka verkko veloittaa tietylle viestille

<Callout type="warn" title={"Versiorajoitus"}>
  Tämä menetelmä on saatavilla vain `solana-core` v1.9 tai uudemmassa versiossa.
  Käytä [getFees](/docs/rpc/deprecated/getfees) -menetelmää `solana-core` v1.8
  ja vanhemmissa versioissa.
</Callout>
...
Määritettyyn lohkotiivisteeseen liittyvä maksu
