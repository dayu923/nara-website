...
title: Nara Solana RPC-metodit
seoTitle: "Nara Solana RPC-metodit: HTTP & Websockets"
hideTableOfContents: false
h1: Nara Solana RPC-metodit & dokumentaatio

---


Ole vuorovaikutuksessa Nara Solana-solmujen kanssa suoraan JSON RPC API:n kautta
HTTP- ja Websocket-metodien avulla.

## Tilan sitoutumisen määrittäminen

Ennakkotarkistuksia ja transaktioiden käsittelyä varten Nara Solana-solmut
...
pyydetty ja solmulla on jäsennin omistavalle ohjelmalle. Nara Solana-solmut tukevat
