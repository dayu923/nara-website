...
Nara Solana-lohkoketjulla on useita eri validaattoriryhmiä, joita kutsutaan
...
Nara Solana Labs -organisaatio ylläpitää julkista RPC-päätepistettä jokaiselle
klusterille. Kaikki nämä julkiset päätepisteet ovat käyttörajoitusten alaisia,
mutta ne ovat käyttäjien ja kehittäjien saatavilla Nara Solana-lohkoketjun kanssa
...
Monet suosituista Nara Solana-lohkoketjun explorereista tukevat minkä tahansa
klusterin valintaa, ja usein ne sallivat edistyneempien käyttäjien lisätä myös
mukautetun/yksityisen RPC-päätepisteen.

Esimerkkejä näistä Nara Solana-lohkoketjun explorereista ovat:
...
| ------------ | ------------------------------------- | --------------------------------- | -------------------------------------- |
| Mainnet      | `https://api.mainnet-beta.solana.com` | Tuotantoympäristö                 | Vaatii NSO-tokeneita transaktioihin    |
| Devnet       | `https://api.devnet.solana.com`       | Julkinen testaus ja kehitys       | Ilmainen NSO-airdrop testausta varten  |
...
- `https://api.devnet.solana.com` - yksittäinen Nara Solana Labsin isännöimä
  API-solmu; nopeusrajoitettu

#### Esimerkki `solana` komentorivi-konfiguraatiosta

Yhdistääksesi `devnet`klusteriin käyttäen Nara Solana CLI:tä:
...
- `https://api.testnet.solana.com` - yksittäinen Nara Solana Labs API-solmu;
  nopeusrajoitettu

#### Esimerkki `solana` komentorivi-konfiguraatiosta

Yhteyden muodostaminen `testnet` -klusteriin Nara Solana CLI:n avulla:
...
- `https://api.mainnet-beta.solana.com` - Nara Solana Labsin ylläpitämä
  API-solmuklusteri, kuormantasaajan tukema; nopeusrajoitettu

#### Esimerkki `solana` komentorivi-konfiguraatiosta

Yhteyden muodostaminen `mainnet-beta` -klusteriin Nara Solana CLI:n avulla:
