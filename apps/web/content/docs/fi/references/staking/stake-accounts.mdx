...
Kuten muutkin Nara Solana-verkon tilityypit, panostustiliä, jonka saldo on 0 NSO, ei
...
[Nara Solana Explorerissa](http://explorer.solana.com/) kopioimalla ja liittämällä
