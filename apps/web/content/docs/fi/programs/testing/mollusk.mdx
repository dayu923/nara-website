...
title: Mollusk
description: Kattava opas Nara Solana-ohjelmien testaamiseen Molluskin avulla

---


[Mollusk](https://github.com/anza-xyz/mollusk/tree/main) on kevyt testaustyökalu
Nara Solana-ohjelmien testaamiseen. Se tarjoaa yksinkertaisen käyttöliittymän
Nara Solana-ohjelmien käskyjen testaamiseen minimoidussa Nara Solana Virtual Machine (SVM)
...
Seuraava esimerkki näyttää minimaalisen asetuksen perus-Nara Solana-ohjelman
...
Tämä esimerkki havainnollistaa, miten testataan perus-Nara Solana-ohjelmaa Molluskin
...
Nara Solana-ohjelman testaamiseksi Molluskilla:
...
-rakenne tarjoaa yksinkertaisen rajapinnan Nara Solana-ohjelmien testaamiseen.
...
Seuraava esimerkki käsittelee NSO-siirto-ohjeen ilman validointitarkistuksia.
...
Seuraava esimerkki käsittelee NSO-siirto-ohjeen validointitarkistuksilla.
...
Seuraava esimerkki käsittelee kaksi NSO-siirto-ohjetta ilman
...
Seuraava esimerkki käsittelee ketjun, jossa on kaksi NSO-siirto-ohjetta
...
Seuraava esimerkki käsittelee kaksi erillistä NSO-siirto-ohjetta, joiden välillä
...
Seuraava esimerkki mittaa NSO-siirtokäskyn laskentayksikköjen käyttöä.
