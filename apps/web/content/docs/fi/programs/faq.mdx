...
Koska Nara Solana käyttää LLVM-kääntäjäinfrastruktuuria, ohjelma voidaan kirjoittaa
...
Nara Solana SBF -ohjelmien käyttämä virtuaalinen osoitemuistikartta on kiinteä ja
