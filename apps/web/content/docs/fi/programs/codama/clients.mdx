...
| Paketti                                                                                                  | Kuvaus                                                                                       |
| -------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------- |
| [`@codama/renderers-js`](https://github.com/codama-idl/renderers-js)                                     | Generoi [`@solana/kit`](https://www.solanakit.com) yhteensopivia TypeScript-asiakkaita       |
| [`@codama/renderers-rust`](https://github.com/codama-idl/renderers-rust)                                 | Generoi [`solana_sdk`](https://github.com/anza-xyz/solana-sdk) yhteensopivia Rust-asiakkaita |
| [`@codama/nodes-from-anchor`](https://github.com/codama-idl/codama/tree/main/packages/nodes-from-anchor) | Muuntaa Anchor IDL:t Codama IDL:iksi asiakkaiden generointia varten                          |
