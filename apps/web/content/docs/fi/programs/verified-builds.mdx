...
ohjelmasi kontrolloidussa ympäristössä käyttäen Nara Solana Verify CLI:tä ja
...
ottaa sen käyttöön Nara Solana-verkossa. Rakennusprosessin aikana luodaan
...
käytettävän
[Nara Solana Explorerissa](https://explorer.solana.com/address/E1fcPKuV1UJEsTJPpab2Jr8y87ZN73i4CHTPLbWQE6CA/verified-build)
ja
...
todennäköisesti epäonnistuu, koska Nara Solana-ohjelmien buildit eivät ole
...
### Asenna Nara Solana Verify CLI

Nara Solana Verify CLI on ensisijainen työkalu, jota käytetään buildien
varmentamiseen. Nara Solana Verify CLI:tä ylläpitää tällä hetkellä
...
Rakentaaksesi todennettavasti Nara Solana-ohjelmasi, siirry hakemistoon, joka
...
Nara Solana-verkossa. On suositeltavaa käyttää moniallekirjoitus- tai
...
> [Nara Solana-klustereissa](/docs/references/clusters) (esim. devnet, testnet,
> mainnet). Varmista, että käytät oikeaa verkko-URL:ää haluamallesi
> Nara Solana-klusterille, jota vastaan haluat todentaa ohjelman. Etätodentaminen
...
Nara Solana Explorer näyttää välittömästi ohjelmasi vahvistustiedot. Kunnes se on
...
ja
[Nara Solana Explorerissa](https://explorer.solana.com/address/PhoeNiXZ8ByJGLkxNfZRnkUfjvmuYqLR89jjFHGqdXY/verified-build),
...
mikä edistää terveempää Nara Solana-ekosysteemiä.
...
Tämä rakentaa vahvistettavan version käyttäen docker-konttia ja Nara Solana-versiota,
...
lähettänyt etätyön OtterSec API:lle. Sinun pitäisi nyt nähdä se Nara Solana
...
kehittäjille SDK:iden löytämisen suoraan Nara Solana Explorerista. Hyödyntämällä
työkaluja kuten Nara Solana Verify CLI ja Docker, voit ylläpitää todennettavia ja
...
Vaikka varmennetut buildit ovat tehokas työkalu Nara Solana-ohjelmien eheyden
varmistamiseen, ne eivät ole täysin luottamuksettomia oletusasetuksilla.
Docker-kuvat rakentaa ja ylläpitää Nara Solana Foundation.
...
[Nara Solana Exploreriin](https://explorer.solana.com/address/PhoeNiXZ8ByJGLkxNfZRnkUfjvmuYqLR89jjFHGqdXY)
tiettyyn pisteeseen asti.

API tai Nara Solana Explorer saattaa mahdollisesti näyttää virheellistä tietoa, jos
ne on vaarannettu.
...
Nara Solana Foundation, OtterSec ja Ellipsis Labs -tiimi eivät ole vastuussa mistään
menetyksistä tai vahingoista, joita saattaa aiheutua varmennettujen
koontiversioiden prosessin käytöstä.

# Security.txt Nara Solana-ohjelmille
...
turvallisuustietojen upottamisen suoraan Nara Solana-älysopimuksiinsa.
...
Lisätäksesi `security.txt` -tiedoston Nara Solana-ohjelmaasi, sisällytä seuraavat
vaiheet:
...
kysellä työkaluilla kuten Nara Solana Explorer, varmistaen että yhteystietosi ja
...
viestintää Nara Solana-ekosysteemissä.

Tämä on
[esimerkki siitä, miltä security.txt näyttää Nara Solana Explorerissa](https://explorer.solana.com/address/HPxKXnBN4vJ8RjpdqDCU7gvNQHeeyGnSviYTJ4fBrDt4/security?cluster=devnet)
