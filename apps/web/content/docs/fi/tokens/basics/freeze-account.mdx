...
-ohje estää kaikki token-siirrot tai token-polttamiset tietyltä token account
-tililtä. Kun tili on jäädytetty, siltä ei voi lähettää tokeneita, vastaanottaa
tokeneita tai sulkea tiliä ennen kuin se on sulatettu. Vain tokenin mint-tilin
jäädytysvaltuutuksen haltija voi jäädyttää tilejä. Jos jäädytysvaltuutus on
peruutettu (asetettu null-arvoksi) mint account -tilillä, tokeneita ei voi
koskaan jäädyttää.
