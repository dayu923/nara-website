...
title: Sulje token-tili
description: Opi sulkemaan token-tilejä.
...
-käsky sulkee token account -tilin pysyvästi ja siirtää kaikki jäljellä olevat
NSO-varat (rent) määritetylle kohdetilille. Token-tilin saldon on oltava nolla
ennen sulkemista. Vain token-tilin omistaja tai nimetty sulkemisvaltuutuksen
haltija voi suorittaa tämän käskyn.
