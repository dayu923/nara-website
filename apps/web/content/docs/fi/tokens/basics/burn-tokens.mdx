...
title: Polta tokeneita
description: Opi polttamaan tokeneita.
...
-käsky tuhoaa tokeneita pysyvästi vähentämällä token accountin saldoa. Poltetut
tokenit poistetaan kierrosta ja se vähentää mint accountissa seurattavaa
`supply` -arvoa. Vain token accountin omistaja voi polttaa tokeneita tililtään.
