...
description: Opi luomaan SPL token accounteja.
...
Voit tarkastella tämän token accountin tietoja
[Nara Solana Explorerissa](https://explorer.solana.com/address/3emsAVdmGKERbHjmGfQ6oZ1e35dkf5iYcS6U4CPKFVaa).
...
alustamisen Cross Program Invocations (CPI) -kutsujen kautta.
