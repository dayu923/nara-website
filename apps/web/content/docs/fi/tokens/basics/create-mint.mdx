...
description: Opi luomaan SPL Token mint.
...
Nara Solana-ekosysteemissä. Voit tarkastella tätä mintiä
[Nara Solana Explorerissa](https://explorer.solana.com/address/EPjFWdd5AufqSSqeM2qN1xzybapC8G4wEGGkZwyTDt1v).
