...
title: Sulauta tili
description: Opi miten sulautetaan jäädytetty token-tili.
...
-käsky kumoaa jäädytyksen, palauttaen täyden toiminnallisuuden aiemmin
jäädytetylle token-tilille. Sulatuksen jälkeen tililtä voi jälleen lähettää ja
vastaanottaa tokeneita normaalisti. Vain token-rahan jäädytysvaltuutettu voi
sulauttaa tilejä.
