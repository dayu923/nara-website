...
title: Luo tokeneita
description: Opi luomaan uusia token-yksiköitä.

---


## Kuinka luoda tokeneita

Tokenien luominen (minting) tuottaa uusia token-yksiköitä käyttäen
...
- Vain mint-oikeuden haltija voi luoda uusia tokeneita
- Vastaanottava token account täytyy olla olemassa luotuja tokeneita varten
