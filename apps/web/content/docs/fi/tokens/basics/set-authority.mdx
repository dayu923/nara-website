...
title: Aseta valtuus
description: Opi asettamaan valtuus mint- tai token-tileille.

---


## Token-valtuuksien ymmärtäminen

### Mint-tilin valtuudet

- **Mint-valtuus**: Hallitsee uusien tokenien luomista. Voi mintata tokeneita
  mille tahansa token-tilille. Usein peruutetaan alkuperäisen tarjonnan luomisen
  jälkeen kiinteän tarjonnan tokenin luomiseksi.
- **Jäädytysvaltuus**: Hallitsee kykyä jäädyttää ja sulattaa token-tilejä. Voi
  estää minkä tahansa token-tilin siirtämästä tokeneita. Usein peruutetaan
  takaamaan käyttäjille, että heidän tokeneitaan ei voida jäädyttää.

### Token-tilin valtuudet

- **Tilin omistaja**: Hallitsee täysin token-tiliä. Voi siirtää tokeneita,
  polttaa tokeneita, hyväksyä valtuutettuja ja sulkea tilin, kun saldo on nolla.
- **Sulkemisvaltuus**: Voi sulkea token-tilin, kun sen saldo on nolla.
  Oletuksena tämä on tilin omistaja, mutta se voidaan delegoida toiselle
  tilille.

## Miten asettaa valtuus
...
-ohje muuttaa tai peruuttaa valtuuksia mint- ja token-tileillä. Vain nykyinen
valtuutettu voi siirtää oikeutensa uuteen osoitteeseen tai peruuttaa ne
pysyvästi asettamalla valtuuden null-arvoksi. Kun valtuus on peruutettu, sitä ei
voida palauttaa.
