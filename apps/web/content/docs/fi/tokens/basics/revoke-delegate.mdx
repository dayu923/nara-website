...
title: Delegoinnin peruuttaminen
description: Opi kuinka token account -delegointi peruutetaan.

---


## Kuinka delegointi peruutetaan
...
-käsky poistaa kaikki siirto-oikeudet nykyiseltä hyväksytyltä delegaatilta.
Peruuttamisen jälkeen delegaatti ei voi enää siirtää mitään tokeneita tililtäsi.
Vain token account -omistaja voi peruuttaa delegaatin.
...
<Callout type="info">
  ...
  jakavat samankaltaiset toteutukset saman toiminnallisuuden saavuttamiseksi.
</Callout>
