...
title: Hyväksy valtuutettu
description: Opi miten hyväksyt valtuutetut token account -tilille.

---


## Miten hyväksyä valtuutettu
...
-käsky antaa toiselle tilille (valtuutetulle) luvan siirtää tietty määrä
tokeneita token account -tililtäsi. Valtuutettu voi siirtää tokeneita
hyväksyttyyn määrään asti, mutta ei sitä enempää. Vain token account -tilin
omistaja voi hyväksyä valtuutetun, ja kullakin token account -tilillä voi olla
vain yksi valtuutettu kerrallaan. Uusi hyväksyntä korvaa aina edellisen.
