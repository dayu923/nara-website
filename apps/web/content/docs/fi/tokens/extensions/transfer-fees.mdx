...
title: Siirtomaksut
description: Opi miten TransferFeeExtension toteutetaan.

---


## Miten TransferFeeExtension toteutetaan
...
mahdollistaa automaattisen maksujen keräämisen jokaisesta tokenin siirrosta.
Maksut kertyvät vastaanottajan token-tilille ja ne voidaan nostaa mint account
-tilille asetetun nostoviranomaisen toimesta.
