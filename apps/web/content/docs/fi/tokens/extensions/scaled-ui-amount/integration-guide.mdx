...
- Palveluiden, jotka tarjoavat historiallista dataa, tulisi tallentaa ja
  **näyttää sekä skaalatut että skaalaamattomat hinnat skaalattua
  käyttöliittymän määrälaajennusta varten**.
...
- Kerroinpäivitykset voivat sisältää aikaleiman, joka on menneisyydessä.
  Suosittelemme lohkon aikaleiman käyttöä historiallisessa datassa.
- Huomaa, että aktiivinen kerroin voi olla joko "multiplier" tai "newMultiplier"
  riippuen nykyisestä aikaleimauksesta ja siitä, milloin uuden kertoimen on
  määrä aktivoitua.
...
### **Markkinadatan kokoajat (Esim: CoinGecko, Birdeye)**
...
| Kokonaistarjonta skaalatulla mukautuksella | Kun näytetään kokonaistarjontaa ja kokonaismarkkina-arvoa, ota skaalatut saldot huomioon                                                                                                                                                                                                    | **P0**       |
| Historiallisten hintojen seuranta          | Tarjoa historiallinen kaavio hinnoista käyttäen skaalattua hintaa ajan myötä.                                                                                                                                                                                                               | **P1**       |
| Historiallisten kertoimien seuranta        | Tarjoa historialliset merkinnät kertoimien päivityksistä korkoa tuottaville tokeneille. Huomaa, että kerroinpäivitykset voivat sisältää aikaleiman, joka on menneisyydessä. Suosittelemme käyttämään lohkon aikaleimaa päivityksessä ilmoitetun aikaleiman sijaan historiallisessa datassa. | **P2**       |
...
| Vaatimus                                   | Kuvaus                                                                                                                                                                                                                                                                 | Prioriteetti |
| :----------------------------------------- | :--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :----------- |
| Skaalatut ja skaalaamattomat hintasyötteet | Tarjoa hintasyötteet sekä skaalattuina että skaalaamattomina hintoina.                                                                                                                                                                                                 | **P0**       |
| Historialliset kerrointiedot               | Tarjoa rajapinnat historiallisilla kerroinmuutoksilla. Huomaa, että kerroinpäivitykset saattavat sisältää aikaleiman, joka on menneisyydessä. Suosittelemme käyttämään lohkon aikaleimaa kerroinpäivityksessä ilmoitetun aikaleiman sijaan historiallisissa tiedoissa. | **P0**       |
| Historialliset hintatiedot                 | Tarjoa rajapinnat historiallisilla hinnoilla, jotka perustuvat sekä skaalattuihin että skaalaamattomiin määriin.                                                                                                                                                       | **P0**       |
