...
title: Token-ryhmät ja jäsenet
description:
  Opi miten GroupPointerExtension ja GroupMemberPointerExtension otetaan
  käyttöön.

---


## Miten GroupPointerExtension ja GroupMemberPointerExtension otetaan käyttöön
...
määrittää mint-tilin ryhmän mint-tiliksi (kuten kokoelman NFT) osoittamalla
tiliin, joka sisältää
[ryhmän määritykset](https://github.com/solana-program/token-group/blob/3b4ff305452fa35754206fc1ad4addb2e2bff511/interface/src/state.rs#L16)
kuten päivitysoikeuden ja enimmäiskoon.
...
määrittää mint-tilin jäsenen mint-tiliksi (kuten NFT kokoelmassa) osoittamalla
tiliin, joka sisältää
[jäsenyyden tiedot](https://github.com/solana-program/token-group/blob/3b4ff305452fa35754206fc1ad4addb2e2bff511/interface/src/state.rs#L67)
kuten ryhmän osoitteen ja jäsennumeron.

Token Extensions Program toteuttaa
[Token Group Interface](https://github.com/solana-program/token-group)
-rajapinnan suoraan, mikä mahdollistaa sekä ryhmä- että jäsentietojen
tallentamisen itse mint-tilille. Kun osoitinlaajennukset osoittavat itse
mint-tiliin,
...
-laajennuksia voidaan käyttää kaikkien kokoelma- ja jäsenyysdatan tallentamiseen
mint-tilillä.
