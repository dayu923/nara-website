...
title: Sulje Mint
description: Opi miten MintCloseAuthority-laajennus otetaan käyttöön.

---


## Miten MintCloseAuthority-laajennus otetaan käyttöön
...
-laajennus mahdollistaa mint account -tilien sulkemisen ja niiden rentin
palauttamisen. Tämä laajennus täytyy alustaa, kun mint luodaan.

Vain nimetty sulkemisvaltuutettu voi sulkea mint account -tilin. Samalla tavalla
kuin token-tilit voidaan sulkea vain kun token-saldo on nolla, mint account
-tilit, joilla on tämä laajennus, voidaan sulkea vain kun koko token-tarjonta on
vähennetty nollaan.
