...
title: Metadata & Metadata Pointer -laajennukset
description:
  Opi miten otetaan käyttöön MetadataPointerExtension ja TokenMetadata
  -laajennus.
...
-rajapinnan suoraan, mikä mahdollistaa metadatan tallentamisen itse mint account
-tilille. Tämä sisältää tokenin nimen, symbolin, URI:n ja lisäkuvaukset. Kun
osoitinlaajennukset osoittavat itse mint-tiliin,
...
-laajennuksia voidaan käyttää kaiken metadatan tallentamiseen mint account
-tilille.
