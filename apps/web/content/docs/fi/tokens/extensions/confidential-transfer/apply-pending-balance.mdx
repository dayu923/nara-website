...
description:
  Opi miten käyttää odottavaa saldoa varojen saamiseksi käytettäväksi.
...
## Miten odottava saldo muutetaan käytettävissä olevaksi saldoksi

Ennen kuin tokeneita voidaan siirtää luottamuksellisesti, julkinen tokenisaldo
täytyy muuntaa luottamukselliseksi saldoksi. Tämä muunnos tapahtuu kahdessa
vaiheessa:

1. **Luottamuksellinen odottava saldo**: Aluksi tokenit "talletetaan" julkisesta
   saldosta "odottavaan" luottamukselliseen saldoon.
2. **Luottamuksellinen käytettävissä oleva saldo**: Odottava saldo "sovelletaan"
   sitten käytettävissä olevaan saldoon, jolloin tokenit ovat käytettävissä
   luottamuksellisiin siirtoihin.

Tämä osio selittää toisen vaiheen: odottavan saldon soveltamisen käytettävissä
olevaan saldoon.

Kun tokeneita "talletetaan" julkisesta saldosta tai kun tokeneita siirretään
luottamuksellisesti yhdeltä token accountilta toiselle, tokenit lisätään aluksi
luottamukselliseen odottavaan saldoon. Ennen kuin tokeneita voidaan käyttää
luottamuksellisiin siirtoihin, odottava saldo täytyy "soveltaa" käytettävissä
olevaan saldoon.
...
Seuraava kaavio näyttää vaiheet, jotka liittyvät odottavan saldon soveltamiseen
...
Muuntaaksesi odottavan saldon käytettävissä olevaksi saldoksi, kutsu
...
`spl_token_client` crate tarjoaa `confidential_transfer_apply_pending_balance`
metodin, joka rakentaa ja lähettää transaktion `ApplyPendingBalance` ohjeella,
kuten alla olevassa esimerkissä on esitetty.

### Esimerkkikoodi

Seuraava esimerkki näyttää, miten luottamuksellinen odottava saldo sovelletaan
luottamukselliseen käytettävissä olevaan saldoon.

Suorittaaksesi esimerkin, käynnistä paikallinen validator Token Extension
Program kloonattuna mainnetistä käyttäen seuraavaa komentoa. Sinulla täytyy olla
Nara Solana CLI asennettuna käynnistääksesi paikallisen validatorin.
...
<Callout type="info">
  Kirjoitushetkellä luottamukselliset siirrot eivät ole käytössä
