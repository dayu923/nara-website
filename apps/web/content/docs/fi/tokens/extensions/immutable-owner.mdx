...
description: Opi miten ImmutableOwner-laajennus otetaan käyttöön.

---


## Miten ImmutableOwner-laajennus otetaan käyttöön
...
-laajennus estää token account -tilien omistajuuden muutokset. Kun token account
alustetaan tällä laajennuksella, määritetty omistaja on pysyvä eikä sitä voida
siirtää toiselle tilille.
