...
title: Oletustila
description: Opi miten DefaultAccountStateExtension otetaan käyttöön.

---


## Miten DefaultAccountStateExtension otetaan käyttöön
...
asettaa oletustilan kaikille uusille token account -tileille, jotka luodaan
mintille. Kun tämä laajennus on käytössä, se alustaa automaattisesti jokaisen
uuden token account -tilin määritetyllä tilalla, kuten jäädytettynä. Tämä
mahdollistaa token-luojille tiettyjen toimintojen pakottamisen, kuten
vaatimuksen, että kaikki uudet tilit ovat oletusarvoisesti jäädytettyjä, kunnes
ne nimenomaisesti sulatetaan.
