...
title: Muistion siirto
description: Opi miten MemoTransferExtension otetaan käyttöön.

---


## Miten MemoTransferExtension otetaan käyttöön
...
vaatii, että kaikkiin saapuviin token-siirtoihin sisältyy liitteenä muistio, kun
se on otettu käyttöön token account -tilillä. Token account -tilin omistaja voi
ottaa tämän laajennuksen käyttöön tai poistaa sen käytöstä.
