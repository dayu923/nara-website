...
title: Pysyvä valtuutettu
description: Opi miten toteuttaa InitializePermanentDelegate-laajennus.

---


## Miten toteuttaa InitializePermanentDelegate-laajennus
...
määrittää peruuttamattoman valtuutetun, jolla on valtuudet kaikkiin token
account -tileihin tietyssä mintissä. Toisin kuin tavalliset valtuutetut, joita
token account -tilien omistajat voivat peruuttaa, pysyvää valtuutettua ei voi
muuttaa tai poistaa. Pysyvä valtuutettu voi siirtää, polttaa ja jäädyttää
tokeneita missä tahansa kyseisen mintin token account -tilissä.
