...
jatkuvasti verkon aikaleiman perusteella, mutta varsinainen token-saldo kussakin
token accountissa pysyy muuttumattomana. Kokonaisarvo (token-saldo plus kertynyt
korko) on vain laskennallinen. Tämä laajennus ei luo uusia tokeneita.
