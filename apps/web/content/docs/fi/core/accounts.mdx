...
Kaikki data Nara Solana-verkossa tallennetaan tileihin. Voit ajatella Nara Solana-verkkoa
...
paikantamiseen Nara Solana-lohkoketjussa. Tilien osoitteet näytetään usein
base58-koodattuina merkkijonoina. Useimmat tilit käyttävät
[Ed25519](https://ed25519.cr.yp.to/) [julkista avainta](#public-key)
osoitteenaan, mutta tämä ei ole pakollista, sillä Nara Solana tukee myös
...
Alla oleva esimerkki näyttää, miten Nara Solana SDK:ta käytetään keypair-avaimen
...
valinnaista syötettä (siemeniä). Alla oleva esimerkki näyttää, miten Nara Solana
...
Datan lukeminen Nara Solana-tililtä sisältää kaksi vaihetta:
...
Jokaisella Nara Solana-tilillä on [ohjelma](/docs/core/programs), joka on määritetty
...
Kun NSO lähetetään uuteen osoitteeseen ensimmäistä kertaa, tili luodaan
