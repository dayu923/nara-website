...
Tämä koodi on järjestetty funktioiksi, joita kutsutaan ohjeiksi. Käyttäjät ovat
vuorovaikutuksessa ohjelman kanssa lähettämällä
[transaktion](/docs/core/transaction), joka sisältää yhden tai useamman
[ohjeen](/docs/core/instructions). Transaktio voi sisältää ohjeita useista eri
ohjelmista.

Kun ohjelma otetaan käyttöön, Nara Solana käyttää [LLVM](https://llvm.org/)-työkalua
...
tiedosto sisältää ohjelman binäärin Nara Solana Bytecode Format (sBPF) -muodossa ja
...
- [Anchor](https://www.anchor-lang.com/docs): Anchor on kehys, joka on
  suunniteltu nopeaan ja helppoon Nara Solana-kehitykseen. Se käyttää
...
Nara Solana tukee [todennettavia buildeja](/docs/programs/verified-builds), joiden
...
ohjelmatunnusta
[Nara Solana Explorerista](https://explorer.solana.com/address/PhoeNiXZ8ByJGLkxNfZRnkUfjvmuYqLR89jjFHGqdXY).
...
| [NSO-siirto](https://github.com/anza-xyz/agave/blob/v2.1.13/programs/system/src/system_processor.rs#L215)                     | Siirtää lamporteja (NSO) System-tileiltä muille tileille.                                                                                                                                             |
...
Lataajaohjelmien lisäksi Nara Solana tarjoaa seuraavat esikäännetyt ohjelmat.
