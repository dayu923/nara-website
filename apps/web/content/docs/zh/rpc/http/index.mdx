...
title: HTTP 方法
seoTitle: Nara Solana RPC HTTP 方法
hideTableOfContents: false
h1: Nara Solana RPC HTTP 方法

---


Nara Solana 节点使用 [JSON-RPC 2.0](https://www.jsonrpc.org/specification)
规范接受 HTTP 请求。

> 对于 JavaScript 应用程序，请使用
> [@solana/web3.js](https://github.com/solana-labs/solana-web3.js)
> 库作为与 Nara Solana 节点交互的 RPC 方法的便捷接口。对于与 Nara Solana 节点的 PubSub 连接，请使用
...
- 交易：由客户端密钥对签名的 Nara Solana 指令列表，用于授权这些操作。
