...
title: 计息代币
description: 了解如何启用 InterestBearingMintExtension。

---


## 如何启用 InterestBearingExtension
...
可以直接在 mint account 上设置利率。利息会根据网络时间戳持续复利，但每个 token
account 中存储的实际代币余额保持不变。总价值（代币余额加上累计利息）只是一个计算结果。使用此扩展不会铸造新的代币。
