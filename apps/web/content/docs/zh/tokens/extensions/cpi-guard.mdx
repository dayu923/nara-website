...
title: CPI Guard
description: 了解如何启用 CpiGuardExtension。

---


## 如何启用 CpiGuardExtension
...
通过跨程序调用 (CPI) 保护代币账户免受意外转账的影响。启用后，此扩展确保代币只能通过直接调用 Token
Extensions Program 的转账指令进行转移，阻止所有其他程序通过 CPI 转移代币。
