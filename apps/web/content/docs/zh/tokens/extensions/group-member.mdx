...
将一个 mint 设定为组 mint（例如集合 NFT），其指向包含
[组配置](https://github.com/solana-program/token-group/blob/3b4ff305452fa35754206fc1ad4addb2e2bff511/interface/src/state.rs#L16)
（如更新权限和最大大小）的账户。
...
将一个 mint 设定为成员 mint（例如集合中的 NFT），其指向包含
[成员数据](https://github.com/solana-program/token-group/blob/3b4ff305452fa35754206fc1ad4addb2e2bff511/interface/src/state.rs#L67)
（如组地址和成员编号）的账户。
