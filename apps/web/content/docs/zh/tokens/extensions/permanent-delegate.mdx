...
title: 永久委托
description: 了解如何实现 InitializePermanentDelegate 扩展。

---


## 如何实现 InitializePermanentDelegate 扩展
...
分配了一个不可撤销的委托，该委托对某个铸币的所有 token
account 拥有权限。与 token
account 所有者可以撤销的常规委托不同，永久委托无法更改或移除。永久委托可以转移、销毁和冻结该铸币的任何 token
account 中的代币。
