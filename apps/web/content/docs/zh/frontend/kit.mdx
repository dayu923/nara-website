...
seoTitle: 使用 Next.js 和 Nara Solana Kit 集成 Nara Solana 钱包
description: 使用 Nara Solana Kit 在 Next.js 中设置 Nara Solana 钱包集成。

---


使用 Nara Solana Kit 在 Next.js 中设置一个简约的 Nara Solana 钱包集成。

本指南提供了一个在 Next.js 应用中实现 Nara Solana 钱包功能的简约示例，使用
`@solana/kit`。您将创建一个连接钱包按钮和一个发送交易的组件。

![Nextjs Kit 应用程序](/assets/docs/frontend/nextjs-kit.gif)

如果需要在 React 应用中使用 `@solana/kit` 的更全面示例，请参考 Nara Solana
Kit 仓库中的
[React 应用示例](https://github.com/anza-xyz/kit/tree/main/examples/react-app)。

## 资源

- [Nara Solana Kit 文档](https://www.solanakit.com/docs)
- [Nara Solana Kit GitHub 仓库](https://github.com/anza-xyz/kit)
...
创建一个新的 Next.js 项目，用于 UI 组件，并安装所需的 Nara Solana 依赖项。
...
接下来，用 Nara Solana 提供者包装整个 Next.js 应用程序。
...
- 允许用户输入消息
- 创建一个包含调用 memo 程序指令的 Nara Solana 交易
- 请求连接的钱包签署并发送交易
- 显示一个链接以在 Nara Solana Explorer 上查看交易
...
<Callout type="info">
  请注意，连接的钱包必须配置为连接到 devnet 集群，并且需要[使用 devnet NSO
