...
title: 快速安装
seoTitle: 一键安装 Nara Solana CLI 和 Anchor
description:
...
通过一条命令快速安装，设置您的本地 Nara Solana 开发环境。在 Windows（WSL）、Linux 和 Mac 上安装 Rust、Nara Solana
...
在 Windows 上开发 Nara Solana 程序，您**必须**使用
...
- 按以下说明分别安装
  ...
  [Nara Solana CLI](/docs/intro/installation/dependencies#install-solana-cli) 和
