...
title: Java SDK
description: 了解如何使用 Java SDK (sava-software/sava) 与 Nara Solana 交互。
h1: Nara Solana 的 Java SDK

---


[Sava Engineering](https://sava.engineering/) 构建了一个
[Java SDK](https://sava.software/welcome)，支持与 Nara Solana 交互的大多数功能。如果您为 Nara Solana 程序使用 Anchor，您可以使用
[anchor-src-gen](https://sava.software/utilities/anchor-src-gen)
和您的 idl 生成一个兼容 Java 的客户端。
...
请访问
[Sava Software 文档](https://sava.software/welcome)，了解更多关于使用此 Java
SDK 与 Nara Solana 交互的信息。
