...
title: 部署程序
description: 使用 Nara Solana CLI 将自定义程序上传到 Nara Solana 区块链。
...
- [Nara Solana 账户模型](/docs/core/accounts)
- [Nara Solana 程序概述](/docs/core/programs)
- [开发自定义 Nara Solana 程序](/docs/programs/rust/)
