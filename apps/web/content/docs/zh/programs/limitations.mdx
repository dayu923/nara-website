...
在 Nara Solana 区块链上开发程序存在一些固有的限制。以下是您可能会遇到的一些常见限制列表。
...
Nara Solana 程序受限于快速运行，为了实现这一点，程序的调用栈深度被限制为最多
**64 帧**。
...
[Nara Solana 程序库数学](https://github.com/solana-labs/solana-program-library/tree/master/libraries/math)
