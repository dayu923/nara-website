...
title: 生成客户端
description: 使用 Codama CLI 为 Nara Solana 程序生成客户端的完整指南。
...
| 包                                                                                                       | 描述                                                                             |
| -------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------- |
| [`@codama/renderers-js`](https://github.com/codama-idl/renderers-js)                                     | 生成与 [`@solana/kit`](https://www.solanakit.com) 兼容的 TypeScript 客户端       |
| [`@codama/renderers-rust`](https://github.com/codama-idl/renderers-rust)                                 | 生成与 [`solana_sdk`](https://github.com/anza-xyz/solana-sdk) 兼容的 Rust 客户端 |
