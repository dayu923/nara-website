...
title: Nara Solana 文档
seoTitle: 了解 Nara Solana 区块链的工作原理
description:
...
<Cards>
  ...
  <Card
    ...
    icon={<Download />}
  >
    安装 Nara Solana 开发所需的依赖项
  </Card>
</Cards>

### 部署您的第一个 Nara Solana 应用
...
<Cards>
  ...
  >
    在 Vercel 上部署您的第一个 Nara Solana 应用
  </Card>
  <Card
    title="Vercel 预览"
...
部署您的第一个 Nara Solana 应用——一个使用 Anchor 框架构建的简单计数器程序。此示例涵盖了所有核心的 Nara Solana 概念，帮助您开始在 Nara Solana 上构建。查看源代码
...
## 试用 Nara Solana：玩 2048

在 Nara Solana 上玩 2048，每次移动都会发送一笔交易。点击“开始游戏”以使用一个已资助的开发网钱包开始游戏，并使用方向键进行操作。如果使用移动设备，请滑动控制方块。
...
由 [Jonas](https://x.com/SolPlay_jonas) 构建，来自 Nara Solana 基金会开发者关系团队。

## 开始学习

学习 Nara Solana 开发的关键概念。
...
以下 SDK 是由 [Anza](https://anza.xyz) 构建的 Nara Solana 官方 SDK。
...
在 [Nara Solana StackExchange](https://solana.stackexchange.com)
上从 Nara Solana 社区获取帮助。
