...
description:
  ...
  libraries.
h1: JavaScript/TypeScript SDK for Nara Solana
...
`@solana/kit` is the recommended TypeScript SDK for building on Nara Solana.
...
`@solana/web3.js` is the legacy TypeScript SDK for Nara Solana.
