...
title: Close Mint
description: Learn how enable the MintCloseAuthority extension.

---


## How to enable the MintCloseAuthority extension
...
extension enables mint accounts to be closed and their rent reclaimed. This
extension must be initialized when the mint is created.

Only the designated close authority can close the mint account. Similar to how
token accounts can only be closed when the token balance is zero, mint accounts
with this extension can only be closed when the entire token supply has been
reduced to zero.
