...
title: Memo transfer
description: Learn how to enable the MemoTransferExtension.

---


## How to enable the MemoTransferExtension
...
requires all incoming token transfers to include an accompanying memo when
enabled on a token account. This extension can be enabled or disabled by the
token account owner.
