...
description: Learn how to enable the ImmutableOwner Extension.

---


## How to enable the ImmutableOwner Extension
...
extension prevents ownership changes for token accounts. When a token account is
initialized with this extension, the designated owner is permanent and cannot be
