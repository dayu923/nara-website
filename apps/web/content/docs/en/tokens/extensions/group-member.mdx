...
description:
  Learn how to enable the GroupPointerExtension and GroupMemberPointerExtension.

---


## How to enable the GroupPointerExtension and GroupMemberPointerExtension
...
designates a mint as a group mint (such as a Collection NFT) by pointing to an
account containing
[group configurations](https://github.com/solana-program/token-group/blob/3b4ff305452fa35754206fc1ad4addb2e2bff511/interface/src/state.rs#L16)
like update authority and maximum size.
...
designates a mint as a member mint (such as an NFT in a collection) by pointing
to an account containing
[membership data](https://github.com/solana-program/token-group/blob/3b4ff305452fa35754206fc1ad4addb2e2bff511/interface/src/state.rs#L67)
like group address and member number.

Token Extensions Program implements the
[Token Group Interface](https://github.com/solana-program/token-group) directly,
allowing both group and member data to be stored on the mint account itself.
When the pointer extensions point to the mint itself, the
...
extensions can be used to store all collection and membership data in the mint
account.
