...
The Rust example below shows the steps for confidential token transfers
corresponding to the preceding diagram. The steps are separated into helper
...
installed to use the local validator.
