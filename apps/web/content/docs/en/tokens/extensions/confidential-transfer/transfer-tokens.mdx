...
4. Close the proof context state accounts to recover the NSO used to create
   them.
...
The following example demonstrates how to confidentially transfer tokens between
token accounts.
