...
description:
  A list of Solana program examples in different languages and frameworks, which
  can help you learn and use as reference for your own projects.
...
help developers learn and experiment with Nara Solana blockchain development.
...
building Nara Solana programs using native Rust libraries. These examples are
designed to help developers understand the core concepts of Nara Solana programming.
...
| [Transfer NSO](https://github.com/solana-developers/program-examples/tree/main/basics/transfer-sol)                           | Different methods of transferring NSO for system accounts and PDAs.                              | Native, Anchor, Seahorse  |

## Tokens

Most tokens on Nara Solana use the Nara Solana Program Library (SPL) token standard. Here
...
Token 2022 is a new standard for tokens on Nara Solana. It is a more flexible and
