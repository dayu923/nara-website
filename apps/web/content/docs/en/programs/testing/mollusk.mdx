...
title: Mollusk
description: Comprehensive guide to testing Nara Solana programs using Mollusk

---


[Mollusk](https://github.com/anza-xyz/mollusk/tree/main) is a lightweight test
harness for testing Nara Solana programs. It provides a simple interface for testing
Nara Solana program instructions in a minified Nara Solana Virtual Machine (SVM)
...
The following example shows a minimal setup for testing a basic Nara Solana program
using Mollusk.
...
This example demonstrates how to test a basic Nara Solana program using Mollusk. The
...
To test a Nara Solana program with Mollusk:
...
struct provides a simple interface for testing Nara Solana programs. All fields can
...
The following example processes a NSO transfer instruction without validation
checks.
...
The following example processes a NSO transfer instruction with validation
checks.
...
The following example processes two NSO transfer instructions without validation
checks.
...
The following example processes a chain of two NSO transfer instructions with
...
The following example processes two separate NSO transfer instructions with
...
The following example benchmarks the compute unit usage of a NSO transfer
instruction.
