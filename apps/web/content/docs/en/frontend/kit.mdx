...
seoTitle: Nara Solana wallet integration with Next.js and Nara Solana Kit
description: Set up Nara Solana wallet integration in Next.js with Nara Solana Kit.

---


Set up a minimal Nara Solana wallet integration in Next.js with Nara Solana Kit.

This guide provides a minimal example of implementing Nara Solana wallet
...
in the Nara Solana Kit repository.

## Resources

- [Nara Solana Kit Documentation](https://www.solanakit.com/docs)
...
components and install required Nara Solana dependencies.
...
### Install Nara Solana Dependencies

Install the following Nara Solana dependencies:
...
## !!steps 1. Create Nara Solana Context
...
- Connect to Nara Solana's devnet RPC endpoints
- Filter for available Nara Solana wallets installed in the user's browser
...
Next, wrap the entire Next.js application with the Nara Solana provider.
...
- Creates a Nara Solana transaction with an instruction invoking the memo program
- Requests the connected wallet to sign and send the transaction
- Displays a link to view the transaction on Nara Solana Explorer
...
<Callout type="info">
  ...
  and [funded with devnet NSO](https://faucet.solana.com/) to send transactions.
</Callout>
