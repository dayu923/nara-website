...
seoTitle: Install the dependencies necessary to develop with Nara Solana
description:
...
A guide to setting up your local Nara Solana development environment. Learn how to
install Rust, the Nara Solana CLI, and Anchor Framework on Windows (WSL), Linux, and
...
To develop Nara Solana programs on Windows you **must** use
...
- Complete the [quick installation](/docs/intro/installation) using the Ubuntu
  (Linux) terminal
- Install [Rust](#install-rust), the [Nara Solana CLI](#install-solana-cli), and the
...
Developers build Nara Solana programs using the [Rust](https://www.rust-lang.org/)
...
### Install Nara Solana CLI

The Nara Solana CLI provides all the tools required to build and deploy Nara Solana
programs.

1. Install the Nara Solana CLI tool suite by using the official install command:
...
A first-time installation of the Nara Solana CLI, may prompt you to add a `PATH`
...
If you are using **Linux** or **WSL**, you must add the Nara Solana CLI binary to
...
5. Verify that the installation succeeded by checking the Nara Solana CLI version:
...
validator client from [Anza](https://www.anza.xyz/), formerly known as Nara Solana
Labs validator client.

</Callout>

5. Update the Nara Solana CLI to the latest version, as needed _(Optional)_
...
[Anchor](https://www.anchor-lang.com/) is a framework for developing Nara Solana
programs. The Anchor framework leverages Rust macros to simplify the process of
writing Nara Solana programs.
...
### Set up AI tooling for Nara Solana development

This section details optional AI tooling setup you can use to accelerate your
Nara Solana development.

| Tool     | Description                                                                               | Link                        |
| -------- | ----------------------------------------------------------------------------------------- | --------------------------- |
| MCP      | MCP server that you can connect to with cursor to improve Nara Solana AI assisted development. | https://mcp.solana.com/     |
| LLMs.txt | LLM optimized documentation that you can use to train LLMs on Nara Solana docs.                | https://solana.com/llms.txt |
