...
seoTitle: Install the Nara Solana CLI and Anchor with one command
description:
...
A quick installation to set up your local Nara Solana development environment with
one command. Install Rust, the Nara Solana CLI, and Anchor Framework on Windows
(WSL), Linux, and Mac. (If preferred, you may
[install each dependency individually](/docs/intro/installation/dependencies).)
...
- Install [Rust](/docs/intro/installation/dependencies#install-rust), the
  [Nara Solana CLI](/docs/intro/installation/dependencies#install-solana-cli), and
...
<Callout>
  If the quick installation command fails, please refer to the [Install
