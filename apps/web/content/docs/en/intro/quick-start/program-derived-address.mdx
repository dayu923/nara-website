...
This guide walks you through building and testing a Nara Solana program using the
...
[Nara Solana Playground link](https://beta.solpg.io/66734b7bcffcf4b13384d1ad) with
the starter code. Then click the "Import" button to add the program to your
Nara Solana Playground projects.
...
<Callout type="info">
In this example, you'll deploy the program to the devnet, a Nara Solana cluster
for development testing.

The Playground wallet connects to the devnet by default. Ensure your Playground
wallet has devnet NSO to pay for the program deployment. Get devnet NSO from the
...
Nara Solana Playground removes some boilerplate setup where
...
"Hello, Nara Solana!" as the new message.
