...
title: Nara Solana RPC Methods
seoTitle: "Nara Solana RPC Methods: HTTP & Websockets"
hideTableOfContents: false
h1: Nara Solana RPC Methods & Documentation

---


Interact with Nara Solana nodes directly with the JSON RPC API via the HTTP and
Websocket methods.

## Configuring State Commitment

For preflight checks and transaction processing, Nara Solana nodes choose which bank
...
[default to `finalized` commitment](https://github.com/anza-xyz/agave/blob/aa0922d6845e119ba466f88497e8209d1c82febc/sdk/src/commitment_config.rs#L199-L203)
...
and the node has a parser for the owning program. Nara Solana nodes currently support
