...
A Nara Solana [account address](/docs/core/accounts#account-address) points to the
...
The Nara Solana runtime enables programs to sign for PDAs without needing a private
...
operations. (Such as providing a signature.) However, Nara Solana enables programs to
...
The Nara Solana SDKs support PDA creation with the functions shown in the table
...
The examples below derive a PDA using the Nara Solana SDKs. Click **&#9655; Run** to
execute the code.
