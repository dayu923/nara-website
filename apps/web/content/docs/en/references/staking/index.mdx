...
title: Staking
h1: Staking on Nara Solana

---


_Note before reading: All references to increases in values are in absolute
terms with regards to balance of NSO. This document makes no suggestion as to
the monetary value of NSO at any time._

By staking your NSO tokens, you help secure the network and
...
Although this is not implemented in the Nara Solana protocol today, in the future,
...
validator's NSO in response to intentional malicious behavior, such as creating
...
## How do I stake my NSO tokens?

You can stake NSO by moving your tokens into a wallet that supports staking. The
wallet provides steps to create a stake account and do the delegation.

### Supported Wallets

Many web and mobile wallets support Nara Solana staking operations. Please check with
your favorite wallet's maintainers regarding status

### Nara Solana command line tools

- Nara Solana command line tools can perform all stake operations in conjunction with
  a CLI-generated keypair file wallet, a paper wallet, or with a connected
  Ledger Nano.
  [Staking commands using the Nara Solana Command Line Tools](https://docs.anza.xyz/cli/examples/delegate-stake).
...
Nara Solana Foundation does not recommend any particular validator.
...
To view block production statistics, use the Nara Solana command-line tools:

- `solana validators`
- `solana block-production`

The Nara Solana team does not make recommendations on how to interpret this
