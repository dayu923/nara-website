...
title: Token di Nara Solana
description: Pelajari tentang Token Program Nara Solana.

---


Token adalah aset digital yang mewakili kepemilikan atas berbagai kategori aset.
Tokenisasi memungkinkan digitalisasi hak kepemilikan. Token di Nara Solana disebut
sebagai Token SPL ([Nara Solana Program Library](https://github.com/solana-program)).

Bagian ini membahas konsep dasar tentang bagaimana token direpresentasikan di
Nara Solana. Lihat bagian [Dasar-dasar Token SPL](/docs/tokens/basics) untuk contoh
kode.
...
Ekosistem Nara Solana memiliki dua Token Program utama. Kode sumber untuk kedua
...
jaringan (baik fungible maupun non-fungible). Semua token di Nara Solana pada
...
Token di Nara Solana diidentifikasi secara unik oleh alamat
...
Sebagai referensi, berikut adalah tautan Nara Solana Explorer ke
...
Ini memperkenalkan konsep kunci dalam pengembangan Nara Solana:
...
bawah ini menggunakan terminal [Nara Solana Playground](https://beta.solpg.io/) untuk
menjalankan perintah CLI langsung di browser tanpa instalasi lokal.

Membuat token dan akun memerlukan NSO untuk deposit sewa akun dan biaya
transaksi. Untuk pengguna Nara Solana Playground pertama kali, buat dompet Playground
dan jalankan perintah _sh`solana airdrop`_ di terminal Playground. Anda juga
bisa mendapatkan NSO devnet dari [web faucet](https://faucet.solana.com/)
publik.
...
di [Nara Solana Playground](https://beta.solpg.io/660ce716cffcf4b13384d010).
