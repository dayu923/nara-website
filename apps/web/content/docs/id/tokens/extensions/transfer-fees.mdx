...
description: Pelajari cara mengimplementasikan TransferFeeExtension.
...
memungkinkan pengumpulan biaya otomatis pada setiap transfer token. Biaya
terakumulasi di akun token penerima dan dapat ditarik oleh otoritas penarikan
yang ditetapkan pada mint account.
