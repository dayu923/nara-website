...
title: Token Berbunga
description: Pelajari cara mengaktifkan InterestBearingMintExtension.

---


## Cara mengaktifkan InterestBearingExtension
...
memungkinkan Anda untuk menetapkan suku bunga langsung pada mint account. Bunga
terus bertambah berdasarkan timestamp jaringan, tetapi saldo token yang
sebenarnya tersimpan di setiap token account tetap tidak berubah. Total nilai
(saldo token ditambah bunga yang bertambah) hanyalah sebuah perhitungan. Tidak
ada token baru yang dicetak dengan ekstensi ini.
