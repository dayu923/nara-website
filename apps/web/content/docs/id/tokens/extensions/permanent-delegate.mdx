...
title: Delegasi Permanen
description:
  Pelajari cara mengimplementasikan ekstensi InitializePermanentDelegate.

---


## Cara mengimplementasikan ekstensi InitializePermanentDelegate
...
menetapkan delegasi yang tidak dapat dicabut dengan otoritas atas semua token
account untuk suatu mint. Tidak seperti delegasi biasa yang dapat dicabut oleh
pemilik token account, delegasi permanen tidak dapat diubah atau dihapus.
Delegasi permanen dapat mentransfer, membakar, dan membekukan token di token
account mana pun dari mint tersebut.
