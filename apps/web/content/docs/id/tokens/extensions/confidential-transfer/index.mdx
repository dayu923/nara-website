...
title: Transfer Rahasia
description:
  Pelajari tentang ekstensi Transfer Rahasia dan cara menggunakannya untuk
  menambahkan fitur opsional ke mint dan akun token.
...
## Apa itu Transfer Rahasia?

Transfer rahasia memungkinkan Anda mentransfer token antar token account tanpa
...
- [Gambaran Umum Protokol](https://www.solana-program.com/docs/confidential-balances/overview) -
...
ke Token Extensions Program yang memungkinkan Anda mentransfer token antar akun
tanpa mengungkapkan jumlah transfer.
...
4. **Deposit** saldo publik pengirim ke **saldo tertunda rahasia**.
5. **Terapkan** saldo tertunda pengirim ke **saldo tersedia rahasia**.
6. Secara rahasia **transfer** token dari token account pengirim ke token
   account penerima.
...
<Cards>
  <Card
    title="Membuat Mint Account"
    href="/docs/tokens/extensions/confidential-transfer/create-mint"
  >
    Cara membuat mint account dengan ekstensi Confidential Transfer
  </Card>
  <Card
    title="Membuat Token Account"
    href="/docs/tokens/extensions/confidential-transfer/create-token-account"
  >
    Cara mengonfigurasi token account dengan ekstensi Confidential Transfer
  </Card>
  <Card
    title="Deposit Token"
    href="/docs/tokens/extensions/confidential-transfer/deposit-tokens"
  >
    Cara melakukan deposit token ke saldo tertunda yang bersifat rahasia
  </Card>
  <Card
    title="Menerapkan Saldo Tertunda"
  ...
  >
    Cara mentransfer token secara rahasia antar token account
  </Card>
</Cards>
...
Contoh Rust di bawah ini menunjukkan langkah-langkah untuk transfer token
rahasia yang sesuai dengan diagram sebelumnya. Langkah-langkah tersebut
dipisahkan menjadi fungsi pembantu untuk kejelasan.
...
Nara Solana CLI yang terinstal untuk menggunakan validator lokal.
...
## Instruksi Confidential Transfer

Daftar lengkap ekstensi Confidential Transfer
[instruksi](https://github.com/solana-program/token-2022/blob/efd0c957fefbd79882d77df5fb2dac88c001249c/program/src/extension/confidential_transfer/instruction.rs#L29)
...
| _rs`UpdateMint`_                    | Memperbarui pengaturan transfer rahasia untuk mint.                                                                                                               |
...
| _rs`Deposit`_                       | Mengkonversi saldo token publik menjadi saldo rahasia tertunda.                                                                                                   |
| _rs`Withdraw`_                      | Mengkonversi saldo rahasia yang tersedia kembali menjadi saldo publik.                                                                                            |
| _rs`Transfer`_                      | Mentransfer token antar token account secara rahasia.                                                                                                             |
| _rs`ApplyPendingBalance`_           | Mengkonversi saldo tertunda menjadi saldo tersedia setelah deposit atau transfer.                                                                                 |
| _rs`EnableConfidentialCredits`_     | Memungkinkan token account menerima transfer token rahasia.                                                                                                       |
| _rs`DisableConfidentialCredits`_    | Memblokir transfer rahasia masuk sambil tetap memungkinkan transfer publik.                                                                                       |
| _rs`EnableNonConfidentialCredits`_  | Memungkinkan token account menerima transfer token publik.                                                                                                        |
| _rs`DisableNonConfidentialCredits`_ | Memblokir transfer reguler untuk membuat akun hanya menerima transfer rahasia.                                                                                    |
| _rs`TransferWithFee`_               | Mentransfer token antar token account secara rahasia dengan biaya.                                                                                                |
| _rs`ConfigureAccountWithRegistry`_  | Cara alternatif untuk mengonfigurasi token account untuk transfer rahasia menggunakan akun _rs`ElGamalRegistry`_ alih-alih bukti _rs`VerifyPubkeyValidity`_.      |
