...
title: Tutup Mint
description: Pelajari cara mengaktifkan ekstensi MintCloseAuthority.

---


## Cara mengaktifkan ekstensi MintCloseAuthority
...
memungkinkan mint account untuk ditutup dan rent-nya diklaim kembali. Ekstensi
ini harus diinisialisasi saat mint dibuat.

Hanya close authority yang ditunjuk yang dapat menutup mint account. Mirip
dengan bagaimana token account hanya dapat ditutup ketika saldo token adalah
nol, mint account dengan ekstensi ini hanya dapat ditutup ketika seluruh pasokan
token telah berkurang menjadi nol.
