...
description: Pelajari cara mengaktifkan InitializeNonTransferableMint.

---


## Cara mengaktifkan ekstensi InitializeNonTransferableMint
...
mencegah token ditransfer antar token account setelah minting. Setelah di-mint,
token akan tetap berada secara permanen di token account. Namun, pemilik token
account masih dapat membakar (burn) token dan menutup token account ketika saldo
mencapai nol.
