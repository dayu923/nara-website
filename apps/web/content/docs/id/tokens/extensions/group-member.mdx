...
description:
  Pelajari cara mengaktifkan GroupPointerExtension dan
  GroupMemberPointerExtension.

---


## Cara mengaktifkan GroupPointerExtension dan GroupMemberPointerExtension
...
menetapkan mint sebagai mint grup (seperti Collection NFT) dengan menunjuk ke
akun yang berisi
[konfigurasi grup](https://github.com/solana-program/token-group/blob/3b4ff305452fa35754206fc1ad4addb2e2bff511/interface/src/state.rs#L16)
seperti otoritas pembaruan dan ukuran maksimum.
...
menetapkan mint sebagai mint anggota (seperti NFT dalam koleksi) dengan menunjuk
ke akun yang berisi
[data keanggotaan](https://github.com/solana-program/token-group/blob/3b4ff305452fa35754206fc1ad4addb2e2bff511/interface/src/state.rs#L67)
seperti alamat grup dan nomor anggota.

Token Extensions Program mengimplementasikan
[Token Group Interface](https://github.com/solana-program/token-group) secara
langsung, memungkinkan data grup dan anggota disimpan pada akun mint itu
sendiri. Ketika ekstensi pointer menunjuk ke mint itu sendiri, ekstensi
...
dapat digunakan untuk menyimpan semua data koleksi dan keanggotaan dalam akun
mint.
