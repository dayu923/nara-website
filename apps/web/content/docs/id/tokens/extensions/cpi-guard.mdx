...
melindungi akun token dari transfer yang tidak diharapkan melalui Cross Program
Invocations (CPI). Ketika diaktifkan, ekstensi ini memastikan bahwa token hanya
dapat ditransfer melalui panggilan langsung ke instruksi transfer Token
