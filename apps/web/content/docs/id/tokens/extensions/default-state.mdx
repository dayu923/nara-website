...
description: Pelajari cara mengaktifkan DefaultAccountStateExtension.

---


## Cara mengaktifkan DefaultAccountStateExtension
...
menetapkan status default untuk semua token account baru yang dibuat untuk
sebuah mint. Ketika diaktifkan, ekstensi ini secara otomatis menginisialisasi
setiap token account baru dengan status tertentu, seperti frozen (dibekukan).
Hal ini memungkinkan pembuat token untuk menerapkan perilaku spesifik, seperti
mewajibkan semua akun baru dibekukan secara default sampai secara eksplisit
dicairkan.
