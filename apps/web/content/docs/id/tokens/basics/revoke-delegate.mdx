...
title: Mencabut Delegasi
description: Pelajari cara mencabut delegasi token account.

---


## Cara Mencabut delegasi
...
menghapus semua izin transfer dari delegasi yang saat ini disetujui. Setelah
pencabutan, delegasi tidak dapat lagi mentransfer token apa pun dari akun Anda.
Hanya pemilik token account yang dapat mencabut delegasi.
...
<Callout type="info">
  ...
  memiliki implementasi yang mirip untuk mencapai fungsionalitas yang sama.
</Callout>
