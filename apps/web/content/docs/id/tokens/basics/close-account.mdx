...
title: Menutup Token Account
description: Pelajari cara menutup token account.
...
secara permanen menutup token account dan mentransfer semua NSO (rent) yang
tersisa ke account tujuan yang ditentukan. Saldo token account harus nol sebelum
ditutup. Hanya pemilik token account atau otoritas penutupan yang ditunjuk yang
dapat mengeksekusi instruksi ini.
