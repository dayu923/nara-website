...
title: Bakar Token
description: Pelajari cara membakar token.
...
secara permanen menghancurkan token dengan mengurangi saldo dalam token account.
Token yang dibakar dihapus dari peredaran dan mengurangi `supply` yang dilacak
pada mint account. Hanya pemilik token account yang dapat membakar token dari
akun mereka.
