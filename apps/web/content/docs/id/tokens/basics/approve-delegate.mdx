...
title: Menyetujui Delegasi
description: Pelajari cara menyetujui delegasi untuk token account.

---


## Cara Menyetujui delegasi
...
memberikan izin kepada akun lain (delegasi) untuk mentransfer sejumlah token
tertentu dari token account Anda. Delegasi dapat mentransfer token hingga jumlah
yang disetujui, tetapi tidak dapat melebihinya. Hanya pemilik token account yang
dapat menyetujui delegasi, dan setiap token account hanya dapat memiliki satu
delegasi pada satu waktu. Setiap persetujuan baru akan menimpa persetujuan
sebelumnya.
