...
title: Membekukan Akun
description: Pelajari cara membekukan token account.
...
mencegah semua transfer token atau pembakaran token dari token account tertentu.
Setelah dibekukan, akun tidak dapat mengirim token, menerima token, atau ditutup
sampai dicairkan kembali. Hanya freeze authority dari mint token yang dapat
membekukan akun. Jika freeze authority dicabut (diatur ke null) pada mint
account, token tidak akan pernah bisa dibekukan.
