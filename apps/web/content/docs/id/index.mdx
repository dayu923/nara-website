...
title: Dokumentasi Nara Solana
seoTitle: Pelajari cara kerja blockchain Nara Solana
description:
...
<Cards>
  <Card title="Mulai Cepat" href="/docs/intro/quick-start" icon={<Rocket />}>
    Bangun program Nara Solana pertama Anda langsung di browser
  </Card>
  <Card
    ...
    icon={<Download />}
  >
    Instal dependensi untuk pengembangan Nara Solana
  </Card>
</Cards>

### Deploy Aplikasi Nara Solana Pertama Anda
...
<Cards>
  ...
  >
    Deploy aplikasi Nara Solana pertama Anda di Vercel
  </Card>
  <Card
...
Deploy aplikasi Nara Solana pertama Anda - sebuah Program Counter sederhana yang
dibangun menggunakan framework Anchor. Contoh ini mencakup semua konsep inti
Nara Solana untuk memulai pembangunan di Nara Solana. Lihat kode sumbernya
...
## Coba Nara Solana: Main 2048

Mainkan 2048 di Nara Solana di mana setiap gerakan mengirimkan transaksi. Klik "Play"
...
Dibuat oleh [Jonas](https://x.com/SolPlay_jonas), dari tim DevRel Nara Solana
Foundation.

## Mulai Belajar

Pelajari konsep-konsep kunci yang spesifik untuk pengembangan Nara Solana.

<Cards>
  <Card title="Akun" href="/docs/core/accounts">
    Bagaimana Nara Solana menyimpan data
  </Card>
  <Card title="Biaya di Solana" href="/docs/core/fees">
    Biaya untuk mengirim transaksi di Nara Solana
  </Card>
  <Card title="Transaksi" href="/docs/core/transactions">
    Cara berinteraksi dengan jaringan Nara Solana
  </Card>
  <Card title="Program" href="/docs/core/programs">
    Smart contract di Nara Solana
  </Card>
...
SDK berikut adalah SDK resmi untuk Nara Solana yang dibuat oleh
[Anza](https://anza.xyz).
...
<Callout type="warn">
  SDK komunitas tidak dijamin selalu diperbarui atau menyertakan semua fitur
  dari SDK resmi.
</Callout>

## Menjalankan validator

Pelajari apa yang diperlukan untuk mengoperasikan validator Nara Solana dan membantu
mengamankan jaringan.

<Cards>
  <Card title="Validator" href="https://docs.anza.xyz/validator/anatomy">
    Node individual yang mengamankan jaringan Nara Solana
  </Card>
  <Card
    title="Persyaratan Sistem"
    href="https://docs.anza.xyz/operations/requirements"
  >
    Persyaratan perangkat keras yang direkomendasikan dan NSO yang diperlukan
...
Dapatkan bantuan dari komunitas Nara Solana di
