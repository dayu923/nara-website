...
Semua data di jaringan Nara Solana disimpan dalam akun. Anda dapat menganggap
jaringan Nara Solana sebagai database publik dengan satu tabel Akun. Hubungan antara
...
blockchain Nara Solana. Alamat akun sering ditampilkan sebagai string yang dikodekan
...
diwajibkan, karena Nara Solana juga mendukung
...
Contoh di bawah ini menunjukkan cara menggunakan SDK Nara Solana untuk membuat
...
(seeds). Contoh di bawah ini menunjukkan cara menggunakan SDK Nara Solana untuk
...
Membaca data dari akun Nara Solana melibatkan dua langkah:
...
Setiap akun Nara Solana memiliki [program](/docs/core/programs) yang ditunjuk sebagai
...
Nara Solana. (Mirip dengan sistem operasi, yang biasanya memiliki file terpisah untuk
program dan datanya.)
...
Ketika NSO dikirim ke alamat baru untuk pertama kalinya, sebuah akun dibuat di
alamat tersebut yang dimiliki oleh System Program.

Dalam contoh di bawah ini, sebuah keypair baru dibuat dan didanai dengan NSO.
