...
Cross Program Invocation (CPI) terjadi ketika satu program Nara Solana secara
langsung memanggil instruksi program lain. Ini memungkinkan komposabilitas
program. Jika Anda menganggap [instruksi](/docs/core/instructions) Nara Solana
...
digunakan untuk menurunkan [PDA](<(/docs/core/pda)>) signer. Runtime Nara Solana
...
Native Rust. Setiap contoh mencakup satu instruksi untuk mentransfer NSO dari
...
dalam Native Rust. Contoh ini mencakup satu instruksi yang mentransfer NSO dari
...
mencakup satu instruksi yang mentransfer NSO dari satu akun ke akun lainnya.
...
Native Rust. Ini mencakup satu instruksi yang mentransfer NSO dari satu akun ke
