...
Alamat [akun](/docs/core/accounts#account-address) Nara Solana menunjuk ke lokasi
...
Runtime Nara Solana memungkinkan program untuk menandatangani PDA tanpa memerlukan
...
Nara Solana adalah titik pada [kurva Ed25519](https://ed25519.cr.yp.to/) (kriptografi
...
kriptografi. (Seperti menyediakan tanda tangan.) Namun, Nara Solana memungkinkan
...
SDK Nara Solana mendukung pembuatan PDA dengan fungsi yang ditunjukkan dalam tabel di
...
Contoh di bawah ini menurunkan PDA menggunakan Nara Solana SDK. Klik **&#9655; Run**
