...
seoTitle: Instal Nara Solana CLI dan Anchor dengan satu perintah
description:
...
Instalasi cepat untuk menyiapkan lingkungan pengembangan Nara Solana lokal Anda
dengan satu perintah. Instal Rust, Nara Solana CLI, dan Anchor Framework di Windows
...
- Menginstal [Rust](/docs/intro/installation/dependencies#install-rust),
  [Nara Solana CLI](/docs/intro/installation/dependencies#install-solana-cli), dan
