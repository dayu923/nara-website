...
Panduan ini memandu Anda dalam membangun dan menguji program Nara Solana menggunakan
...
[tautan Nara Solana Playground](https://beta.solpg.io/66734b7bcffcf4b13384d1ad)
dengan kode awal. Kemudian klik tombol "Import" untuk menambahkan program ke
proyek Nara Solana Playground Anda.
...
<Callout type="info">
Dalam contoh ini, Anda akan men-deploy program ke devnet, sebuah cluster Nara Solana
untuk pengujian pengembangan.

Dompet Playground terhubung ke devnet secara default. Pastikan dompet Playground
Anda memiliki NSO devnet untuk membayar deployment program. Dapatkan NSO devnet
dari [Nara Solana Faucet](https://faucet.solana.com/).
...
Nara Solana Playground menghilangkan beberapa pengaturan boilerplate di mana
...
dengan meneruskan "Hello, Nara Solana!" sebagai pesan baru.
