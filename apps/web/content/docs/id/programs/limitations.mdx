...
Mengembangkan program di blockchain Nara Solana memiliki beberapa batasan yang
melekat padanya. Berikut adalah daftar batasan umum yang mungkin Anda temui.

## Pustaka Rust

Karena program onchain berbasis Rust harus deterministik saat berjalan di
lingkungan single-thread dengan sumber daya terbatas, program tersebut memiliki
beberapa batasan pada berbagai pustaka.
...
Program Nara Solana dibatasi untuk berjalan dengan cepat, dan untuk memfasilitasi
