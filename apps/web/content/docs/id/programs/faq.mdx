...
Program onchain Nara Solana dikompilasi melalui
...
Karena Nara Solana menggunakan infrastruktur kompiler LLVM, program dapat ditulis
...
Peta memori alamat virtual yang digunakan oleh program SBF Nara Solana bersifat tetap
