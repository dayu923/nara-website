...
mengimplementasikan build terverifikasi untuk program mereka di Nara Solana. Kami
...
deploy ke jaringan Nara Solana sesuai dengan kode sumber di repositori Anda. Dengan
...
Anda dalam lingkungan terkontrol menggunakan Nara Solana Verify CLI dan Docker. Ini
...
men-deploy-nya ke jaringan Nara Solana. Selama proses pembangunan, sebuah
...
kemungkinan besar akan gagal karena build program Nara Solana tidak deterministik di
...
### Instal Nara Solana Verify CLI

Nara Solana Verify CLI adalah alat utama yang digunakan untuk memverifikasi build.
Nara Solana Verify CLI saat ini dikelola oleh
...
Untuk membangun program Nara Solana Anda secara terverifikasi, navigasikan ke
...
menerapkannya ke jaringan Nara Solana. Disarankan untuk menggunakan solusi
...
> [cluster Nara Solana](/docs/references/clusters) yang berbeda (yaitu devnet,
> testnet, mainnet). Pastikan Anda menggunakan URL jaringan yang benar untuk
> cluster Nara Solana yang ingin Anda verifikasi programnya. Verifikasi jarak jauh
...
verifikasi ke onchain. Jika Anda melakukannya, Nara Solana Explorer akan segera
...
yang berkontribusi pada ekosistem Nara Solana yang lebih sehat.
...
Menggunakan
[build terverifikasi di Nara Solana](/developers/guides/advanced/verified-builds)
memastikan integritas dan kepercayaan program Anda di jaringan dan memungkinkan
pengembang untuk menemukan SDK Anda langsung dari Nara Solana Explorer. Dengan
memanfaatkan alat seperti Nara Solana Verify CLI dan Docker, Anda dapat
...
program Nara Solana Anda, ini tidak sepenuhnya trustless dalam pengaturan default.
Image docker dibangun dan dihosting oleh Nara Solana Foundation.
...
API atau Nara Solana Explorer berpotensi menampilkan informasi yang salah jika
disusupi.
...
Nara Solana Foundation, OtterSec, dan tim Ellipsis Labs tidak bertanggung jawab atas
kerugian atau kerusakan yang mungkin terjadi akibat penggunaan pipeline build
terverifikasi.

# Security.txt untuk program Nara Solana
...
dan keamanan secara langsung dalam kontrak pintar Nara Solana mereka. Terinspirasi
...
Untuk menambahkan `security.txt` ke program Nara Solana Anda, ikuti langkah-langkah
berikut:
...
tersebut dapat dengan mudah diakses melalui alat seperti Nara Solana Explorer,
...
komunikasi yang lebih baik dalam ekosistem Nara Solana.

Ini adalah
[contoh bagaimana security.txt terlihat di Nara Solana Explorer](https://explorer.solana.com/address/HPxKXnBN4vJ8RjpdqDCU7gvNQHeeyGnSviYTJ4fBrDt4/security?cluster=devnet)
