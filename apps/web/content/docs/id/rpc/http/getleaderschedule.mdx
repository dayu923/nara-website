...
h1: Metode RPC getLeaderSchedule

---


Mengembalikan jadwal pemimpin untuk satu epoch
...
Mengambil jadwal pemimpin untuk epoch yang sesuai dengan slot yang disediakan.
Jika tidak ditentukan, jadwal pemimpin untuk epoch saat ini akan diambil.
...
Mengembalikan `null` jika epoch yang diminta tidak ditemukan, jika tidak
mengembalikan objek di mana:

- Keys adalah identitas validator (sebagai string yang dikodekan base-58)
- Values adalah array indeks slot leader relatif terhadap slot pertama dalam
  epoch yang diminta
