...
h1: Metode RPC getTokenSupply

---


Mengembalikan total pasokan dari jenis Token SPL.
...
Total pasokan token mentah tanpa desimal, representasi string dari u64
...
Total persediaan token, menggunakan desimal yang ditentukan oleh mint

##### !! uiAmountString

!type string

Total persediaan token sebagai string, menggunakan desimal yang ditentukan oleh
mint
