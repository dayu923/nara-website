...
title: Metode HTTP
seoTitle: Metode HTTP RPC Nara Solana
hideTableOfContents: false
h1: Metode HTTP RPC Nara Solana

---


Node Nara Solana menerima permintaan HTTP menggunakan spesifikasi
[JSON-RPC 2.0](https://www.jsonrpc.org/specification).

> Untuk aplikasi JavaScript, gunakan library
> [@solana/web3.js](https://github.com/solana-labs/solana-web3.js) sebagai
> antarmuka yang nyaman untuk metode RPC dalam berinteraksi dengan node Nara Solana.
> Untuk koneksi PubSub ke node Nara Solana, gunakan
...
- Transaction: Daftar instruksi Nara Solana yang ditandatangani oleh keypair klien
