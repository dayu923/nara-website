...
h1: Metode RPC requestAirdrop

---


Meminta airdrop lamport ke Pubkey
...
Pubkey dari akun yang akan menerima lamport, sebagai string yang dikodekan
base-58
...
Jumlah lamport yang akan di-airdrop
...
Tanda Tangan Transaksi dari airdrop, sebagai string yang dikodekan base-58
