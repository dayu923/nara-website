...
h1: Metode RPC getFeeForMessage

---


Dapatkan biaya yang akan dikenakan jaringan untuk Message tertentu

<Callout type="warn" title={"Batasan Versi"}>
  Metode ini hanya tersedia di `solana-core` v1.9 atau yang lebih baru. Silakan
  gunakan [getFees](/docs/rpc/deprecated/getfees) untuk `solana-core` v1.8 dan
  di bawahnya.
</Callout>
...
Message yang dikodekan dengan Base-64
...
Biaya yang sesuai dengan pesan pada blockhash yang ditentukan
