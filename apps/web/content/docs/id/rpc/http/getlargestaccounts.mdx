...
h1: Metode RPC getLargestAccounts

---


Mengembalikan 20 akun terbesar, berdasarkan saldo lamport (hasil mungkin
di-cache hingga dua jam)
...
Filter hasil berdasarkan jenis akun
...
Hasilnya akan berupa objek JSON RpcResponse dengan `value` sama dengan array
objek yang berisi:
...
Alamat akun yang dikodekan Base-58

##### !! lamports

!type u64

Jumlah lamports dalam akun
