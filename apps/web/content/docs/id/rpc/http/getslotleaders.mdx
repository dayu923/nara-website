...
h1: Metode RPC getSlotLeaders

---


Mengembalikan pemimpin slot untuk rentang slot tertentu
...
Batas, sebagai integer u64 (antara 1 dan 5.000)
...
Array identitas publik Node sebagai string yang dikodekan base-58.
