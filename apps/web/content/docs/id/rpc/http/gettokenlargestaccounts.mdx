...
h1: Metode RPC getTokenLargestAccounts
...
Pubkey dari token Mint yang ingin diquery, sebagai string yang dikodekan base-58
...
Alamat dari token account

##### !! amount

!type string

Saldo token account mentah tanpa desimal, representasi string dari u64
...
Saldo token account, menggunakan desimal yang ditentukan oleh mint **TIDAK
DIGUNAKAN LAGI**
...
Saldo token account sebagai string, menggunakan desimal yang ditentukan oleh
mint
