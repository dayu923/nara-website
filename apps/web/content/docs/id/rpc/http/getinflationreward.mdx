...
h1: Metode RPC getInflationReward

---


Mengembalikan imbalan inflasi / staking untuk daftar alamat dalam satu epoch
...
Array alamat yang akan diquery, sebagai string yang dikodekan base-58
...
Lihat
[Mengkonfigurasi State Commitment](/docs/rpc#configuring-state-commitment).

##### !! epoch

!type u64

Epoch di mana imbalan terjadi. Jika dihilangkan, epoch sebelumnya akan digunakan
...
Bidang hasil akan berupa array JSON dari objek yang berisi:

##### !! epoch

!type u64

Epoch saat reward terjadi

##### !! effectiveSlot

!type u64

Slot di mana rewards berlaku

##### !! amount

!type u64

Jumlah reward dalam lamport

##### !! postBalance

!type u64

Saldo akhir akun dalam lamport

##### !! commission

!type u8 | undefined

Komisi akun vote saat reward dikreditkan
