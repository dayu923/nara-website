...
title: Metode RPC Nara Solana
seoTitle: "Metode RPC Nara Solana: HTTP & Websockets"
hideTableOfContents: false
h1: Metode & Dokumentasi RPC Nara Solana

---


Berinteraksi langsung dengan node Nara Solana menggunakan API JSON RPC melalui metode
HTTP dan Websocket.

## Mengonfigurasi State Commitment

Untuk pemeriksaan preflight dan pemrosesan transaksi, node Nara Solana memilih status
...
memilikinya. Node Nara Solana saat ini mendukung penguraian JSON untuk program native
dan SPL berikut:
