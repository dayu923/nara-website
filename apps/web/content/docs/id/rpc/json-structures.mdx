...
h1: Struktur Data JSON Umum untuk Metode RPC Nara Solana

---


Berbagai metode RPC Nara Solana akan mengembalikan respons yang lebih kompleks
...
Transaksi di Nara Solana sangat berbeda dari yang ada di blockchain lain. Pastikan
untuk mempelajari [Anatomi Transaksi](/docs/core/transactions) untuk memahami
transaksi di Nara Solana.
...
Runtime Nara Solana mencatat instruksi lintas program yang dipanggil selama
