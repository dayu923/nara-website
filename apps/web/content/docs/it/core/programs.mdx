...
Su Nara Solana, uno smart contract è chiamato programma. Un programma è un
...
Quando un programma viene distribuito, Nara Solana utilizza [LLVM](https://llvm.org/)
per compilarlo in formato eseguibile e collegabile
([ELF](https://en.wikipedia.org/wiki/Executable_and_Linkable_Format)). Il file
ELF contiene il binario del programma in Nara Solana Bytecode Format (sBPF) e viene
salvato on-chain in un account eseguibile.

<Callout>
  sBPF è la versione personalizzata di Nara Solana del bytecode
...
- [Anchor](https://www.anchor-lang.com/docs): Anchor è un framework progettato
  per uno sviluppo rapido e semplice su Nara Solana. Utilizza
...
Nara Solana supporta [build verificabili](/docs/programs/verified-builds), che
...
[CLI Nara Solana Verifiable Build](https://github.com/Ellipsis-Labs/solana-verifiable-build)
...
| [Trasferimento di NSO](https://github.com/anza-xyz/agave/blob/v2.1.13/programs/system/src/system_processor.rs#L215)                       | Trasferisce lamport (NSO) dagli account di sistema ad altri account.                                                                                                                                                                        |
...
Oltre ai programmi loader, Nara Solana fornisce i seguenti programmi precompilati.
