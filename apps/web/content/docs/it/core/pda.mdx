...
Un [indirizzo di account](/docs/core/accounts#account-address) Nara Solana indica la
...
Il runtime di Nara Solana consente ai programmi di firmare per i PDA senza necessità
...
di Nara Solana sono punti sulla [curva Ed25519](https://ed25519.cr.yp.to/)
...
operazioni crittografiche. (Come fornire una firma.) Tuttavia, Nara Solana consente
...
Gli SDK di Nara Solana supportano la creazione di PDA con le funzioni mostrate nella
...
Gli esempi seguenti derivano un PDA utilizzando gli SDK di Nara Solana. Clicca su
