...
title: Mollusk
description: Guida completa per testare i programmi Nara Solana utilizzando Mollusk

---


[Mollusk](https://github.com/anza-xyz/mollusk/tree/main) è un framework di test
leggero per testare i programmi Nara Solana. Fornisce un'interfaccia semplice per
testare le istruzioni dei programmi Nara Solana in un ambiente Nara Solana Virtual Machine
...
Nara Solana di base utilizzando Mollusk.

<ScrollyCoding>

## !!steps Programma Hello World

Questo esempio dimostra come testare un programma Nara Solana di base utilizzando
...
Per testare un programma Nara Solana con Mollusk:

1. [Crea un'istanza di `Mollusk`](mention:mollusk) - Inizializza Mollusk con un
...
fornisce un'interfaccia semplice per testare i programmi Nara Solana. Tutti i campi
...
| [`process_and_validate_instruction`](#single-instruction-with-checks)          | Elabora un'istruzione ed esegue una serie di controlli sul risultato, generando un panic se qualsiasi controllo fallisce.         |
| [`process_instruction_chain`](#multiple-instructions)                          | Elabora più istruzioni e restituisce il risultato.                                                                                |
| [`process_and_validate_instruction_chain`](#multiple-instructions-with-checks) | Elabora più istruzioni ed esegue una serie di controlli su ciascun risultato, generando un panic se qualsiasi controllo fallisce. |
...
L'esempio seguente elabora un'istruzione di trasferimento di NSO senza controlli
di validazione.
...
L'esempio seguente elabora un'istruzione di trasferimento NSO con controlli di
validazione.
...
L'esempio seguente elabora due istruzioni di trasferimento NSO senza controlli
di validazione.
...
L'esempio seguente elabora una catena di due istruzioni di trasferimento NSO con
...
Mollusk fornisce un insieme di
[metodi di supporto](https://docs.rs/mollusk-svm-result/0.5.0/mollusk_svm_result/check/struct.Check.html)
...
Il seguente esempio elabora due istruzioni separate di trasferimento di NSO con
...
Il seguente esempio esegue il benchmarking dell'utilizzo delle unità di calcolo
di un'istruzione di trasferimento NSO.
...
Il seguente esempio dimostra come testare un trasferimento di token utilizzando
Mollusk.
