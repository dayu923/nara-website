...
I programmi onchain di Nara Solana sono compilati tramite
...
Poiché Nara Solana utilizza l'infrastruttura del compilatore LLVM, un programma può
...
Nara Solana è fissa e strutturata come segue
