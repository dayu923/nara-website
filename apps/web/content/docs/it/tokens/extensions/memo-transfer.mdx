...
title: Trasferimento con memo
description: Impara come abilitare MemoTransferExtension.

---


## Come abilitare MemoTransferExtension
...
richiede che tutti i trasferimenti di token in entrata includano un memo di
accompagnamento quando abilitato su un token account. Questa estensione può
essere abilitata o disabilitata dal proprietario del token account.
