...
description: Scopri come abilitare l'estensione ImmutableOwner.

---


## Come abilitare l'estensione ImmutableOwner
...
impedisce modifiche di proprietà per i token account. Quando un token account
viene inizializzato con questa estensione, il proprietario designato è
permanente e non può essere trasferito a un altro account.
