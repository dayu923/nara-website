...
description: Scopri come abilitare DefaultAccountStateExtension.

---


## Come abilitare DefaultAccountStateExtension
...
imposta uno stato predefinito per tutti i nuovi token account creati per una
mint. Quando abilitata, questa estensione inizializza automaticamente ogni nuovo
token account con uno stato specifico, come quello congelato. Questo permette ai
creatori di token di imporre comportamenti specifici, come richiedere che tutti
i nuovi account siano congelati per impostazione predefinita fino a quando non
vengono esplicitamente scongelati.
