...
Solo l'autorità di chiusura designata può chiudere il mint account. Analogamente
a come gli account token possono essere chiusi solo quando il saldo è zero, i
mint account con questa estensione possono essere chiusi solo quando l'intera
fornitura di token è stata ridotta a zero.
