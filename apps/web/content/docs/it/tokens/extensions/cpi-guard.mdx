...
title: CPI Guard
description: Scopri come abilitare il CpiGuardExtension.

---


## Come abilitare il CpiGuardExtension
...
protegge gli account token da trasferimenti inaspettati attraverso Cross Program
Invocations (CPI). Quando abilitata, questa estensione garantisce che i token
possano essere trasferiti solo attraverso chiamate dirette all'istruzione di
trasferimento del Token Extensions Program, bloccando tutti gli altri programmi
dal trasferire token tramite CPI.
