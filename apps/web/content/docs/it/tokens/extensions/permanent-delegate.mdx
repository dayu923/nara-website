...
description: Scopri come implementare l'estensione InitializePermanentDelegate.

---


## Come implementare l'estensione InitializePermanentDelegate
...
assegna un delegato irrevocabile con autorità su tutti i token account per una
mint. A differenza dei delegati normali che i proprietari dei token account
possono revocare, un delegato permanente non può essere cambiato o rimosso. Il
delegato permanente può trasferire, bruciare e congelare token in qualsiasi
token account di quella mint.
