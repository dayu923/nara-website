...
title: Commissioni di trasferimento
description: Impara come implementare la TransferFeeExtension.

---


## Come implementare la TransferFeeExtension
...
permette la raccolta automatica delle commissioni su ogni trasferimento di
token. Le commissioni si accumulano negli account token del destinatario e
possono essere prelevate dall'autorità di prelievo impostata sul mint account.
