...
description:
  Scopri come abilitare GroupPointerExtension e GroupMemberPointerExtension.

---


## Come abilitare GroupPointerExtension e GroupMemberPointerExtension
...
designa un mint come mint di gruppo (come un NFT di collezione) puntando a un
account contenente
[configurazioni di gruppo](https://github.com/solana-program/token-group/blob/3b4ff305452fa35754206fc1ad4addb2e2bff511/interface/src/state.rs#L16)
come l'autorità di aggiornamento e la dimensione massima.
...
designa un mint come mint membro (come un NFT in una collezione) puntando a un
account contenente
[dati di appartenenza](https://github.com/solana-program/token-group/blob/3b4ff305452fa35754206fc1ad4addb2e2bff511/interface/src/state.rs#L67)
come l'indirizzo del gruppo e il numero del membro.

Il Token Extensions Program implementa direttamente la
[Token Group Interface](https://github.com/solana-program/token-group),
consentendo di memorizzare sia i dati del gruppo che quelli dei membri
direttamente nell'account mint stesso. Quando le estensioni del puntatore
puntano al mint stesso, le estensioni
...
possono essere utilizzate per memorizzare tutti i dati della collezione e
dell'appartenenza nell'account mint.
