...
# Supporto dell'estensione Scaled UI Amount su Nara Solana
...
- Ci aspettiamo che gli importi scalati vengano utilizzati più frequentemente
  poiché questo è in linea con come il mondo della finanza tradizionale tratta i
  grafici relativi ai token con stock split.
- Gli aggiornamenti del moltiplicatore possono includere un timestamp che si
  riferisce al passato. Consigliamo di utilizzare il timestamp del blocco per i
  dati storici.
- Si noti che il moltiplicatore attivo può essere il "multiplier" o il
  "newMultiplier" a seconda del timestamp corrente e di quando il nuovo
...
| Monitoraggio storico del moltiplicatore  | Fornire marcatori storici degli aggiornamenti del moltiplicatore per i token fruttiferi. Si noti che gli aggiornamenti del moltiplicatore possono includere un timestamp che si riferisce al passato. Consigliamo di utilizzare il timestamp del blocco invece del timestamp indicato nell'aggiornamento del moltiplicatore per i dati storici. | **P2**   |
...
| Requisito                       | Descrizione                                                                                                                                                                                                                                                                                    | Priorità |
| :------------------------------ | :--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :------- |
| Feed di prezzi scalati e non    | Fornire feed di prezzi sia per prezzi scalati che non scalati.                                                                                                                                                                                                                                 | **P0**   |
| Dati storici dei moltiplicatori | Offrire API con modifiche storiche dei moltiplicatori. Nota che gli aggiornamenti dei moltiplicatori possono includere un timestamp riferito al passato. Consigliamo di utilizzare il timestamp del blocco invece di quello indicato nell'aggiornamento del moltiplicatore per i dati storici. | **P0**   |
