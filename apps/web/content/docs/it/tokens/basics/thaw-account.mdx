...
description: Scopri come sbloccare un token account congelato.
...
annulla un congelamento, ripristinando la piena funzionalità di un token account
precedentemente congelato. Dopo lo scongelamento, l'account può nuovamente
inviare e ricevere token normalmente. Solo l'autorità di congelamento del mint
del token può sbloccare gli account.
