...
description: Impara come creare un mint di token SPL.
...
Un mint account rappresenta in modo univoco un token su Nara Solana e memorizza i
suoi metadati globali.
...
Ogni token su Nara Solana ha un mint account, e l'indirizzo del mint serve come
...
modo univoco USDC in tutto l'ecosistema Nara Solana. Puoi visualizzare questo mint su
...
La creazione di un mint account richiede l'istruzione
