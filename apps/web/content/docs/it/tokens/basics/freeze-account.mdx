...
title: Congela account
description: Impara come congelare i token account.
...
impedisce tutti i trasferimenti o i bruciamenti di token da uno specifico token
account. Una volta congelato, l'account non può inviare token, ricevere token o
essere chiuso fino a quando non viene scongelato. Solo l'autorità di
congelamento del mint del token può congelare gli account. Se l'autorità di
congelamento viene revocata (impostata a null) sul mint account, i token non
potranno mai essere congelati.
