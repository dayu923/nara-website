...
title: Approva delegato
description: Impara come approvare i delegati per un token account.

---


## Come approvare un delegato
...
concede a un altro account (il delegato) il permesso di trasferire una quantità
specifica di token dal tuo token account. Il delegato può trasferire token fino
all'importo approvato, ma non può superarlo. Solo il proprietario del token
account può approvare un delegato, e ogni token account può avere un solo
delegato alla volta. Qualsiasi nuova approvazione sovrascrive quella precedente.
