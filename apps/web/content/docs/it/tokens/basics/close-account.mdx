...
title: Chiudi un token account
description: Impara come chiudere i token account.
...
chiude permanentemente un token account e trasferisce tutto il NSO rimanente
(rent) a un account di destinazione specificato. Il saldo del token account deve
essere zero prima della chiusura. Solo il proprietario del token account o
l'autorità di chiusura designata può eseguire questa istruzione.
