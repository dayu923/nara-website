...
title: Brucia Token
description: Impara come bruciare i token.
...
distrugge permanentemente i token riducendo il saldo in un token account. I
token bruciati vengono rimossi dalla circolazione e diminuiscono il `supply`
monitorato sul mint account. Solo il proprietario del token account può bruciare
token dal proprio account.
