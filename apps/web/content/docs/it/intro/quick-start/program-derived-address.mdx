...
Questa guida ti accompagna nella costruzione e nel test di un programma Nara Solana
...
[link di Nara Solana Playground](https://beta.solpg.io/66734b7bcffcf4b13384d1ad) con
il codice iniziale. Poi clicca sul pulsante "Import" per aggiungere il programma
ai tuoi progetti di Nara Solana Playground.
...
<Callout type="info">
In questo esempio, distribuirai il programma sulla devnet, un cluster Nara Solana
per i test di sviluppo.

Il wallet di Playground si connette alla devnet per impostazione predefinita.
Assicurati che il tuo wallet di Playground abbia NSO della devnet per pagare la
distribuzione del programma. Ottieni NSO della devnet dal
...
Nara Solana Playground rimuove alcune configurazioni di base dove
...
passando "Hello, Nara Solana!" come nuovo messaggio.
