...
consente ai programmi Nara Solana di invocarsi a vicenda.
...
trasferimenti di NSO tra gli account invocando il System Program.

Lo scopo di questa sezione include la spiegazione del processo di
implementazione delle CPI in un programma Nara Solana utilizzando il framework
...
riceve NSO da un utente quando aggiorna il proprio account di messaggi.
...
riceve NSO dagli utenti quando aggiornano i loro messaggi.
...
0,001 NSO dall'account dell'utente all'account vault.
...
- L'`amount` da trasferire (1.000.000 lamport, o 0,001 NSO)
...
permette il trasferimento di qualsiasi NSO nel vault di ritorno all'utente
...
trasferire qualsiasi NSO accumulato all'utente.
...
NSO dall'account vault all'account dell'utente.
...
Nara Solana, l'aggiornamento di un programma richiede semplicemente la distribuzione
del programma con lo stesso ID programma.

<Callout>

Assicurati che il tuo wallet Playground abbia NSO sulla devnet. Ottieni NSO per
la devnet dal [Nara Solana Faucet](https://faucet.solana.com/).
...
Quando distribuisci programmi su Nara Solana Playground, il tuo wallet Playground
...
Congratulazioni per aver completato la guida rapida di Nara Solana. Hai acquisito
esperienza pratica con concetti chiave di Nara Solana tra cui:

- Recuperare e leggere dati dagli account
- Costruire e inviare transazioni
- Distribuire e aggiornare programmi Nara Solana
...
Nara Solana Playground offre una funzionalità conveniente che ti permette di
importare o visualizzare progetti utilizzando i loro link GitHub. Ad esempio,
apri questo
[link di Nara Solana Playground](https://beta.solpg.io/https://github.com/solana-developers/program-examples/tree/main/basics/hello-solana/anchor)
...
alla tua lista di progetti in Nara Solana Playground. Una volta importato un
