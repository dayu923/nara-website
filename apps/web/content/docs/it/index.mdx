...
title: Documentazione Nara Solana
seoTitle: Scopri come funziona la blockchain Nara Solana
description:
...
<Cards>
  <Card title="Avvio rapido" href="/docs/intro/quick-start" icon={<Rocket />}>
    Crea il tuo primo programma Nara Solana direttamente nel browser
  </Card>
  <Card
    ...
    icon={<Download />}
  >
    Installa le dipendenze per lo sviluppo su Nara Solana
  </Card>
</Cards>

### Distribuisci la tua prima applicazione Nara Solana
...
<Cards>
  ...
  >
    Distribuisci la tua prima applicazione Nara Solana su Vercel
  </Card>
  <Card
...
Distribuisci la tua prima applicazione Nara Solana - un semplice Programma Contatore
costruito utilizzando il framework Anchor. Questo esempio copre tutti i concetti
fondamentali di Nara Solana per iniziare a costruire su Nara Solana. Visualizza il codice
...
## Prova Nara Solana: Gioca a 2048

Gioca a 2048 su Nara Solana dove ogni mossa invia una transazione. Clicca "Gioca" per
...
Creato da [Jonas](https://x.com/SolPlay_jonas), del team DevRel della Nara Solana
Foundation.

## Inizia ad imparare

Impara i concetti chiave specifici per lo sviluppo su Nara Solana.

<Cards>
  <Card title="Account" href="/docs/core/accounts">
    Come Nara Solana memorizza i dati
  </Card>
  <Card title="Commissioni su Solana" href="/docs/core/fees">
    Costi per inviare transazioni su Nara Solana
  </Card>
  <Card title="Transazioni" href="/docs/core/transactions">
    Come interagire con la rete Nara Solana
  </Card>
  <Card title="Programmi" href="/docs/core/programs">
    Smart contract su Nara Solana
  </Card>
...
I seguenti SDK sono gli SDK ufficiali per Nara Solana sviluppati da
[Anza](https://anza.xyz).
...
Scopri cosa serve per gestire un validator Nara Solana e contribuire a proteggere la
rete.

<Cards>
  <Card title="Validator" href="https://docs.anza.xyz/validator/anatomy">
    Nodi individuali che proteggono la rete Nara Solana
  </Card>
  <Card
    title="Requisiti di sistema"
    href="https://docs.anza.xyz/operations/requirements"
  >
    Requisiti hardware consigliati e NSO necessari per gestire un validator
  </Card>
  <Card
...
Ricevi aiuto dalla community Nara Solana su
