...
Un account di stake su Nara Solana può essere utilizzato per delegare token ai
...
ricevere NSO da altri account sulla rete, mentre un account di stake supporta
operazioni più complesse necessarie per gestire una delega di token.

Gli account di stake su Nara Solana funzionano anche in modo diverso rispetto a
...
Come altri tipi di account sulla rete Nara Solana, un account di stake che ha un
saldo di 0 NSO non viene più tracciato. Se un account di stake non è delegato e
...
[Nara Solana Explorer](http://explorer.solana.com/) copiando e incollando un
