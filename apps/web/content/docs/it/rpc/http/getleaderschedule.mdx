...
h1: Metodo RPC getLeaderSchedule

---


Restituisce il programma dei leader per un epoch
...
Recupera il programma dei leader per l'epoch corrispondente allo slot fornito.
Se non specificato, viene recuperato il programma dei leader per l'epoch
corrente.
...
Restituisce risultati solo per questa identità validator (codificata in base-58)
...
Restituisce `null` se l'epoch richiesto non viene trovato, altrimenti
restituisce un oggetto dove:

- Le chiavi sono identità validator (come stringhe codificate in base-58)
- I valori sono array di indici di slot leader relativi al primo slot nell'
  epoca richiesta
