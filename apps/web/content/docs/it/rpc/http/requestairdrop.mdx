...
h1: Metodo RPC requestAirdrop

---


Richiede un airdrop di lamport a una Pubkey
...
Pubkey dell'account che riceverà i lamport, come stringa codificata in base-58
...
Quantità di lamport da inviare tramite airdrop
...
Firma della transazione dell'airdrop, come stringa codificata in base-58
