...
title: Metodi HTTP
seoTitle: Metodi HTTP RPC di Nara Solana
hideTableOfContents: false
h1: Metodi HTTP RPC di Nara Solana

---


I nodi Nara Solana accettano richieste HTTP utilizzando la specifica
...
> interfaccia conveniente per i metodi RPC per interagire con un nodo Nara Solana.
> Per una connessione PubSub a un nodo Nara Solana, utilizza
...
- Transaction: Un elenco di istruzioni Nara Solana firmate da una keypair client per
