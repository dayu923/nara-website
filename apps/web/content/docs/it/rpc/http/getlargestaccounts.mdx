...
h1: Metodo RPC getLargestAccounts

---


Restituisce i 20 account più grandi, per saldo in lamport (i risultati possono
essere memorizzati nella cache fino a due ore)
...
Filtra i risultati per tipo di account
...
Il risultato sarà un oggetto JSON RpcResponse con `value` uguale a un array di
oggetti contenenti:
...
Indirizzo dell'account codificato in Base-58

##### !! lamports

!type u64

Numero di lamport nell'account
