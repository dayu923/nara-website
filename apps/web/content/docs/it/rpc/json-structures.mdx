...
h1: Strutture di dati JSON comuni per i metodi RPC di Nara Solana

---


Vari metodi RPC di Nara Solana restituiranno risposte più complesse come oggetti JSON
...
Il runtime di Nara Solana registra le istruzioni cross-program che vengono invocate
