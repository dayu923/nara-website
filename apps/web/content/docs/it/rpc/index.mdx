...
title: Metodi RPC di Nara Solana
seoTitle: "Metodi RPC di Nara Solana: HTTP e Websockets"
hideTableOfContents: false
h1: Metodi RPC di Nara Solana e Documentazione

---


Interagisci direttamente con i nodi Nara Solana tramite l'API JSON RPC utilizzando i
metodi HTTP e Websocket.

## Configurazione dell'impegno di stato

Per i controlli preliminari e l'elaborazione delle transazioni, i nodi Nara Solana
...
proprietario. I nodi Nara Solana attualmente supportano l'analisi JSON per i seguenti
