...
Một tài khoản stake trên Nara Solana có thể được sử dụng để ủy thác token cho các
...
và nhận NSO từ các tài khoản khác trên mạng lưới, trong khi tài khoản stake hỗ
trợ các hoạt động phức tạp hơn cần thiết để quản lý việc ủy thác token.

Tài khoản stake trên Nara Solana cũng hoạt động khác so với các mạng blockchain
Proof-of-Stake khác mà bạn có thể đã quen thuộc. Tài liệu này mô tả cấu trúc cấp
cao và các chức năng của tài khoản stake Nara Solana.
...
Giống như các loại tài khoản khác trên mạng Nara Solana, tài khoản stake có số dư 0
NSO sẽ không còn được theo dõi. Nếu tài khoản stake không được ủy quyền và tất
...
[Nara Solana Explorer](http://explorer.solana.com/) bằng cách sao chép và dán địa chỉ
