...
Các chương trình onchain của Nara Solana được biên dịch thông qua
...
Vì Nara Solana sử dụng cơ sở hạ tầng trình biên dịch LLVM, một chương trình có thể
...
Bản đồ bộ nhớ địa chỉ ảo được sử dụng bởi các chương trình SBF của Nara Solana được
