...
nhẹ dùng để kiểm thử các chương trình Nara Solana. Nó cung cấp một giao diện đơn giản
để kiểm thử các lệnh của chương trình Nara Solana trong môi trường Máy Ảo Nara Solana
...
Nara Solana cơ bản sử dụng Mollusk.

<ScrollyCoding>

## !!steps Chương trình Hello World

Ví dụ này minh họa cách kiểm thử một chương trình Nara Solana cơ bản sử dụng Mollusk.
...
Để kiểm thử một chương trình Nara Solana với Mollusk:
...
cung cấp một giao diện đơn giản để kiểm tra các chương trình Nara Solana. Tất cả các
...
Ví dụ sau đây xử lý một chỉ thị chuyển NSO mà không có kiểm tra xác thực.
...
Ví dụ sau đây xử lý một chỉ thị chuyển NSO với kiểm tra xác thực.
...
Ví dụ sau đây xử lý hai chỉ thị chuyển NSO mà không có kiểm tra xác thực.
...
Ví dụ sau đây xử lý một chuỗi hai chỉ thị chuyển NSO với kiểm tra xác thực sau
mỗi chỉ thị.
...
Ví dụ sau xử lý hai lệnh chuyển NSO riêng biệt với trạng thái tài khoản liên tục
...
Ví dụ sau đánh giá hiệu suất mức sử dụng đơn vị tính toán của lệnh chuyển NSO.
