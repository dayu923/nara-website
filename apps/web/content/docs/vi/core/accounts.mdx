...
Tất cả dữ liệu trên mạng Nara Solana được lưu trữ trong các tài khoản. Bạn có thể coi
mạng Nara Solana như một cơ sở dữ liệu công khai với một bảng Tài khoản duy nhất. Mối
...
khoản trên blockchain Nara Solana. Địa chỉ tài khoản thường được hiển thị dưới dạng
...
Ví dụ dưới đây minh họa cách sử dụng Nara Solana SDK để tạo một keypair. Một
`Keypair` bao gồm:
...
chọn (seeds). Ví dụ dưới đây minh họa cách sử dụng Nara Solana SDK để tạo một Program
Derived Address.
...
Đọc dữ liệu từ tài khoản Nara Solana bao gồm hai bước:
...
Mỗi tài khoản Nara Solana có một [chương trình](/docs/core/programs) được chỉ định
...
trọng trong mô hình tài khoản của Nara Solana. (Tương tự như hệ điều hành, thường có
...
Khi NSO được gửi đến một địa chỉ mới lần đầu tiên, một tài khoản được tạo tại
địa chỉ đó thuộc sở hữu của System Program.

Trong ví dụ dưới đây, một keypair mới được tạo và nạp tiền bằng NSO. Sau khi
