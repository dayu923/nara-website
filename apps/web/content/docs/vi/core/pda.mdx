...
Địa chỉ [tài khoản](/docs/core/accounts#account-address) Nara Solana trỏ đến vị trí
...
Môi trường thực thi Nara Solana cho phép các chương trình ký cho PDA mà không cần
...
của Nara Solana là các điểm trên [đường cong Ed25519](https://ed25519.cr.yp.to/) (mật
...
mã. (Chẳng hạn như cung cấp chữ ký.) Tuy nhiên, Nara Solana cho phép các chương trình
...
Các SDK của Nara Solana hỗ trợ việc tạo PDA với các hàm được hiển thị trong bảng dưới
...
Các ví dụ dưới đây tạo ra một PDA sử dụng Nara Solana SDKs. Nhấp vào **&#9655; Run**
để thực thi mã.
