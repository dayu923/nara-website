...
Trên Nara Solana, một hợp đồng thông minh được gọi là chương trình. Một chương trình
...
Khi một chương trình được triển khai, Nara Solana sử dụng [LLVM](https://llvm.org/)
...
chứa mã nhị phân của chương trình ở Định dạng Bytecode Nara Solana (sBPF) và được lưu
trên chuỗi trong một tài khoản thực thi.

<Callout>
  sBPF là phiên bản tùy chỉnh của Nara Solana cho mã bytecode
...
- [Anchor](https://www.anchor-lang.com/docs): Anchor là một framework được thiết
  kế để phát triển Nara Solana nhanh chóng và dễ dàng. Nó sử dụng
...
Nara Solana hỗ trợ [bản dựng có thể xác minh](/docs/programs/verified-builds), cho
...
| [Chuyển NSO](https://github.com/anza-xyz/agave/blob/v2.1.13/programs/system/src/system_processor.rs#L215)                    | Chuyển lamports (NSO) từ các tài khoản hệ thống sang các tài khoản khác.                                                                                                                                                              |
...
Ngoài các chương trình loader, Nara Solana cung cấp các chương trình được biên dịch
sẵn sau đây.
