...
Mỗi giao dịch Nara Solana đều yêu cầu một khoản phí giao dịch, được thanh toán bằng
NSO. Phí giao dịch được chia thành hai phần: phí cơ bản và phí ưu tiên. Phí cơ
...
chữ ký được bao gồm. Phí này được thanh toán bởi người ký đầu tiên trong giao
dịch. Chỉ các tài khoản thuộc sở hữu của System Program mới có thể thanh toán
phí giao dịch. Phí cơ bản được chia như sau:

- **50% bị đốt:** Một nửa bị
  [đốt](https://github.com/anza-xyz/agave/blob/v2.1.13/sdk/fee-calculator/src/lib.rs#L70)
  (lấy ra khỏi nguồn cung NSO đang lưu hành).
