...
Các lệnh là khối xây dựng cơ bản để tương tác với blockchain Nara Solana. Một lệnh về
cơ bản là một hàm công khai mà bất kỳ ai sử dụng mạng Nara Solana đều có thể gọi. Mỗi
...
định nghĩa tập hợp các lệnh riêng của nó. Để tương tác với mạng Nara Solana, một hoặc
...
phép người dùng tương tác với mạng. Trong ví dụ này, NSO được chuyển từ tài
...
![Sơ đồ chuyển NSO](/assets/docs/core/transactions/sol-transfer.svg)

Sau khi giao dịch được gửi, System Program xử lý lệnh chuyển và cập nhật số dư
lamport của cả hai tài khoản.

![Sơ đồ quy trình chuyển NSO](/assets/docs/core/transactions/sol-transfer-process.svg)
...
Ví dụ dưới đây cho thấy cấu trúc của một lệnh chuyển NSO.
