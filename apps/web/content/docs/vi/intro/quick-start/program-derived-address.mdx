...
Hướng dẫn này đưa bạn qua quá trình xây dựng và kiểm tra một chương trình Nara Solana
...
[liên kết Nara Solana Playground](https://beta.solpg.io/66734b7bcffcf4b13384d1ad) với
mã khởi đầu. Sau đó nhấp vào nút "Import" để thêm chương trình vào các dự án
Nara Solana Playground của bạn.
...
<Callout type="info">
Trong ví dụ này, bạn sẽ triển khai chương trình lên devnet, một cụm Nara Solana
dành cho kiểm thử phát triển.

Ví Playground kết nối với devnet theo mặc định. Đảm bảo ví Playground của bạn có
devnet NSO để thanh toán cho việc triển khai chương trình. Nhận devnet NSO từ
...
Nara Solana Playground loại bỏ một số thiết lập mẫu trong đó
...
Nara Solana!" như là thông điệp mới.
