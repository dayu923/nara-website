...
title: Tiện ích mở rộng Metadata & Metadata Pointer
description:
  Tìm hiểu cách kích hoạt tiện ích mở rộng MetadataPointerExtension và
  TokenMetadata.

---


## Cách kích hoạt tiện ích mở rộng MetadataPointerExtension và TokenMetadata
...
cho phép mint account xác định địa chỉ của tài khoản metadata của nó. Con trỏ
này có thể tham chiếu đến bất kỳ tài khoản nào thuộc sở hữu của chương trình
triển khai
[Token Metadata Interface](https://github.com/solana-program/token-metadata/tree/main),
cung cấp tính linh hoạt trong việc lưu trữ metadata.
...
cho phép metadata được lưu trữ trên chính mint account. Điều này bao gồm tên
token, ký hiệu, URI và dữ liệu mô tả bổ sung. Khi các tiện ích mở rộng con trỏ
trỏ đến chính mint, tiện ích mở rộng
...
có thể được sử dụng để lưu trữ tất cả metadata trong mint account.
