...
description: Tìm hiểu cách kích hoạt InterestBearingMintExtension.

---


## Cách kích hoạt InterestBearingExtension
...
cho phép bạn thiết lập lãi suất trực tiếp trên mint account. Lãi suất được tính
gộp liên tục dựa trên dấu thời gian của mạng, nhưng số dư token thực tế được lưu
trữ trong mỗi token account vẫn không thay đổi. Tổng giá trị (số dư token cộng
với lãi tích lũy) chỉ là một phép tính. Không có token mới nào được tạo ra với
