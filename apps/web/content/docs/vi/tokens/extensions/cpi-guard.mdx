...
title: CPI Guard
description: Tìm hiểu cách kích hoạt CpiGuardExtension.

---


## Cách kích hoạt CpiGuardExtension
...
bảo vệ các tài khoản token khỏi các giao dịch chuyển tiền không mong muốn thông
qua Cross Program Invocations (CPIs). Khi được kích hoạt, tiện ích mở rộng này
đảm bảo rằng token chỉ có thể được chuyển thông qua các lệnh gọi trực tiếp đến
hướng dẫn chuyển của Token Extensions Program, chặn tất cả các chương trình khác
chuyển token thông qua CPI.
