...
description: Tìm hiểu cách triển khai TransferFeeExtension.
...
cho phép thu phí tự động trên mỗi giao dịch chuyển token. Phí tích lũy trong các
tài khoản token của người nhận và có thể được rút bởi quyền rút tiền được thiết
lập trên mint account.
