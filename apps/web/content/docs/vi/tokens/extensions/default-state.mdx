...
description: Tìm hiểu cách kích hoạt DefaultAccountStateExtension.

---


## Cách kích hoạt DefaultAccountStateExtension
...
thiết lập trạng thái mặc định cho tất cả các token account mới được tạo cho một
mint. Khi được kích hoạt, tiện ích mở rộng này tự động khởi tạo mỗi token
account mới với một trạng thái cụ thể, chẳng hạn như đóng băng. Điều này cho
phép người tạo token áp dụng các hành vi cụ thể, như yêu cầu tất cả các tài
khoản mới phải được đóng băng theo mặc định cho đến khi được mở băng một cách rõ
ràng.
