...
title: Chủ sở hữu bất biến
description: Tìm hiểu cách kích hoạt tiện ích mở rộng ImmutableOwner.

---


## Cách kích hoạt tiện ích mở rộng ImmutableOwner
...
ngăn chặn việc thay đổi quyền sở hữu cho các token account. Khi một token
account được khởi tạo với tiện ích mở rộng này, chủ sở hữu được chỉ định là vĩnh
viễn và không thể chuyển nhượng cho tài khoản khác.
