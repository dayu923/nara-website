...
title: Chuyển khoản memo
description: Tìm hiểu cách kích hoạt MemoTransferExtension.

---


## Cách kích hoạt MemoTransferExtension
...
yêu cầu tất cả các giao dịch chuyển token đến phải bao gồm một memo kèm theo khi
được kích hoạt trên token account. Tiện ích mở rộng này có thể được kích hoạt
hoặc vô hiệu hóa bởi chủ sở hữu token account.
