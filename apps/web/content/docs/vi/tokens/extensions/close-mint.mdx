...
title: Đóng Mint
description: Tìm hiểu cách kích hoạt tiện ích mở rộng MintCloseAuthority.
...
cho phép đóng các mint account và lấy lại rent của chúng. Tiện ích mở rộng này
phải được khởi tạo khi mint account được tạo.

Chỉ có người có quyền đóng được chỉ định mới có thể đóng mint account. Tương tự
như cách các tài khoản token chỉ có thể được đóng khi số dư token bằng không,
các mint account có tiện ích mở rộng này chỉ có thể được đóng khi toàn bộ lượng
cung token đã giảm xuống còn không.
