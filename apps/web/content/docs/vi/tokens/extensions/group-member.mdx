...
description:
  Tìm hiểu cách kích hoạt GroupPointerExtension và GroupMemberPointerExtension.

---


## Cách kích hoạt GroupPointerExtension và GroupMemberPointerExtension
...
chỉ định một mint account là mint nhóm (như một NFT Bộ sưu tập) bằng cách trỏ
đến một tài khoản chứa
[cấu hình nhóm](https://github.com/solana-program/token-group/blob/3b4ff305452fa35754206fc1ad4addb2e2bff511/interface/src/state.rs#L16)
như quyền cập nhật và kích thước tối đa.
...
chỉ định một mint account là mint thành viên (như một NFT trong bộ sưu tập) bằng
cách trỏ đến một tài khoản chứa
[dữ liệu thành viên](https://github.com/solana-program/token-group/blob/3b4ff305452fa35754206fc1ad4addb2e2bff511/interface/src/state.rs#L67)
như địa chỉ nhóm và số thành viên.

Token Extensions Program triển khai trực tiếp
[Token Group Interface](https://github.com/solana-program/token-group), cho phép
cả dữ liệu nhóm và thành viên được lưu trữ trên chính tài khoản mint. Khi các
tiện ích mở rộng con trỏ trỏ đến chính mint, các tiện ích mở rộng
...
có thể được sử dụng để lưu trữ tất cả dữ liệu bộ sưu tập và thành viên trong tài
khoản mint.
