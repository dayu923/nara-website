...
title: Token trên Nara Solana
description: Tìm hiểu về Token Programs của Nara Solana.
...
Nara Solana được gọi là SPL
([Nara Solana Program Library](https://github.com/solana-program)) Token.

Phần này bao gồm các khái niệm cơ bản về cách token được biểu diễn trên Nara Solana.
...
Hệ sinh thái Nara Solana có hai Token Programs chính. Mã nguồn cho cả hai chương
trình bên dưới.
...
token có thể thay thế và không thể thay thế). Tất cả token trên Nara Solana về cơ bản
...
Token trên Nara Solana được xác định duy nhất bởi địa chỉ của một
...
Để tham khảo, đây là liên kết Nara Solana Explorer đến
...
Điều này giới thiệu một khái niệm quan trọng trong phát triển Nara Solana:
...
dụng terminal của [Nara Solana Playground](https://beta.solpg.io/) để chạy các lệnh
CLI trực tiếp trong trình duyệt mà không cần cài đặt cục bộ.

Việc tạo token và tài khoản yêu cầu NSO cho tiền đặt cọc rent tài khoản và phí
giao dịch. Đối với người dùng Nara Solana Playground lần đầu, hãy tạo một ví
Playground và chạy lệnh _sh`solana airdrop`_ trong terminal Playground. Bạn cũng
có thể nhận devnet NSO từ [web faucet](https://faucet.solana.com/) công khai.
...
trên [Nara Solana Playground](https://beta.solpg.io/660ce716cffcf4b13384d010).
