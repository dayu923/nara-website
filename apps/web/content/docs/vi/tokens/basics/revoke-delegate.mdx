...
description: Tìm hiểu cách thu hồi ủy quyền của token account.

---


## Cách Thu hồi ủy quyền
...
xóa tất cả quyền chuyển token từ người được ủy quyền hiện tại. Sau khi thu hồi,
người được ủy quyền không thể chuyển bất kỳ token nào từ tài khoản của bạn nữa.
Chỉ chủ sở hữu token account mới có thể thu hồi ủy quyền.
