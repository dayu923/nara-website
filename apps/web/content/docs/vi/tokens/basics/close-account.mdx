...
title: Đóng tài khoản token
description: Tìm hiểu cách đóng tài khoản token.
...
đóng vĩnh viễn một token account và chuyển toàn bộ NSO còn lại (rent) đến một
tài khoản đích được chỉ định. Số dư của token account phải bằng không trước khi
đóng. Chỉ chủ sở hữu token account hoặc người được ủy quyền đóng mới có thể thực
hiện lệnh này.
