...
title: Phê duyệt Ủy quyền
description: Tìm hiểu cách phê duyệt ủy quyền cho token account.

---


## Cách phê duyệt ủy quyền
...
cấp quyền cho một tài khoản khác (người được ủy quyền) để chuyển một số lượng
token cụ thể từ token account của bạn. Người được ủy quyền có thể chuyển token
tối đa đến số lượng đã được phê duyệt, nhưng không thể vượt quá giới hạn đó. Chỉ
chủ sở hữu token account có thể phê duyệt ủy quyền, và mỗi token account chỉ có
thể có một người được ủy quyền tại một thời điểm. Bất kỳ phê duyệt mới nào cũng
sẽ ghi đè lên phê duyệt trước đó.
