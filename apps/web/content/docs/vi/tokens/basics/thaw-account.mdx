...
title: Giải đóng tài khoản
description: Tìm hiểu cách giải đóng một token account đã bị đóng băng.
...
đảo ngược quá trình đóng băng, khôi phục đầy đủ chức năng cho một token account
đã bị đóng băng trước đó. Sau khi giải đóng, tài khoản có thể gửi và nhận token
một cách bình thường trở lại. Chỉ có freeze authority của mint token mới có thể
giải đóng các tài khoản.
