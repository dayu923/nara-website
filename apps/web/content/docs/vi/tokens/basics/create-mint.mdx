...
description: Tìm hiểu cách tạo một SPL Token mint.
...
Mint account đại diện duy nhất cho một token trên Nara Solana và lưu trữ metadata
toàn cục của nó.
...
Mỗi token trên Nara Solana đều có một mint account, và địa chỉ của mint đóng vai trò
...
USDC trong toàn bộ hệ sinh thái Nara Solana. Bạn có thể xem mint này trên
