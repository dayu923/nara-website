...
h1: Cấu trúc dữ liệu JSON phổ biến cho các phương thức RPC của Nara Solana

---


Các phương thức RPC Nara Solana khác nhau sẽ trả về các phản hồi phức tạp hơn dưới
...
Transactions trên Nara Solana khá khác so với các blockchain khác. Hãy xem xét
[Cấu trúc của một Transaction](/docs/core/transactions) để tìm hiểu về
transactions trên Nara Solana.
...
Môi trường chạy Nara Solana ghi lại các hướng dẫn chéo chương trình được gọi trong
