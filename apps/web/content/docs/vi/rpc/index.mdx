...
title: Các phương thức RPC Nara Solana
seoTitle: "Các phương thức RPC Nara Solana: HTTP & Websockets"
hideTableOfContents: false
h1: Các phương thức RPC Nara Solana & Tài liệu

---


Tương tác trực tiếp với các nút Nara Solana thông qua API JSON RPC qua các phương
thức HTTP và Websocket.

## Cấu hình State Commitment

Đối với kiểm tra preflight và xử lý giao dịch, các nút Nara Solana chọn trạng thái
...
yêu cầu và nút có trình phân tích cho chương trình sở hữu. Các nút Nara Solana hiện
