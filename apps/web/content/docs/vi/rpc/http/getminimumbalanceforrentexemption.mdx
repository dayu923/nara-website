...
h1: Phương thức RPC getMinimumBalanceForRentExemption

---


Trả về số dư tối thiểu cần thiết để làm cho tài khoản được miễn rent.
...
Số lamport tối thiểu cần có trong tài khoản để duy trì miễn rent
