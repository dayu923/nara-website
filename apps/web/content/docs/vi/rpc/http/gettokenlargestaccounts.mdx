...
h1: Phương thức RPC getTokenLargestAccounts

---


Trả về 20 tài khoản lớn nhất của một loại Token SPL cụ thể.
...
Địa chỉ của token account

##### !! amount

!type string

Số dư token account thô không có số thập phân, một chuỗi biểu diễn của u64

##### !! decimals

!type u8

Số chữ số cơ số 10 ở bên phải dấu thập phân

##### !! uiAmount

!type number | null

Số dư token account, sử dụng số thập phân được quy định bởi mint **ĐÃ LỖI THỜI**

##### !! uiAmountString

!type string

Số dư token account dưới dạng chuỗi, sử dụng số thập phân được quy định bởi mint
