...
h1: Phương thức RPC getSlotLeaders

---


Trả về các slot leader cho một khoảng slot nhất định
...
Slot bắt đầu, dưới dạng số nguyên u64
...
Giới hạn, dưới dạng số nguyên u64 (từ 1 đến 5.000)
...
Mảng các khóa công khai định danh Node dưới dạng chuỗi mã hóa base-58.
