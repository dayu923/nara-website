...
h1: Phương thức RPC getBalance

---


Trả về số dư lamport của tài khoản với Pubkey được cung cấp
...
Đối tượng JSON RpcResponse với trường value được đặt thành số dư.
