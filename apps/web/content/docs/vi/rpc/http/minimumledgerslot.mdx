...
h1: Phương thức RPC minimumLedgerSlot

---


Trả về slot thấp nhất mà node có thông tin trong sổ cái của nó.

<Callout type="info">
  Giá trị này có thể tăng theo thời gian nếu node được cấu hình để xóa dữ liệu
  sổ cái cũ hơn
</Callout>
