...
seoTitle: Phương thức HTTP RPC của Nara Solana
hideTableOfContents: false
h1: Phương thức HTTP RPC của Nara Solana

---


Các node Nara Solana chấp nhận các yêu cầu HTTP sử dụng đặc tả
...
> diện thuận tiện cho các phương thức RPC để tương tác với node Nara Solana. Đối với
> kết nối PubSub đến node Nara Solana, hãy sử dụng
...
- Transaction: Một danh sách các hướng dẫn Nara Solana được ký bởi một keypair của
