...
h1: getEpochSchedule RPCメソッド

---


このクラスターからepochスケジュール情報を返します
...
結果フィールドは以下のフィールドを持つオブジェクトになります：

##### !! firstNormalEpoch

!type u64

最初の通常の長さのepoch、`log2(slotsPerEpoch) - log2(MINIMUM_SLOTS_PER_EPOCH)`
...
epochの開始前に、そのepochのリーダースケジュールを計算するためのslot数。
