...
title: メタデータとメタデータポインタ拡張機能
description: MetadataPointerExtensionとTokenMetadata拡張機能の有効化方法を学びましょう。

---


## MetadataPointerExtensionとTokenMetadata拡張機能の有効化方法

[`MetadataPointerExtension`](https://github.com/solana-program/token-2022/blob/6f2473344d70271f632c3e9b7e945be00186c536/interface/src/instruction.rs#L711)は、mint
accountがそのメタデータアカウントのアドレスを指定できるようにします。このポインタは[Token Metadata Interface](https://github.com/solana-program/token-metadata/tree/main)を実装するプログラムが所有する任意のアカウントを参照でき、メタデータの保存場所に柔軟性を提供します。

Token Extensions
Programは[Token Metadata Interface](https://github.com/solana-program/token-metadata/blob/main/interface/src/instruction.rs)を直接実装しており、メタデータをmint
account自体に保存することができます。これにはトークンの名前、シンボル、URI、および追加の説明データが含まれます。ポインタ拡張機能がmint自体を指す場合、[TokenMetadata](https://github.com/solana-program/token-2022/blob/6f2473344d70271f632c3e9b7e945be00186c536/interface/src/extension/token_metadata/mod.rs#L7)拡張機能を使用して、すべてのメタデータをmint
accountに保存できます。
