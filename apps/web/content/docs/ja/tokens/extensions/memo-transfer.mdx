...
title: メモ転送
description: MemoTransferExtensionを有効にする方法を学びます。
...
[`MemoTransferExtension`](https://github.com/solana-program/token-2022/blob/6f2473344d70271f632c3e9b7e945be00186c536/interface/src/instruction.rs#L623)は、token
