...
title: イミュータブルオーナー
description: ImmutableOwner拡張機能の有効化方法について学びます。

---


## ImmutableOwner拡張機能の有効化方法
...
拡張機能はtoken accountの所有権変更を防止します。この拡張機能を使用してtoken
accountを初期化すると、指定された所有者は永続的となり、別のアカウントに転送することはできません。
