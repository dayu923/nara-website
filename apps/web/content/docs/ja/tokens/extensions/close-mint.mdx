...
title: ミントのクローズ
description: MintCloseAuthority拡張機能を有効にする方法を学びます。

---


## MintCloseAuthority拡張機能を有効にする方法

[`MintCloseAuthority`](https://github.com/solana-program/token-2022/blob/6f2473344d70271f632c3e9b7e945be00186c536/interface/src/instruction.rs#L569)拡張機能により、mint
accountをクローズしてrentを回収することができます。この拡張機能はmintの作成時に初期化する必要があります。

指定されたクローズ権限を持つ者だけがmint
accountをクローズできます。トークンアカウントがトークン残高がゼロの場合にのみクローズできるのと同様に、この拡張機能を持つmint
accountは、トークンの供給量全体がゼロに減少した場合にのみクローズできます。
