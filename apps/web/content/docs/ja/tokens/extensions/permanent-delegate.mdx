...
title: 永久的な委任者
description: InitializePermanentDelegate拡張機能の実装方法を学びます。

---


## InitializePermanentDelegate拡張機能の実装方法

[`InitializePermanentDelegate`](https://github.com/solana-program/token-2022/blob/6f2473344d70271f632c3e9b7e945be00186c536/interface/src/instruction.rs#L678)は、ミントの全てのtoken
accountに対する権限を持つ、取り消し不可能な委任者を割り当てます。通常の委任者はtoken
accountの所有者が取り消すことができますが、永久的な委任者は変更や削除ができません。永久的な委任者は、そのミントの任意のtoken
accountのトークンを転送、焼却、凍結することができます。
