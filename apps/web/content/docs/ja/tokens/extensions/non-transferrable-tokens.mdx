...
title: 譲渡不可トークン
description: InitializeNonTransferableMintの有効化方法を学びます。

---


## InitializeNonTransferableMint拡張機能の有効化方法

[`InitializeNonTransferableMint`](https://github.com/solana-program/token-2022/blob/6f2473344d70271f632c3e9b7e945be00186c536/interface/src/instruction.rs#L647)は、ミント後にtoken
accountの間でトークンが転送されるのを防ぎます。ミントされると、トークンはtoken
accountに永続的に残ります。ただし、token
accountの所有者は引き続きトークンをバーンし、残高がゼロになるとtoken
accountを閉じることができます。
