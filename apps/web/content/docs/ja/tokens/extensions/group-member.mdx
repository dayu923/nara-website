...
title: トークングループとメンバー
description: GroupPointerExtensionとGroupMemberPointerExtensionを有効にする方法を学びましょう。

---


## GroupPointerExtensionとGroupMemberPointerExtensionを有効にする方法

[`GroupPointerExtension`](https://github.com/solana-program/token-2022/blob/6f2473344d70271f632c3e9b7e945be00186c536/interface/src/instruction.rs#L718)は、アップデート権限や最大サイズなどの[グループ設定](https://github.com/solana-program/token-group/blob/3b4ff305452fa35754206fc1ad4addb2e2bff511/interface/src/state.rs#L16)を含むアカウントを指定することで、ミントをグループミント（コレクションNFTなど）として指定します。

[`GroupMemberPointerExtension`](https://github.com/solana-program/token-2022/blob/6f2473344d70271f632c3e9b7e945be00186c536/interface/src/instruction.rs#L725)は、グループアドレスやメンバー番号などの[メンバーシップデータ](https://github.com/solana-program/token-group/blob/3b4ff305452fa35754206fc1ad4addb2e2bff511/interface/src/state.rs#L67)を含むアカウントを指定することで、ミントをメンバーミント（コレクション内のNFTなど）として指定します。

Token Extensions
Programは[Token Group Interface](https://github.com/solana-program/token-group)を直接実装しており、グループデータとメンバーデータの両方をmint
accountそのものに保存できます。ポインタ拡張機能がミント自体を指す場合、[TokenGroup](https://github.com/solana-program/token-2022/blob/6f2473344d70271f632c3e9b7e945be00186c536/interface/src/extension/token_group/mod.rs#L7)と[TokenGroupMember](https://github.com/solana-program/token-2022/blob/6f2473344d70271f632c3e9b7e945be00186c536/interface/src/extension/token_group/mod.rs#L11)拡張機能を使用して、すべてのコレクションとメンバーシップデータをmint
accountに保存できます。
