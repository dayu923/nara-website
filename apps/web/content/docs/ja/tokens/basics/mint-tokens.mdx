...
title: トークンのミント
description: トークンの新しい単位をミントする方法を学びましょう。
...
命令を使用してトークンの新しい単位を作成します。

- ミント権限を持つ者のみが新しいトークンをミントできます
- ミントされたトークンを受け取るための宛先token accountが存在する必要があります

<Callout type="info">
  [トークン
  プログラム](https://github.com/solana-program/token/blob/3daf44899f0bd71c879d28dffdfb788dd944f3c5/program/src/processor.rs#L521)
  と[トークン拡張
  プログラム](https://github.com/solana-program/token-2022/blob/efd0c957fefbd79882d77df5fb2dac88c001249c/program/src/processor.rs#L973)
  は同じ機能を実現するために類似の実装を共有しています。
</Callout>
