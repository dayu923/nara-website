...
title: アカウントのフリーズ
description: トークンアカウントをフリーズする方法を学びましょう。
...
instructionsは、特定のtoken
accountからのすべてのトークン転送またはトークンバーンを防止します。一度フリーズされると、アカウントはトークンの送信、受信、または解凍されるまで閉鎖することができません。トークンのmintのフリーズ権限を持つ者だけがアカウントをフリーズできます。mint
accountでフリーズ権限が取り消された（nullに設定された）場合、トークンは二度とフリーズされることはありません。

<Callout type="info">
  [Token
  Program](https://github.com/solana-program/token/blob/a7c488ca39ed4cd71a87950ed854929816e9099f/program/src/instruction.rs#L228)と[Token
  Extensions
  Program](https://github.com/solana-program/token-2022/blob/efd0c957fefbd79882d77df5fb2dac88c001249c/program/src/instruction.rs#L291)は同じ機能を実現するために類似の実装を共有しています。
</Callout>
