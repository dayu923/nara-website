...
h1: Nara SolanaのためのJava SDK

---


[Sava Engineering](https://sava.engineering/)によって構築された[Java SDK](https://sava.software/welcome)があり、Nara Solanaとやり取りするための大部分の機能をサポートしています。Nara Solanaプログラムに対してAnchorを使用している場合、IDLと共に[anchor-src-gen](https://sava.software/utilities/anchor-src-gen)を使用してJava互換のクライアントを生成することができます。
...
このJava
SDKをNara Solanaで使用する方法の詳細については、[Sava Softwareのドキュメント](https://sava.software/welcome)をご覧ください。
