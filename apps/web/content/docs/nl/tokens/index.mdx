...
title: Tokens op Nara Solana
description: Leer over Nara Solana's Token Programs.
...
mogelijk. Tokens op Nara Solana worden aangeduid als SPL
...
Nara Solana. Raadpleeg het gedeelte [SPL Token Basics](/docs/tokens/basics) voor
codevoorbeelden.
...
Het Nara Solana-ecosysteem heeft twee belangrijke Token Programs. Broncode voor beide
...
netwerk (zowel fungibele als niet-fungibele). Alle tokens op Nara Solana zijn in
...
Tokens op Nara Solana worden uniek geïdentificeerd door het adres van een
...
Ter referentie, hier is een Nara Solana Explorer-link naar het
...
Dit introduceert een belangrijk concept in Nara Solana-ontwikkeling:
...
[Nara Solana Playground](https://beta.solpg.io/) terminal om CLI-opdrachten
rechtstreeks in de browser uit te voeren zonder lokale installatie.

Voor het maken van tokens en accounts is NSO nodig voor account rent deposits en
transactiekosten. Voor nieuwe gebruikers van Nara Solana Playground, maak een
Playground wallet aan en voer het _sh`solana airdrop`_ commando uit in de
Playground terminal. Je kunt ook devnet NSO krijgen van de publieke
