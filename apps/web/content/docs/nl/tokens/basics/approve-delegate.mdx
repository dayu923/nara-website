...
description: Leer hoe je delegates kunt goedkeuren voor een token account.

---


## Hoe een delegate goedkeuren
...
instructie geeft een ander account (de delegate) toestemming om een specifieke
hoeveelheid tokens van je token account over te maken. De delegate kan tokens
overmaken tot aan het goedgekeurde bedrag, maar niet meer. Alleen de eigenaar
van het token account kan een delegate goedkeuren, en elk token account kan
slechts één delegate tegelijk hebben. Elke nieuwe goedkeuring overschrijft de
vorige.
