...
description: Leer hoe je tokens kunt overmaken tussen token-accounts.

---


## Hoe tokens over te maken

Token-overdrachten verplaatsen tokens tussen token-accounts van dezelfde mint
met behulp van de
...
- Beide token-accounts moeten hetzelfde tokentype (mint) bevatten
- Alleen de eigenaar of gemachtigde van het bronaccount kan overdrachten
  autoriseren
