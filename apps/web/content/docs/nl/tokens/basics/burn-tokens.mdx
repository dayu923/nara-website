...
title: Tokens verbranden
description: Leer hoe je tokens kunt verbranden.
...
instructie vernietigt tokens permanent door het saldo in een token account te
verminderen. Verbrande tokens worden uit circulatie gehaald en verminderen de
`supply` die wordt bijgehouden op het mint account. Alleen de eigenaar van het
token account kan tokens uit hun account verbranden.
