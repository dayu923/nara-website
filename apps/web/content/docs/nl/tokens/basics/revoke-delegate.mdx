...
title: Delegate intrekken
description: Leer hoe je de token account delegate kunt intrekken.

---


## Hoe een delegate intrekken

De
[`Revoke`](https://github.com/solana-program/token/blob/a7c488ca39ed4cd71a87950ed854929816e9099f/instruction.rs#L133C5-L133C11)
instructie verwijdert alle overdrachtsrechten van de momenteel goedgekeurde
delegate. Na intrekking kan de delegate geen tokens meer overmaken vanaf je
account. Alleen de eigenaar van de token account kan een delegate intrekken.
