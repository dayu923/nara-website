...
description: Leer hoe je een bevroren token account kunt ontdooien.
...
instructie keert een bevriezing om, waardoor een eerder bevroren token account
weer volledig functioneel wordt. Na het ontdooien kan het account weer normaal
tokens verzenden en ontvangen. Alleen de freeze authority van de token's mint
kan accounts ontdooien.
