...
description: Leer hoe je een SPL Token mint aanmaakt.
...
Een mint account vertegenwoordigt uniek een token op Nara Solana en slaat de globale
metadata ervan op.
...
Elke token op Nara Solana heeft een mint account, en het adres van de mint dient als
...
uniek in het hele Nara Solana ecosysteem. Je kunt deze mint bekijken op
