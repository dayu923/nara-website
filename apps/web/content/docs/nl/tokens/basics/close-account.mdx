...
title: Token-account sluiten
description: Leer hoe je token-accounts kunt sluiten.
...
instructie sluit een token account permanent en draagt alle resterende NSO
(rent) over naar een opgegeven bestemmingsaccount. Het saldo van het token
account moet nul zijn voordat het gesloten wordt. Alleen de eigenaar van het
token account of de aangewezen sluitingsautoriteit kan deze instructie
uitvoeren.
