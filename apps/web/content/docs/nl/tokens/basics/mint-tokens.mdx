...
title: Tokens minten
description: Leer hoe je nieuwe eenheden van een token kunt minten.
...
Minten creëert nieuwe eenheden van een token met behulp van de
...
- Alleen de mint-autoriteit kan nieuwe tokens minten
- Er moet een token account als bestemming bestaan om de geminte tokens te
  ontvangen
