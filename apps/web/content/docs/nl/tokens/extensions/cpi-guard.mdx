...
title: CPI Guard
description: Leer hoe je de CpiGuardExtension kunt inschakelen.

---


## Hoe de CpiGuardExtension in te schakelen
...
beschermt tokenaccounts tegen onverwachte overdrachten via Cross Program
Invocations (CPIs). Wanneer ingeschakeld, zorgt deze extensie ervoor dat tokens
alleen overgedragen kunnen worden via directe aanroepen naar de
overdrachtsinstructie van het Token Extensions Program, waardoor alle andere
programma's worden geblokkeerd om tokens over te dragen via CPI.
