...
description: Leer hoe je de InitializeNonTransferableMint kunt inschakelen.

---


## Hoe de InitializeNonTransferableMint-extensie in te schakelen
...
voorkomt dat tokens na het minten tussen token accounts worden overgedragen.
Eenmaal gemint blijven de tokens permanent in het token account. De eigenaar van
het token account kan echter nog steeds tokens verbranden en het token account
sluiten wanneer het saldo nul bereikt.
