...
title: Transferkosten
description: Leer hoe je de TransferFeeExtension implementeert.

---


## Hoe de TransferFeeExtension te implementeren
...
maakt automatische inning van kosten mogelijk bij elke tokenoverdracht. Kosten
worden verzameld in de ontvanger-tokenaccounts en kunnen worden opgenomen door
de opname-autoriteit die is ingesteld op de mint account.
