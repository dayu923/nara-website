...
description:
  Leer hoe je de GroupPointerExtension en GroupMemberPointerExtension kunt
  inschakelen.

---


## Hoe je de GroupPointerExtension en GroupMemberPointerExtension inschakelt
...
wijst een mint aan als een groepsmint (zoals een Collection NFT) door te
verwijzen naar een account dat
[groepsconfiguraties](https://github.com/solana-program/token-group/blob/3b4ff305452fa35754206fc1ad4addb2e2bff511/interface/src/state.rs#L16)
bevat zoals update authority en maximale grootte.
...
wijst een mint aan als een lidmint (zoals een NFT in een collectie) door te
verwijzen naar een account dat
[lidmaatschapsgegevens](https://github.com/solana-program/token-group/blob/3b4ff305452fa35754206fc1ad4addb2e2bff511/interface/src/state.rs#L67)
bevat zoals groepsadres en lidnummer.

Token Extensions Program implementeert de
[Token Group Interface](https://github.com/solana-program/token-group) direct,
waardoor zowel groeps- als lidgegevens kunnen worden opgeslagen op het mint
account zelf. Wanneer de pointer extensions naar de mint zelf verwijzen, kunnen
de
...
extensions worden gebruikt om alle collectie- en lidmaatschapsgegevens in het
mint account op te slaan.
