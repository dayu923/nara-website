...
title: Mint sluiten
description: Leer hoe je de MintCloseAuthority-extensie inschakelt.

---


## Hoe de MintCloseAuthority-extensie in te schakelen
...
extensie maakt het mogelijk om mint accounts te sluiten en hun rent terug te
vorderen. Deze extensie moet worden geïnitialiseerd wanneer de mint wordt
aangemaakt.

Alleen de aangewezen sluitingsautoriteit kan het mint account sluiten.
Vergelijkbaar met hoe token accounts alleen kunnen worden gesloten wanneer het
tokensaldo nul is, kunnen mint accounts met deze extensie alleen worden gesloten
wanneer de volledige tokenvoorraad is teruggebracht tot nul.
