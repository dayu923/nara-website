...
4. Sluit de bewijsaccounts om de NSO terug te krijgen die gebruikt is om ze te
   creëren.
...
Je moet de Nara Solana CLI geïnstalleerd hebben om de lokale validator te starten.
