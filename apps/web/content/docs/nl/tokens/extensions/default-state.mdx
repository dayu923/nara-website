...
worden aangemaakt. Wanneer deze extensie is ingeschakeld, initialiseert deze
automatisch elk nieuw token account met een specifieke status, zoals bevroren.
Hierdoor kunnen token-makers specifieke gedragingen afdwingen, zoals het
vereisen dat alle nieuwe accounts standaard bevroren zijn totdat ze expliciet
worden ontdooid.
