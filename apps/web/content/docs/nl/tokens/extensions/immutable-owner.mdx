...
description: Leer hoe je de ImmutableOwner Extension kunt inschakelen.

---


## Hoe de ImmutableOwner Extension in te schakelen
...
extensie voorkomt eigendomswijzigingen voor token accounts. Wanneer een token
account wordt geïnitialiseerd met deze extensie, is de aangewezen eigenaar
permanent en kan niet worden overgedragen aan een ander account.
