...
title: Memo-overdracht
description: Leer hoe je de MemoTransferExtension kunt inschakelen.

---


## Hoe de MemoTransferExtension in te schakelen
...
vereist dat alle inkomende token-overdrachten vergezeld gaan van een memo
wanneer deze is ingeschakeld op een token account. Deze extensie kan worden in-
of uitgeschakeld door de eigenaar van het token account.
