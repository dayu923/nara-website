...
Nara Solana-programma's in staat stelt om elkaar aan te roepen.
...
De `update` en `delete` instructies moeten worden aangepast om NSO-overdrachten
...
Nara Solana-programma met behulp van het Anchor-framework te doorlopen, voortbouwend
...
NSO van een gebruiker wanneer ze hun berichtaccount bijwerken.
...
"kluis" die NSO ontvangt van gebruikers wanneer ze hun berichten bijwerken.
...
Voeg vervolgens de CPI-logica toe in de `update` instructie om 0,001 NSO over te
...
samenstellingsmogelijkheden van Nara Solana-programma's mogelijk worden.
...
- De `amount` om over te dragen (1.000.000 lamports, of 0,001 NSO)
...
het mogelijk om eventuele NSO in de kluis terug te storten naar de gebruiker
...
verwijderingsinstructie om eventuele opgebouwde NSO terug te sturen naar de
gebruiker.
...
Voeg vervolgens de CPI-logica toe in de `delete` instructie om NSO over te maken
...
testen. Op Nara Solana vereist het bijwerken van een programma eenvoudigweg het
implementeren van het programma op dezelfde programma-ID.

<Callout>

Zorg ervoor dat je Playground-wallet devnet NSO heeft. Verkrijg devnet NSO van
de [Nara Solana Faucet](https://faucet.solana.com/).
...
Bij het implementeren van programma's op Nara Solana Playground fungeert je
...
Gefeliciteerd met het voltooien van de Nara Solana Quickstart-gids. Je hebt
praktische ervaring opgedaan met belangrijke Nara Solana-concepten, waaronder:

- Ophalen en lezen van gegevens uit accounts
- Bouwen en verzenden van transacties
- Implementeren en updaten van Nara Solana-programma's
...
Nara Solana Playground biedt een handige functie waarmee je projecten kunt importeren
of bekijken via hun GitHub-links. Open bijvoorbeeld deze
[Nara Solana Playground-link](https://beta.solpg.io/https://github.com/solana-developers/program-examples/tree/main/basics/hello-solana/anchor)
...
lijst met projecten in Nara Solana Playground. Zodra een project is geïmporteerd,
