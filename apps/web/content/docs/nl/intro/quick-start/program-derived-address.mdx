...
Deze handleiding leidt je door het bouwen en testen van een Nara Solana-programma met
...
Begin door deze
[Nara Solana Playground-link](https://beta.solpg.io/66734b7bcffcf4b13384d1ad) te
openen met de starterscode. Klik vervolgens op de knop "Import" om het programma
toe te voegen aan je Nara Solana Playground-projecten.
...
<Callout type="info">
In dit voorbeeld implementeer je het programma op het devnet, een Nara Solana-cluster
voor ontwikkelingstests.

De Playground-wallet maakt standaard verbinding met het devnet. Zorg ervoor dat
je Playground- wallet devnet NSO heeft om te betalen voor de
programma-implementatie. Verkrijg devnet NSO via de
...
Nara Solana Playground verwijdert enkele standaard setup code waarbij
...
aanroept, waarbij "Hello, Nara Solana!" als het nieuwe bericht wordt doorgegeven.
