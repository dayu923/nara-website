...
Lees gegevens van het Nara Solana-netwerk door verschillende accounts op te halen.
Dit gedeelte helpt je de structuur van Nara Solana [accounts](/docs/core/accounts) te
begrijpen. Elk Nara Solana-account heeft een uniek
...
voornamelijk gebruikt om NSO te bewaren en transacties te ondertekenen. Wanneer
NSO voor het eerst naar een nieuw adres wordt verzonden, wordt automatisch een
systeemaccount aangemaakt.

Het onderstaande voorbeeld genereert een [nieuw keypair](mention:keypair),
[vraagt NSO aan](mention:airdrop) om het nieuwe openbare sleuteladres te
...
Het `lamports` veld bevat het NSO-saldo van het account, in
...
Nara Solana-programma's bieden clientbibliotheken met hulpfuncties die het
...
data bekijken in de Nara Solana Explorer.
