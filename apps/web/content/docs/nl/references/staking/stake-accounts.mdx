...
Een stake-account op Nara Solana kan worden gebruikt om tokens te delegeren aan
...
systeemaccount kan alleen NSO verzenden en ontvangen van andere accounts op het
...
Stake-accounts op Nara Solana werken ook anders dan die van andere Proof-of-Stake
blockchain-netwerken waarmee je misschien bekend bent. Dit document beschrijft
de structuur en functies van een Nara Solana stake-account op hoofdlijnen.
...
Net als andere soorten accounts op het Nara Solana-netwerk wordt een stake-account
met een saldo van 0 NSO niet meer bijgehouden. Als een stake-account niet is
...
[Nara Solana Explorer](http://explorer.solana.com/) door een account- adres te
