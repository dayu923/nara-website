...
Geeft de slot-leiders terug voor een bepaald slot-bereik
...
Limiet, als u64 integer (tussen 1 en 5.000)
...
Array van node-identiteit publieke sleutels als base-58 gecodeerde strings.
