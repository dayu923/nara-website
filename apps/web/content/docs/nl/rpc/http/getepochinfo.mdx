...
Geeft informatie over de huidige epoch
...
De huidige slot ten opzichte van het begin van de huidige epoch

##### !! slotsInEpoch

!type u64

Het aantal slots in deze epoch

##### !! transactionCount

!type u64 | null

Totaal aantal transacties zonder fouten verwerkt sinds genesis
