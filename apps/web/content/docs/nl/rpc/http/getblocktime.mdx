...
Geeft de geschatte productietijd van een blok terug.

<Callout type="info">
  Elke validator rapporteert regelmatig hun UTC-tijd aan het grootboek door af
  en toe een tijdstempel toe te voegen aan een Vote voor een specifiek blok. De
  tijd van een opgevraagd blok wordt berekend uit het stake-gewogen gemiddelde
  van de Vote tijdstempels in een reeks recente blokken die zijn vastgelegd in
  het grootboek.
</Callout>
