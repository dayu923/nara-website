...
Geeft de specifieke inflatiewaarden voor de huidige epoch terug
...
Inflatie toegewezen aan validators

##### !! foundation

!type f64

Inflatie toegewezen aan de stichting

##### !! epoch

!type u64

Epoch waarvoor deze waarden geldig zijn
