...
h1: requestAirdrop RPC-methode

---


Vraagt een airdrop van lamports aan voor een pubkey
...
Pubkey van het account dat lamports ontvangt, als een base-58 gecodeerde string
...
Aantal lamports om te airdroppen
...
Transactiehandtekening van de airdrop, als een base-58 gecodeerde string
