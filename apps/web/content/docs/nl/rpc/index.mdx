...
title: Nara Solana RPC-methoden
seoTitle: "Nara Solana RPC-methoden: HTTP & Websockets"
hideTableOfContents: false
h1: Nara Solana RPC-methoden & documentatie

---


Communiceer direct met Nara Solana-nodes via de JSON RPC API met behulp van HTTP- en
Websocket-methoden.

## Configureren van state commitment

Voor preflight-controles en transactieverwerking kiezen Nara Solana-nodes welke bank
...
eigenaarsprogramma. Nara Solana-nodes ondersteunen momenteel JSON-parsing voor de
