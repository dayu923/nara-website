...
Alle gegevens op het Nara Solana-netwerk worden opgeslagen in accounts. Je kunt het
Nara Solana-netwerk zien als een openbare database met één Accounts-tabel. De relatie
...
het account op de Nara Solana-blockchain te lokaliseren. Account-adressen worden vaak
...
adres, maar dit is niet vereist, aangezien Nara Solana ook
...
Het onderstaande voorbeeld laat zien hoe je de Nara Solana SDK kunt gebruiken om een
...
optionele inputs (seeds). Het onderstaande voorbeeld laat zien hoe je de Nara Solana
...
Het lezen van gegevens uit een Nara Solana-account omvat twee stappen:
...
Elk Nara Solana-account heeft een [programma](/docs/core/programs) aangewezen als
...
kenmerk van Nara Solana's accountmodel. (Vergelijkbaar met besturingssystemen, die
...
Wanneer NSO voor het eerst naar een nieuw adres wordt verzonden, wordt er een
...
gefinancierd met NSO. Na het uitvoeren van de code kun je zien dat het adres van
