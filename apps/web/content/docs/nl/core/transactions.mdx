...
Om met het Nara Solana-netwerk te communiceren, moet je een transactie versturen. Je
...
<Callout>
  ...
  pakket passen zonder fragmentatie, gebruikt Nara Solana 1280 bytes (de minimale MTU
...
NSO-overdrachtsinstructie bevat.
...
<Callout>
  Je kunt de transactie ook vinden met behulp van [Nara Solana
