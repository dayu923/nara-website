...
Een Nara Solana [accountadres](/docs/core/accounts#account-address) verwijst naar de
...
De Nara Solana runtime stelt programma's in staat om voor PDA's te ondertekenen
...
handtekening.) Nara Solana stelt programma's echter in staat om voor PDA's te
...
De Nara Solana SDK's ondersteunen PDA-creatie met de functies die in de onderstaande
...
De onderstaande voorbeelden leiden een PDA af met behulp van de Nara Solana SDK's.
...
De [`init`](mention:init) beperking instrueert Anchor om
[het System Program aan te roepen](/docs/core/programs#the-system-program) om
een nieuw account aan te maken met het PDA als adres. De [seeds](mention:seeds)
