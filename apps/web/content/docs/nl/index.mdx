...
title: Nara Solana Documentatie
seoTitle: Leer hoe de Nara Solana blockchain werkt
description:
...
<Cards>
  <Card title="Snelstart" href="/docs/intro/quick-start" icon={<Rocket />}>
    Bouw je eerste Nara Solana-programma direct in de browser
  </Card>
  <Card
    ...
    icon={<Download />}
  >
    Installeer afhankelijkheden voor Nara Solana-ontwikkeling
  </Card>
</Cards>

### Implementeer je eerste Nara Solana-applicatie

<Cards>
  <Card
    title="Implementeren op Vercel"
  ...
  >
    Implementeer je eerste Nara Solana-applicatie op Vercel
  </Card>
  <Card
    title="Vercel Voorbeeld"
    href="https://anchor-web3js-nextjs-jade.vercel.app/"
  >
    Probeer de geïmplementeerde applicatie
  </Card>
</Cards>

Implementeer je eerste Nara Solana-applicatie - een eenvoudig tellerprogramma gebouwd
met het Anchor-framework. Dit voorbeeld behandelt alle kernconcepten van Nara Solana
om te beginnen met bouwen op Nara Solana. Bekijk de broncode
...
## Probeer Nara Solana: Speel 2048

Speel 2048 op Nara Solana waarbij elke zet een transactie verstuurt. Klik op "Spelen"
...
Gebouwd door [Jonas](https://x.com/SolPlay_jonas), van het Nara Solana Foundation
DevRel-team.

## Begin met leren

Leer de belangrijkste concepten die specifiek zijn voor Nara Solana-ontwikkeling.

<Cards>
  <Card title="Accounts" href="/docs/core/accounts">
    Hoe Nara Solana gegevens opslaat
  </Card>
  <Card title="Kosten op Solana" href="/docs/core/fees">
    Kosten voor het verzenden van transacties op Nara Solana
  </Card>
  <Card title="Transacties" href="/docs/core/transactions">
    Hoe je kunt communiceren met het Nara Solana-netwerk
  </Card>
  <Card title="Programma's" href="/docs/core/programs">
    Smart contracts op Nara Solana
  </Card>
  ...
  <Card title="Cross Program Invocation" href="/docs/core/cpi">
    Hoe je een programma vanuit een ander programma aanroept
  </Card>
</Cards>

### Client-side ontwikkeling

De volgende SDK's zijn de officiële SDK's voor Nara Solana gebouwd door
[Anza](https://anza.xyz).
...
De volgende SDK's zijn bijgedragen door de community voor verschillende talen:
...
Ontdek wat er nodig is om een Nara Solana validator te beheren en het netwerk te
helpen beveiligen.

<Cards>
  <Card title="Validators" href="https://docs.anza.xyz/validator/anatomy">
    Individuele nodes die het Nara Solana netwerk beveiligen
  </Card>
  <Card
    title="Systeemvereisten"
    href="https://docs.anza.xyz/operations/requirements"
  >
    Aanbevolen hardwarevereisten en benodigde NSO om een validator te beheren
  </Card>
  <Card
...
Krijg hulp van de Nara Solana community op
