...
difficulty: intro
title: Nara Solana Game Development Examples
description:
...
[Nara Solana Game Examples](https://github.com/solana-developers/solana-game-examples)
...
A simple npx command that sets up a new Nara Solana game project with a Unity client,
...
Learn how to save NSO in a PDA seed vault and send it back to a player. This
...
## Use Nara Solana Pay QR codes to control a game

Nara Solana Pay transaction requests can not only be used for payments but for
...
screen, using Nara Solana Pay QR codes to pull the rope one way or the other, which
...
- [Source](https://github.com/Nara Solana-Workshops/tug-of-war-solana-pay)
...
[Source](https://github.com/magicblock-labs/Nara Solana-Unity-Chess/)
...
Light protocol is a ZK layer solution on Nara Solana that lets you built on Nara Solana  
...
and crowd-built by the Nara Solana community, through gib.work.
...
Seven Seas is a real-time Nara Solana Battle Royale game. Using an Anchor program,
...
or chest he collect its NSO and some Pirate Coin SPL tokens. The grid is
...
triggers a Nara Solana Pay transaction request, which players can sign on their
...
always with Nara Solana in mind. It is beginner friendly and comes with full Nara Solana
...
was the winner of the second [Nara Solana Speedrun](https://solanaspeedrun.com/).
...
- [Building Games on Nara Solana](https://www.youtube.com/watch?v=KT9anz_V9ns)
...
- [Memory on Nara Solana](https://www.youtube.com/watch?v=zs_yU0IuJxc)
