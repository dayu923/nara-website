...
difficulty: beginner
title: Hello World for Nara Solana Game Development
description:
...
Nara Solana blockchain. This game, lovingly called _Tiny Adventure_, is a
beginner-friendly Nara Solana program created using the
...
> in this
> [Nara Solana Playground example](https://beta.solpg.io/tutorials/tiny-adventure).
...
To help make our initial Nara Solana development faster, we will use the Nara Solana
...
started with Nara Solana development.
...
Playground Wallet. Here is an example of how to use Nara Solana Playground:

![Setting up the Nara Solana Playground](/assets/guides/hello-world/solpg.gif)
...
[instruction handlers](/docs/core/transactions#instruction):
...
With the program completed, it's time to build and deploy it on Nara Solana
Playground!

If this is your first time using Nara Solana Playground, create a Playground Wallet
first and ensure that you're connected to a Devnet endpoint. Then, run
`solana airdrop 5`. Once you have enough NSO, build and deploy the program. If
the command fails you there are other ways on
[how to get devnet NSO](/developers/guides/getstarted/solana-token-airdrop-and-faucets)
here.
...
explanations for each step. In Nara Solana Playground, navigate to the `client.ts`
...
submitting a transaction to the Nara Solana network.
...
Finally, run the client by clicking the “Run” button in Nara Solana Playground. The
...
2. Add a chest that rewards players with
   [NSO Rewards](/developers/guides/games/store-sol-in-pda) or let the player
   collect coins and
...
where we will demonstrate how to store NSO in the program and distribute it to
players as rewards.

### More Resources

You can also discover more Nara Solana game development resources here:

- [Getting Started Guide](/developers/guides/games/getting-started-with-game-development)
- [Nara Solana Gaming SDKs](/developers/docs/clients/game-sdks)
