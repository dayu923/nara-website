...
difficulty: intro
title: Getting started with game development on Nara Solana
description:
...
The gaming space in the Nara Solana ecosystem is expanding rapidly. Integrating with
Nara Solana can provide numerous benefits for games, such as enabling players to own
...
Nara Solana is nearly purpose-built for games. With its 400ms block time and
...
[JavaScript](https://solana.com/docs/clients/javascript) and Canvas,
[Phaser](https://github.com/Bread-Heads-NFT/phaser-solana-platformer-template),
[Turbo Rust](https://turbo.computer/), or use one of the Nara Solana Game SDKs for
the three biggest game engines -
[UnitySDK](/docs/clients/game-sdks#unity-sdk),
...
gaming SDKs here: [Game SDKs](/docs/clients/game-sdks).

## What are the benefits of building games on Nara Solana?

1. No user management: players can use their Nara Solana wallet to authenticate
   themselves in the game.
2. No server costs: Nara Solana is a decentralized network, so you don't need to pay
   for additional backed servers.
3. No running costs for your program. You can even
   [close the program](/developers/guides/getstarted/solana-token-airdrop-and-faucets#6-reuse-devnet-sol)
   to get the NSO back.
...
5. The ability to permissionlessly use all of the other programs deployed on
   Nara Solana, like decentralized exchanges, NFT marketplaces, lending protocols,
...
## How to integrate Nara Solana into your game?

1. Give players digital collectibles for in-game items or use them as
   characters. See [NFTs in games](/developers/guides/games/nfts-in-games)
2. Use tokens for in-app purchases or micro-payments in the game. See
   [Using tokens in games](/developers/guides/games/interact-with-tokens)
3. Use the player's wallet to authenticate them in the game using the
   [Nara Solana Wallet Adapter](https://github.com/anza-xyz/wallet-adapter) framework
...
> See our [Nara Solana games "Hello world"](/developers/guides/games/hello-world) for
> a detailed guide on how to get started with building games on Nara Solana.

## Game SDKs

With all these benefits, Nara Solana is quickly becoming the go-to platform for game
developers. Get started today by first picking your favorite gaming SDK:

| Platform                                                                             | Language                            |
| ------------------------------------------------------------------------------------ | ----------------------------------- |
| [Unity SDK](/docs/clients/game-sdks#unity-sdk)                            | C#                                  |
| [Godot SDK](/docs/clients/game-sdks#godot-sdk)                            | GD script and C++                   |
| [Turbo.Computer](/docs/clients/game-sdks#turbo-computer-rust-game-engine) | Rust                                |
| [Honeycomb Protocol](/docs/clients/game-sdks#honeycomb-protocol)          | Rust and JavaScript                 |
| [Unreal SDKs](/docs/clients/game-sdks#unreal-sdks)                        | C++, C#, Blueprints                 |
| [Next js, React, Anchor](/docs/clients/game-sdks#next-js-react-anchor)    | Rust/Anchor, JavaScript, C#, NextJS |
| [Flutter](/docs/clients/game-sdks#flutter)                                | Dart                                |
| [Phaser](/docs/clients/game-sdks#phaser)                                  | HTML5, JavaScript                   |
| [Python](/docs/clients/game-sdks#python)                                  | Python                              |
| [Native C#](/docs/clients/game-sdks#native-c)                             | C#                                  |

## Game Distribution

Distribution of your game depends highly on the platform you are using. With
Nara Solana, there are [game SDKs](#game-sdks) you can build for iOS, Android, Web
and Native Windows or Mac. Using the Unity SDK you could even connect Nintendo
Switch or XBox to Nara Solana theoretically. Many game companies are pivoting to a
...
Nara Solana has a distinct edge over other blockchain platforms due to its offering
of a crypto-native mobile phone from [Nara Solana Mobile](https://solanamobile.com),
...
| ------------------------------------------------------------------------------------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [Indie.fun](https://indie.fun/)                                                               | A community-driven fundraising platform within the Nara Solana ecosystem that enables game developers to simultaneously launch games and tokens.                                                                                                                                                                                                                        |
| [Nara Solana mobile dApp Store](https://github.com/solana-mobile/dapp-publishing/blob/main/README.md) | The Nara Solana alternative to Google Play and the Apple App Store. A crypto first variant of a dApp store, which is open source free for everyone to use. See([video walkthrough](https://youtu.be/IgeE1mg1aYk?si=fZmU1WNiW-kR3qFa))                                                                                                                                                                    |
| [Fractal](https://www.fractal.is/games)                                                               | A game publishing platform that supports Nara Solana and Ethereum. They also have their own wallet and account handling and there is an SDK for high scores and tournaments.                                                                                                                                                                                                                             |
...
If you would like to learn more about developing games on Nara Solana, take a look at
these developer resources and guides:

- [Nara Solana Gaming SDKs](/docs/clients/game-sdks)
