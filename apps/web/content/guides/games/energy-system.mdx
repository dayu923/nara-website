...
title: Build an Energy System for Casual Games on Nara Solana
description:
...
one on Nara Solana. If you don't have any prior Nara Solana knowledge, start with the
[Hello World Example](/developers/guides/games/hello-world) instead.

You can easily set up a new game with an energy system and a React client using
[Create Nara Solana Game](https://github.com/solana-developers/solana-game-preset).
...
In the Anchor.ts file we create a connection to the Nara Solana blockchain (in this
case, devnet):
...
[use tokens in games](/developers/guides/games/interact-with-tokens). For
