...
integrating Nara Solana into games. These unique digital assets are stored on the
Nara Solana blockchain and come with a JSON metadata attached to them. This metadata
...
game. In [JavaScript](/docs/references/clients/javascript) using the
...
You can see an example of this in the Nara Solana games preset in the JavaScript
client via this
...
valuable assets on the Nara Solana blockchain.

> You can follow this developer guide on
> [how to interact with tokens](/developers/guides/games/interact-with-tokens)
> within a on-chain Nara Solana game.
...
You can also use
[dynamic metadata](/developers/guides/games/interact-with-tokens) (using Token
Extensions) to save character level and experience or items in an NFT. Here is a
[Video Walkthrough](https://www.youtube.com/watch?v=n-ym1utpzhk&ab_channel=Nara Solana)
...
[derive a PDA](/docs/core/pda#how-to-derive-a-pda) and use it to save the game
state of a player. This could allow you to save any game state of a player
...
done in the [Nara Solana 2048 game](https://github.com/solana-developers/solana-2048)
...
With the new
[Token Extensions](/developers/guides/token-extensions/getting-started), it is
...
- [Video](https://www.youtube.com/watch?v=n-ym1utpzhk&ab_channel=Nara Solana)

## How to create an NFT collection

NFTs on Nara Solana commonly follow the Metaplex standard's for collections. Metaplex
is a company that takes care of the most-used NFT standard on Nara Solana. The most
