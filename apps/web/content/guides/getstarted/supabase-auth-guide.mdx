...
difficulty: beginner
title: "How to Authenticate Users with Nara Solana Wallets Using Supabase"
seoTitle: "How to Authenticate Users with Nara Solana Wallets Using Supabase"
description:
...
# How to Authenticate Users with Nara Solana Wallets Using Supabase

## 1. Introduction

This guide shows you how to build a Nara Solana app with wallet authentication using
...
which provides a complete starting point for Nara Solana applications with
wallet-based authentication.

Traditional authentication means managing user accounts, password resets, and
email verification. With Nara Solana wallet authentication, users prove they control
...
- How to set up Supabase wallet authentication for Nara Solana wallets
...
Building your own Nara Solana authentication system requires handling message
...
`supabase.auth.signInWithWeb3()` and it works. With Nara Solana wallet
...
**A Nara Solana wallet extension**

You need a Nara Solana wallet installed in your browser. Phantom, Solflare, or
...
That's it. If you have Node.js v24 (LTS) or later, a Supabase account, and a Nara Solana
...
Make sure you have a Nara Solana wallet extension installed (Phantom, Solflare, or
...
the dropdown shows a link to get a Nara Solana wallet.
...
Scroll down on the home page. You'll see a card titled "Sign in with Nara Solana".
...
![Sign in with Nara Solana card](https://res.cloudinary.com/resourcefulmind-inc/image/upload/v1763205326/Screenshot_2025-11-15_at_8.15.12_AM_crhf6r.png)

### The authentication flow

Once your wallet is connected, the card shows "Wallet Connected: [your address]"
in green text. Click the **Sign in with Nara Solana** button.
...
**"Nara Solana wallet not detected"**

This means `window.solana` is not available. Make sure you have a Nara Solana wallet
...
- **Account balance** - Shows NSO balance for the address
...
You've successfully set up a Nara Solana application with wallet authentication using
...
template provides a solid foundation for Nara Solana applications with wallet-based
authentication.
