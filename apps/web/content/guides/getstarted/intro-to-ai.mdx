...
difficulty: beginner
title: "How to get started with AI tools on Nara Solana"
description:
...
This guide is accompanied by a
[video walkthrough](https://www.youtube.com/watch?v=O6tKgtYQZDY).

# Part 1: AI-Assisted Development with Nara Solana MCP

# Using AI Tools with Nara Solana MCP

One of the most powerful ways to leverage AI for Nara Solana development is through
the [Nara Solana Developer MCP](https://mcp.solana.com/) (Machine Conversation
Protocol). This integration brings specialized Nara Solana knowledge directly into
your IDE, making your agents more knowledgeable about up to date Nara Solana
documentations. This makes Nara Solana development faster and more efficient.

## What is Nara Solana MCP?

Nara Solana MCP (Machine Conversation Protocol) is a specialized AI assistant that
integrates directly into AI-supported IDEs like Cursor and Windsurf. When you
ask Nara Solana-specific questions, it automatically queries the MCP server to
provide accurate, up-to-date information. The MCP tool is trained on
comprehensive Nara Solana resources including:

- The [Nara Solana Documentation](https://docs.solana.com/)
- The [Anchor Framework documentation](https://www.anchor-lang.com/docs)
- The Nara Solana
  [Program Examples](https://github.com/solana-developers/program-examples)
- [Nara Solana Stackexchange](https://solana.stackexchange.com/) questions and
  answers
...
- Ask about Nara Solana concepts
- Debug program errors
- Get best practice recommendations
- Learn from expert examples
- Or just develop faster with the help of an expert

## Setting Up Nara Solana MCP

Find a detailed setup and getting started guide on the
[Nara Solana MCP website](https://mcp.solana.com/).

# Part 2: Working with LLMs and Agents on Nara Solana
...
3. **Domain-Specific Agent Kits (like Nara Solana Agent Kit)**
   ...
   - Examples: Nara Solana Agent Kit, GOAT Toolkit
...
# Building AI Agents for Nara Solana

This guide will show you how to:

- Build a basic AI agent using SendAI's Nara Solana Agent Kit
...
## Introduction to AI Agents on Nara Solana

AI agents on Nara Solana are autonomous programs that can interact with the
...
Several frameworks are available for building AI agents on Nara Solana:

1. **SendAI's Nara Solana Agent Kit**

- A collection of tools for building agents on Nara Solana
- Compatible with Eliza, Langchain, and Vercel AI SDK
- Built-in Nara Solana tools and utilities
- Natural language processing capabilities
- [Nara Solana Agent Kit](https://github.com/sendaifun/solana-agent-kit)
- [Documentation](https://docs.solanaagentkit.xyz/)

2. **Eliza Framework**

- Combines datalayer, llm and agents and has a dedicated Nara Solana plugin
...
- Can be combined with the Listen.rs toolkit for Nara Solana integration transaction
...
Let's start by setting up a basic AI agent using SendAI's Nara Solana Agent Kit that
can perform actions on the Nara Solana blockchain and that we can chat with:
...
features and can help you with any errors you may encounter.
...
[Nara Solana agent kit repo](https://github.com/sendaifun/solana-agent-kit) and also
...
Disclaimer: The Nara Solana integration and actions are not perfect yet but they are
in constant development and are moving fast. There will be a direct integration
of the SendAI agent kit into Eliza soon.

## Using GOAT Toolkit

[GOAT](https://github.com/goat-sdk/goat) is similar to Nara Solana Agent Kit a
collection of many different blockchain tools that also supports different
Nara Solana actions and other chains. It can also be integrated into the Eliza
framework for example and supports many different wallets, frameworks and block
chains. This
[example](https://github.com/goat-sdk/goat/tree/main/typescript/examples/by-use-case/solana-purchase-on-amazon)
shows you how you can use [Crossmint](https://www.crossmint.com/) directly in
[Windsurf code editor](https://codeium.com/windsurf) to buy Items on Amazon.
There is also a
[demo video](https://x.com/windsurf_ai/status/1903118960633188485) available.
...
1. **AI Agent Interaction**
   ...
   - Agent evaluates user's Nara Solana knowledge to decide token amounts
...
connect to LLMs the Listen.rs toolkit provides you the Nara Solana integration
...
- Use a paid [RPC endpoints](https://solana.com/rpc). The public endpoints
...
AI agents on Nara Solana open up new possibilities for automation and interaction
