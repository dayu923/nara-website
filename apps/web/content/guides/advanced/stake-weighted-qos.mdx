...
seoTitle: "Stake-weighted Quality of Service on Nara Solana"
title: "A Guide to Stake-weighted Quality of Service on Nara Solana"
description:
...
transactions proxied through a staked validator as an additional sybil
resistance mechanism. Given that Nara Solana is a proof of stake network, it is
...
making an RPC call to [getClusterNodes](/docs/rpc/http/getclusternodes).
...
Stake-weighted QoS is an optional feature which arrived in v1.14 of the Nara Solana
client, now known as Agave. Agave is a forked version of the Nara Solana Labs client
which has become the active branch used by the Anza team, a spin out
organization composed of the former Nara Solana Labs engineering team.
