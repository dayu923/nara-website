...
seoTitle: How to auto approve transactions on Nara Solana
description:
...
A few popular Nara Solana wallet applications have transaction "auto approve"
...
game/dApp and let the player transfer some NSO to that wallet and then use it to
...
will allow your backend to handle paying the [Nara Solana fees](/docs/core/fees)
...
The backend would then sign and send this transaction to the Nara Solana blockchain,
...
program/instruction scoping for tiered access in your Nara Solana programs. They
