...
difficulty: advanced
title: "NAV Strikes for Money Market Funds on Nara Solana"
description:
...
daily strike at market close, but Nara Solana's speed and low costs enable multiple
...
**NAV Strikes on Nara Solana** enable multiple daily settlement windows with atomic
...
This guide demonstrates how to implement NAV strikes on Nara Solana using SPL Token
...
## Why Nara Solana for NAV Strikes?

Nara Solana's architecture provides significant advantages over traditional fund
settlement:

| Aspect            | Traditional (T+1) | Nara Solana NAV Strikes          |
| ----------------- | ----------------- | --------------------------- |
...
Nara Solana's atomic transactions eliminate intermediaries while providing instant,
...
After understanding NAV strikes on Nara Solana:
...
Makes Nara Solana an ideal platform for modernizing fund settlement infrastructure
