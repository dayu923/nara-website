...
With the
[Token Extension program](/developers/guides/token-extensions/getting-started),
you can create NFTs and digital assets using the metadata extensions. Together,
these extensions
([metadata pointer and token metadata](/developers/guides/token-extensions/metadata-pointer))
...
[web3 games](/solutions/games-tooling) since we can now have
...
based NFTs and custom metadata using an [Anchor program](https://www.anchor-lang.com/docs).
...
You can find a video walkthrough of this example on the Nara Solana Foundation
Youtube channel:
...
[on-chain program](/docs/core/programs).
...
The example above is based on the Nara Solana Games Preset, which generates you a
scaffold that includes a JavaScript and Unity client for this game, including
the configuration for interacting with the Nara Solana Anchor program.
...
[setup your local environment](/docs/intro/installation) for Nara Solana development,
...
your Nara Solana local test validator to have the program deployed (and keep the
...
Then you can set the [Nara Solana Explorer](https://explorer.solana.com/) to use your
...
If you can't get devnet NSO you can copy your address from the console and
...
### Connect to the Nara Solana test validator in Unity

If you want to avoid having to worry about maintaining devnet NSO, you can
