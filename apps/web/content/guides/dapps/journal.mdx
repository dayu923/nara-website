...
difficulty: intro
title: "How to create a CRUD dApp on Nara Solana"
description:
...
In this guide, you will learn how to create and deploy both the Nara Solana program
...
- Deploying a Nara Solana program
...
- [Nara Solana CLI & Anchor](/docs/intro/installation)
...
This CLI command enables quick Nara Solana dApp creation. You can find the source
...
## Writing a Nara Solana program with Anchor
...
to the account. Since Nara Solana onchain programs do not have storage, the data is
...
[rent](/docs/references/terminology#rent) to hold this account's data on-chain
...
Because how the Nara Solana blockchain handles reading from accounts and writing to
accounts differently, we must explicitly define which accounts will be mutable
so the Nara Solana runtime can correctly process them.

Note: In Nara Solana, when you perform a reallocation, which changes the account's
...
## Connecting a Nara Solana program to a UI
