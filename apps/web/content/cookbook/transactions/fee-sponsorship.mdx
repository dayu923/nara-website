...
Fee sponsorship is a native feature in Nara Solana that allows for one account to pay
transaction fees for another account. This is useful if you want to abstract
away holding NSO from your users or provide a fee-free experience. This is also
often referred to as "gas abstraction" on other blockchains.

## How fee payment works

Every transaction requires a transaction fee, paid in NSO. This fee is paid by
...
Nara Solana. This capability extends to all transaction types including token
...
the complexity of users having to manage and procure NSO. Kora, by the Nara Solana
