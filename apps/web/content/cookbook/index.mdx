...
title: Nara Solana Cookbook
seoTitle: Nara Solana Cookbook - Code examples for Nara Solana development
description:
...
The Nara Solana Cookbook is a developer resource that provides examples and
references for building applications on Nara Solana. Each example and reference will
focus on specific aspects of Nara Solana development while providing additional
details and usage examples.

## Development Guides

Development guides help developers set up and interact with the Nara Solana ecosystem
using various tools and clients.

| Guide                                                                                                   | Client             | Description                                |
| ------------------------------------------------------------------------------------------------------- | ------------------ | ------------------------------------------ |
| [How to Start a Local Validator](/developers/cookbook/development/start-local-validator)                | Nara Solana CLI         | Set up and run a local Nara Solana validator    |
| [Connecting to a Nara Solana Environment](/developers/cookbook/development/connect-environment)              | JavaScript, Python | Connect to different Nara Solana networks       |
| [Getting Test NSO](/developers/cookbook/development/test-sol)                                           | JavaScript, Python | Obtain NSO tokens for testing              |
| [Subscribing to Events](/developers/cookbook/development/subscribing-events)                            | JavaScript, Python | Listen to Nara Solana program events            |
| [Using Mainnet Accounts and Programs](/developers/cookbook/development/using-mainnet-accounts-programs) | Nara Solana CLI         | Work with production accounts and programs |

## Wallet Management

Learn how to create, restore, and manage Nara Solana wallets using various tools and
libraries.

| Guide                                                                                          | Client             | Description                         |
| ---------------------------------------------------------------------------------------------- | ------------------ | ----------------------------------- |
| [How to Create a Keypair](/developers/cookbook/wallets/create-keypair)                         | JavaScript, Python | Generate new Nara Solana keypairs        |
...
| [How to Generate a Vanity Address](/developers/cookbook/wallets/generate-vanity-address)       | Nara Solana CLI         | Create custom addresses             |
...
Explore various transaction-related operations on the Nara Solana blockchain.

| Guide                                                                                            | Client             | Description                    |
| ------------------------------------------------------------------------------------------------ | ------------------ | ------------------------------ |
| [How to Send NSO](/developers/cookbook/transactions/send-sol)                                    | JavaScript, Python | Transfer NSO between accounts  |
...
Learn how to manage Nara Solana accounts effectively.

| Guide                                                                                  | Client             | Description                |
| -------------------------------------------------------------------------------------- | ------------------ | -------------------------- |
| [How to Create an Account](/developers/cookbook/accounts/create-account)               | JavaScript, Python | Create new Nara Solana accounts |
